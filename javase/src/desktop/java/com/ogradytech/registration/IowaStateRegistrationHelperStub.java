 ...
 * @author Shai Almog
 */
public class IowaStateRegistrationHelperStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "IowaStateRegistrationHelper";
    ...
    private IowaStateRegistrationHelper mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new IowaStateRegistrationHelperStub());
    }
        ...
        Display.getInstance().callSerially(new Runnable() {
            ...
            public void run() {
                if(Display.getInstance().isEdt()) {
                    mainApp = new IowaStateRegistrationHelper();
                    mainApp.init(this);
                    mainApp.start();
