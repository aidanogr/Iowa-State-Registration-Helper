...
JAVA_VOID com_codename1_ui_Form___INIT_____com_codename1_ui_layouts_Layout(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_Label_getText___R_java_lang_String(threadStateData, get_field_com_codename1_ui_Form_title(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1735872041;
    if (virtual_com_codename1_ui_Label_shouldTickerStart___R_boolean(threadStateData, get_field_com_codename1_ui_Form_title(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1735872041;
...
JAVA_VOID com_codename1_ui_Form_revalidateLater___com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_util_Set_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_Form_pendingRevalidateQueue(__cn1ThisObject), locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1235678342;
...
label_L885459806:
    ...
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L352185757;
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Container_contains___com_codename1_ui_Component_R_boolean(threadStateData, locals[3].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L197535883;
...
label_L197535883:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Container_contains___com_codename1_ui_Component_R_boolean(threadStateData, locals[1].data.o, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1245434971;
...
JAVA_VOID com_codename1_ui_Form_flushRevalidateQueue__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_java_util_Set_isEmpty___R_boolean(threadStateData, get_field_com_codename1_ui_Form_pendingRevalidateQueue(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1328388446;
...
label_L1637411253:
    if (ilocals_2_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1964335680;
...
JAVA_VOID com_codename1_ui_Form_setCurrentInputDevice___com_codename1_ui_VirtualInputDevice(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_currentInputDevice(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L278166606;
...
JAVA_VOID com_codename1_ui_Form_initGlobalToolbar__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_Toolbar_isGlobalToolbar___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L912784040;
...
JAVA_INT com_codename1_ui_Form_getInvisibleAreaUnderVKB___com_codename1_ui_Form_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L391575500;
...
JAVA_INT com_codename1_ui_Form_getInvisibleAreaUnderVKB___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_bottomPaddingMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L825791803;
    __CN1_DEBUG_INFO(492);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L825791803:
    __CN1_DEBUG_INFO(494);
    if (get_field_com_codename1_ui_Form_overrideInvisibleAreaUnderVKB(__cn1ThisObject)<0) /* IFLT CustomJump */ goto label_L41810270;
...
JAVA_VOID com_codename1_ui_Form_initAdPadding___com_codename1_ui_Display(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L722378544;
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[2].data.o)<=0) /* IFLE CustomJump */ goto label_L722378544;
...
JAVA_OBJECT com_codename1_ui_Form_createStatusBar___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L858846125;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L256004657;
...
label_L858846125:
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2842), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1555928242;
...
JAVA_VOID com_codename1_ui_Form_initTitleBarStatus__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_Form_shouldPaintStatusBar___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1969925628;
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() != JAVA_NULL) /* IFNONNULL */ goto label_L1969925628;
...
JAVA_OBJECT com_codename1_ui_Form_findScrollableChild___com_codename1_ui_Container_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_Container_isScrollableY___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1884982716;
...
label_L166022233:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1081253633;
    ...
    if (virtual_com_codename1_ui_Component_isScrollableY___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L223566397;
...
label_L223566397:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L762708774;
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L762708774;
...
JAVA_OBJECT com_codename1_ui_Form_getTitleArea___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_toolbar(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1244560331;
    if (virtual_com_codename1_ui_Toolbar_getParent___R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_Form_toolbar(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1244560331;
...
JAVA_OBJECT com_codename1_ui_Form_getUIManager___R_com_codename1_ui_plaf_UIManager(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_uiManager(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1465663131;
...
JAVA_VOID com_codename1_ui_Form_addShowListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_showListener(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1962420141;
...
JAVA_VOID com_codename1_ui_Form_removeShowListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_showListener(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1942211849;
...
JAVA_VOID com_codename1_ui_Form_addOrientationListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_orientationListener(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2081703861;
...
JAVA_VOID com_codename1_ui_Form_addSizeChangedListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_sizeChangedListener(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L614655333;
...
JAVA_VOID com_codename1_ui_Form_removeSizeChangedListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_sizeChangedListener(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1043773344;
...
JAVA_VOID com_codename1_ui_Form_sizeChangedInternal___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1623287356;
...
label_L1623287356:
    ...
    if (ilocals_3_==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L257749659;
    if (ilocals_4_==ilocals_2_) /* IF_ICMPEQ CustomJump */ goto label_L257749659;
    __CN1_DEBUG_INFO(890);
    if (get_field_com_codename1_ui_Form_orientationListener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1013364696;
...
label_L1013364696:
    ...
    if (virtual_com_codename1_ui_Form_getToolbar___R_com_codename1_ui_Toolbar(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L937860163;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1551760389;
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L257749659;
...
label_L257749659:
    ...
    if (get_field_com_codename1_ui_Form_sizeChangedListener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L878511419;
...
label_L1024240671:
    ...
    if (get_field_com_codename1_ui_Form_formLayeredPane(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1049312121;
    if (/* CustomInvoke */virtual_com_codename1_ui_Container_isDragRegion___int_int_R_boolean(threadStateData, get_field_com_codename1_ui_Form_formLayeredPane(__cn1ThisObject), ilocals_1_, ilocals_2_)==0) /* IFEQ CustomJump */ goto label_L1049312121;
...
label_L1368251707:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L220558713;
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L220558713;
    __CN1_DEBUG_INFO(953);
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    goto label_L1368251707;

label_L220558713:
    __CN1_DEBUG_INFO(955);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L154795841;
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_isDragRegion___int_int_R_boolean(threadStateData, locals[4].data.o, ilocals_1_, ilocals_2_)==0) /* IFEQ CustomJump */ goto label_L154795841;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_INT com_codename1_ui_Form_getDragRegionStatus___int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_3_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1218864105;
...
label_L1218864105:
    ...
    if (get_field_com_codename1_ui_Form_formLayeredPane(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2004683715;
...
label_L829956506:
    ...
    if (ilocals_4_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L763755364;
...
label_L763755364:
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1447521302;
...
label_L973068874:
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1232819726;
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L1232819726;
    __CN1_DEBUG_INFO(984);
    /* VarOp.assignFrom */ locals[6].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[6].data.o);locals[6].type=CN1_TYPE_OBJECT;    goto label_L973068874;

label_L1232819726:
    __CN1_DEBUG_INFO(986);
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1000556746;
...
label_L1000556746:
    ...
    if (virtual_com_codename1_ui_Form_isScrollable___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1447521302;
...
JAVA_VOID com_codename1_ui_Form_paintGlassImpl___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_Form_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1458152564;
...
label_L1458152564:
    ...
    if (get_field_com_codename1_ui_Form_glassPane(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1169249153;
...
label_L1169249153:
    ...
    if (get_field_com_codename1_ui_Form_dragged(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L47971575;
    if (virtual_com_codename1_ui_Component_isDragAndDropInitialized___R_boolean(threadStateData, get_field_com_codename1_ui_Form_dragged(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L47971575;
...
JAVA_VOID com_codename1_ui_Form_addKeyListener___int_com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Form_keyListeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L597623166;
...
JAVA_VOID com_codename1_ui_Form_removeKeyListener___int_com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Form_keyListeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L953080701;
...
JAVA_VOID com_codename1_ui_Form_addKeyListener___int_com_codename1_ui_events_ActionListener_java_util_HashMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L718130408;
...
label_L718130408:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1896000574;
...
label_L1896000574:
    ...
    if (/* CustomInvoke */virtual_java_util_ArrayList_contains___java_lang_Object_R_boolean(threadStateData, locals[5].data.o, locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L1062831184;
...
JAVA_VOID com_codename1_ui_Form_removeKeyListener___int_com_codename1_ui_events_ActionListener_java_util_HashMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L766681183;
...
label_L766681183:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1767674765;
...
label_L1767674765:
    ...
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, locals[5].data.o)!=0) /* IFNE CustomJump */ goto label_L224113092;
...
JAVA_VOID com_codename1_ui_Form_initLaf___com_codename1_ui_plaf_UIManager(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1268124507cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL1268124507cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L1268124507cn1_class_id_java_lang_Exception1, label_L1180383462, restoreToL1268124507cn1_class_id_java_lang_Exception1);
    ...
    if (get_field_com_codename1_ui_Form_menuBar(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1268124507, 0);
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L454248060, 0);

label_L1268124507:
 tryBlockOffsetL1268124507cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1268124507cn1_class_id_java_lang_Exception1);
    restoreToL1268124507cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
...
JAVA_BOOLEAN com_codename1_ui_Form_isInSameColumn___com_codename1_ui_Component_com_codename1_ui_Component_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1692066743;
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L535687332;
...
JAVA_OBJECT com_codename1_ui_Form_getLayeredPane___java_lang_Class_boolean_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L508323203;
...
label_L495984416:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L508323203;
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[5].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2887))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L786728464;
...
label_L449541293:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L1829287142;
...
label_L1829287142:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L129958347;
    __CN1_DEBUG_INFO(1440);
    if (ilocals_8_<=0) /* IFLE CustomJump */ goto label_L792210014;
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L792210014;
...
label_L129958347:
    ...
    if (ilocals_8_<=0) /* IFLE CustomJump */ goto label_L1402606475;
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1402606475;
...
JAVA_OBJECT com_codename1_ui_Form_getFormLayeredPane___java_lang_Class_boolean_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Form_formLayeredPane(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L70666339;
...
label_L1457352442:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L645717550;
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2887))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1620989914;
...
label_L521985523:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1298350375;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L221145867;
...
label_L1298350375:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L579590740;
...
JAVA_OBJECT com_codename1_ui_Form_getLayeredPaneImpl___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_layeredPane(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L188647125;
...
JAVA_OBJECT com_codename1_ui_Form_getActualPane___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_layeredPane(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1924411652;
...
JAVA_OBJECT com_codename1_ui_Form_getActualPane___com_codename1_ui_Container_int_int_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L236002428;
    if (/* CustomInvoke */virtual_com_codename1_ui_Container_getResponderAt___int_int_R_com_codename1_ui_Component(threadStateData, locals[1].data.o, ilocals_2_, ilocals_3_)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L236002428;
...
label_L236002428:
    ...
    if (get_field_com_codename1_ui_Form_menuBar(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1292784864;
    if (/* CustomInvoke */virtual_com_codename1_ui_MenuBar_contains___int_int_R_boolean(threadStateData, get_field_com_codename1_ui_Form_menuBar(__cn1ThisObject), ilocals_2_, ilocals_3_)==0) /* IFEQ CustomJump */ goto label_L1292784864;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getToolbar___R_com_codename1_ui_Toolbar(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1292784864;
...
JAVA_VOID com_codename1_ui_Form_setLayout___com_codename1_ui_layouts_Layout(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L855206842;
...
JAVA_VOID com_codename1_ui_Form_updateIcsIconCommandBehavior__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1628848368;
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() != JAVA_NULL) /* IFNONNULL */ goto label_L1628848368;
...
JAVA_VOID com_codename1_ui_Form_setTitle___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_toolbar(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1742885458;
...
label_L1742885458:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1492431642;
    ...
    if (virtual_com_codename1_ui_Form_isInitialized___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L564766469;
    if (virtual_com_codename1_ui_Label_isTickerEnabled___R_boolean(threadStateData, get_field_com_codename1_ui_Form_title(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L564766469;
    ...
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L1928028672;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1928028672;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(7);
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L124702413;
...
label_L124702413:
    ...
    if (virtual_com_codename1_ui_Label_shouldTickerStart___R_boolean(threadStateData, get_field_com_codename1_ui_Form_title(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L2063581529;
...
label_L2063581529:
    ...
    if (virtual_com_codename1_ui_Label_isTickerRunning___R_boolean(threadStateData, get_field_com_codename1_ui_Form_title(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L377667724;
...
label_L1492431642:
    ...
    if (/* CustomInvoke */com_codename1_ui_Container_contains___com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, get_field_com_codename1_ui_Form_titleArea(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1070619454;
...
label_L1070619454:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    BC_ALOAD(0);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L564766469;
...
JAVA_OBJECT com_codename1_ui_Form_getTitle___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_toolbar(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1320809135;
...
JAVA_VOID com_codename1_ui_Form_registerAnimated___com_codename1_ui_animations_Animation(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_animatableComponents(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1201360998;
...
label_L1201360998:
    ...
    if (/* CustomInvoke */virtual_java_util_ArrayList_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_Form_animatableComponents(__cn1ThisObject), locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1692317071;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1975);
    if (get_field_com_codename1_ui_Component_internalRegisteredAnimated(locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L859279938;
...
label_L723310524:
    ...
    if (get_field_com_codename1_ui_Form_internalAnimatableComponents(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L775093282;
...
label_L775093282:
    ...
    if (/* CustomInvoke */virtual_java_util_ArrayList_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_Form_internalAnimatableComponents(__cn1ThisObject), locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1062295206;
...
JAVA_VOID com_codename1_ui_Form_deregisterAnimatedInternal___com_codename1_ui_animations_Animation(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_internalAnimatableComponents(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1925044167;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1998);
    if (get_field_com_codename1_ui_Component_internalRegisteredAnimated(locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L1157484092;
...
JAVA_VOID com_codename1_ui_Form_deregisterAnimated___com_codename1_ui_animations_Animation(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_animatableComponents(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1898730595;
...
JAVA_BOOLEAN com_codename1_ui_Form_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_Form_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1832101486;
...
JAVA_VOID com_codename1_ui_Form_repaintAnimations__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_static_com_codename1_ui_Form_rippleComponent(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L789885174;
    ...
    if (get_static_com_codename1_ui_Form_rippleMotion(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L789885174;
...
label_L789885174:
    ...
    if (get_field_com_codename1_ui_Form_animatableComponents(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L95553286;
...
label_L95553286:
    ...
    if (get_field_com_codename1_ui_Form_internalAnimatableComponents(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L380556447;
...
label_L380556447:
    ...
    if (get_field_com_codename1_ui_Form_animMananger(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1725825266;
...
JAVA_INT com_codename1_ui_Form_getSideGap___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_Form_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1816633311;
...
JAVA_VOID com_codename1_ui_Form_paintScrollbars___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_Form_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2044211046;
...
label_L513241240:
    if (ilocals_3_>=virtual_java_util_ArrayList_size___R_int(threadStateData, locals[1].data.o)) /* IF_ICMPGE CustomJump */ goto label_L268258490;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1595180029;
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1729045606;
    if (/* CustomInvoke */virtual_java_util_ArrayList_contains___java_lang_Object_R_boolean(threadStateData, locals[2].data.o, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1729045606;
    __CN1_DEBUG_INFO(2081);
    goto label_L1595180029;

label_L1729045606:
    __CN1_DEBUG_INFO(2083);
    if (virtual_com_codename1_ui_animations_Animation_animate___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1595180029;
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L201245433;
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1888400144;
...
JAVA_BOOLEAN com_codename1_ui_Form_hasAnimations___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_Form_animatableComponents(__cn1ThisObject))>0) /* IFGT CustomJump */ goto label_L1720760826;

label_L1661178041:
    if (get_field_com_codename1_ui_Form_internalAnimatableComponents(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1821228886;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() > 0) /* IFGT */ goto label_L1720760826;

label_L1821228886:
    if (get_field_com_codename1_ui_Form_animMananger(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1228603887;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1228603887;
...
JAVA_VOID com_codename1_ui_Form_refreshTheme___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_menuBar(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1442768482;
...
label_L1442768482:
    ...
    if (get_field_com_codename1_ui_Form_titleArea(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1409848452;
...
label_L1409848452:
    ...
    if (get_field_com_codename1_ui_Form_toolbar(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1169015699;
...
label_L1169015699:
    ...
    if (get_field_com_codename1_ui_Form_toolbar(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1711154833;
...
label_L1470959992:
    if (ilocals_3_>=CN1_ARRAY_LENGTH(locals[2].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1200689594;
...
label_L1751751420:
    if (ilocals_3_>=CN1_ARRAY_LENGTH(locals[2].data.o)) /* IF_ICMPGE CustomJump */ goto label_L2084041029;
...
label_L2084041029:
    ...
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1711154833;
...
JAVA_VOID com_codename1_ui_Form_dispatchCommand___com_codename1_ui_Command_com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L404994500;
...
label_L1532874332:
    ...
    if (get_static_com_codename1_ui_Form_comboLock(threadStateData)==0) /* IFEQ CustomJump */ goto label_L2135359921;
...
label_L182254297:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L263495647;
...
label_L2135359921:
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L976133979;
    __CN1_DEBUG_INFO(2281);
    if (get_field_com_codename1_ui_Form_commandListener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2107853606;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L2107853606;
...
label_L976133979:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L281312377;
...
label_L992302041:
    ...
    if (get_static_com_codename1_ui_Form_comboLock(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1967118241;
    __CN1_DEBUG_INFO(2306);
    BC_ALOAD(1);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getCancelMenuItem___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_Form_menuBar(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L312629339;
...
label_L1967118241:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getSelectCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_Form_menuBar(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L565627330;
    __CN1_DEBUG_INFO(2313);
    if (get_field_com_codename1_ui_Form_commandListener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L815590838;
    __CN1_DEBUG_INFO(2314);
    /* CustomInvoke */virtual_com_codename1_ui_util_EventDispatcher_fireActionEvent___com_codename1_ui_events_ActionEvent(threadStateData, get_field_com_codename1_ui_Form_commandListener(__cn1ThisObject), locals[2].data.o); 
    __CN1_DEBUG_INFO(2315);
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L815590838;
...
JAVA_VOID com_codename1_ui_Form_initFocused__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L999663323;
    __CN1_DEBUG_INFO(2325);
    if (get_field_com_codename1_ui_Form_formLayeredPane(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1005928818;
    PUSH_POINTER(get_field_com_codename1_ui_Form_formLayeredPane(__cn1ThisObject));
...
label_L748316439:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2067586671;
...
label_L2067586671:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1829313709;
...
JAVA_VOID com_codename1_ui_Form_show___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_transitionOutAnimator(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2087075503;
    if (get_field_com_codename1_ui_Form_transitionInAnimator(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2087075503;
...
label_L2087075503:
    ...
    if (virtual_com_codename1_ui_Form_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L62610667;
...
JAVA_VOID com_codename1_ui_Form_deinitializeImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL452373864cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL452373864cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L452373864cn1_class_id_java_lang_Exception1, label_L1000386113, restoreToL452373864cn1_class_id_java_lang_Exception1);
    __CN1_DEBUG_INFO(2376);
    if (get_static_com_codename1_ui_Form_comboLock(threadStateData)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1996385500, 0);

label_L452373864:
 tryBlockOffsetL452373864cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L452373864cn1_class_id_java_lang_Exception1);
    restoreToL452373864cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
...
label_L1996385500:
    ...
    if (virtual_com_codename1_ui_Form_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L804993772, 0);
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L804993772, 0);
...
JAVA_VOID com_codename1_ui_Form_initComponentImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L2020602315;
...
label_L2020602315:
    ...
    if (virtual_com_codename1_ui_Form_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1174641185;
    ...
    if (get_field_com_codename1_ui_Form_pointerPressedListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1126074033;
...
label_L849520318:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L902096996;
...
label_L1126074033:
    ...
    if (get_field_com_codename1_ui_Form_pointerDraggedListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1747644505;
...
label_L1302568105:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1597425891;
...
label_L1747644505:
    ...
    if (get_field_com_codename1_ui_Form_pointerReleasedListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1788036341;
...
label_L1016881733:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1434769862;
...
label_L1788036341:
    ...
    if (get_field_com_codename1_ui_Form_longPressListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1174641185;
...
label_L491762195:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1829496747;
...
JAVA_VOID com_codename1_ui_Form_setSmoothScrolling___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_contentPane(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1861616277;
...
JAVA_VOID com_codename1_ui_Form_onShowCompletedImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_showListener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L824691524;
...
label_L824691524:
    ...
    if (get_field_com_codename1_ui_Form_editOnShow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L52642932;
...
JAVA_VOID com_codename1_ui_Form_showModal___int_int_int_int_boolean_boolean_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_BOOLEAN __cn1Arg5, JAVA_BOOLEAN __cn1Arg6, JAVA_BOOLEAN __cn1Arg7) {
    ...
    if (get_field_com_codename1_ui_Form_previousForm(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1662824745;
    ...
    if (get_field_com_codename1_ui_Form_previousForm(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1025566069;
...
label_L1025566069:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1662824745;
...
locals[8].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2535);
    if (virtual_com_codename1_ui_Dialog_isDisposed___R_boolean(threadStateData, locals[8].data.o)==0) /* IFEQ CustomJump */ goto label_L1662824745;
...
label_L1662824745:
    ...
    if (ilocals_1_>0) /* IFGT CustomJump */ goto label_L844264574;
    if (ilocals_2_>0) /* IFGT CustomJump */ goto label_L844264574;
    if (ilocals_3_>0) /* IFGT CustomJump */ goto label_L844264574;
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L726374052;

label_L844264574:
    __CN1_DEBUG_INFO(2545);
    if (virtual_com_codename1_ui_Label_isVisible___R_boolean(threadStateData, get_field_com_codename1_ui_Form_title(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L769195805;
...
label_L769195805:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L401194142;
...
label_L1093703004:
    ...
    if (virtual_com_codename1_ui_Form_getTransitionOutAnimator___R_com_codename1_ui_animations_Transition(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L737852016;
    if (virtual_com_codename1_ui_Form_getTransitionInAnimator___R_com_codename1_ui_animations_Transition(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L737852016;
...
label_L737852016:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L1907228381;
...
JAVA_VOID com_codename1_ui_Form_initDialogBgPainter___com_codename1_ui_Painter_com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L154146418;
    if (virtual_com_codename1_ui_Component_BGPainter_getPreviousForm___R_com_codename1_ui_Form(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L154146418;
...
JAVA_VOID com_codename1_ui_Form_disposeImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_previousForm(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L842588842;
    __CN1_DEBUG_INFO(2655);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getCurrent___R_com_codename1_ui_Form(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    BC_ALOAD(0);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L746436902;
    PUSH_INT(1); /* ICONST_1 */
...
label_L628599133:
    ...
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L375951774;
...
label_L583351682:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L375951774;
    __CN1_DEBUG_INFO(2659);
    if (get_field_com_codename1_ui_Form_previousForm(locals[2].data.o)!=__cn1ThisObject) /* IF_ACMPNE CustomJump */ goto label_L1664093259;
...
locals[2].type=CN1_TYPE_OBJECT;    goto label_L583351682;
...
label_L375951774:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_Form_previousForm(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L979387846;
    __CN1_DEBUG_INFO(2670);
    if (virtual_com_codename1_ui_Dialog_isDisposed___R_boolean(threadStateData, get_field_com_codename1_ui_Form_previousForm(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1758910325;
...
label_L1758910325:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L842588842;
...
JAVA_VOID com_codename1_ui_Form_repaint___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_Form_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L191351920;
...
label_L191351920:
    ...
    if (virtual_com_codename1_ui_Component_hasElevation___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L4573619;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L4573619;
...
label_L4573619:
    ...
    if (virtual_com_codename1_ui_Form_isVisible___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L951317000;
    PUSH_OBJ(com_codename1_ui_CN_getCurrentForm___R_com_codename1_ui_Form(threadStateData));
    BC_ALOAD(0);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L951317000;
...
JAVA_OBJECT com_codename1_ui_Form_getComponentForm___R_com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_Form_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1719727892;
...
JAVA_VOID com_codename1_ui_Form_setFocused___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L1404150776;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2756);
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L2107105388;
    if (virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2107105388;
    __CN1_DEBUG_INFO(2763);
    virtual_com_codename1_ui_Component_repaint__(threadStateData, locals[2].data.o); 

label_L2107105388:
    __CN1_DEBUG_INFO(2768);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1519611492;
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L1519611492;
    __CN1_DEBUG_INFO(2769);
    if (/* CustomInvoke */com_codename1_ui_Form_changeFocusState___com_codename1_ui_Component_boolean_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o, 1 /* ICONST_1 */)!=0) /* IFNE CustomJump */ goto label_L994712181;
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1706741895;

label_L994712181:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L661440732;
...
JAVA_BOOLEAN com_codename1_ui_Form_changeFocusState___com_codename1_ui_Component_boolean_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L222250245;
    BC_ALOAD(4);
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L222250245;
    BC_ALOAD(4);
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1051890381;
...
label_L2144962543:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1913257909;
...
label_L99195804:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L803685654;
    ...
    if (ilocals_6_!=virtual_com_codename1_ui_geom_Dimension_getWidth___R_int(threadStateData, locals[8].data.o)) /* IF_ICMPNE CustomJump */ goto label_L473061882;
    if (ilocals_7_==virtual_com_codename1_ui_geom_Dimension_getHeight___R_int(threadStateData, locals[8].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L803685654;
...
JAVA_VOID com_codename1_ui_Form_longKeyPress___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L561772958;
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(0);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L561772958;
...
JAVA_VOID com_codename1_ui_Form_longPointerPress___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Form_longPressListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1745331030;
    if (virtual_com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(threadStateData, get_field_com_codename1_ui_Form_longPressListeners(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1745331030;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1745331030;
...
label_L1745331030:
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2111669429;
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_contains___int_int_R_boolean(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject), ilocals_1_, ilocals_2_)==0) /* IFEQ CustomJump */ goto label_L2111669429;
    __CN1_DEBUG_INFO(2872);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Component_getComponentForm___R_com_codename1_ui_Form(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(0);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L2111669429;
...
JAVA_VOID com_codename1_ui_Form_keyPressed___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_MenuBar_handlesKeycode___int_R_boolean(threadStateData, get_field_com_codename1_ui_Form_menuBar(__cn1ThisObject), ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L1940844413;
...
label_L1940844413:
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L224878495;
    __CN1_DEBUG_INFO(3164);
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1487884406;
...
label_L1487884406:
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1229365242;
...
label_L1229365242:
    ...
    if (virtual_com_codename1_ui_Component_handlesInput___R_boolean(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1301763240;
...
label_L224878495:
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1488298739;
...
JAVA_VOID com_codename1_ui_Form_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_MenuBar_handlesKeycode___int_R_boolean(threadStateData, get_field_com_codename1_ui_Form_menuBar(__cn1ThisObject), ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L636575568;
...
label_L636575568:
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1387556178;
    __CN1_DEBUG_INFO(3226);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Component_getComponentForm___R_com_codename1_ui_Form(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(0);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1387556178;
    __CN1_DEBUG_INFO(3227);
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1387556178;
...
label_L1387556178:
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1931977799;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1931977799;
...
JAVA_VOID com_codename1_ui_Form_fireKeyEvent___java_util_HashMap_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L108012266;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L108012266;
...
label_L1492897838:
    if (ilocals_5_>=virtual_java_util_ArrayList_size___R_int(threadStateData, locals[3].data.o)) /* IF_ICMPGE CustomJump */ goto label_L108012266;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L693434027;
...
JAVA_VOID com_codename1_ui_Form_keyRepeated___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L298862004;
...
label_L298862004:
    ...
    if (virtual_com_codename1_ui_Component_handlesInput___R_boolean(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L532613259;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L423870962;
    if (ilocals_2_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L423870962;
    if (ilocals_2_==2 /* ICONST_2 */) /* IF_ICMPEQ CustomJump */ goto label_L423870962;
    if (ilocals_2_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L532613259;
...
JAVA_VOID com_codename1_ui_Form_initRippleEffect___int_int_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (virtual_com_codename1_ui_Component_isRippleEffect___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L505343709;
...
JAVA_VOID com_codename1_ui_Form_tactileTouchVibe___int_int_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (get_field_com_codename1_ui_Form_tactileTouchDuration(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L2038585029;
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_isTactileTouch___int_int_R_boolean(threadStateData, locals[3].data.o, ilocals_1_, ilocals_2_)==0) /* IFEQ CustomJump */ goto label_L2038585029;
...
label_L1985235978:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2127123542;
    __CN1_DEBUG_INFO(3306);
    if (get_field_com_codename1_ui_Container_draggedMotionX(locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1955226954;
    if (get_field_com_codename1_ui_Container_draggedMotionY(locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L495650048;
...
label_L495650048:
    ...
    /* VarOp.assignFrom */ locals[2].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[2].data.o);locals[2].type=CN1_TYPE_OBJECT;    goto label_L1985235978;
...
label_L1695301724:
    ...
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1116462450;
    __CN1_DEBUG_INFO(3326);
    /* VarOp.assignFrom */ locals[3].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[3].data.o);locals[3].type=CN1_TYPE_OBJECT;    goto label_L1695301724;

label_L1116462450:
    __CN1_DEBUG_INFO(3328);
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L552266488;
    ...
    if (/* CustomInvoke */com_codename1_ui_Form_isCurrentlyScrolling___com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L552266488;
...
JAVA_VOID com_codename1_ui_Form_setPressedCmp___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1955251955;
...
JAVA_VOID com_codename1_ui_Form_pointerPressed___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Form_resumeDragAfterScrolling___int_int_R_boolean(threadStateData, __cn1ThisObject, ilocals_1_, ilocals_2_)==0) /* IFEQ CustomJump */ goto label_L1879000767;
...
label_L1879000767:
    ...
    if (get_field_com_codename1_ui_Form_pointerPressedListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L406183058;
    if (virtual_com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(threadStateData, get_field_com_codename1_ui_Form_pointerPressedListeners(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L406183058;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L406183058;
...
label_L406183058:
    ...
    if (ilocals_2_<virtual_com_codename1_ui_Container_getY___R_int(threadStateData, locals[4].data.o)) /* IF_IMPLT CustomJump */ goto label_L984235065;
    if (ilocals_1_<virtual_com_codename1_ui_Container_getX___R_int(threadStateData, locals[4].data.o)) /* IF_IMPLT CustomJump */ goto label_L984235065;
...
label_L1895203464:
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1705634364;
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1705634364;
    __CN1_DEBUG_INFO(3411);
    /* VarOp.assignFrom */ locals[5].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[5].data.o);locals[5].type=CN1_TYPE_OBJECT;    goto label_L1895203464;
...
label_L1705634364:
    ...
    if (virtual_com_codename1_ui_Component_isDragAndDropInitialized___R_boolean(threadStateData, locals[5].data.o)!=0) /* IFNE CustomJump */ goto label_L766621271;
...
label_L1137013089:
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L132338135;
    if (virtual_com_codename1_ui_Container_isDraggable___R_boolean(threadStateData, locals[6].data.o)!=0) /* IFNE CustomJump */ goto label_L132338135;
    __CN1_DEBUG_INFO(3421);
    /* VarOp.assignFrom */ locals[6].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[6].data.o);locals[6].type=CN1_TYPE_OBJECT;    goto label_L1137013089;

label_L132338135:
    __CN1_DEBUG_INFO(3423);
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L766621271;
    if (virtual_com_codename1_ui_Container_isDraggable___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L766621271;
    BC_ALOAD(6);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Form);
    if(POP_INT() != 0) /* IFNE */ goto label_L766621271;
...
label_L766621271:
    ...
    if (/* CustomInvoke */com_codename1_ui_Form_isCurrentlyScrolling___com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L227549952;
...
label_L227549952:
    ...
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1183912264;
    __CN1_DEBUG_INFO(3434);
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L766722027;
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L766722027;
...
label_L1183912264:
    ...
    goto label_L818130531;

label_L984235065:
    __CN1_DEBUG_INFO(3446);
    if (ilocals_2_>=virtual_com_codename1_ui_Container_getY___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1483050851;
...
label_L1620643420:
    ...
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1424043852;
    __CN1_DEBUG_INFO(3449);
    /* VarOp.assignFrom */ locals[5].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[5].data.o);locals[5].type=CN1_TYPE_OBJECT;    goto label_L1620643420;

label_L1424043852:
    __CN1_DEBUG_INFO(3451);
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1300497562;
...
label_L1680365536:
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L971936990;
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L971936990;
    __CN1_DEBUG_INFO(3465);
    /* VarOp.assignFrom */ locals[5].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[5].data.o);locals[5].type=CN1_TYPE_OBJECT;    goto label_L1680365536;
...
label_L1251133097:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1282100951;
    __CN1_DEBUG_INFO(3488);
    if (get_field_com_codename1_ui_Container_draggedMotionX(locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L556151572;
    if (get_field_com_codename1_ui_Container_draggedMotionY(locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1822624650;
...
label_L1822624650:
    ...
    /* VarOp.assignFrom */ locals[2].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[2].data.o);locals[2].type=CN1_TYPE_OBJECT;    goto label_L1251133097;
...
JAVA_VOID com_codename1_ui_Form_addComponentAwaitingRelease___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_componentsAwaitingRelease(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1553544410;
...
JAVA_VOID com_codename1_ui_Form_removeComponentAwaitingRelease___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_componentsAwaitingRelease(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1287062222;
...
JAVA_VOID com_codename1_ui_Form_clearComponentsAwaitingRelease__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_componentsAwaitingRelease(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L943501193;
...
JAVA_VOID com_codename1_ui_Form_autoRelease___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Form_componentsAwaitingRelease(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1690796457;
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_Form_componentsAwaitingRelease(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1690796457;
...
label_L1911379471:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L95980430;
...
label_L95980430:
    ...
    if (locals[3].data.o==locals[4].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1478835287;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(3532);
    ...
    if (ilocals_7_<=0) /* IFLE CustomJump */ goto label_L12006451;
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_geom_Rectangle_contains___int_int_R_boolean(threadStateData, locals[8].data.o, ilocals_1_, ilocals_2_)!=0) /* IFNE CustomJump */ goto label_L468797188;
...
label_L1478835287:
    ...
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_ReleasableComponent);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1690796457;
    if (virtual_com_codename1_ui_ReleasableComponent_isAutoRelease___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1690796457;
...
JAVA_VOID com_codename1_ui_Form_pointerDragged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Form_dragStopFlag(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1515477775;
...
label_L1515477775:
    ...
    if (get_field_com_codename1_ui_Form_pointerDraggedListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L736236438;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L736236438;
...
label_L736236438:
    ...
    if (get_field_com_codename1_ui_Form_dragged(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L307080309;
...
label_L307080309:
    ...
    if (get_field_com_codename1_ui_Form_pressedCmp(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L51712095;
    if (virtual_com_codename1_ui_Component_isStickyDrag___R_boolean(threadStateData, get_field_com_codename1_ui_Form_pressedCmp(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L51712095;
...
label_L51712095:
    ...
    if (get_field_com_codename1_ui_Form_stickyDrag(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2070003473;
...
label_L2070003473:
    ...
    if (ilocals_1_>=virtual_com_codename1_ui_Container_getX___R_int(threadStateData, locals[5].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1076133192;
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1073041213;
...
label_L1655081931:
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L348731252;
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L348731252;
    __CN1_DEBUG_INFO(3600);
    /* VarOp.assignFrom */ locals[6].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[6].data.o);locals[6].type=CN1_TYPE_OBJECT;    goto label_L1655081931;

label_L348731252:
    __CN1_DEBUG_INFO(3603);
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1073041213;
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L1073041213;
    ...
    if (locals[6].data.o!=get_field_com_codename1_ui_Form_pressedCmp(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1073041213;
    if (virtual_com_codename1_ui_Component_isStickyDrag___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L1073041213;
...
label_L345132865:
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L25916650;
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L25916650;
    __CN1_DEBUG_INFO(3615);
    /* VarOp.assignFrom */ locals[6].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[6].data.o);locals[6].type=CN1_TYPE_OBJECT;    goto label_L345132865;

label_L25916650:
    __CN1_DEBUG_INFO(3617);
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1228777520;
    __CN1_DEBUG_INFO(3618);
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L529766927;
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L529766927;
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L529766927;
...
label_L529766927:
    ...
    if (locals[6].data.o!=get_field_com_codename1_ui_Form_pressedCmp(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1228777520;
    if (virtual_com_codename1_ui_Component_isStickyDrag___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L1228777520;
...
JAVA_VOID com_codename1_ui_Form_pointerDragged___int_1ARRAY_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Form_dragStopFlag(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1164280115;
...
label_L1164280115:
    ...
    if (get_field_com_codename1_ui_Form_pointerDraggedListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1124804249;
    if (virtual_com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(threadStateData, get_field_com_codename1_ui_Form_pointerDraggedListeners(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1124804249;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1124804249;
...
label_L1124804249:
    ...
    if (get_field_com_codename1_ui_Form_dragged(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1733520096;
...
label_L1733520096:
    ...
    if (get_field_com_codename1_ui_Form_pressedCmp(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1679022055;
    if (virtual_com_codename1_ui_Component_isStickyDrag___R_boolean(threadStateData, get_field_com_codename1_ui_Form_pressedCmp(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1679022055;
    __CN1_DEBUG_INFO(3656);
    set_field_com_codename1_ui_Form_stickyDrag(threadStateData, get_field_com_codename1_ui_Form_pressedCmp(__cn1ThisObject), __cn1ThisObject);

label_L1679022055:
    __CN1_DEBUG_INFO(3658);
    if (get_field_com_codename1_ui_Form_stickyDrag(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L219594319;
...
label_L219594319:
    ...
    if (CN1_ARRAY_ELEMENT_INT(locals[1].data.o, 0 /* ICONST_0 */)>=virtual_com_codename1_ui_Container_getX___R_int(threadStateData, locals[5].data.o)) /* IF_ICMPGE CustomJump */ goto label_L397639322;
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1808470758;
...
label_L700546109:
    ...
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L287136919;
    __CN1_DEBUG_INFO(3670);
    /* VarOp.assignFrom */ locals[6].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[6].data.o);locals[6].type=CN1_TYPE_OBJECT;    goto label_L700546109;

label_L287136919:
    __CN1_DEBUG_INFO(3672);
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1808470758;
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L1808470758;
    ...
    if (locals[6].data.o!=get_field_com_codename1_ui_Form_pressedCmp(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1808470758;
    if (virtual_com_codename1_ui_Component_isStickyDrag___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L1808470758;
...
label_L375781972:
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L621449265;
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L621449265;
    __CN1_DEBUG_INFO(3684);
    /* VarOp.assignFrom */ locals[6].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[6].data.o);locals[6].type=CN1_TYPE_OBJECT;    goto label_L375781972;

label_L621449265:
    __CN1_DEBUG_INFO(3686);
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1835529707;
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1332038894;
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L1332038894;
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L1332038894;
...
label_L1332038894:
    ...
    if (locals[6].data.o!=get_field_com_codename1_ui_Form_pressedCmp(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1835529707;
    if (virtual_com_codename1_ui_Component_isStickyDrag___R_boolean(threadStateData, locals[6].data.o)==0) /* IFEQ CustomJump */ goto label_L1835529707;
...
label_L1435191618:
    ...
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L118566118;
    __CN1_DEBUG_INFO(3717);
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    goto label_L1435191618;

label_L118566118:
    __CN1_DEBUG_INFO(3719);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L820804897;
...
label_L2130329443:
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1879202713;
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1879202713;
    __CN1_DEBUG_INFO(3734);
    /* VarOp.assignFrom */ locals[5].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[5].data.o);locals[5].type=CN1_TYPE_OBJECT;    goto label_L2130329443;

label_L1879202713:
    __CN1_DEBUG_INFO(3736);
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1899280551;
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L576902869;
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L576902869;
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L576902869;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isDesktop___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L576902869;
...
JAVA_VOID com_codename1_ui_Form_pointerHover___int_1ARRAY_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Form_dragged(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1088327571;
...
label_L255156436:
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L995482901;
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L995482901;
...
label_L995482901:
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1000592566;
    ...
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1370979551;
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1370979551;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isDesktop___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1370979551;
...
label_L1000592566:
    ...
    if (com_codename1_ui_TooltipManager_getInstance___R_com_codename1_ui_TooltipManager(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1878045132;
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1142931081;
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ goto label_L1142931081;
...
JAVA_BOOLEAN com_codename1_ui_Form_isSingleFocusMode___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_formLayeredPane(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1619543326;
    ...
    SP--; SP[-1].data.i = SP[-1].data.i + (*SP).data.i; /* IADD */
    PUSH_INT(2); /* ICONST_2 */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1168849885;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1619543326:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L373485230;
    PUSH_INT(1); /* ICONST_1 */
...
label_L841721161:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L682182987;
...
label_L153950082:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1344946518;
    ...
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1410791643;
    __CN1_DEBUG_INFO(3815);
    if (ilocals_1_<=0) /* IFLE CustomJump */ goto label_L1692481404;
...
label_L1410791643:
    ...
    if (ilocals_1_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L185587524;
...
JAVA_BOOLEAN com_codename1_ui_Form_fireReleaseListeners___int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_Form_pointerReleasedListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1780414044;
    if (virtual_com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(threadStateData, get_field_com_codename1_ui_Form_pointerReleasedListeners(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1780414044;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1780414044;
    __CN1_DEBUG_INFO(3836);
    if (get_field_com_codename1_ui_Form_dragged(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L120157876;
    __CN1_DEBUG_INFO(3837);
    if (virtual_com_codename1_ui_Component_isDragAndDropInitialized___R_boolean(threadStateData, get_field_com_codename1_ui_Form_dragged(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1919497442;
...
JAVA_VOID com_codename1_ui_Form_pointerReleased___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    int restoreToL40875343501;
    int tryBlockOffsetL40875343501;
    DEFINE_CATCH_BLOCK(catch_L40875343501, label_L320453674, restoreToL40875343501);
    int restoreToL66556487402;
    int tryBlockOffsetL66556487402;
    DEFINE_CATCH_BLOCK(catch_L66556487402, label_L320453674, restoreToL66556487402);
    int restoreToL23750349103;
    int tryBlockOffsetL23750349103;
    DEFINE_CATCH_BLOCK(catch_L23750349103, label_L320453674, restoreToL23750349103);
    int restoreToL31276668504;
    int tryBlockOffsetL31276668504;
    DEFINE_CATCH_BLOCK(catch_L31276668504, label_L320453674, restoreToL31276668504);
    int restoreToL176847178805;
    int tryBlockOffsetL176847178805;
    DEFINE_CATCH_BLOCK(catch_L176847178805, label_L320453674, restoreToL176847178805);
    int restoreToL33191845506;
    int tryBlockOffsetL33191845506;
    DEFINE_CATCH_BLOCK(catch_L33191845506, label_L320453674, restoreToL33191845506);
    int restoreToL128643730807;
    int tryBlockOffsetL128643730807;
    DEFINE_CATCH_BLOCK(catch_L128643730807, label_L320453674, restoreToL128643730807);
    int restoreToL32045367408;
    int tryBlockOffsetL32045367408;
    DEFINE_CATCH_BLOCK(catch_L32045367408, label_L320453674, restoreToL32045367408);

label_L408753435:
 tryBlockOffsetL40875343501 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L40875343501);
    restoreToL40875343501 = threadStateData->threadObjectStackOffset;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(3855);
    ...
    if (get_field_com_codename1_ui_Form_componentsAwaitingRelease(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L237503491, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_Form_componentsAwaitingRelease(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L237503491, 0);
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1123573668, 1);
...
label_L1123573668:
    ...
    if (locals[8].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2039328061, 1);
...
label_L2039328061:
    ...
    if (locals[7].data.o!=locals[8].data.o) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L665564874, 0);
    __CN1_DEBUG_INFO(3872);
    set_field_com_codename1_ui_Form_componentsAwaitingRelease(threadStateData, JAVA_NULL /* ACONST_NULL */, __cn1ThisObject);
    __CN1_DEBUG_INFO(3873);
    if (get_field_com_codename1_ui_Form_dragged(__cn1ThisObject)!=locals[8].data.o) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L1768797728, 1);
    __CN1_DEBUG_INFO(3874);
    if (virtual_com_codename1_ui_Component_isDragAndDropInitialized___R_boolean(threadStateData, locals[8].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1768473046, 1);
...
label_L2107141507:
    ...
    set_field_com_codename1_ui_Form_dragged(threadStateData, JAVA_NULL /* ACONST_NULL */, __cn1ThisObject);
    JUMP_TO(label_L125802780, 1);

label_L1768797728:
    __CN1_DEBUG_INFO(3881);
    /* CustomInvoke */com_codename1_ui_LeadUtil_pointerReleased___com_codename1_ui_Component_int_int(threadStateData, locals[8].data.o, ilocals_1_, ilocals_2_); 
    __CN1_DEBUG_INFO(3882);
    if (get_field_com_codename1_ui_Form_dragged(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L125802780, 1);
    __CN1_DEBUG_INFO(3883);
    if (virtual_com_codename1_ui_Component_isDragAndDropInitialized___R_boolean(threadStateData, get_field_com_codename1_ui_Form_dragged(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L61334373, 1);
...
label_L665564874:
 tryBlockOffsetL66556487402 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L66556487402);
    restoreToL66556487402 = threadStateData->threadObjectStackOffset;
    ...
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_ReleasableComponent);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L237503491, 0);
    ...
    if (ilocals_10_>0) /* IFGT CustomJump */ JUMP_TO(label_L753853622, 1);
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_contains___int_int_R_boolean(threadStateData, locals[8].data.o, ilocals_1_, ilocals_2_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L237503491, 0);
...
label_L753853622:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_geom_Rectangle_contains___int_int_R_boolean(threadStateData, locals[11].data.o, ilocals_1_, ilocals_2_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L237503491, 0);
    __CN1_DEBUG_INFO(3902);
    set_field_com_codename1_ui_Form_componentsAwaitingRelease(threadStateData, JAVA_NULL /* ACONST_NULL */, __cn1ThisObject);
    __CN1_DEBUG_INFO(3903);
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_contains___int_int_R_boolean(threadStateData, locals[8].data.o, ilocals_1_, ilocals_2_)!=0) /* IFNE CustomJump */ JUMP_TO(label_L237503491, 0);
...
label_L237503491:
 tryBlockOffsetL23750349103 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L23750349103);
    restoreToL23750349103 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(3911);
    if (/* CustomInvoke */com_codename1_ui_Form_fireReleaseListeners___int_int_R_boolean(threadStateData, __cn1ThisObject, ilocals_1_, ilocals_2_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L312766685, 0);
...
label_L312766685:
 tryBlockOffsetL31276668504 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L31276668504);
    restoreToL31276668504 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(3914);
    if (get_field_com_codename1_ui_Form_dragStopFlag(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1768471788, 0);
    __CN1_DEBUG_INFO(3915);
    if (get_field_com_codename1_ui_Form_dragged(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1432929903, 1);
    __CN1_DEBUG_INFO(3916);
    if (virtual_com_codename1_ui_Component_isDragAndDropInitialized___R_boolean(threadStateData, get_field_com_codename1_ui_Form_dragged(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L242762528, 1);
...
label_L1768471788:
 tryBlockOffsetL176847178805 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L176847178805);
    restoreToL176847178805 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(3927);
    if (get_field_com_codename1_ui_Form_dragged(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1064040618, 1);
    __CN1_DEBUG_INFO(3930);
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L331918455, 0);
    __CN1_DEBUG_INFO(3933);
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L19423, 1);
...
label_L331918455:
 tryBlockOffsetL33191845506 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L33191845506);
    restoreToL33191845506 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(3938);
    if (/* CustomInvoke */virtual_com_codename1_ui_MenuBar_contains___int_int_R_boolean(threadStateData, get_field_com_codename1_ui_Form_menuBar(__cn1ThisObject), ilocals_1_, ilocals_2_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1286437308, 0);
...
label_L2057227460:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L744715819, 1);
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L744715819, 1);
    __CN1_DEBUG_INFO(3941);
    /* VarOp.assignFrom */ locals[7].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[7].data.o);locals[7].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L2057227460, 1);
...
label_L744715819:
    ...
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2017603323, 1);
    __CN1_DEBUG_INFO(3945);
    if (ilocals_5_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1594214614, 1);
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1594214614, 1);
...
label_L1286437308:
 tryBlockOffsetL128643730807 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L128643730807);
    restoreToL128643730807 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(3953);
    if (get_field_com_codename1_ui_Form_stickyDrag(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1759522611, 1);
    __CN1_DEBUG_INFO(3954);
    if (virtual_com_codename1_ui_Component_isDragAndDropInitialized___R_boolean(threadStateData, get_field_com_codename1_ui_Form_stickyDrag(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1687430663, 1);
...
label_L222882200:
    ...
    virtual_com_codename1_ui_Form_repaint__(threadStateData, __cn1ThisObject); 
    JUMP_TO(label_L2096808863, 1);

label_L1759522611:
    __CN1_DEBUG_INFO(3962);
    if (ilocals_2_<virtual_com_codename1_ui_Container_getY___R_int(threadStateData, locals[6].data.o)) /* IF_IMPLT CustomJump */ JUMP_TO(label_L361423492, 1);
    if (ilocals_1_<virtual_com_codename1_ui_Container_getX___R_int(threadStateData, locals[6].data.o)) /* IF_IMPLT CustomJump */ JUMP_TO(label_L361423492, 1);
...
label_L438660480:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1357597228, 1);
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1357597228, 1);
    __CN1_DEBUG_INFO(3965);
    /* VarOp.assignFrom */ locals[7].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[7].data.o);locals[7].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L438660480, 1);

label_L1357597228:
    __CN1_DEBUG_INFO(3967);
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L812229472, 1);
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L812229472, 1);
    ...
    if (ilocals_5_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1916139819, 1);
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1916139819, 1);
...
label_L361423492:
    ...
    if (ilocals_2_>=virtual_com_codename1_ui_Container_getY___R_int(threadStateData, locals[6].data.o)) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L2022012779, 1);
...
label_L1232948374:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1775488894, 1);
    ...
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L977195776, 1);
...
label_L2022012779:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L428089645, 1);
...
label_L1319778140:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L972404515, 1);
    if (virtual_com_codename1_ui_Component_isIgnorePointerEvents___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L972404515, 1);
    __CN1_DEBUG_INFO(3997);
    /* VarOp.assignFrom */ locals[7].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[7].data.o);locals[7].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1319778140, 1);
...
label_L972404515:
    ...
    if (ilocals_5_!=0) /* IFNE CustomJump */ JUMP_TO(label_L37768026, 1);
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L37768026, 1);
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L37768026, 1);
...
label_L1064040618:
    ...
    if (virtual_com_codename1_ui_Component_isDragAndDropInitialized___R_boolean(threadStateData, get_field_com_codename1_ui_Form_dragged(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L989171574, 1);
...
label_L2096808863:
    ...
    if (get_field_com_codename1_ui_Form_componentsAwaitingRelease(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L783117220, 1);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isRecursivePointerRelease___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L783117220, 1);
    __CN1_DEBUG_INFO(4024);
    /* VarOp.assignFrom */     ilocals_7_ = 0 /* ICONST_0 */; 

label_L664836465:
    if (ilocals_7_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_Form_componentsAwaitingRelease(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L832743930, 1);
    ...
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_LeadUtil_leadComponentImpl___com_codename1_ui_Component_R_com_codename1_ui_Component(threadStateData, locals[8].data.o));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_ReleasableComponent);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L834153999, 1);
...
END_TRY(1);    __CN1_DEBUG_INFO(4034);
    ...
    JUMP_TO(label_L1645557354, 0);

label_L320453674:
 tryBlockOffsetL32045367408 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L32045367408);
    restoreToL32045367408 = threadStateData->threadObjectStackOffset;
...
label_L486994287:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1188871851;
    ...
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ goto label_L920926249;
    __CN1_DEBUG_INFO(4150);
    if (/* CustomInvoke */com_codename1_ui_Form_isInSameRow___com_codename1_ui_Component_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o, locals[7].data.o)==0) /* IFEQ CustomJump */ goto label_L920926249;
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L355222677;
    __CN1_DEBUG_INFO(4154);
    if (ilocals_9_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L920926249;
    __CN1_DEBUG_INFO(4155);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1589745212;
    __CN1_DEBUG_INFO(4156);
    if (virtual_com_codename1_ui_Component_getAbsoluteX___R_int(threadStateData, locals[2].data.o)>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L1589745212;
...
locals[2].type=CN1_TYPE_OBJECT;    goto label_L920926249;

label_L355222677:
    __CN1_DEBUG_INFO(4163);
    if (ilocals_9_<=ilocals_8_) /* IF_ICMPLE CustomJump */ goto label_L920926249;
    __CN1_DEBUG_INFO(4164);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1794705481;
    __CN1_DEBUG_INFO(4165);
    if (virtual_com_codename1_ui_Component_getAbsoluteX___R_int(threadStateData, locals[2].data.o)<=ilocals_8_) /* IF_ICMPLE CustomJump */ goto label_L1794705481;
...
label_L920926249:
    ...
    if (virtual_com_codename1_ui_Container_isBlockFocus___R_boolean(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ goto label_L2110472873;
...
label_L57488372:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1336210565;
    ...
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ goto label_L1759328722;
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1246023616;
...
label_L1246023616:
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L1625539182;
    __CN1_DEBUG_INFO(4192);
    if (ilocals_9_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L1759328722;
    __CN1_DEBUG_INFO(4193);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L134943275;
    ...
    if (virtual_com_codename1_ui_Component_getAbsoluteY___R_int(threadStateData, locals[2].data.o)>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L161069393;
    __CN1_DEBUG_INFO(4196);
    if (ilocals_10_==0) /* IFEQ CustomJump */ goto label_L1708084589;
    __CN1_DEBUG_INFO(4197);
    goto label_L457245448;

label_L1708084589:
    __CN1_DEBUG_INFO(4199);
    if (/* CustomInvoke */com_codename1_ui_Form_isInSameRow___com_codename1_ui_Component_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[7].data.o, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L161069393;
    if (/* CustomInvoke */com_codename1_ui_Form_isInSameColumn___com_codename1_ui_Component_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o, locals[7].data.o)!=0) /* IFNE CustomJump */ goto label_L161069393;
    __CN1_DEBUG_INFO(4200);
    goto label_L457245448;

label_L161069393:
    __CN1_DEBUG_INFO(4203);
    if (ilocals_10_==0) /* IFEQ CustomJump */ goto label_L134943275;
    if (/* CustomInvoke */com_codename1_ui_Form_isInSameRow___com_codename1_ui_Component_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[7].data.o, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L134943275;
...
label_L134943275:
    ...
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[7].data.o;
locals[2].type=CN1_TYPE_OBJECT;    goto label_L1759328722;

label_L1625539182:
    __CN1_DEBUG_INFO(4210);
    if (ilocals_9_<=ilocals_8_) /* IF_ICMPLE CustomJump */ goto label_L1759328722;
    ...
    if (virtual_com_codename1_ui_Component_getAbsoluteY___R_int(threadStateData, locals[2].data.o)<=ilocals_8_) /* IF_ICMPLE CustomJump */ goto label_L261925632;
    __CN1_DEBUG_INFO(4214);
    if (ilocals_10_==0) /* IFEQ CustomJump */ goto label_L271002555;
    __CN1_DEBUG_INFO(4215);
    goto label_L457245448;

label_L271002555:
    __CN1_DEBUG_INFO(4217);
    if (/* CustomInvoke */com_codename1_ui_Form_isInSameRow___com_codename1_ui_Component_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[7].data.o, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L261925632;
    if (/* CustomInvoke */com_codename1_ui_Form_isInSameColumn___com_codename1_ui_Component_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o, locals[7].data.o)!=0) /* IFNE CustomJump */ goto label_L261925632;
    __CN1_DEBUG_INFO(4218);
    goto label_L457245448;

label_L261925632:
    __CN1_DEBUG_INFO(4221);
    if (ilocals_10_==0) /* IFEQ CustomJump */ goto label_L1259065345;
    if (/* CustomInvoke */com_codename1_ui_Form_isInSameRow___com_codename1_ui_Component_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[7].data.o, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1259065345;
...
label_L1759328722:
    ...
    if (virtual_com_codename1_ui_Container_isBlockFocus___R_boolean(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ goto label_L457245448;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(4248);
    if (get_field_com_codename1_ui_Form_formLayeredPane(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L376660032;
...
label_L376660032:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2086477093;
...
label_L2086477093:
    ...
    if (get_field_com_codename1_ui_Form_cyclicFocus(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1427020774;
    __CN1_DEBUG_INFO(4260);
    BC_ALOAD(0);
    PUSH_POINTER(get_field_com_codename1_ui_Form_focused(__cn1ThisObject));
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    BC_ALOAD(3);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1066856480;
    PUSH_INT(1); /* ICONST_1 */
...
label_L854255346:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1427020774;
    __CN1_DEBUG_INFO(4262);
    BC_ALOAD(0);
    BC_ALOAD(2);
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    BC_ALOAD(3);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L650797503;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1211827856:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L262535196;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(4265);
    ...
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    BC_ALOAD(3);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1780306540;
    PUSH_INT(1); /* ICONST_1 */
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(4286);
    if (get_field_com_codename1_ui_Form_formLayeredPane(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1753113235;
    __CN1_DEBUG_INFO(4287);
    /* VarOp.assignFrom */ locals[2].data.o = /* CustomInvoke */com_codename1_ui_Form_findNextFocusHorizontal___com_codename1_ui_Component_com_codename1_ui_Component_com_codename1_ui_Container_boolean_R_com_codename1_ui_Component(threadStateData, __cn1ThisObject, get_field_com_codename1_ui_Form_focused(__cn1ThisObject), JAVA_NULL /* ACONST_NULL */, get_field_com_codename1_ui_Form_formLayeredPane(__cn1ThisObject), ilocals_1_);locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(4288);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1753113235;
...
label_L1753113235:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1752220610;
...
label_L1752220610:
    ...
    if (get_field_com_codename1_ui_Form_cyclicFocus(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L263233676;
    __CN1_DEBUG_INFO(4298);
    BC_ALOAD(0);
    PUSH_POINTER(get_field_com_codename1_ui_Form_focused(__cn1ThisObject));
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    BC_ALOAD(3);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L531576940;
    PUSH_INT(1); /* ICONST_1 */
...
label_L81705968:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L263233676;
    __CN1_DEBUG_INFO(4300);
    BC_ALOAD(0);
    BC_ALOAD(2);
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    BC_ALOAD(3);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1784551034;
    PUSH_INT(1); /* ICONST_1 */
...
label_L244668763:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L107632469;
...
JAVA_OBJECT com_codename1_ui_Form_findNextFocusDown___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1519482659;
    __CN1_DEBUG_INFO(4318);
    if (virtual_com_codename1_ui_Component_getNextFocusDown___R_com_codename1_ui_Component(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2118482375;
...
JAVA_OBJECT com_codename1_ui_Form_findNextFocusUp___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2037343019;
    __CN1_DEBUG_INFO(4333);
    if (virtual_com_codename1_ui_Component_getNextFocusUp___R_com_codename1_ui_Component(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1570022108;
...
JAVA_OBJECT com_codename1_ui_Form_findNextFocusRight___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L216919586;
    __CN1_DEBUG_INFO(4348);
    if (virtual_com_codename1_ui_Component_getNextFocusRight___R_com_codename1_ui_Component(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1504912697;
...
JAVA_OBJECT com_codename1_ui_Form_findNextFocusLeft___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Form_focused(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1531409183;
    __CN1_DEBUG_INFO(4363);
    if (virtual_com_codename1_ui_Component_getNextFocusLeft___R_com_codename1_ui_Component(threadStateData, get_field_com_codename1_ui_Form_focused(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L591247593;
...
JAVA_VOID com_codename1_ui_Form_updateFocus___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1086508626;
        case 2: goto label_L1614238;
        case 3: goto label_L1621615881;
        case 4: goto label_L1621615881;
        case 5: goto label_L773059332;
        case 6: goto label_L2020935882;
        default: goto label_L1621615881;
    }
...
label_L2020935882:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1025786379;
    __CN1_DEBUG_INFO(4386);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[3].data.o;
locals[2].type=CN1_TYPE_OBJECT;    goto label_L1025786379;
...
label_L1025786379:
    ...
    if (virtual_com_codename1_ui_Form_isFocusScrolling___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1651795723;
...
label_L1651795723:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Form_moveScrollTowards___int_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, ilocals_1_, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1406018450;
...
JAVA_BOOLEAN com_codename1_ui_Form_moveScrollTowards___int_com_codename1_ui_Component_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L53301881;
    __CN1_DEBUG_INFO(4439);
    BC_ALOAD(3);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L470187021;
    __CN1_DEBUG_INFO(4440);
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;    locals[4].data.o = locals[3].data.o;
locals[4].type=CN1_TYPE_OBJECT;    goto label_L1561005241;
...
label_L1561005241:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L53301881;
    __CN1_DEBUG_INFO(4445);
    if (locals[4].data.o!=__cn1ThisObject) /* IF_ACMPNE CustomJump */ goto label_L2138793529;
...
label_L2138793529:
    ...
    if (virtual_com_codename1_ui_Container_isScrollable___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L380394805;
...
label_L380394805:
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    goto label_L1561005241;
...
label_L728370857:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L409007038;
    __CN1_DEBUG_INFO(4488);
    if (virtual_com_codename1_ui_Container_isScrollable___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1825656946;
    __CN1_DEBUG_INFO(4489);
    if (locals[2].data.o!=__cn1ThisObject) /* IF_ACMPNE CustomJump */ goto label_L2026873444;
    __CN1_DEBUG_INFO(4491);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getContentPane___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Container_isScrollable___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L873002645;
...
label_L1825656946:
    ...
    /* VarOp.assignFrom */ locals[2].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[2].data.o);locals[2].type=CN1_TYPE_OBJECT;    goto label_L728370857;
...
JAVA_VOID com_codename1_ui_Form_requestFocus___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1306429814;
    if (/* CustomInvoke */virtual_com_codename1_ui_Form_contains___com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1306429814;
...
JAVA_VOID com_codename1_ui_Form_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_inInternalPaint(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1216863787;
...
label_L1216863787:
    ...
    if (get_field_com_codename1_ui_Form_tint(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L994584048;
...
JAVA_VOID com_codename1_ui_Form_setVisible___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_Form_mediaComponents(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1085041526;
...
label_L2038484780:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1085041526;
...
JAVA_OBJECT com_codename1_ui_Form_getPropertyValue___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3005))==0) /* IFEQ CustomJump */ goto label_L251666609;
    __CN1_DEBUG_INFO(4742);
    if (virtual_com_codename1_ui_Form_getTitleComponent___R_com_codename1_ui_Label(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L251666609;
...
label_L251666609:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3006))==0) /* IFEQ CustomJump */ goto label_L1973281540;
    __CN1_DEBUG_INFO(4747);
    if (virtual_com_codename1_ui_Form_getTitleArea___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1973281540;
...
JAVA_OBJECT com_codename1_ui_Form_setPropertyValue___java_lang_String_java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3005))==0) /* IFEQ CustomJump */ goto label_L1447678234;
    __CN1_DEBUG_INFO(4759);
    if (virtual_com_codename1_ui_Form_getTitleComponent___R_com_codename1_ui_Label(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L693083472;
...
label_L1447678234:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3006))==0) /* IFEQ CustomJump */ goto label_L658781536;
    __CN1_DEBUG_INFO(4765);
    if (virtual_com_codename1_ui_Form_getTitleArea___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1037793103;
