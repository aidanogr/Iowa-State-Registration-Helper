...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_4_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL70430964801;
    int tryBlockOffsetL70430964801;
    DEFINE_CATCH_BLOCK(catch_L70430964801, label_L317960117, restoreToL70430964801);
    int restoreToL31796011702;
    int tryBlockOffsetL31796011702;
    DEFINE_CATCH_BLOCK(catch_L31796011702, label_L317960117, restoreToL31796011702);
    __CN1_DEBUG_INFO(3703);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_IOSMedia_access$2100___com_codename1_impl_ios_IOSImplementation_IOSMedia_R_java_util_List(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_4_this_1(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1290614253, 0);
    ...
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L1290614253, 0);
...
label_L704309648:
 tryBlockOffsetL70430964801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L70430964801);
    restoreToL70430964801 = threadStateData->threadObjectStackOffset;
...
label_L53903834:
END_TRY(1);    JUMP_TO(label_L740467528, 0);

label_L317960117:
 tryBlockOffsetL31796011702 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L31796011702);
    restoreToL31796011702 = threadStateData->threadObjectStackOffset;
...
label_L2077662850:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1290614253, 0);
