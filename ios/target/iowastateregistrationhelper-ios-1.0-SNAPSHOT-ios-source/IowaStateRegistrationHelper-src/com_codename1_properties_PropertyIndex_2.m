...
label_L2136672550:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L601930040;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1884534347;
...
label_L1856795099:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1218653263;
...
label_L1357067993:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L632236798;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L35263828;
        case 2: goto label_L255172197;
        case 3: goto label_L1587874456;
        default: goto label_L42017640;
    }
...
label_L35263828:
    ...
    BC_ALOAD(8);
    BC_INSTANCEOF(cn1_class_id_com_codename1_properties_Property);
    if(POP_INT() == 0) /* IFEQ */ goto label_L42017640;
