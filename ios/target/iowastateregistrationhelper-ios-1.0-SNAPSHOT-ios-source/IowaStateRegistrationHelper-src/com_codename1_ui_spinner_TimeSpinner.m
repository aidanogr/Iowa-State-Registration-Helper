...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 10164, 200);
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_initSpinner__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 10164, 9950);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(91);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_hour(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1773826778;
    __CN1_DEBUG_INFO(92);
    BC_ALOAD(0);
    ...
    POP_MANY(2);
    __CN1_DEBUG_INFO(94);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_currentMeridiem(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L773562690;
    __CN1_DEBUG_INFO(95);
    BC_ALOAD(0);
...
label_L180121605:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_spinner_SpinnerRenderer_setUIID___java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10005)); 
    __CN1_DEBUG_INFO(130);
    /* CustomInvoke */virtual_com_codename1_ui_spinner_SpinnerRenderer_setUIID___java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10005)); 
    __CN1_DEBUG_INFO(131);
    /* CustomInvoke */virtual_com_codename1_ui_spinner_Spinner_setRenderingPrototype___java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_TimeSpinner_amPM(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(10165)); 
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_addComponents__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 10164, 9951);
    ...
    if (get_field_com_codename1_ui_spinner_TimeSpinner_amPM(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1499383906;
    ...
    if (get_field_com_codename1_ui_spinner_TimeSpinner_durationMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1674071345;
    ...
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_localize___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9821), STRING_FROM_CONSTANT_POOL_OFFSET(9821));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    com_codename1_ui_Label___INIT_____java_lang_String(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    BC_ASTORE(4);
    __CN1_DEBUG_INFO(154);
    /* CustomInvoke */virtual_com_codename1_ui_Label_setUIID___java_lang_String(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10166)); 
...
label_L1674071345:
    ...
    if (get_field_com_codename1_ui_spinner_TimeSpinner_durationMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L271249851;
    __CN1_DEBUG_INFO(163);
    PUSH_POINTER(__NEW_com_codename1_ui_Label(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_spinner_TimeSpinner_getUIManager___R_com_codename1_ui_plaf_UIManager(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_localize___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9822), STRING_FROM_CONSTANT_POOL_OFFSET(9822));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    com_codename1_ui_Label___INIT_____java_lang_String(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    BC_ASTORE(4);
    __CN1_DEBUG_INFO(164);
    /* CustomInvoke */virtual_com_codename1_ui_Label_setUIID___java_lang_String(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10167)); 
...
label_L271249851:
    ...
    if (get_field_com_codename1_ui_spinner_TimeSpinner_showMeridiem(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1499383906;
...
label_L1499383906:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_layouts_LayeredLayout_setInsets___com_codename1_ui_Component_java_lang_String_R_com_codename1_ui_layouts_LayeredLayout(threadStateData, locals[1].data.o, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10168)); 
...
JAVA_OBJECT com_codename1_ui_spinner_TimeSpinner_getPropertyValue___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 10164, 2363);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(198);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10169))==0) /* IFEQ CustomJump */ goto label_L2038405091;
    __CN1_DEBUG_INFO(199);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_durationMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1456299382;
...
label_L2038405091:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10154))==0) /* IFEQ CustomJump */ goto label_L2009932635;
...
label_L2009932635:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10155))==0) /* IFEQ CustomJump */ goto label_L808297264;
...
label_L808297264:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10156))==0) /* IFEQ CustomJump */ goto label_L896068185;
...
label_L896068185:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10157))==0) /* IFEQ CustomJump */ goto label_L166868847;
    __CN1_DEBUG_INFO(214);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_currentMeridiem(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L389749489;
...
label_L166868847:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10158))==0) /* IFEQ CustomJump */ goto label_L1246891781;
    __CN1_DEBUG_INFO(220);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_showMeridiem(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L949624372;
...
JAVA_OBJECT com_codename1_ui_spinner_TimeSpinner_setPropertyValue___java_lang_String_java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 10164, 2364);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(232);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10154))==0) /* IFEQ CustomJump */ goto label_L541789959;
...
label_L541789959:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10155))==0) /* IFEQ CustomJump */ goto label_L1869116781;
...
label_L1869116781:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10156))==0) /* IFEQ CustomJump */ goto label_L899179938;
...
label_L899179938:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10157))==0) /* IFEQ CustomJump */ goto label_L1570485915;
...
label_L1570485915:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10158))==0) /* IFEQ CustomJump */ goto label_L634435864;
...
label_L634435864:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10169))==0) /* IFEQ CustomJump */ goto label_L163537874;
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setMinuteStep___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(7, 2, 0, 10164, 9823);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(273);
    if (ilocals_1_<1 /* ICONST_1 */) /* IF_IMPLT CustomJump */ goto label_L2147267122;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(60);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L2136210488;
...
label_L2136210488:
    ...
    if (get_field_com_codename1_ui_spinner_TimeSpinner_minute(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1609269939;
...
JAVA_BOOLEAN com_codename1_ui_spinner_TimeSpinner_isShowMeridiem___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10164, 9826);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(286);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_showMeridiem(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L758700911;
    if (get_field_com_codename1_ui_spinner_TimeSpinner_durationMode(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L758700911;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L936350168;
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setShowMeridiem___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(7, 2, 0, 10164, 9827);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(294);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_durationMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1461520677;
...
label_L1461520677:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1424029551;
...
label_L1072213311:
    ...
    if (get_field_com_codename1_ui_spinner_TimeSpinner_hour(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1952627275;
...
label_L1952627275:
    ...
    if (virtual_com_codename1_ui_spinner_TimeSpinner_isInitialized___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1258934723;
...
JAVA_INT com_codename1_ui_spinner_TimeSpinner_getCurrentHour___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10164, 10172);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(320);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_hour(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L411114562;
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setCurrentHour___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 10164, 10173);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(331);
    set_field_com_codename1_ui_spinner_TimeSpinner_currentHour(threadStateData, ilocals_1_, __cn1ThisObject);
    __CN1_DEBUG_INFO(332);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_hour(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1652214584;
...
JAVA_INT com_codename1_ui_spinner_TimeSpinner_getCurrentMinute___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10164, 10174);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(341);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_minute(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L53188062;
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setCurrentMinute___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 10164, 10175);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(351);
    set_field_com_codename1_ui_spinner_TimeSpinner_currentMinute(threadStateData, ilocals_1_, __cn1ThisObject);
    __CN1_DEBUG_INFO(352);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_minute(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L103402417;
...
JAVA_BOOLEAN com_codename1_ui_spinner_TimeSpinner_isCurrentMeridiem___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10164, 10176);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(361);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_durationMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L375039034;
    __CN1_DEBUG_INFO(362);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L375039034:
    __CN1_DEBUG_INFO(364);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_amPM(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L583896770;
    ...
    { JAVA_INT tmpResult = virtual_java_lang_Integer_intValue___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L2107079200;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setCurrentMeridiem___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 10164, 10177);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(374);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_durationMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1980976027;
...
label_L1980976027:
    ...
    if (get_field_com_codename1_ui_spinner_TimeSpinner_amPM(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L946237445;
    __CN1_DEBUG_INFO(379);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L2129021779;
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setDurationMode___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10164, 10179);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(400);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L288468653;
    ...
    PUSH_INT(24);
    set_field_com_codename1_ui_spinner_TimeSpinner_endHour(threadStateData, POP_INT(), POP_OBJ());
    goto label_L2098356355;

label_L288468653:
    __CN1_DEBUG_INFO(405);
    if (get_field_com_codename1_ui_spinner_TimeSpinner_showMeridiem(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1996472700;
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setHoursVisible___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 10164, 10180);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
label_L1079214960:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L982495267;
    ...
    BC_ALOAD(3);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L651638041;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1219452728;
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setMinutesVisible___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* visible */
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 10164, 10181);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
label_L1980377966:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L119156209;
    ...
    BC_ALOAD(3);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L419082230;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L715027790;
...
JAVA_BOOLEAN com_codename1_ui_spinner_TimeSpinner_pinch___int_1ARRAY_int_1ARRAY_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setPinchBlocksDragAndDrop___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
com_codename1_ui_Component_setPinchBlocksDragAndDrop___boolean(threadStateData, __cn1ThisObject, __cn1Arg1);
}


JAVA_BOOLEAN com_codename1_ui_spinner_TimeSpinner_isPinchBlocksDragAndDrop___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
...
JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setDragTransparency___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
com_codename1_ui_Component_setDragTransparency___byte(threadStateData, __cn1ThisObject, __cn1Arg1);
}


JAVA_BYTE com_codename1_ui_spinner_TimeSpinner_getDragTransparency___R_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    return com_codename1_ui_Component_getDragTransparency___R_byte(threadStateData, __cn1ThisObject);
}


JAVA_VOID com_codename1_ui_spinner_TimeSpinner_setDefaultDragTransparency___byte(CODENAME_ONE_THREAD_STATE, JAVA_BYTE __cn1Arg1) {
com_codename1_ui_Component_setDefaultDragTransparency___byte(threadStateData, __cn1Arg1);
}


JAVA_BYTE com_codename1_ui_spinner_TimeSpinner_getDefaultDragTransparency___R_byte(CODENAME_ONE_THREAD_STATE) {
...
JAVA_BOOLEAN virtual_com_codename1_ui_spinner_TimeSpinner_isInitialized___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_isInitialized___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[266])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_spinner_TimeSpinner_getLayout___R_com_codename1_ui_layouts_Layout(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_getLayout___R_com_codename1_ui_layouts_Layout)__cn1ThisObject->__codenameOneParentClsReference->vtable[324])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_setLayout___com_codename1_ui_layouts_Layout(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_setLayout___com_codename1_ui_layouts_Layout)__cn1ThisObject->__codenameOneParentClsReference->vtable[326])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_addComponent___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_addComponent___com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[333])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_removeAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_removeAll__)__cn1ThisObject->__codenameOneParentClsReference->vtable[347])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_spinner_TimeSpinner_createSeparator___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_createSeparator___R_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[397])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_addComponents__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_addComponents__)__cn1ThisObject->__codenameOneParentClsReference->vtable[398])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_setMinuteStep___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_setMinuteStep___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[399])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_setShowMeridiem___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_setShowMeridiem___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[401])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_spinner_TimeSpinner_getCurrentHour___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_getCurrentHour___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[402])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_setCurrentHour___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_setCurrentHour___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[403])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_spinner_TimeSpinner_getCurrentMinute___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_getCurrentMinute___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[404])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_setCurrentMinute___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_setCurrentMinute___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[405])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_spinner_TimeSpinner_isCurrentMeridiem___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_isCurrentMeridiem___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[406])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_setCurrentMeridiem___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_setCurrentMeridiem___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[407])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_setDurationMode___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_setDurationMode___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[408])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_setHoursVisible___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_setHoursVisible___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[409])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_spinner_TimeSpinner_setMinutesVisible___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_spinner_TimeSpinner_setMinutesVisible___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[410])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
void __INIT_VTABLE_com_codename1_ui_spinner_TimeSpinner(CODENAME_ONE_THREAD_STATE, void** vtable) {
    ...
    vtable[283] = &com_codename1_ui_spinner_TimeSpinner_getPropertyValue___java_lang_String_R_java_lang_Object;
    vtable[284] = &com_codename1_ui_spinner_TimeSpinner_setPropertyValue___java_lang_String_java_lang_Object_R_java_lang_String;
    vtable[396] = &com_codename1_ui_spinner_TimeSpinner_initSpinner__;
    vtable[398] = &com_codename1_ui_spinner_TimeSpinner_addComponents__;
    vtable[399] = &com_codename1_ui_spinner_TimeSpinner_setMinuteStep___int;
    vtable[400] = &com_codename1_ui_spinner_TimeSpinner_isShowMeridiem___R_boolean;
    vtable[401] = &com_codename1_ui_spinner_TimeSpinner_setShowMeridiem___boolean;
    vtable[402] = &com_codename1_ui_spinner_TimeSpinner_getCurrentHour___R_int;
    vtable[403] = &com_codename1_ui_spinner_TimeSpinner_setCurrentHour___int;
    vtable[404] = &com_codename1_ui_spinner_TimeSpinner_getCurrentMinute___R_int;
    vtable[405] = &com_codename1_ui_spinner_TimeSpinner_setCurrentMinute___int;
    vtable[406] = &com_codename1_ui_spinner_TimeSpinner_isCurrentMeridiem___R_boolean;
    vtable[407] = &com_codename1_ui_spinner_TimeSpinner_setCurrentMeridiem___boolean;
    vtable[408] = &com_codename1_ui_spinner_TimeSpinner_setDurationMode___boolean;
    vtable[409] = &com_codename1_ui_spinner_TimeSpinner_setHoursVisible___boolean;
    vtable[410] = &com_codename1_ui_spinner_TimeSpinner_setMinutesVisible___boolean;
}
...
void __STATIC_INITIALIZER_com_codename1_ui_spinner_TimeSpinner(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_ui_spinner_TimeSpinner.vtable = malloc(sizeof(void*) *411);
