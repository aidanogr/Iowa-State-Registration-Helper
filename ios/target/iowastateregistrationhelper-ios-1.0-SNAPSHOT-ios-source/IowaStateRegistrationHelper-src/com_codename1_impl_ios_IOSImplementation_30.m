...
const struct clazz *base_interfaces_for_com_codename1_impl_ios_IOSImplementation_30[] = {&class__java_lang_Runnable};
struct clazz class__com_codename1_impl_ios_IOSImplementation_30 = {
  DEBUG_GC_INIT &class__java_lang_Class, 999999, 0, 0, 0, 0, &__FINALIZER_com_codename1_impl_ios_IOSImplementation_30 ,0 , &__GC_MARK_com_codename1_impl_ios_IOSImplementation_30,  0, cn1_class_id_com_codename1_impl_ios_IOSImplementation_30, "com.codename1.impl.ios.IOSImplementation.30", 0, 0, 0, JAVA_FALSE, &class__java_lang_Object, base_interfaces_for_com_codename1_impl_ios_IOSImplementation_30, 1, &__NEW_INSTANCE_com_codename1_impl_ios_IOSImplementation_30, 0
, 0, 0, 0, JAVA_TRUE, 0, 0};
...
JAVA_OBJECT __NEW_INSTANCE_com_codename1_impl_ios_IOSImplementation_30(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_impl_ios_IOSImplementation_30(threadStateData);
    JAVA_OBJECT o = codenameOneGcMalloc(threadStateData, sizeof(struct obj__com_codename1_impl_ios_IOSImplementation_30), &class__com_codename1_impl_ios_IOSImplementation_30);
com_codename1_impl_ios_IOSImplementation_30___INIT____(threadStateData, o);
    return o;
}


JAVA_VOID com_codename1_impl_ios_IOSImplementation_30___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9629, 200);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(8416);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_30_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9629, 202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(8418);
...
void __INIT_VTABLE_com_codename1_impl_ios_IOSImplementation_30(CODENAME_ONE_THREAD_STATE, void** vtable) {
    ...
    vtable[10] = &com_codename1_impl_ios_IOSImplementation_30_run__;
}
...
void __STATIC_INITIALIZER_com_codename1_impl_ios_IOSImplementation_30(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_impl_ios_IOSImplementation_30.vtable = malloc(sizeof(void*) *11);
