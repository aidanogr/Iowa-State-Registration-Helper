...
JAVA_VOID com_codename1_util_MathUtil___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3702, 200);
...
JAVA_DOUBLE com_codename1_util_MathUtil_exp___double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 3702, 3703);
...
JAVA_DOUBLE com_codename1_util_MathUtil_pow___double_double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(4, 4, 0, 3702, 1040);
    dlocals_0_ = __cn1Arg1;
...
JAVA_DOUBLE com_codename1_util_MathUtil_acos___double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    volatile JAVA_DOUBLE dlocals_0_ = 0; /* a */
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 3702, 3706);
    dlocals_0_ = __cn1Arg1;
...
JAVA_DOUBLE com_codename1_util_MathUtil_atan2___double_double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(4, 4, 0, 3702, 3707);
    dlocals_0_ = __cn1Arg1;
    dlocals_2_ = __cn1Arg2;
...
JAVA_DOUBLE com_codename1_util_MathUtil_ieee754_exp___double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(22, 20, 0, 3702, 3708);
    dlocals_0_ = __cn1Arg1;
    ...
    if (ilocals_14_<1082535490) /* IF_IMPLT CustomJump */ goto label_L423459527;
    __CN1_DEBUG_INFO(233);
    if (ilocals_14_<2146435072) /* IF_IMPLT CustomJump */ goto label_L2097361864;
    __CN1_DEBUG_INFO(234);
    /* VarOp.assignFrom */ ilocals_15_=((JAVA_INT)(llocals_18_ & 4294967295LL));
    __CN1_DEBUG_INFO(235);
    if (((ilocals_14_ & 1048575) | ilocals_15_)==0) /* IFEQ CustomJump */ goto label_L408648902;
...
label_L408648902:
    ...
    if (ilocals_13_!=0) /* IFNE CustomJump */ goto label_L546552684;
    BC_DLOAD(0);
    goto label_L1384781563;
...
label_L2097361864:
    ...
    if (CN1_CMP_EXPR(dlocals_0_, 709.782712893384)<=0) /* IFLE CustomJump */ goto label_L913564177;
    __CN1_DEBUG_INFO(242);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1.0 / 0.0;

label_L913564177:
    __CN1_DEBUG_INFO(244);
    if (CN1_CMP_EXPR(dlocals_0_, -745.1332191019411)>=0) /* IFGE CustomJump */ goto label_L423459527;
    __CN1_DEBUG_INFO(245);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* DCONST_0 */;

label_L423459527:
    __CN1_DEBUG_INFO(250);
    if (ilocals_14_<=1071001154) /* IF_ICMPLE CustomJump */ goto label_L1972176213;
    __CN1_DEBUG_INFO(251);
    if (ilocals_14_>=1072734898) /* IF_ICMPGE CustomJump */ goto label_L1215858771;
...
label_L1254584937:
    ...
    goto label_L1670210122;

label_L1972176213:
    __CN1_DEBUG_INFO(262);
    if (ilocals_14_>=1043333120) /* IF_ICMPGE CustomJump */ goto label_L1670210122;
    __CN1_DEBUG_INFO(263);
    if (CN1_CMP_EXPR((1.0E300 + dlocals_0_), 1 /* DCONST_1 */)<=0) /* IFLE CustomJump */ goto label_L1670210122;
...
label_L1670210122:
    ...
    if (ilocals_12_!=0) /* IFNE CustomJump */ goto label_L2125952195;
...
label_L2125952195:
    ...
    SP++;
    PUSH_INT(-1021);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1912688982;
...
JAVA_DOUBLE com_codename1_util_MathUtil_ieee754_pow___double_double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(24, 57, 0, 3702, 3710);
    dlocals_0_ = __cn1Arg1;
    dlocals_2_ = __cn1Arg2;
    ...
    if ((ilocals_42_ | ilocals_44_)!=0) /* IFNE CustomJump */ goto label_L456824281;
    __CN1_DEBUG_INFO(506);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* DCONST_1 */;

label_L456824281:
    __CN1_DEBUG_INFO(510);
    if (ilocals_41_>2146435072) /* IF_ICMPGT CustomJump */ goto label_L1911830487;
    if (ilocals_41_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L1367787521;
    if (ilocals_43_!=0) /* IFNE CustomJump */ goto label_L1911830487;

label_L1367787521:
    if (ilocals_42_>2146435072) /* IF_ICMPGT CustomJump */ goto label_L1911830487;
    if (ilocals_42_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L551821075;
    if (ilocals_44_==0) /* IFEQ CustomJump */ goto label_L551821075;
...
label_L551821075:
    ...
    if (ilocals_39_>=0) /* IFGE CustomJump */ goto label_L1874842251;
    __CN1_DEBUG_INFO(522);
    if (ilocals_42_<1128267776) /* IF_IMPLT CustomJump */ goto label_L1067780644;
    __CN1_DEBUG_INFO(523);
    /* VarOp.assignFrom */     ilocals_37_ = 2 /* ICONST_2 */; 
    goto label_L1874842251;

label_L1067780644:
    __CN1_DEBUG_INFO(524);
    if (ilocals_42_<1072693248) /* IF_IMPLT CustomJump */ goto label_L1874842251;
    ...
    SP++;
    PUSH_INT(20);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1476664081;
    __CN1_DEBUG_INFO(527);
    /* VarOp.assignFrom */ ilocals_35_=BC_ISHR_EXPR(ilocals_44_, (52 - ilocals_36_));
    __CN1_DEBUG_INFO(528);
    if (BC_ISHL_EXPR(ilocals_35_, (52 - ilocals_36_))!=ilocals_44_) /* IF_ICMPNE CustomJump */ goto label_L1874842251;
...
label_L1476664081:
    ...
    if (ilocals_44_!=0) /* IFNE CustomJump */ goto label_L1874842251;
    __CN1_DEBUG_INFO(532);
    /* VarOp.assignFrom */ ilocals_35_=BC_ISHR_EXPR(ilocals_42_, (20 - ilocals_36_));
    __CN1_DEBUG_INFO(533);
    if (BC_ISHL_EXPR(ilocals_35_, (20 - ilocals_36_))!=ilocals_42_) /* IF_ICMPNE CustomJump */ goto label_L1874842251;
    __CN1_DEBUG_INFO(534);
    /* VarOp.assignFrom */ ilocals_37_=(2 /* ICONST_2 */ - (ilocals_35_ & 1 /* ICONST_1 */));

label_L1874842251:
    __CN1_DEBUG_INFO(541);
    if (ilocals_44_!=0) /* IFNE CustomJump */ goto label_L1478007685;
    __CN1_DEBUG_INFO(542);
    if (ilocals_42_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L1226973575;
    __CN1_DEBUG_INFO(543);
    if (((ilocals_41_ - 1072693248) | ilocals_43_)!=0) /* IFNE CustomJump */ goto label_L1581377197;
...
label_L1581377197:
    ...
    if (ilocals_41_<1072693248) /* IF_IMPLT CustomJump */ goto label_L644195047;
    __CN1_DEBUG_INFO(546);
    if (ilocals_40_<0) /* IFLT CustomJump */ goto label_L985514269;
    BC_DLOAD(2);
    goto label_L1649140180;
...
label_L644195047:
    ...
    if (ilocals_40_>=0) /* IFGE CustomJump */ goto label_L862853054;
    BC_DLOAD(2);
    SP[-1].data.d *= -1; /* DNEG */
    goto label_L949483950;
...
label_L1226973575:
    ...
    if (ilocals_42_!=1072693248) /* IF_ICMPNE CustomJump */ goto label_L1819701896;
    __CN1_DEBUG_INFO(552);
    if (ilocals_40_>=0) /* IFGE CustomJump */ goto label_L1359899539;
...
label_L1819701896:
    ...
    if (ilocals_40_!=1073741824) /* IF_ICMPNE CustomJump */ goto label_L312362475;
...
label_L312362475:
    ...
    if (ilocals_40_!=1071644672) /* IF_ICMPNE CustomJump */ goto label_L1478007685;
    __CN1_DEBUG_INFO(562);
    if (ilocals_39_<0) /* IFLT CustomJump */ goto label_L1478007685;
...
label_L1478007685:
    ...
    if (ilocals_43_!=0) /* IFNE CustomJump */ goto label_L365135007;
    __CN1_DEBUG_INFO(571);
    if (ilocals_41_==2146435072) /* IF_ICMPEQ CustomJump */ goto label_L1249789597;
    if (ilocals_41_==0) /* IFEQ CustomJump */ goto label_L1249789597;
    if (ilocals_41_!=1072693248) /* IF_ICMPNE CustomJump */ goto label_L365135007;

label_L1249789597:
    __CN1_DEBUG_INFO(572);
    /* VarOp.assignFrom */     dlocals_4_ = dlocals_6_;
    __CN1_DEBUG_INFO(573);
    if (ilocals_40_>=0) /* IFGE CustomJump */ goto label_L1754201778;
    __CN1_DEBUG_INFO(574);
    /* VarOp.assignFrom */ dlocals_4_=(1 /* DCONST_1 */ / dlocals_4_);

label_L1754201778:
    __CN1_DEBUG_INFO(576);
    if (ilocals_39_>=0) /* IFGE CustomJump */ goto label_L140468053;
    __CN1_DEBUG_INFO(577);
    if (((ilocals_41_ - 1072693248) | ilocals_37_)!=0) /* IFNE CustomJump */ goto label_L20039101;
    __CN1_DEBUG_INFO(578);
    /* VarOp.assignFrom */ dlocals_4_=((dlocals_4_ - dlocals_4_) / (dlocals_4_ - dlocals_4_));
    goto label_L140468053;

label_L20039101:
    __CN1_DEBUG_INFO(579);
    if (ilocals_37_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L140468053;
...
label_L365135007:
    ...
    if ((ilocals_38_ | ilocals_37_)!=0) /* IFNE CustomJump */ goto label_L960704936;
...
label_L960704936:
    ...
    if ((ilocals_38_ | (ilocals_37_ - 1 /* ICONST_1 */))!=0) /* IFNE CustomJump */ goto label_L640103260;
    __CN1_DEBUG_INFO(596);
    /* VarOp.assignFrom */     dlocals_24_ = -1.0;

label_L640103260:
    __CN1_DEBUG_INFO(600);
    if (ilocals_42_<=1105199104) /* IF_ICMPLE CustomJump */ goto label_L1416656186;
    __CN1_DEBUG_INFO(601);
    if (ilocals_42_<=1139802112) /* IF_ICMPLE CustomJump */ goto label_L1533234724;
    __CN1_DEBUG_INFO(602);
    if (ilocals_41_>1072693247) /* IF_ICMPGT CustomJump */ goto label_L2064513681;
    __CN1_DEBUG_INFO(603);
    if (ilocals_40_>=0) /* IFGE CustomJump */ goto label_L1680837503;
    PUSH_DOUBLE(1.0 / 0.0); /* LDC */
    goto label_L857865061;
...
label_L2064513681:
    ...
    if (ilocals_41_<1072693248) /* IF_IMPLT CustomJump */ goto label_L1533234724;
    __CN1_DEBUG_INFO(606);
    if (ilocals_40_<=0) /* IFLE CustomJump */ goto label_L1920110923;
    PUSH_DOUBLE(1.0 / 0.0); /* LDC */
    goto label_L1715414246;
...
label_L1533234724:
    ...
    if (ilocals_41_>=1072693247) /* IF_ICMPGE CustomJump */ goto label_L2119380781;
    __CN1_DEBUG_INFO(611);
    if (ilocals_40_>=0) /* IFGE CustomJump */ goto label_L1108674897;
    BC_DLOAD(24);
    PUSH_DOUBLE(1.0E300); /* LDC */
    SP--; SP[-1].data.d = SP[-1].data.d * (*SP).data.d; /* DMUL */
    PUSH_DOUBLE(1.0E300); /* LDC */
    SP--; SP[-1].data.d = SP[-1].data.d * (*SP).data.d; /* DMUL */
    goto label_L613097617;
...
label_L2119380781:
    ...
    if (ilocals_41_<=1072693248) /* IF_ICMPLE CustomJump */ goto label_L990656754;
    __CN1_DEBUG_INFO(614);
    if (ilocals_40_<=0) /* IFLE CustomJump */ goto label_L1556173561;
    BC_DLOAD(24);
    PUSH_DOUBLE(1.0E300); /* LDC */
    SP--; SP[-1].data.d = SP[-1].data.d * (*SP).data.d; /* DMUL */
    PUSH_DOUBLE(1.0E300); /* LDC */
    SP--; SP[-1].data.d = SP[-1].data.d * (*SP).data.d; /* DMUL */
    goto label_L921999281;
...
label_L990656754:
    ...
    goto label_L1267115606;

label_L1416656186:
    __CN1_DEBUG_INFO(628);
    /* VarOp.assignFrom */     ilocals_38_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(630);
    if (ilocals_41_>=1048576) /* IF_ICMPGE CustomJump */ goto label_L286772348;
...
label_L286772348:
    ...
    if (ilocals_35_>235662) /* IF_ICMPGT CustomJump */ goto label_L1201078845;
    __CN1_DEBUG_INFO(640);
    /* VarOp.assignFrom */     ilocals_36_ = 0 /* ICONST_0 */; 
    goto label_L1439452257;

label_L1201078845:
    __CN1_DEBUG_INFO(641);
    if (ilocals_35_>=767610) /* IF_ICMPGE CustomJump */ goto label_L721876120;
...
label_L1267115606:
    ...
    if (ilocals_35_<1083179008) /* IF_IMPLT CustomJump */ goto label_L81639848;
    __CN1_DEBUG_INFO(701);
    if (((ilocals_35_ - 1083179008) | ilocals_34_)==0) /* IFEQ CustomJump */ goto label_L2066011620;
...
label_L2066011620:
    ...
    if (CN1_CMP_EXPR((dlocals_14_ + 8.008566259537294E-17), (dlocals_4_ - dlocals_12_))<=0) /* IFLE CustomJump */ goto label_L1279013285;
...
label_L81639848:
    ...
    if ((ilocals_35_ & 2147483647)<1083231232) /* IF_IMPLT CustomJump */ goto label_L1279013285;
    __CN1_DEBUG_INFO(709);
    if (((ilocals_35_ - -1064252416) | ilocals_34_)==0) /* IFEQ CustomJump */ goto label_L1342357134;
...
label_L1342357134:
    ...
    if (CN1_CMP_EXPR(dlocals_14_, (dlocals_4_ - dlocals_12_))>0) /* IFGT CustomJump */ goto label_L1279013285;
...
label_L1279013285:
    ...
    if (ilocals_34_<=1071644672) /* IF_ICMPLE CustomJump */ goto label_L972774879;
    ...
    if (ilocals_35_>=0) /* IFGE CustomJump */ goto label_L1680684273;
...
label_L972774879:
    ...
    if (BC_ISHR_EXPR(ilocals_35_, 20)>0) /* IFGT CustomJump */ goto label_L1236369608;
...
JAVA_DOUBLE com_codename1_util_MathUtil_ieee754_acos___double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    ...
    volatile JAVA_DOUBLE dlocals_8_ = 0; /* v8 */
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(24, 20, 0, 3702, 3711);
    dlocals_0_ = __cn1Arg1;
    ...
    if (ilocals_19_<1072693248) /* IF_IMPLT CustomJump */ goto label_L1869873220;
    ...
    SP[-1].data.i = (JAVA_INT)SP[-1].data.l; /* L2I */
    SP--; SP[-1].data.i = SP[-1].data.i | (*SP).data.i; /* IOR */
    if(POP_INT() != 0) /* IFNE */ goto label_L1651715047;
    __CN1_DEBUG_INFO(788);
    if (ilocals_18_<=0) /* IFLE CustomJump */ goto label_L662786209;
...
label_L1869873220:
    ...
    if (ilocals_19_>=1071644672) /* IF_ICMPGE CustomJump */ goto label_L1041697470;
    __CN1_DEBUG_INFO(797);
    if (ilocals_19_>1012924416) /* IF_ICMPGT CustomJump */ goto label_L1898859288;
...
label_L1041697470:
    ...
    if (ilocals_18_>=0) /* IFGE CustomJump */ goto label_L184117961;
...
JAVA_DOUBLE com_codename1_util_MathUtil_ieee754_atan___double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    ...
    volatile JAVA_DOUBLE dlocals_8_ = 0; /* v8 */
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(24, 13, 0, 3702, 3713);
    dlocals_0_ = __cn1Arg1;
    ...
    if (ilocals_10_<1141899264) /* IF_IMPLT CustomJump */ goto label_L1973093841;
    __CN1_DEBUG_INFO(955);
    if (ilocals_10_>2146435072) /* IF_ICMPGT CustomJump */ goto label_L647411335;
    if (ilocals_10_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L245652059;
    BC_DLOAD(0);
    ...
    SP--; SP[-1].data.l = SP[-1].data.l & (*SP).data.l; /* LAND */
    SP[-1].data.i = (JAVA_INT)SP[-1].data.l; /* L2I */
    if(POP_INT() == 0) /* IFEQ */ goto label_L245652059;
...
label_L245652059:
    ...
    if (ilocals_11_<=0) /* IFLE CustomJump */ goto label_L1475886210;
...
label_L1973093841:
    ...
    if (ilocals_10_>=1071382528) /* IF_ICMPGE CustomJump */ goto label_L2053115425;
    __CN1_DEBUG_INFO(966);
    if (ilocals_10_>=1042284544) /* IF_ICMPGE CustomJump */ goto label_L1775349092;
    __CN1_DEBUG_INFO(967);
    if (CN1_CMP_EXPR((1.0E300 + dlocals_0_), 1 /* DCONST_1 */)<=0) /* IFLE CustomJump */ goto label_L1775349092;
...
label_L2053115425:
    ...
    if (ilocals_10_>=1072889856) /* IF_ICMPGE CustomJump */ goto label_L1392602264;
    __CN1_DEBUG_INFO(975);
    if (ilocals_10_>=1072037888) /* IF_ICMPGE CustomJump */ goto label_L694841823;
...
label_L1392602264:
    ...
    if (ilocals_10_>=1073971200) /* IF_ICMPGE CustomJump */ goto label_L1303659291;
...
label_L1166754951:
    ...
    if (ilocals_12_>=0) /* IFGE CustomJump */ goto label_L1384421718;
...
label_L1384421718:
    ...
    if (ilocals_11_>=0) /* IFGE CustomJump */ goto label_L179915314;
    BC_DLOAD(8);
    SP[-1].data.d *= -1; /* DNEG */
    goto label_L1881617971;
...
JAVA_DOUBLE com_codename1_util_MathUtil_ieee754_atan2___double_double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(6, 14, 0, 3702, 3714);
    dlocals_0_ = __cn1Arg1;
    dlocals_2_ = __cn1Arg2;
    ...
    if ((ilocals_10_ | BC_ISHR_EXPR((ilocals_12_ | (-(ilocals_12_))), 31))>2146435072) /* IF_ICMPGT CustomJump */ goto label_L526655415;
    if ((ilocals_11_ | BC_ISHR_EXPR((ilocals_13_ | (-(ilocals_13_))), 31))<=2146435072) /* IF_ICMPLE CustomJump */ goto label_L1776057124;
...
label_L1776057124:
    ...
    if (((ilocals_8_ - 1072693248) | ilocals_12_)!=0) /* IFNE CustomJump */ goto label_L695489783;
...
label_L695489783:
    ...
    if ((ilocals_11_ | ilocals_13_)!=0) /* IFNE CustomJump */ goto label_L1613461828;
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1603095377;
        case 1: goto label_L1603095377;
        case 2: goto label_L1434590943;
        case 3: goto label_L1582967668;
        default: goto label_L1613461828;
    }
...
label_L1613461828:
    ...
    if ((ilocals_10_ | ilocals_12_)!=0) /* IFNE CustomJump */ goto label_L1702926498;
    __CN1_DEBUG_INFO(1071);
    if (ilocals_9_>=0) /* IFGE CustomJump */ goto label_L1348632704;
    PUSH_DOUBLE(-1.5707963267948966); /* LDC */
    goto label_L357767349;
...
label_L1702926498:
    ...
    if (ilocals_10_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L450728160;
    __CN1_DEBUG_INFO(1076);
    if (ilocals_11_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L2079936145;
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1071364078;
        case 1: goto label_L851478032;
        case 2: goto label_L1156336184;
        case 3: goto label_L1968179698;
        default: goto label_L391554161;
    }
...
label_L2079936145:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L563105933;
        case 1: goto label_L118186765;
        case 2: goto label_L1927406983;
        case 3: goto label_L1345757830;
        default: goto label_L450728160;
    }
...
label_L450728160:
    ...
    if (ilocals_11_!=2146435072) /* IF_ICMPNE CustomJump */ goto label_L1937867829;
    __CN1_DEBUG_INFO(1102);
    if (ilocals_9_>=0) /* IFGE CustomJump */ goto label_L802062915;
    PUSH_DOUBLE(-1.5707963267948966); /* LDC */
    goto label_L1392412640;
...
label_L1937867829:
    ...
    SP++;
    PUSH_INT(60);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L926498219;
    __CN1_DEBUG_INFO(1108);
    /* VarOp.assignFrom */     dlocals_4_ = 1.5707963267948966;
    goto label_L1214687061;

label_L926498219:
    __CN1_DEBUG_INFO(1109);
    if (ilocals_8_>=0) /* IFGE CustomJump */ goto label_L325183616;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_6_; 
    SP++;
    PUSH_INT(-60);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L325183616;
...
label_L1214687061:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L889633931;
        case 1: goto label_L1269566437;
        case 2: goto label_L915231178;
        default: goto label_L708090483;
    }
...
JAVA_DOUBLE com_codename1_util_MathUtil_scalb___double_int_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(6, 6, 0, 3702, 3715);
    dlocals_0_ = __cn1Arg1;
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L718702938;
    __CN1_DEBUG_INFO(1138);
    if ((ilocals_5_ | (ilocals_4_ & 2147483647))!=0) /* IFNE CustomJump */ goto label_L17714374;
...
label_L17714374:
    ...
    if (ilocals_2_>=-50000) /* IF_ICMPGE CustomJump */ goto label_L718702938;
...
label_L718702938:
    ...
    SP++;
    PUSH_INT(2047);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1565613612;
...
label_L1565613612:
    ...
    SP++;
    PUSH_INT(2046);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1404608759;
...
label_L1404608759:
    ...
    if (ilocals_3_<=0) /* IFLE CustomJump */ goto label_L1295679363;
...
label_L1295679363:
    ...
    SP++;
    PUSH_INT(-54);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1050768030;
    __CN1_DEBUG_INFO(1161);
    if (ilocals_2_<=50000) /* IF_ICMPLE CustomJump */ goto label_L1767304024;
...
JAVA_DOUBLE com_codename1_util_MathUtil_copySign___double_double_R_double(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2) {
    ...
    volatile JAVA_DOUBLE dlocals_2_ = 0; /* y */
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(6, 4, 0, 3702, 3717);
    dlocals_0_ = __cn1Arg1;
    dlocals_2_ = __cn1Arg2;
...
JAVA_INT com_codename1_util_MathUtil_round___float_R_int(CODENAME_ONE_THREAD_STATE, JAVA_FLOAT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 3702, 1049);
...
JAVA_LONG com_codename1_util_MathUtil_round___double_R_long(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1) {
    volatile JAVA_DOUBLE dlocals_0_ = 0; /* a */
    __STATIC_INITIALIZER_com_codename1_util_MathUtil(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 3702, 1049);
    dlocals_0_ = __cn1Arg1;
...
JAVA_VOID com_codename1_util_MathUtil___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(5, 0, 0, 3702, 861);
