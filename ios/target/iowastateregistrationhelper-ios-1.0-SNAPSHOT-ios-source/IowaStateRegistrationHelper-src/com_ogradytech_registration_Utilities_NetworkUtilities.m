...
JAVA_VOID com_ogradytech_registration_Utilities_NetworkUtilities___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10499, 200);
...
JAVA_VOID com_ogradytech_registration_Utilities_NetworkUtilities_fetchAcademicPeriods___com_codename1_ui_spinner_Picker(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_ogradytech_registration_Utilities_NetworkUtilities(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 10499, 10500);
    ...
    __CN1_DEBUG_INFO(29);
    /* CustomInvoke */virtual_com_codename1_io_ConnectionRequest_setUrl___java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10501)); 
    __CN1_DEBUG_INFO(30);
...
JAVA_OBJECT com_ogradytech_registration_Utilities_NetworkUtilities_parseAcademicPeriodsAPIResponse___byte_1ARRAY_R_com_ogradytech_registration_Utilities_AcademicPeriod_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_ogradytech_registration_Utilities_NetworkUtilities(threadStateData);
    DEFINE_METHOD_STACK(7, 9, 0, 10499, 10502);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    int restoreToL655733738cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL655733738cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L655733738cn1_class_id_java_io_IOException1, label_L1099552523, restoreToL655733738cn1_class_id_java_io_IOException1);
    __CN1_DEBUG_INFO(66);
...
label_L655733738:
 tryBlockOffsetL655733738cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L655733738cn1_class_id_java_io_IOException1);
    restoreToL655733738cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
    ...
    __CN1_DEBUG_INFO(75);
    if (virtual_java_util_List_size___R_int(threadStateData, locals[5].data.o)<3 /* ICONST_3 */) /* IF_IMPLT CustomJump */ JUMP_TO(label_L66724371, 1);
    { JAVA_INT tmpResult = virtual_java_util_List_size___R_int(threadStateData, locals[5].data.o);
    PUSH_INT(tmpResult); }
    PUSH_INT(3); /* ICONST_3 */
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    JUMP_TO(label_L1047934137, 1);
...
label_L1614133563:
    if (ilocals_7_>=virtual_java_util_List_size___R_int(threadStateData, locals[5].data.o)) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1862994526, 1);
    __CN1_DEBUG_INFO(76);
    ...
    __CN1_DEBUG_INFO(75);
    BC_IINC(7, 1);
    JUMP_TO(label_L1614133563, 1);

label_L1862994526:
END_TRY(1);    __CN1_DEBUG_INFO(81);
    JUMP_TO(label_L839771540, 0);
...
JAVA_VOID com_ogradytech_registration_Utilities_NetworkUtilities_lambda$fetchAcademicPeriods$0___com_codename1_io_ConnectionRequest_com_codename1_ui_spinner_Picker_com_codename1_io_NetworkEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_com_ogradytech_registration_Utilities_NetworkUtilities(threadStateData);
    DEFINE_METHOD_STACK(6, 5, 0, 10499, 10503);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(300);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1037163664;
    { JAVA_INT tmpResult = virtual_com_codename1_io_ConnectionRequest_getResponseCode___R_int(threadStateData, locals[0].data.o);
    PUSH_INT(tmpResult); }
    PUSH_INT(199);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L180316302;
...
label_L695530017:
    if (ilocals_4_>=CN1_ARRAY_LENGTH(get_static_com_ogradytech_registration_Utilities_NetworkUtilities_academicPeriods(threadStateData))) /* IF_ICMPGE CustomJump */ goto label_L1200546947;
    __CN1_DEBUG_INFO(42);
    if (CN1_ARRAY_ELEMENT_OBJECT(get_static_com_ogradytech_registration_Utilities_NetworkUtilities_academicPeriods(threadStateData), ilocals_4_)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L443713699;
