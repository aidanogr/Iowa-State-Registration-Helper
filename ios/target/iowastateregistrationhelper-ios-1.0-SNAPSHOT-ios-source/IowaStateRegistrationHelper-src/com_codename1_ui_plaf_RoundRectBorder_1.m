...
JAVA_VOID com_codename1_ui_plaf_RoundRectBorder_1___INIT_____com_codename1_ui_plaf_RoundRectBorder_int_int_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 5888, 201);
...
JAVA_VOID com_codename1_ui_plaf_RoundRectBorder_1_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(8, 13, 0, 5888, 2358);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL190275622801;
    int tryBlockOffsetL190275622801;
    DEFINE_CATCH_BLOCK(catch_L190275622801, label_L1713988669, restoreToL190275622801);
    int restoreToL175222366002;
    int tryBlockOffsetL175222366002;
    DEFINE_CATCH_BLOCK(catch_L175222366002, label_L1713988669, restoreToL175222366002);
    int restoreToL171398866903;
    int tryBlockOffsetL171398866903;
    DEFINE_CATCH_BLOCK(catch_L171398866903, label_L1713988669, restoreToL171398866903);
...
label_L1902756228:
 tryBlockOffsetL190275622801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L190275622801);
    restoreToL190275622801 = threadStateData->threadObjectStackOffset;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(580);
    ...
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$100___com_codename1_ui_plaf_RoundRectBorder_R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))<=0) /* IFLE CustomJump */ JUMP_TO(label_L768702707, 1);
...
label_L1684368286:
    if (ilocals_8_<0) /* IFLT CustomJump */ JUMP_TO(label_L768702707, 1);
...
label_L768702707:
    ...
    if (virtual_com_codename1_ui_plaf_Style_getBgImage___R_com_codename1_ui_Image(threadStateData, locals[9].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1752223660, 0);
    ...
    if (ilocals_10_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1163216403, 1);
    if (ilocals_10_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1752223660, 0);
...
label_L1163216403:
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1675999402, 1);
...
label_L1675999402:
    ...
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$700___com_codename1_ui_plaf_RoundRectBorder_R_com_codename1_ui_Stroke(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L747833043, 1);
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$800___com_codename1_ui_plaf_RoundRectBorder_R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))<=0) /* IFLE CustomJump */ JUMP_TO(label_L747833043, 1);
    ...
    BC_FCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L747833043, 1);
...
label_L1752223660:
 tryBlockOffsetL175222366002 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L175222366002);
    restoreToL175222366002 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$700___com_codename1_ui_plaf_RoundRectBorder_R_com_codename1_ui_Stroke(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1114681666, 1);
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$800___com_codename1_ui_plaf_RoundRectBorder_R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))<=0) /* IFLE CustomJump */ JUMP_TO(label_L1114681666, 1);
    /* CustomInvoke */PUSH_FLOAT(com_codename1_ui_plaf_RoundRectBorder_access$900___com_codename1_ui_plaf_RoundRectBorder_R_float(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject)));
    PUSH_FLOAT(0); /* FCONST_0 */
    BC_FCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1114681666, 1);
...
label_L1713988669:
 tryBlockOffsetL171398866903 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L171398866903);
    restoreToL171398866903 = threadStateData->threadObjectStackOffset;
