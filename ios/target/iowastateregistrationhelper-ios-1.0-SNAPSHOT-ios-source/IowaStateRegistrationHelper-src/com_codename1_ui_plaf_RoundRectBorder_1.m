...
JAVA_VOID com_codename1_ui_plaf_RoundRectBorder_1_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL52714191901;
    int tryBlockOffsetL52714191901;
    DEFINE_CATCH_BLOCK(catch_L52714191901, label_L1383031847, restoreToL52714191901);
    int restoreToL114465348502;
    int tryBlockOffsetL114465348502;
    DEFINE_CATCH_BLOCK(catch_L114465348502, label_L1383031847, restoreToL114465348502);
    int restoreToL138303184703;
    int tryBlockOffsetL138303184703;
    DEFINE_CATCH_BLOCK(catch_L138303184703, label_L1383031847, restoreToL138303184703);
...
label_L527141919:
 tryBlockOffsetL52714191901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L52714191901);
    restoreToL52714191901 = threadStateData->threadObjectStackOffset;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(580);
    ...
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$100___com_codename1_ui_plaf_RoundRectBorder_R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))<=0) /* IFLE CustomJump */ JUMP_TO(label_L1327169167, 1);
...
label_L1227170244:
    if (ilocals_8_<0) /* IFLT CustomJump */ JUMP_TO(label_L1327169167, 1);
...
label_L1327169167:
    ...
    if (virtual_com_codename1_ui_plaf_Style_getBgImage___R_com_codename1_ui_Image(threadStateData, locals[9].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1144653485, 0);
    ...
    if (ilocals_10_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1843207249, 1);
    if (ilocals_10_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1144653485, 0);
...
label_L1843207249:
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1965779427, 1);
...
label_L1965779427:
    ...
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$700___com_codename1_ui_plaf_RoundRectBorder_R_com_codename1_ui_Stroke(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L358636931, 1);
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$800___com_codename1_ui_plaf_RoundRectBorder_R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))<=0) /* IFLE CustomJump */ JUMP_TO(label_L358636931, 1);
    ...
    BC_FCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L358636931, 1);
...
label_L1144653485:
 tryBlockOffsetL114465348502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L114465348502);
    restoreToL114465348502 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$700___com_codename1_ui_plaf_RoundRectBorder_R_com_codename1_ui_Stroke(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L33238764, 1);
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$800___com_codename1_ui_plaf_RoundRectBorder_R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))<=0) /* IFLE CustomJump */ JUMP_TO(label_L33238764, 1);
    /* CustomInvoke */PUSH_FLOAT(com_codename1_ui_plaf_RoundRectBorder_access$900___com_codename1_ui_plaf_RoundRectBorder_R_float(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject)));
    PUSH_FLOAT(0); /* FCONST_0 */
    BC_FCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L33238764, 1);
...
label_L1383031847:
 tryBlockOffsetL138303184703 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L138303184703);
    restoreToL138303184703 = threadStateData->threadObjectStackOffset;
