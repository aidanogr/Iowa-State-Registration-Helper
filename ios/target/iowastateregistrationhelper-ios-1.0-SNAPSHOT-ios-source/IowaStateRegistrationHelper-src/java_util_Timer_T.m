...
JAVA_VOID java_util_Timer_T___INIT_____java_util_Timer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3167, 201);
...
JAVA_VOID java_util_Timer_T_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3167, 203);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL530498535cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL530498535cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L530498535cn1_class_id_java_lang_InterruptedException1, label_L411506101, restoreToL530498535cn1_class_id_java_lang_InterruptedException1);
...
label_L530498535:
 tryBlockOffsetL530498535cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L530498535cn1_class_id_java_lang_InterruptedException1);
    restoreToL530498535cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
void __STATIC_INITIALIZER_java_util_Timer_T(CODENAME_ONE_THREAD_STATE) {
    ...
    class__java_util_Timer_T.vtable = malloc(sizeof(void*) *19);
