...
JAVA_VOID com_codename1_ui_tree_Tree___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(10, 1, 0, 8925, 200);
    ...
    PUSH_INT(0); /* ICONST_0 */
    /* LDC: 'Colors'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8926));
    ...
    PUSH_INT(1); /* ICONST_1 */
    /* LDC: 'Letters'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8927));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(2); /* ICONST_2 */
    /* LDC: 'Numbers'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8928));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(0); /* ICONST_0 */
    /* LDC: 'Red'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8929));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(1); /* ICONST_1 */
    /* LDC: 'Green'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8930));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(2); /* ICONST_2 */
    /* LDC: 'Blue'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8931));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(0); /* ICONST_0 */
    /* LDC: 'A'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8932));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(1); /* ICONST_1 */
    /* LDC: 'B'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8933));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(2); /* ICONST_2 */
    /* LDC: 'C'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8934));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(0); /* ICONST_0 */
    /* LDC: '1'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(2300));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(1); /* ICONST_1 */
    /* LDC: '2'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8935));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(2); /* ICONST_2 */
    /* LDC: '3'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(8936));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
...
JAVA_OBJECT com_codename1_ui_tree_Tree_getPropertyValue___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8925, 2363);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(260);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8941))==0) /* IFEQ CustomJump */ goto label_L1922859107;
...
JAVA_OBJECT com_codename1_ui_tree_Tree_setPropertyValue___java_lang_String_java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 8925, 2364);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(270);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8941))==0) /* IFEQ CustomJump */ goto label_L1089280002;
...
JAVA_VOID com_codename1_ui_tree_Tree___INIT_____com_codename1_ui_tree_TreeModel(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 8925, 200);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (get_static_com_codename1_ui_tree_Tree_folder(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L600270822;
    __CN1_DEBUG_INFO(286);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeImageConstant___java_lang_String_R_com_codename1_ui_Image(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8943));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    set_static_com_codename1_ui_tree_Tree_folder(threadStateData, PEEK_OBJ(1));
    SP--;
    __CN1_DEBUG_INFO(287);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeImageConstant___java_lang_String_R_com_codename1_ui_Image(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8944));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    set_static_com_codename1_ui_tree_Tree_openFolder(threadStateData, PEEK_OBJ(1));
    SP--;
    __CN1_DEBUG_INFO(288);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeImageConstant___java_lang_String_R_com_codename1_ui_Image(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8945));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L600270822:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_tree_Tree_setUIID___java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(8946)); 
...
JAVA_OBJECT com_codename1_ui_tree_Tree_getModel___R_com_codename1_ui_tree_TreeModel(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8925, 4494);
...
JAVA_VOID com_codename1_ui_tree_Tree_setModel___com_codename1_ui_tree_TreeModel(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 8925, 4497);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_tree_Tree_expandNode___boolean_com_codename1_ui_Component_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 8925, 8950);
...
JAVA_OBJECT com_codename1_ui_tree_Tree_expandNode___boolean_com_codename1_ui_Component_boolean_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 8925, 8950);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_tree_Tree_expandNodeImpl___boolean_com_codename1_ui_Component_boolean_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* revalidate */
    DEFINE_INSTANCE_METHOD_STACK(5, 9, 0, 8925, 8951);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ilocals_3_ = __cn1Arg3;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L267061647;
    __CN1_DEBUG_INFO(355);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[4].data.o;
locals[2].type=CN1_TYPE_OBJECT;
label_L267061647:
    __CN1_DEBUG_INFO(357);
    /* CustomInvoke */virtual_com_codename1_ui_Component_putClientProperty___java_lang_String_java_lang_Object(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(86), STRING_FROM_CONSTANT_POOL_OFFSET(207)); 
    __CN1_DEBUG_INFO(358);
    if (get_static_com_codename1_ui_tree_Tree_openFolder(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L434249609;
...
label_L837237183:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Component_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(87));
    PUSH_OBJ(tmpResult); }
    ...
    /* VarOp.assignFrom */ locals[7].data.o = /* CustomInvoke */virtual_com_codename1_ui_Component_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(84));locals[7].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(366);
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Container_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[6].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(136), locals[8].data.o); 
    ...
    if (virtual_com_codename1_ui_tree_Tree_isInitialized___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L688361522;
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L688361522;
    ...
    if (get_field_com_codename1_ui_tree_Tree_multilineMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2121745388;
...
label_L688361522:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L2121745388;
...
JAVA_VOID com_codename1_ui_tree_Tree_collapseNode___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(5, 2, 0, 8925, 8958);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_tree_Tree_collapseNode___com_codename1_ui_Component_com_codename1_ui_animations_Transition(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    DEFINE_INSTANCE_METHOD_STACK(4, 7, 0, 8925, 8958);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1269938539;
    __CN1_DEBUG_INFO(520);
    /* VarOp.assignFrom */ locals[1].type=CN1_TYPE_INVALID;    locals[1].data.o = locals[3].data.o;
locals[1].type=CN1_TYPE_OBJECT;
label_L1269938539:
    __CN1_DEBUG_INFO(522);
    /* CustomInvoke */virtual_com_codename1_ui_Component_putClientProperty___java_lang_String_java_lang_Object(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(86), JAVA_NULL /* ACONST_NULL */); 
    __CN1_DEBUG_INFO(523);
    if (get_static_com_codename1_ui_tree_Tree_folder(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L465427162;
...
label_L1756877039:
    if (ilocals_5_>=virtual_com_codename1_ui_Container_getComponentCount___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1914526580;
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L874634941;
    __CN1_DEBUG_INFO(531);
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1103079913;
...
JAVA_OBJECT com_codename1_ui_tree_Tree_getSelectedItem___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8925, 4492);
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1885991030;
    __CN1_DEBUG_INFO(554);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Component_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(84));
    PUSH_OBJ(tmpResult); }
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_OBJ();
...
JAVA_VOID com_codename1_ui_tree_Tree_buildBranch___java_lang_Object_int_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 11, 0, 8925, 8963);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L584724454:
    if (ilocals_7_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1369206732;
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_tree_TreeModel_isLeaf___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_tree_Tree_model(__cn1ThisObject), locals[8].data.o)==0) /* IFEQ CustomJump */ goto label_L1792110618;
...
label_L1792110618:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Container_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[10].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(61), locals[9].data.o); 
...
label_L2127407451:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Component_putClientProperty___java_lang_String_java_lang_Object(threadStateData, locals[9].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(84), locals[8].data.o); 
    __CN1_DEBUG_INFO(650);
    /* CustomInvoke */virtual_com_codename1_ui_Component_putClientProperty___java_lang_String_java_lang_Object(threadStateData, locals[9].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(85), locals[1].data.o); 
    __CN1_DEBUG_INFO(651);
    /* CustomInvoke */virtual_com_codename1_ui_Component_putClientProperty___java_lang_String_java_lang_Object(threadStateData, locals[9].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(87), locals[6].data.o); 
    __CN1_DEBUG_INFO(637);
    BC_IINC(7, 1);
    goto label_L584724454;
...
JAVA_OBJECT com_codename1_ui_tree_Tree_createNodeComponent___java_lang_Object_int_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    volatile JAVA_INT ilocals_2_ = 0; /* depth */
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 8925, 8919);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8964)); 
    __CN1_DEBUG_INFO(667);
    if (/* CustomInvoke */virtual_com_codename1_ui_tree_TreeModel_isLeaf___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_tree_Tree_model(__cn1ThisObject), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L269145726;
    __CN1_DEBUG_INFO(668);
    if (get_static_com_codename1_ui_tree_Tree_nodeImage(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1899640261;
...
label_L269145726:
    ...
    if (get_static_com_codename1_ui_tree_Tree_folder(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L293108580;
...
JAVA_VOID com_codename1_ui_tree_Tree_bindNodeListener___com_codename1_ui_events_ActionListener_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 8925, 8965);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1460139539;
...
JAVA_VOID com_codename1_ui_tree_Tree_setNodeIcon___com_codename1_ui_Image_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 8925, 8949);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Button);
    if(POP_INT() == 0) /* IFEQ */ goto label_L2008249643;
...
JAVA_VOID com_codename1_ui_tree_Tree_setNodeMaterialIcon___char_com_codename1_ui_Component_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_FLOAT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 8925, 8966);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_tree_Tree_createNode___java_lang_Object_int_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    volatile JAVA_INT ilocals_2_ = 0; /* depth */
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 8925, 6229);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(731);
    if (get_field_com_codename1_ui_tree_Tree_multilineMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1667737224;
    ...
    /* CustomInvoke */virtual_com_codename1_components_SpanButton_setUIID___java_lang_String(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8964)); 
    __CN1_DEBUG_INFO(734);
    /* CustomInvoke */virtual_com_codename1_components_SpanButton_setTextUIID___java_lang_String(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8964)); 
    __CN1_DEBUG_INFO(735);
    if (/* CustomInvoke */virtual_com_codename1_ui_tree_TreeModel_isLeaf___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_tree_Tree_model(__cn1ThisObject), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L831931099;
...
JAVA_VOID com_codename1_ui_tree_Tree_updateNodeComponentStyle___com_codename1_ui_plaf_Style_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    volatile JAVA_INT ilocals_2_ = 0; /* depth */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 8925, 8967);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
...
JAVA_OBJECT com_codename1_ui_tree_Tree_childToDisplayLabel___java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 8925, 8923);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_tree_Tree_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 8925, 1858);
...
label_L1756435781:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L901751227;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1798443618;
...
label_L901751227:
    ...
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L2097217770;
...
JAVA_OBJECT com_codename1_ui_tree_Tree_access$000___com_codename1_ui_tree_Tree_boolean_com_codename1_ui_Component_boolean_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_BOOLEAN __cn1Arg4) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_tree_Tree(threadStateData);
    DEFINE_METHOD_STACK(4, 4, 0, 8925, 216);
...
JAVA_VOID com_codename1_ui_tree_Tree_access$200___com_codename1_ui_tree_Tree_com_codename1_ui_Component_com_codename1_ui_animations_Transition(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    __STATIC_INITIALIZER_com_codename1_ui_tree_Tree(threadStateData);
    DEFINE_METHOD_STACK(3, 3, 0, 8925, 801);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_tree_Tree_access$600___com_codename1_ui_tree_Tree_R_com_codename1_ui_util_EventDispatcher(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_tree_Tree(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 8925, 1525);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(71);
...
JAVA_VOID com_codename1_ui_tree_Tree_access$700___com_codename1_ui_tree_Tree_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_codename1_ui_tree_Tree(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 8925, 807);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_ui_tree_Tree_access$800___com_codename1_ui_tree_Tree_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_tree_Tree(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 8925, 809);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(71);
...
JAVA_OBJECT com_codename1_ui_tree_Tree_access$900___com_codename1_ui_tree_Tree_boolean_com_codename1_ui_Component_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    volatile JAVA_INT ilocals_1_ = 0; /* x1 */
    __STATIC_INITIALIZER_com_codename1_ui_tree_Tree(threadStateData);
    DEFINE_METHOD_STACK(3, 3, 0, 8925, 811);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    locals[2].data.o = __cn1Arg3;
...
JAVA_BOOLEAN com_codename1_ui_tree_Tree_pinch___int_1ARRAY_int_1ARRAY_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
...
JAVA_VOID com_codename1_ui_tree_Tree_setPinchBlocksDragAndDrop___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
com_codename1_ui_Component_setPinchBlocksDragAndDrop___boolean(threadStateData, __cn1ThisObject, __cn1Arg1);
}


JAVA_BOOLEAN com_codename1_ui_tree_Tree_isPinchBlocksDragAndDrop___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
...
JAVA_VOID com_codename1_ui_tree_Tree_setDragTransparency___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
com_codename1_ui_Component_setDragTransparency___byte(threadStateData, __cn1ThisObject, __cn1Arg1);
}


JAVA_BYTE com_codename1_ui_tree_Tree_getDragTransparency___R_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    return com_codename1_ui_Component_getDragTransparency___R_byte(threadStateData, __cn1ThisObject);
}


JAVA_VOID com_codename1_ui_tree_Tree_setDefaultDragTransparency___byte(CODENAME_ONE_THREAD_STATE, JAVA_BYTE __cn1Arg1) {
com_codename1_ui_Component_setDefaultDragTransparency___byte(threadStateData, __cn1Arg1);
}


JAVA_BYTE com_codename1_ui_tree_Tree_getDefaultDragTransparency___R_byte(CODENAME_ONE_THREAD_STATE) {
...
JAVA_BOOLEAN virtual_com_codename1_ui_tree_Tree_isInitialized___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_tree_Tree_isInitialized___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[266])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_tree_Tree_setLayout___com_codename1_ui_layouts_Layout(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_tree_Tree_setLayout___com_codename1_ui_layouts_Layout)__cn1ThisObject->__codenameOneParentClsReference->vtable[326])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_tree_Tree_removeAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_tree_Tree_removeAll__)__cn1ThisObject->__codenameOneParentClsReference->vtable[347])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_tree_Tree_revalidate__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_tree_Tree_revalidate__)__cn1ThisObject->__codenameOneParentClsReference->vtable[350])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_tree_Tree_revalidateLater__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_tree_Tree_revalidateLater__)__cn1ThisObject->__codenameOneParentClsReference->vtable[352])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_tree_Tree_getComponentCount___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_tree_Tree_getComponentCount___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[368])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_tree_Tree_getComponentAt___int_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_tree_Tree_getComponentAt___int_R_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[369])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_tree_Tree_setScrollableY___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_tree_Tree_setScrollableY___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[378])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_tree_Tree_animateLayoutAndWait___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_tree_Tree_animateLayoutAndWait___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[388])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_tree_Tree_setModel___com_codename1_ui_tree_TreeModel(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_tree_Tree_setModel___com_codename1_ui_tree_TreeModel)__cn1ThisObject->__codenameOneParentClsReference->vtable[397])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_tree_Tree_createNodeComponent___java_lang_Object_int_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_tree_Tree_createNodeComponent___java_lang_Object_int_R_com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[399])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_tree_Tree_bindNodeListener___com_codename1_ui_events_ActionListener_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_tree_Tree_bindNodeListener___com_codename1_ui_events_ActionListener_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[400])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_tree_Tree_setNodeIcon___com_codename1_ui_Image_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_tree_Tree_setNodeIcon___com_codename1_ui_Image_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[401])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_tree_Tree_setNodeMaterialIcon___char_com_codename1_ui_Component_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_FLOAT __cn1Arg3) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_tree_Tree_setNodeMaterialIcon___char_com_codename1_ui_Component_float)__cn1ThisObject->__codenameOneParentClsReference->vtable[402])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2, __cn1Arg3);
}
...
JAVA_OBJECT virtual_com_codename1_ui_tree_Tree_createNode___java_lang_Object_int_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_tree_Tree_createNode___java_lang_Object_int_R_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[403])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_OBJECT virtual_com_codename1_ui_tree_Tree_childToDisplayLabel___java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_tree_Tree_childToDisplayLabel___java_lang_Object_R_java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[404])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
void __INIT_VTABLE_com_codename1_ui_tree_Tree(CODENAME_ONE_THREAD_STATE, void** vtable) {
    ...
    vtable[283] = &com_codename1_ui_tree_Tree_getPropertyValue___java_lang_String_R_java_lang_Object;
    vtable[284] = &com_codename1_ui_tree_Tree_setPropertyValue___java_lang_String_java_lang_Object_R_java_lang_String;
    vtable[396] = &com_codename1_ui_tree_Tree_getModel___R_com_codename1_ui_tree_TreeModel;
    vtable[397] = &com_codename1_ui_tree_Tree_setModel___com_codename1_ui_tree_TreeModel;
    vtable[398] = &com_codename1_ui_tree_Tree_getSelectedItem___R_java_lang_Object;
    vtable[399] = &com_codename1_ui_tree_Tree_createNodeComponent___java_lang_Object_int_R_com_codename1_ui_Button;
    vtable[400] = &com_codename1_ui_tree_Tree_bindNodeListener___com_codename1_ui_events_ActionListener_com_codename1_ui_Component;
    vtable[401] = &com_codename1_ui_tree_Tree_setNodeIcon___com_codename1_ui_Image_com_codename1_ui_Component;
    vtable[402] = &com_codename1_ui_tree_Tree_setNodeMaterialIcon___char_com_codename1_ui_Component_float;
    vtable[403] = &com_codename1_ui_tree_Tree_createNode___java_lang_Object_int_R_com_codename1_ui_Component;
    vtable[404] = &com_codename1_ui_tree_Tree_childToDisplayLabel___java_lang_Object_R_java_lang_String;
}
...
void __STATIC_INITIALIZER_com_codename1_ui_tree_Tree(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_ui_tree_Tree.vtable = malloc(sizeof(void*) *405);
