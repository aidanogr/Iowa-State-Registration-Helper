...
JAVA_VOID com_codename1_io_JSONParser_parse___java_io_Reader_com_codename1_io_JSONParseCallback(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL629372839cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL629372839cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L629372839cn1_class_id_java_lang_NumberFormatException1, label_L1277160809, restoreToL629372839cn1_class_id_java_lang_NumberFormatException1);
    int restoreToL638112861cn1_class_id_java_lang_NumberFormatException2;
    int tryBlockOffsetL638112861cn1_class_id_java_lang_NumberFormatException2;
    DEFINE_CATCH_BLOCK(catch_L638112861cn1_class_id_java_lang_NumberFormatException2, label_L1654520666, restoreToL638112861cn1_class_id_java_lang_NumberFormatException2);
    int restoreToL195081872cn1_class_id_java_lang_NumberFormatException3;
    int tryBlockOffsetL195081872cn1_class_id_java_lang_NumberFormatException3;
    DEFINE_CATCH_BLOCK(catch_L195081872cn1_class_id_java_lang_NumberFormatException3, label_L747984007, restoreToL195081872cn1_class_id_java_lang_NumberFormatException3);
    int restoreToL1778269260cn1_class_id_java_lang_NumberFormatException4;
    int tryBlockOffsetL1778269260cn1_class_id_java_lang_NumberFormatException4;
    DEFINE_CATCH_BLOCK(catch_L1778269260cn1_class_id_java_lang_NumberFormatException4, label_L950954487, restoreToL1778269260cn1_class_id_java_lang_NumberFormatException4);
    int restoreToL866488267cn1_class_id_java_lang_Exception5;
    int tryBlockOffsetL866488267cn1_class_id_java_lang_Exception5;
    DEFINE_CATCH_BLOCK(catch_L866488267cn1_class_id_java_lang_Exception5, label_L199868206, restoreToL866488267cn1_class_id_java_lang_Exception5);
    int restoreToL9740045cn1_class_id_java_lang_Exception6;
    int tryBlockOffsetL9740045cn1_class_id_java_lang_Exception6;
    DEFINE_CATCH_BLOCK(catch_L9740045cn1_class_id_java_lang_Exception6, label_L199868206, restoreToL9740045cn1_class_id_java_lang_Exception6);
...
label_L866488267:
 tryBlockOffsetL866488267cn1_class_id_java_lang_Exception5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L866488267cn1_class_id_java_lang_Exception5);
    restoreToL866488267cn1_class_id_java_lang_Exception5 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(277);
    if (virtual_com_codename1_io_JSONParseCallback_isAlive___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L103010850, 1);
    ...
    if (ilocals_10_>=0) /* IFGE CustomJump */ JUMP_TO(label_L9740045, 0);
...
label_L9740045:
 tryBlockOffsetL9740045cn1_class_id_java_lang_Exception6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L9740045cn1_class_id_java_lang_Exception6);
    restoreToL9740045cn1_class_id_java_lang_Exception6 = threadStateData->threadObjectStackOffset;
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1262399289, 1);
    __CN1_DEBUG_INFO(284);
    BC_IINC(4, 1);
    __CN1_DEBUG_INFO(285);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 
    JUMP_TO(label_L224950719, 1);
...
label_L224950719:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L356649202, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: JUMP_TO(label_L831160736, 1);
        case 92: JUMP_TO(label_L259237839, 1);
        default: JUMP_TO(label_L1100517919, 1);
    }
...
label_L831160736:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1142429510, 1);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L570038756, 1);
...
label_L259237839:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L917040074, 1);
...
label_L629372839:
 tryBlockOffsetL629372839cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L629372839cn1_class_id_java_lang_NumberFormatException1);
    restoreToL629372839cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L917040074:
    ...
    SP--;
    switch((*SP).data.i) {
        case 110: JUMP_TO(label_L1552840327, 1);
        case 114: JUMP_TO(label_L755576935, 1);
        case 116: JUMP_TO(label_L1812291616, 1);
        default: JUMP_TO(label_L1128952562, 1);
    }
...
label_L356649202:
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: JUMP_TO(label_L1407003104, 1);
        case 10: JUMP_TO(label_L1407003104, 1);
        case 11: JUMP_TO(label_L2093499056, 1);
        case 12: JUMP_TO(label_L2093499056, 1);
        case 13: JUMP_TO(label_L1407003104, 1);
        case 14: JUMP_TO(label_L2093499056, 1);
        case 15: JUMP_TO(label_L2093499056, 1);
        case 16: JUMP_TO(label_L2093499056, 1);
        case 17: JUMP_TO(label_L2093499056, 1);
        case 18: JUMP_TO(label_L2093499056, 1);
        case 19: JUMP_TO(label_L2093499056, 1);
        case 20: JUMP_TO(label_L2093499056, 1);
        case 21: JUMP_TO(label_L2093499056, 1);
        case 22: JUMP_TO(label_L2093499056, 1);
        case 23: JUMP_TO(label_L2093499056, 1);
        case 24: JUMP_TO(label_L2093499056, 1);
        case 25: JUMP_TO(label_L2093499056, 1);
        case 26: JUMP_TO(label_L2093499056, 1);
        case 27: JUMP_TO(label_L2093499056, 1);
        case 28: JUMP_TO(label_L2093499056, 1);
        case 29: JUMP_TO(label_L2093499056, 1);
        case 30: JUMP_TO(label_L2093499056, 1);
        case 31: JUMP_TO(label_L2093499056, 1);
        case 32: JUMP_TO(label_L1407003104, 1);
        case 33: JUMP_TO(label_L2093499056, 1);
        case 34: JUMP_TO(label_L926134772, 1);
        case 35: JUMP_TO(label_L2093499056, 1);
        case 36: JUMP_TO(label_L2093499056, 1);
        case 37: JUMP_TO(label_L2093499056, 1);
        case 38: JUMP_TO(label_L2093499056, 1);
        case 39: JUMP_TO(label_L2093499056, 1);
        case 40: JUMP_TO(label_L2093499056, 1);
        case 41: JUMP_TO(label_L2093499056, 1);
        case 42: JUMP_TO(label_L2093499056, 1);
        case 43: JUMP_TO(label_L2093499056, 1);
        case 44: JUMP_TO(label_L1894826834, 1);
        case 45: JUMP_TO(label_L1318310462, 1);
        case 46: JUMP_TO(label_L1318310462, 1);
        case 47: JUMP_TO(label_L2093499056, 1);
        case 48: JUMP_TO(label_L1318310462, 1);
        case 49: JUMP_TO(label_L1318310462, 1);
        case 50: JUMP_TO(label_L1318310462, 1);
        case 51: JUMP_TO(label_L1318310462, 1);
        case 52: JUMP_TO(label_L1318310462, 1);
        case 53: JUMP_TO(label_L1318310462, 1);
        case 54: JUMP_TO(label_L1318310462, 1);
        case 55: JUMP_TO(label_L1318310462, 1);
        case 56: JUMP_TO(label_L1318310462, 1);
        case 57: JUMP_TO(label_L1318310462, 1);
        case 58: JUMP_TO(label_L1894826834, 1);
        case 59: JUMP_TO(label_L2093499056, 1);
        case 60: JUMP_TO(label_L2093499056, 1);
        case 61: JUMP_TO(label_L2093499056, 1);
        case 62: JUMP_TO(label_L2093499056, 1);
        case 63: JUMP_TO(label_L2093499056, 1);
        case 64: JUMP_TO(label_L2093499056, 1);
        case 65: JUMP_TO(label_L2093499056, 1);
        case 66: JUMP_TO(label_L2093499056, 1);
        case 67: JUMP_TO(label_L2093499056, 1);
        case 68: JUMP_TO(label_L2093499056, 1);
        case 69: JUMP_TO(label_L1318310462, 1);
        case 70: JUMP_TO(label_L2093499056, 1);
        case 71: JUMP_TO(label_L2093499056, 1);
        case 72: JUMP_TO(label_L2093499056, 1);
        case 73: JUMP_TO(label_L2093499056, 1);
        case 74: JUMP_TO(label_L2093499056, 1);
        case 75: JUMP_TO(label_L2093499056, 1);
        case 76: JUMP_TO(label_L2093499056, 1);
        case 77: JUMP_TO(label_L2093499056, 1);
        case 78: JUMP_TO(label_L2093499056, 1);
        case 79: JUMP_TO(label_L2093499056, 1);
        case 80: JUMP_TO(label_L2093499056, 1);
        case 81: JUMP_TO(label_L2093499056, 1);
        case 82: JUMP_TO(label_L2093499056, 1);
        case 83: JUMP_TO(label_L2093499056, 1);
        case 84: JUMP_TO(label_L2093499056, 1);
        case 85: JUMP_TO(label_L2093499056, 1);
        case 86: JUMP_TO(label_L2093499056, 1);
        case 87: JUMP_TO(label_L2093499056, 1);
        case 88: JUMP_TO(label_L2093499056, 1);
        case 89: JUMP_TO(label_L2093499056, 1);
        case 90: JUMP_TO(label_L2093499056, 1);
        case 91: JUMP_TO(label_L1950052389, 1);
        case 92: JUMP_TO(label_L2093499056, 1);
        case 93: JUMP_TO(label_L1588446023, 1);
        case 94: JUMP_TO(label_L2093499056, 1);
        case 95: JUMP_TO(label_L2093499056, 1);
        case 96: JUMP_TO(label_L2093499056, 1);
        case 97: JUMP_TO(label_L2093499056, 1);
        case 98: JUMP_TO(label_L2093499056, 1);
        case 99: JUMP_TO(label_L2093499056, 1);
        case 100: JUMP_TO(label_L1318310462, 1);
        case 101: JUMP_TO(label_L1318310462, 1);
        case 102: JUMP_TO(label_L682713491, 1);
        case 103: JUMP_TO(label_L2093499056, 1);
        case 104: JUMP_TO(label_L2093499056, 1);
        case 105: JUMP_TO(label_L2093499056, 1);
        case 106: JUMP_TO(label_L2093499056, 1);
        case 107: JUMP_TO(label_L2093499056, 1);
        case 108: JUMP_TO(label_L1318310462, 1);
        case 109: JUMP_TO(label_L2093499056, 1);
        case 110: JUMP_TO(label_L2028160153, 1);
        case 111: JUMP_TO(label_L2093499056, 1);
        case 112: JUMP_TO(label_L2093499056, 1);
        case 113: JUMP_TO(label_L2093499056, 1);
        case 114: JUMP_TO(label_L2093499056, 1);
        case 115: JUMP_TO(label_L2093499056, 1);
        case 116: JUMP_TO(label_L1467394552, 1);
        case 117: JUMP_TO(label_L2093499056, 1);
        case 118: JUMP_TO(label_L2093499056, 1);
        case 119: JUMP_TO(label_L2093499056, 1);
        case 120: JUMP_TO(label_L1318310462, 1);
        case 121: JUMP_TO(label_L2093499056, 1);
        case 122: JUMP_TO(label_L2093499056, 1);
        case 123: JUMP_TO(label_L1735520170, 1);
        case 124: JUMP_TO(label_L2093499056, 1);
        case 125: JUMP_TO(label_L1148172078, 1);
        default: JUMP_TO(label_L2093499056, 1);
    }
...
label_L2028160153:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L650835126, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L866488267, 0);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L866488267, 0);
...
label_L1467394552:
    ...
    SP++;
    PUSH_INT(114);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1142006014, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L745868137, 1);
...
label_L682713491:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1686386255, 1);
...
label_L1686386255:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L769354865, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L703665376, 1);
...
label_L1735520170:
    ...
    if (locals[9].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L698743076, 1);
    __CN1_DEBUG_INFO(403);
    if (virtual_com_codename1_io_JSONParser_KeyStack_size___R_int(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1600888965, 1);
    __CN1_DEBUG_INFO(404);
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(7537);
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L698743076, 1);
...
label_L1148172078:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L2115824028, 1);

label_L638112861:
 tryBlockOffsetL638112861cn1_class_id_java_lang_NumberFormatException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L638112861cn1_class_id_java_lang_NumberFormatException2);
    restoreToL638112861cn1_class_id_java_lang_NumberFormatException2 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L653766932, 2);
    __CN1_DEBUG_INFO(418);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L547160119, 2);
...
label_L586212137:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L993640162, 1);
...
label_L1588446023:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L551405440, 1);

label_L195081872:
 tryBlockOffsetL195081872cn1_class_id_java_lang_NumberFormatException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L195081872cn1_class_id_java_lang_NumberFormatException3);
    restoreToL195081872cn1_class_id_java_lang_NumberFormatException3 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1753868052, 2);
    __CN1_DEBUG_INFO(452);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1304803463, 2);
    __CN1_DEBUG_INFO(453);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L998101363, 2);
...
label_L998101363:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1968369755, 1);
...
label_L1894826834:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1380194466, 1);

label_L1778269260:
 tryBlockOffsetL1778269260cn1_class_id_java_lang_NumberFormatException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1778269260cn1_class_id_java_lang_NumberFormatException4);
    restoreToL1778269260cn1_class_id_java_lang_NumberFormatException4 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L841323501, 2);
    __CN1_DEBUG_INFO(490);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1728457363, 2);
    __CN1_DEBUG_INFO(491);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L95735296, 2);
...
label_L95735296:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2001164060, 1);
...
JAVA_OBJECT com_codename1_io_JSONParser_parseJSON___java_io_Reader_R_java_util_Map(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_strict(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1063777791;
...
JAVA_OBJECT com_codename1_io_JSONParser_parse___java_io_Reader_R_java_util_Hashtable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_strict(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L478214365;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isStackHash___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L1370665958;
...
JAVA_VOID com_codename1_io_JSONParser_startBlock___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L540005572;
    ...
    goto label_L997361164;

label_L540005572:
    __CN1_DEBUG_INFO(614);
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2132487943;
    __CN1_DEBUG_INFO(615);
    PUSH_POINTER(__NEW_java_util_LinkedHashMap(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_LinkedHashMap___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    BC_ASTORE(2);
    goto label_L1733110667;
...
label_L1733110667:
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L966416978;
...
JAVA_VOID com_codename1_io_JSONParser_startArray___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L817012565;
...
label_L1051589563:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1427013366;
...
label_L1427013366:
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2090630781;
...
JAVA_VOID com_codename1_io_JSONParser_stringToken___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L156321306;
    __CN1_DEBUG_INFO(717);
    if (get_field_com_codename1_io_JSONParser_currentKey(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L789475336;
    __CN1_DEBUG_INFO(718);
    set_field_com_codename1_io_JSONParser_currentKey(threadStateData, locals[1].data.o, __cn1ThisObject);
    goto label_L813603842;

label_L789475336:
    __CN1_DEBUG_INFO(720);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1747087615;
    if (virtual_com_codename1_io_JSONParser_isIncludeNullsInstance___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1807780471;
...
JAVA_VOID com_codename1_io_JSONParser_numericToken___double(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_DOUBLE __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L932325687;
...
JAVA_VOID com_codename1_io_JSONParser_longToken___long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L144055893;
...
JAVA_VOID com_codename1_io_JSONParser_booleanToken___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1100474457;
