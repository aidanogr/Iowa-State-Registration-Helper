...
JAVA_BOOLEAN com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1430674428;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_com_codename1_io_JSONParser);
    if(POP_INT() == 0) /* IFEQ */ goto label_L90332066;
...
JAVA_VOID com_codename1_io_JSONParser_parse___java_io_Reader_com_codename1_io_JSONParseCallback(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL1763704761cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL1763704761cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L1763704761cn1_class_id_java_lang_NumberFormatException1, label_L1203500109, restoreToL1763704761cn1_class_id_java_lang_NumberFormatException1);
    int restoreToL1872487054cn1_class_id_java_lang_NumberFormatException2;
    int tryBlockOffsetL1872487054cn1_class_id_java_lang_NumberFormatException2;
    DEFINE_CATCH_BLOCK(catch_L1872487054cn1_class_id_java_lang_NumberFormatException2, label_L902427943, restoreToL1872487054cn1_class_id_java_lang_NumberFormatException2);
    int restoreToL1843343821cn1_class_id_java_lang_NumberFormatException3;
    int tryBlockOffsetL1843343821cn1_class_id_java_lang_NumberFormatException3;
    DEFINE_CATCH_BLOCK(catch_L1843343821cn1_class_id_java_lang_NumberFormatException3, label_L1387774425, restoreToL1843343821cn1_class_id_java_lang_NumberFormatException3);
    int restoreToL106819604cn1_class_id_java_lang_NumberFormatException4;
    int tryBlockOffsetL106819604cn1_class_id_java_lang_NumberFormatException4;
    DEFINE_CATCH_BLOCK(catch_L106819604cn1_class_id_java_lang_NumberFormatException4, label_L1159675750, restoreToL106819604cn1_class_id_java_lang_NumberFormatException4);
    int restoreToL778097908cn1_class_id_java_lang_Exception5;
    int tryBlockOffsetL778097908cn1_class_id_java_lang_Exception5;
    DEFINE_CATCH_BLOCK(catch_L778097908cn1_class_id_java_lang_Exception5, label_L1562292756, restoreToL778097908cn1_class_id_java_lang_Exception5);
    int restoreToL1272033405cn1_class_id_java_lang_Exception6;
    int tryBlockOffsetL1272033405cn1_class_id_java_lang_Exception6;
    DEFINE_CATCH_BLOCK(catch_L1272033405cn1_class_id_java_lang_Exception6, label_L1562292756, restoreToL1272033405cn1_class_id_java_lang_Exception6);
...
label_L778097908:
 tryBlockOffsetL778097908cn1_class_id_java_lang_Exception5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L778097908cn1_class_id_java_lang_Exception5);
    restoreToL778097908cn1_class_id_java_lang_Exception5 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(277);
    if (virtual_com_codename1_io_JSONParseCallback_isAlive___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L662967389, 1);
    ...
    if (ilocals_10_>=0) /* IFGE CustomJump */ JUMP_TO(label_L1272033405, 0);
...
label_L1272033405:
 tryBlockOffsetL1272033405cn1_class_id_java_lang_Exception6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1272033405cn1_class_id_java_lang_Exception6);
    restoreToL1272033405cn1_class_id_java_lang_Exception6 = threadStateData->threadObjectStackOffset;
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L2005488238, 1);
    __CN1_DEBUG_INFO(284);
    BC_IINC(4, 1);
    __CN1_DEBUG_INFO(285);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 
    JUMP_TO(label_L1605357721, 1);
...
label_L1605357721:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1477312973, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: JUMP_TO(label_L513413353, 1);
        case 92: JUMP_TO(label_L591211382, 1);
        default: JUMP_TO(label_L37162128, 1);
    }
...
label_L513413353:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L715093362, 1);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1682716048, 1);
...
label_L591211382:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L336141860, 1);
...
label_L1763704761:
 tryBlockOffsetL1763704761cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1763704761cn1_class_id_java_lang_NumberFormatException1);
    restoreToL1763704761cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L336141860:
    ...
    SP--;
    switch((*SP).data.i) {
        case 110: JUMP_TO(label_L1759914811, 1);
        case 114: JUMP_TO(label_L885186621, 1);
        case 116: JUMP_TO(label_L400867034, 1);
        default: JUMP_TO(label_L1082753194, 1);
    }
...
label_L1477312973:
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: JUMP_TO(label_L1107476456, 1);
        case 10: JUMP_TO(label_L1107476456, 1);
        case 11: JUMP_TO(label_L467988572, 1);
        case 12: JUMP_TO(label_L467988572, 1);
        case 13: JUMP_TO(label_L1107476456, 1);
        case 14: JUMP_TO(label_L467988572, 1);
        case 15: JUMP_TO(label_L467988572, 1);
        case 16: JUMP_TO(label_L467988572, 1);
        case 17: JUMP_TO(label_L467988572, 1);
        case 18: JUMP_TO(label_L467988572, 1);
        case 19: JUMP_TO(label_L467988572, 1);
        case 20: JUMP_TO(label_L467988572, 1);
        case 21: JUMP_TO(label_L467988572, 1);
        case 22: JUMP_TO(label_L467988572, 1);
        case 23: JUMP_TO(label_L467988572, 1);
        case 24: JUMP_TO(label_L467988572, 1);
        case 25: JUMP_TO(label_L467988572, 1);
        case 26: JUMP_TO(label_L467988572, 1);
        case 27: JUMP_TO(label_L467988572, 1);
        case 28: JUMP_TO(label_L467988572, 1);
        case 29: JUMP_TO(label_L467988572, 1);
        case 30: JUMP_TO(label_L467988572, 1);
        case 31: JUMP_TO(label_L467988572, 1);
        case 32: JUMP_TO(label_L1107476456, 1);
        case 33: JUMP_TO(label_L467988572, 1);
        case 34: JUMP_TO(label_L1633844381, 1);
        case 35: JUMP_TO(label_L467988572, 1);
        case 36: JUMP_TO(label_L467988572, 1);
        case 37: JUMP_TO(label_L467988572, 1);
        case 38: JUMP_TO(label_L467988572, 1);
        case 39: JUMP_TO(label_L467988572, 1);
        case 40: JUMP_TO(label_L467988572, 1);
        case 41: JUMP_TO(label_L467988572, 1);
        case 42: JUMP_TO(label_L467988572, 1);
        case 43: JUMP_TO(label_L467988572, 1);
        case 44: JUMP_TO(label_L1405230085, 1);
        case 45: JUMP_TO(label_L1872257073, 1);
        case 46: JUMP_TO(label_L1872257073, 1);
        case 47: JUMP_TO(label_L467988572, 1);
        case 48: JUMP_TO(label_L1872257073, 1);
        case 49: JUMP_TO(label_L1872257073, 1);
        case 50: JUMP_TO(label_L1872257073, 1);
        case 51: JUMP_TO(label_L1872257073, 1);
        case 52: JUMP_TO(label_L1872257073, 1);
        case 53: JUMP_TO(label_L1872257073, 1);
        case 54: JUMP_TO(label_L1872257073, 1);
        case 55: JUMP_TO(label_L1872257073, 1);
        case 56: JUMP_TO(label_L1872257073, 1);
        case 57: JUMP_TO(label_L1872257073, 1);
        case 58: JUMP_TO(label_L1405230085, 1);
        case 59: JUMP_TO(label_L467988572, 1);
        case 60: JUMP_TO(label_L467988572, 1);
        case 61: JUMP_TO(label_L467988572, 1);
        case 62: JUMP_TO(label_L467988572, 1);
        case 63: JUMP_TO(label_L467988572, 1);
        case 64: JUMP_TO(label_L467988572, 1);
        case 65: JUMP_TO(label_L467988572, 1);
        case 66: JUMP_TO(label_L467988572, 1);
        case 67: JUMP_TO(label_L467988572, 1);
        case 68: JUMP_TO(label_L467988572, 1);
        case 69: JUMP_TO(label_L1872257073, 1);
        case 70: JUMP_TO(label_L467988572, 1);
        case 71: JUMP_TO(label_L467988572, 1);
        case 72: JUMP_TO(label_L467988572, 1);
        case 73: JUMP_TO(label_L467988572, 1);
        case 74: JUMP_TO(label_L467988572, 1);
        case 75: JUMP_TO(label_L467988572, 1);
        case 76: JUMP_TO(label_L467988572, 1);
        case 77: JUMP_TO(label_L467988572, 1);
        case 78: JUMP_TO(label_L467988572, 1);
        case 79: JUMP_TO(label_L467988572, 1);
        case 80: JUMP_TO(label_L467988572, 1);
        case 81: JUMP_TO(label_L467988572, 1);
        case 82: JUMP_TO(label_L467988572, 1);
        case 83: JUMP_TO(label_L467988572, 1);
        case 84: JUMP_TO(label_L467988572, 1);
        case 85: JUMP_TO(label_L467988572, 1);
        case 86: JUMP_TO(label_L467988572, 1);
        case 87: JUMP_TO(label_L467988572, 1);
        case 88: JUMP_TO(label_L467988572, 1);
        case 89: JUMP_TO(label_L467988572, 1);
        case 90: JUMP_TO(label_L467988572, 1);
        case 91: JUMP_TO(label_L942829525, 1);
        case 92: JUMP_TO(label_L467988572, 1);
        case 93: JUMP_TO(label_L1246132954, 1);
        case 94: JUMP_TO(label_L467988572, 1);
        case 95: JUMP_TO(label_L467988572, 1);
        case 96: JUMP_TO(label_L467988572, 1);
        case 97: JUMP_TO(label_L467988572, 1);
        case 98: JUMP_TO(label_L467988572, 1);
        case 99: JUMP_TO(label_L467988572, 1);
        case 100: JUMP_TO(label_L1872257073, 1);
        case 101: JUMP_TO(label_L1872257073, 1);
        case 102: JUMP_TO(label_L153580963, 1);
        case 103: JUMP_TO(label_L467988572, 1);
        case 104: JUMP_TO(label_L467988572, 1);
        case 105: JUMP_TO(label_L467988572, 1);
        case 106: JUMP_TO(label_L467988572, 1);
        case 107: JUMP_TO(label_L467988572, 1);
        case 108: JUMP_TO(label_L1872257073, 1);
        case 109: JUMP_TO(label_L467988572, 1);
        case 110: JUMP_TO(label_L621942110, 1);
        case 111: JUMP_TO(label_L467988572, 1);
        case 112: JUMP_TO(label_L467988572, 1);
        case 113: JUMP_TO(label_L467988572, 1);
        case 114: JUMP_TO(label_L467988572, 1);
        case 115: JUMP_TO(label_L467988572, 1);
        case 116: JUMP_TO(label_L250977006, 1);
        case 117: JUMP_TO(label_L467988572, 1);
        case 118: JUMP_TO(label_L467988572, 1);
        case 119: JUMP_TO(label_L467988572, 1);
        case 120: JUMP_TO(label_L1872257073, 1);
        case 121: JUMP_TO(label_L467988572, 1);
        case 122: JUMP_TO(label_L467988572, 1);
        case 123: JUMP_TO(label_L2006757696, 1);
        case 124: JUMP_TO(label_L467988572, 1);
        case 125: JUMP_TO(label_L1168398461, 1);
        default: JUMP_TO(label_L467988572, 1);
    }
...
label_L621942110:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1890131314, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L778097908, 0);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L778097908, 0);
...
label_L250977006:
    ...
    SP++;
    PUSH_INT(114);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1386863459, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1076721351, 1);
...
label_L153580963:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L534213125, 1);
...
label_L534213125:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L62505055, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L680072609, 1);
...
label_L2006757696:
    ...
    if (locals[9].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1178969461, 1);
    __CN1_DEBUG_INFO(403);
    if (virtual_com_codename1_io_JSONParser_KeyStack_size___R_int(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L187903706, 1);
    __CN1_DEBUG_INFO(404);
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(7537);
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1178969461, 1);
...
label_L1168398461:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1811351040, 1);

label_L1872487054:
 tryBlockOffsetL1872487054cn1_class_id_java_lang_NumberFormatException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1872487054cn1_class_id_java_lang_NumberFormatException2);
    restoreToL1872487054cn1_class_id_java_lang_NumberFormatException2 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1017502292, 2);
    __CN1_DEBUG_INFO(418);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1470148280, 2);
...
label_L1173819240:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L384030416, 1);
...
label_L1246132954:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L67557666, 1);

label_L1843343821:
 tryBlockOffsetL1843343821cn1_class_id_java_lang_NumberFormatException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1843343821cn1_class_id_java_lang_NumberFormatException3);
    restoreToL1843343821cn1_class_id_java_lang_NumberFormatException3 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1442935412, 2);
    __CN1_DEBUG_INFO(452);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L737196947, 2);
    __CN1_DEBUG_INFO(453);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L598588779, 2);
...
label_L598588779:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L298893301, 1);
...
label_L1405230085:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1277160809, 1);

label_L106819604:
 tryBlockOffsetL106819604cn1_class_id_java_lang_NumberFormatException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L106819604cn1_class_id_java_lang_NumberFormatException4);
    restoreToL106819604cn1_class_id_java_lang_NumberFormatException4 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1654520666, 2);
    __CN1_DEBUG_INFO(490);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L747984007, 2);
    __CN1_DEBUG_INFO(491);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L950954487, 2);
...
label_L950954487:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L199868206, 1);
...
JAVA_OBJECT com_codename1_io_JSONParser_parseJSON___java_io_Reader_R_java_util_Map(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_strict(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L9740045;
...
JAVA_OBJECT com_codename1_io_JSONParser_parse___java_io_Reader_R_java_util_Hashtable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_strict(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1262399289;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isStackHash___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L224950719;
...
JAVA_VOID com_codename1_io_JSONParser_startBlock___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L831160736;
    ...
    goto label_L259237839;

label_L831160736:
    __CN1_DEBUG_INFO(614);
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1100517919;
    __CN1_DEBUG_INFO(615);
    PUSH_POINTER(__NEW_java_util_LinkedHashMap(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_LinkedHashMap___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    BC_ASTORE(2);
    goto label_L1142429510;
...
label_L1142429510:
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L570038756;
...
JAVA_VOID com_codename1_io_JSONParser_startArray___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L917040074;
...
label_L848193662:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1128952562;
...
label_L1128952562:
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1552840327;
...
JAVA_VOID com_codename1_io_JSONParser_stringToken___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1812291616;
    __CN1_DEBUG_INFO(717);
    if (get_field_com_codename1_io_JSONParser_currentKey(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2093499056;
...
label_L2093499056:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L926134772;
    if (virtual_com_codename1_io_JSONParser_isIncludeNullsInstance___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1894826834;
...
JAVA_VOID com_codename1_io_JSONParser_numericToken___double(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_DOUBLE __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1318310462;
...
JAVA_VOID com_codename1_io_JSONParser_longToken___long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1588446023;
...
JAVA_VOID com_codename1_io_JSONParser_booleanToken___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2028160153;
