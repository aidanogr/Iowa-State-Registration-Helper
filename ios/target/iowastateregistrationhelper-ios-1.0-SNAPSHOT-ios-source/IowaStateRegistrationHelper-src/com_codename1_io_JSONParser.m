...
JAVA_VOID com_codename1_io_JSONParser_parse___java_io_Reader_com_codename1_io_JSONParseCallback(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL769237467cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL769237467cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L769237467cn1_class_id_java_lang_NumberFormatException1, label_L9740045, restoreToL769237467cn1_class_id_java_lang_NumberFormatException1);
    int restoreToL434334138cn1_class_id_java_lang_NumberFormatException2;
    int tryBlockOffsetL434334138cn1_class_id_java_lang_NumberFormatException2;
    DEFINE_CATCH_BLOCK(catch_L434334138cn1_class_id_java_lang_NumberFormatException2, label_L1262399289, restoreToL434334138cn1_class_id_java_lang_NumberFormatException2);
    int restoreToL1684494770cn1_class_id_java_lang_NumberFormatException3;
    int tryBlockOffsetL1684494770cn1_class_id_java_lang_NumberFormatException3;
    DEFINE_CATCH_BLOCK(catch_L1684494770cn1_class_id_java_lang_NumberFormatException3, label_L224950719, restoreToL1684494770cn1_class_id_java_lang_NumberFormatException3);
    int restoreToL148894580cn1_class_id_java_lang_NumberFormatException4;
    int tryBlockOffsetL148894580cn1_class_id_java_lang_NumberFormatException4;
    DEFINE_CATCH_BLOCK(catch_L148894580cn1_class_id_java_lang_NumberFormatException4, label_L356649202, restoreToL148894580cn1_class_id_java_lang_NumberFormatException4);
    int restoreToL1812291616cn1_class_id_java_lang_Exception5;
    int tryBlockOffsetL1812291616cn1_class_id_java_lang_Exception5;
    DEFINE_CATCH_BLOCK(catch_L1812291616cn1_class_id_java_lang_Exception5, label_L831160736, restoreToL1812291616cn1_class_id_java_lang_Exception5);
    int restoreToL1100517919cn1_class_id_java_lang_Exception6;
    int tryBlockOffsetL1100517919cn1_class_id_java_lang_Exception6;
    DEFINE_CATCH_BLOCK(catch_L1100517919cn1_class_id_java_lang_Exception6, label_L831160736, restoreToL1100517919cn1_class_id_java_lang_Exception6);
...
label_L1812291616:
 tryBlockOffsetL1812291616cn1_class_id_java_lang_Exception5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1812291616cn1_class_id_java_lang_Exception5);
    restoreToL1812291616cn1_class_id_java_lang_Exception5 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(277);
    if (virtual_com_codename1_io_JSONParseCallback_isAlive___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L259237839, 1);
    ...
    if (ilocals_10_>=0) /* IFGE CustomJump */ JUMP_TO(label_L1100517919, 0);
...
label_L1100517919:
 tryBlockOffsetL1100517919cn1_class_id_java_lang_Exception6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1100517919cn1_class_id_java_lang_Exception6);
    restoreToL1100517919cn1_class_id_java_lang_Exception6 = threadStateData->threadObjectStackOffset;
...
label_L570038756:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L866488267, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: JUMP_TO(label_L917040074, 1);
        case 92: JUMP_TO(label_L848193662, 1);
...
label_L917040074:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1552840327, 1);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L755576935, 1);
...
label_L848193662:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L2093499056, 1);
...
label_L769237467:
 tryBlockOffsetL769237467cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L769237467cn1_class_id_java_lang_NumberFormatException1);
    restoreToL769237467cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L2093499056:
    ...
    SP--;
    switch((*SP).data.i) {
        case 110: JUMP_TO(label_L1894826834, 1);
        case 114: JUMP_TO(label_L1318310462, 1);
        case 116: JUMP_TO(label_L1950052389, 1);
        default: JUMP_TO(label_L926134772, 1);
    }
...
label_L866488267:
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: JUMP_TO(label_L682713491, 1);
        case 10: JUMP_TO(label_L682713491, 1);
        case 11: JUMP_TO(label_L1588446023, 1);
        case 12: JUMP_TO(label_L1588446023, 1);
        case 13: JUMP_TO(label_L682713491, 1);
        case 14: JUMP_TO(label_L1588446023, 1);
        case 15: JUMP_TO(label_L1588446023, 1);
        case 16: JUMP_TO(label_L1588446023, 1);
        case 17: JUMP_TO(label_L1588446023, 1);
        case 18: JUMP_TO(label_L1588446023, 1);
        case 19: JUMP_TO(label_L1588446023, 1);
        case 20: JUMP_TO(label_L1588446023, 1);
        case 21: JUMP_TO(label_L1588446023, 1);
        case 22: JUMP_TO(label_L1588446023, 1);
        case 23: JUMP_TO(label_L1588446023, 1);
        case 24: JUMP_TO(label_L1588446023, 1);
        case 25: JUMP_TO(label_L1588446023, 1);
        case 26: JUMP_TO(label_L1588446023, 1);
        case 27: JUMP_TO(label_L1588446023, 1);
        case 28: JUMP_TO(label_L1588446023, 1);
        case 29: JUMP_TO(label_L1588446023, 1);
        case 30: JUMP_TO(label_L1588446023, 1);
        case 31: JUMP_TO(label_L1588446023, 1);
        case 32: JUMP_TO(label_L682713491, 1);
        case 33: JUMP_TO(label_L1588446023, 1);
        case 34: JUMP_TO(label_L2028160153, 1);
        case 35: JUMP_TO(label_L1588446023, 1);
        case 36: JUMP_TO(label_L1588446023, 1);
        case 37: JUMP_TO(label_L1588446023, 1);
        case 38: JUMP_TO(label_L1588446023, 1);
        case 39: JUMP_TO(label_L1588446023, 1);
        case 40: JUMP_TO(label_L1588446023, 1);
        case 41: JUMP_TO(label_L1588446023, 1);
        case 42: JUMP_TO(label_L1588446023, 1);
        case 43: JUMP_TO(label_L1588446023, 1);
        case 44: JUMP_TO(label_L1467394552, 1);
        case 45: JUMP_TO(label_L1735520170, 1);
        case 46: JUMP_TO(label_L1735520170, 1);
        case 47: JUMP_TO(label_L1588446023, 1);
        case 48: JUMP_TO(label_L1735520170, 1);
        case 49: JUMP_TO(label_L1735520170, 1);
        case 50: JUMP_TO(label_L1735520170, 1);
        case 51: JUMP_TO(label_L1735520170, 1);
        case 52: JUMP_TO(label_L1735520170, 1);
        case 53: JUMP_TO(label_L1735520170, 1);
        case 54: JUMP_TO(label_L1735520170, 1);
        case 55: JUMP_TO(label_L1735520170, 1);
        case 56: JUMP_TO(label_L1735520170, 1);
        case 57: JUMP_TO(label_L1735520170, 1);
        case 58: JUMP_TO(label_L1467394552, 1);
        case 59: JUMP_TO(label_L1588446023, 1);
        case 60: JUMP_TO(label_L1588446023, 1);
        case 61: JUMP_TO(label_L1588446023, 1);
        case 62: JUMP_TO(label_L1588446023, 1);
        case 63: JUMP_TO(label_L1588446023, 1);
        case 64: JUMP_TO(label_L1588446023, 1);
        case 65: JUMP_TO(label_L1588446023, 1);
        case 66: JUMP_TO(label_L1588446023, 1);
        case 67: JUMP_TO(label_L1588446023, 1);
        case 68: JUMP_TO(label_L1588446023, 1);
        case 69: JUMP_TO(label_L1735520170, 1);
        case 70: JUMP_TO(label_L1588446023, 1);
        case 71: JUMP_TO(label_L1588446023, 1);
        case 72: JUMP_TO(label_L1588446023, 1);
        case 73: JUMP_TO(label_L1588446023, 1);
        case 74: JUMP_TO(label_L1588446023, 1);
        case 75: JUMP_TO(label_L1588446023, 1);
        case 76: JUMP_TO(label_L1588446023, 1);
        case 77: JUMP_TO(label_L1588446023, 1);
        case 78: JUMP_TO(label_L1588446023, 1);
        case 79: JUMP_TO(label_L1588446023, 1);
        case 80: JUMP_TO(label_L1588446023, 1);
        case 81: JUMP_TO(label_L1588446023, 1);
        case 82: JUMP_TO(label_L1588446023, 1);
        case 83: JUMP_TO(label_L1588446023, 1);
        case 84: JUMP_TO(label_L1588446023, 1);
        case 85: JUMP_TO(label_L1588446023, 1);
        case 86: JUMP_TO(label_L1588446023, 1);
        case 87: JUMP_TO(label_L1588446023, 1);
        case 88: JUMP_TO(label_L1588446023, 1);
        case 89: JUMP_TO(label_L1588446023, 1);
        case 90: JUMP_TO(label_L1588446023, 1);
        case 91: JUMP_TO(label_L1148172078, 1);
        case 92: JUMP_TO(label_L1588446023, 1);
        case 93: JUMP_TO(label_L650835126, 1);
        case 94: JUMP_TO(label_L1588446023, 1);
        case 95: JUMP_TO(label_L1588446023, 1);
        case 96: JUMP_TO(label_L1588446023, 1);
        case 97: JUMP_TO(label_L1588446023, 1);
        case 98: JUMP_TO(label_L1588446023, 1);
        case 99: JUMP_TO(label_L1588446023, 1);
        case 100: JUMP_TO(label_L1735520170, 1);
        case 101: JUMP_TO(label_L1735520170, 1);
        case 102: JUMP_TO(label_L1142006014, 1);
        case 103: JUMP_TO(label_L1588446023, 1);
        case 104: JUMP_TO(label_L1588446023, 1);
        case 105: JUMP_TO(label_L1588446023, 1);
        case 106: JUMP_TO(label_L1588446023, 1);
        case 107: JUMP_TO(label_L1588446023, 1);
        case 108: JUMP_TO(label_L1735520170, 1);
        case 109: JUMP_TO(label_L1588446023, 1);
        case 110: JUMP_TO(label_L745868137, 1);
        case 111: JUMP_TO(label_L1588446023, 1);
        case 112: JUMP_TO(label_L1588446023, 1);
        case 113: JUMP_TO(label_L1588446023, 1);
        case 114: JUMP_TO(label_L1588446023, 1);
        case 115: JUMP_TO(label_L1588446023, 1);
        case 116: JUMP_TO(label_L362417934, 1);
        case 117: JUMP_TO(label_L1588446023, 1);
        case 118: JUMP_TO(label_L1588446023, 1);
        case 119: JUMP_TO(label_L1588446023, 1);
        case 120: JUMP_TO(label_L1735520170, 1);
        case 121: JUMP_TO(label_L1588446023, 1);
        case 122: JUMP_TO(label_L1588446023, 1);
        case 123: JUMP_TO(label_L1686386255, 1);
        case 124: JUMP_TO(label_L1588446023, 1);
        case 125: JUMP_TO(label_L769354865, 1);
        default: JUMP_TO(label_L1588446023, 1);
    }
...
label_L745868137:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L703665376, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1812291616, 0);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1812291616, 0);
...
label_L362417934:
    ...
    SP++;
    PUSH_INT(114);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1817615535, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L698743076, 1);
...
label_L2115824028:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L653766932, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L547160119, 1);
...
label_L1686386255:
    ...
    if (locals[9].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L993640162, 1);
    __CN1_DEBUG_INFO(403);
    if (virtual_com_codename1_io_JSONParser_KeyStack_size___R_int(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L551405440, 1);
    __CN1_DEBUG_INFO(404);
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(7537);
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L993640162, 1);
...
label_L769354865:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1753868052, 1);

label_L434334138:
 tryBlockOffsetL434334138cn1_class_id_java_lang_NumberFormatException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L434334138cn1_class_id_java_lang_NumberFormatException2);
    restoreToL434334138cn1_class_id_java_lang_NumberFormatException2 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1304803463, 2);
    __CN1_DEBUG_INFO(418);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L998101363, 2);
...
label_L1968369755:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1380194466, 1);
...
label_L650835126:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L841323501, 1);

label_L1684494770:
 tryBlockOffsetL1684494770cn1_class_id_java_lang_NumberFormatException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1684494770cn1_class_id_java_lang_NumberFormatException3);
    restoreToL1684494770cn1_class_id_java_lang_NumberFormatException3 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1728457363, 2);
    __CN1_DEBUG_INFO(452);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L95735296, 2);
    __CN1_DEBUG_INFO(453);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L2001164060, 2);
...
label_L2001164060:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1776486626, 1);
...
label_L1467394552:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1063777791, 1);

label_L148894580:
 tryBlockOffsetL148894580cn1_class_id_java_lang_NumberFormatException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L148894580cn1_class_id_java_lang_NumberFormatException4);
    restoreToL148894580cn1_class_id_java_lang_NumberFormatException4 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L478214365, 2);
    __CN1_DEBUG_INFO(490);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1370665958, 2);
    __CN1_DEBUG_INFO(491);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L552015146, 2);
...
label_L552015146:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L540005572, 1);
...
JAVA_OBJECT com_codename1_io_JSONParser_parseJSON___java_io_Reader_R_java_util_Map(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_strict(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2132487943;
...
JAVA_OBJECT com_codename1_io_JSONParser_parse___java_io_Reader_R_java_util_Hashtable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_strict(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1733110667;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isStackHash___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L966416978;
...
JAVA_VOID com_codename1_io_JSONParser_startBlock___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L817012565;
...
label_L817012565:
    ...
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1427013366;
...
label_L2090630781:
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1483742860;
...
JAVA_VOID com_codename1_io_JSONParser_startArray___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L789475336;
...
label_L813603842:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1747087615;
...
label_L1747087615:
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1807780471;
...
JAVA_VOID com_codename1_io_JSONParser_stringToken___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1934114123;
    __CN1_DEBUG_INFO(717);
    if (get_field_com_codename1_io_JSONParser_currentKey(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L144055893;
...
label_L144055893:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1100474457;
    if (virtual_com_codename1_io_JSONParser_isIncludeNullsInstance___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1929848645;
...
JAVA_VOID com_codename1_io_JSONParser_numericToken___double(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_DOUBLE __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1272708038;
...
JAVA_VOID com_codename1_io_JSONParser_longToken___long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L123251782;
...
JAVA_VOID com_codename1_io_JSONParser_booleanToken___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1497258319;
