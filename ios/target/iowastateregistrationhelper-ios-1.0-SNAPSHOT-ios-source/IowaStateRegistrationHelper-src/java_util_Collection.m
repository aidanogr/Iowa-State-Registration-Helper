...
void __STATIC_INITIALIZER_java_util_Collection(CODENAME_ONE_THREAD_STATE) {
    ...
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList] = malloc(sizeof(int*) * 40);
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][0] = 0;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][1] = 2;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][2] = 10;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][3] = 11;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][4] = 12;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][5] = 13;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][6] = 14;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][7] = 15;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][8] = 16;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][9] = 17;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][10] = 18;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][11] = 19;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][12] = 20;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][13] = 21;
    classToInterfaceMap_java_util_Collection[cn1_class_id_com_ogradytech_registration_Utilities_BikeLock_BikeLockList][14] = 22;
