...
JAVA_VOID com_ogradytech_registration_Utilities_FunctionQueue___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 10591, 201);
...
JAVA_VOID com_ogradytech_registration_Utilities_FunctionQueue_add___java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10591, 1229);
...
JAVA_VOID com_ogradytech_registration_Utilities_FunctionQueue_begin__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 10591, 10592);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL616998001cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL616998001cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L616998001cn1_class_id_java_lang_InterruptedException1, label_L1648700617, restoreToL616998001cn1_class_id_java_lang_InterruptedException1);
...
label_L616998001:
 tryBlockOffsetL616998001cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L616998001cn1_class_id_java_lang_InterruptedException1);
    restoreToL616998001cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_ogradytech_registration_Utilities_FunctionQueue_getNumberOfPendingTasks___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10591, 10593);
