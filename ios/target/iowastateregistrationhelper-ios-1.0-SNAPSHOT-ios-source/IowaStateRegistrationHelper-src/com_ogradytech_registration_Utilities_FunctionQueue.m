...
JAVA_VOID com_ogradytech_registration_Utilities_FunctionQueue___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 10503, 200);
...
JAVA_VOID com_ogradytech_registration_Utilities_FunctionQueue_add___java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10503, 1228);
...
JAVA_VOID com_ogradytech_registration_Utilities_FunctionQueue_begin__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 10503, 10504);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1520489781cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1520489781cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1520489781cn1_class_id_java_lang_InterruptedException1, label_L1563053805, restoreToL1520489781cn1_class_id_java_lang_InterruptedException1);
    __CN1_DEBUG_INFO(16);
    JUMP_TO(label_L1464177809, 0);
...
label_L1520489781:
 tryBlockOffsetL1520489781cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1520489781cn1_class_id_java_lang_InterruptedException1);
    restoreToL1520489781cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(20);
    /* CustomInvoke */java_lang_Thread_sleep___long(threadStateData, 150LL); 

label_L2092117157:
END_TRY(1);    __CN1_DEBUG_INFO(21);
    JUMP_TO(label_L1464177809, 0);
...
label_L1464177809:
    __CN1_DEBUG_INFO(16);
    if (virtual_java_util_Queue_isEmpty___R_boolean(threadStateData, get_field_com_ogradytech_registration_Utilities_FunctionQueue_queue(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1057507014, 0);
    __CN1_DEBUG_INFO(25);
...
JAVA_INT com_ogradytech_registration_Utilities_FunctionQueue_getNumberOfPendingTasks___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10503, 10505);
