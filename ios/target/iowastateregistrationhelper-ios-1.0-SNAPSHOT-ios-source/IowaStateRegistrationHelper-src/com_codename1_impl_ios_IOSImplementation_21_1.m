...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_21_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL79598269401;
    int tryBlockOffsetL79598269401;
    DEFINE_CATCH_BLOCK(catch_L79598269401, label_L452457802, restoreToL79598269401);
    int restoreToL45245780202;
    int tryBlockOffsetL45245780202;
    DEFINE_CATCH_BLOCK(catch_L45245780202, label_L452457802, restoreToL45245780202);
...
label_L795982694:
 tryBlockOffsetL79598269401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L79598269401);
    restoreToL79598269401 = threadStateData->threadObjectStackOffset;
...
label_L1301179818:
END_TRY(1);    JUMP_TO(label_L1857910993, 0);

label_L452457802:
 tryBlockOffsetL45245780202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L45245780202);
    restoreToL45245780202 = threadStateData->threadObjectStackOffset;
