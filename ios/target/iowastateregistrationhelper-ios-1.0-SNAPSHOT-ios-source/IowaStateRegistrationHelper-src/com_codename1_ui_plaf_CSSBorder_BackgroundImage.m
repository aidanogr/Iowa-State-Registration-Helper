...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BackgroundImage_toCSSString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_linearGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L476709123;
...
label_L476709123:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_radialGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2017574192;
...
label_L2017574192:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1170735890;
    if (virtual_com_codename1_ui_Image_getImageName___R_java_lang_String(threadStateData, get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1170735890;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BackgroundImage_getBackgroundPositionCSSString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L2077462509;
        case 1: goto label_L931003277;
        case 2: goto label_L1117812847;
        default: goto label_L1198859194;
    }
...
label_L1198859194:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_verticalPosition(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L540962910;
...
label_L67928167:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_horizontalPosition(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1186663391;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BackgroundImage_getTargetRect___com_codename1_ui_Component_com_codename1_ui_geom_Rectangle2D_com_codename1_ui_geom_Rectangle2D_R_com_codename1_ui_geom_Rectangle2D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1444912530;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L478468106;
        case 2: goto label_L2095803461;
        case 99: goto label_L1653634548;
...
label_L478468106:
    ...
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ goto label_L1916224178;
...
label_L1916224178:
    ...
    PUSH_DOUBLE(tmpResult); }
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ goto label_L1212782393;
...
label_L2095803461:
    ...
    SP[-1].data.d = SP[-1].data.i; /* I2D */;
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ goto label_L1212782393;
...
label_L1212782393:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1436127733;
        case 2: goto label_L885481831;
        case 99: goto label_L817092761;
        default: goto label_L2027499247;
    }
...
label_L2027499247:
    ...
    switch((*SP).data.i) {
        ...
        case 99: goto label_L1078783335;
...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BackgroundImage_paint___com_codename1_ui_Graphics_com_codename1_ui_Component_com_codename1_ui_geom_Rectangle2D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L539322891;
    __CN1_DEBUG_INFO(1418);
    PUSH_INT(get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_repeat(__cn1ThisObject));
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1649096004;
        case 1: goto label_L1162595263;
        case 2: goto label_L748673892;
        case 3: goto label_L669096398;
        default: goto label_L473655651;
    }
...
label_L1436610577:
    ...
    if (CN1_CMP_EXPR(dlocals_6_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L120999784;
...
label_L957559364:
    ...
    if (CN1_CMP_EXPR(dlocals_6_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L2124688514;
...
label_L1578712821:
    ...
    if (CN1_CMP_EXPR(dlocals_6_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L216758017;
...
label_L556223230:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L17222024;
...
label_L539322891:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_linearGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1641677843;
...
locals[15].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1483);
    ...
    BC_DCMPL();
    if(POP_INT() == 0) /* IFEQ */ goto label_L1445448489;
...
label_L2043313130:
    if (ilocals_18_>=ilocals_17_) /* IF_ICMPGE CustomJump */ goto label_L1296833449;
...
label_L1296833449:
    ...
    if (locals[15].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1641677843;
...
label_L1641677843:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_radialGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1990419108;
