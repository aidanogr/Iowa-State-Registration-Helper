...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BackgroundImage_toCSSString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_linearGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1795568752;
...
label_L1795568752:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_radialGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L577592048;
...
label_L577592048:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1383675856;
    if (virtual_com_codename1_ui_Image_getImageName___R_java_lang_String(threadStateData, get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1383675856;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BackgroundImage_getBackgroundPositionCSSString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L919962315;
        case 1: goto label_L1814730197;
        case 2: goto label_L618199162;
        default: goto label_L1057262726;
    }
...
label_L1057262726:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_verticalPosition(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L626889335;
...
label_L753214674:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_horizontalPosition(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L946448101;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BackgroundImage_getTargetRect___com_codename1_ui_Component_com_codename1_ui_geom_Rectangle2D_com_codename1_ui_geom_Rectangle2D_R_com_codename1_ui_geom_Rectangle2D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L238590461;
    ...
    switch((*SP).data.i) {
        ...
        case 99: goto label_L220588152;
        default: goto label_L1192787792;
    }
...
label_L2101891021:
    ...
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ goto label_L2014406233;
...
label_L2014406233:
    ...
    PUSH_DOUBLE(tmpResult); }
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ goto label_L1192787792;
...
label_L2022586114:
    ...
    SP[-1].data.d = SP[-1].data.i; /* I2D */;
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ goto label_L1192787792;
...
label_L1192787792:
    ...
    switch((*SP).data.i) {
        ...
        case 99: goto label_L1468809177;
        default: goto label_L610056415;
    }
...
label_L610056415:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L649316770;
        case 2: goto label_L605787935;
        case 99: goto label_L308221618;
        default: goto label_L1401212518;
    }
...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BackgroundImage_paint___com_codename1_ui_Graphics_com_codename1_ui_Component_com_codename1_ui_geom_Rectangle2D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1799545709;
    __CN1_DEBUG_INFO(1418);
    PUSH_INT(get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_repeat(__cn1ThisObject));
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L320414325;
        case 1: goto label_L2031705122;
        case 2: goto label_L211507865;
        case 3: goto label_L1891535340;
...
label_L1329362952:
    ...
    if (CN1_CMP_EXPR(dlocals_6_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L430290487;
...
label_L298156448:
    ...
    if (CN1_CMP_EXPR(dlocals_6_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1263102442;
...
label_L154487101:
    ...
    if (CN1_CMP_EXPR(dlocals_6_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L627411361;
...
label_L885403615:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L162752456;
...
label_L1799545709:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_linearGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L515398215;
...
locals[15].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1483);
    ...
    BC_DCMPL();
    if(POP_INT() == 0) /* IFEQ */ goto label_L212329343;
...
label_L1741092056:
    if (ilocals_18_>=ilocals_17_) /* IF_ICMPGE CustomJump */ goto label_L161123811;
...
locals[19].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1496);
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L142561311;
...
label_L161123811:
    ...
    if (locals[15].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L515398215;
...
label_L515398215:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_radialGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1038585959;
