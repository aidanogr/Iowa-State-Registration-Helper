...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BackgroundImage_toCSSString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_linearGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1044639817;
...
label_L1044639817:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_radialGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L343722304;
...
label_L343722304:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1968861720;
    if (virtual_com_codename1_ui_Image_getImageName___R_java_lang_String(threadStateData, get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1968861720;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BackgroundImage_getBackgroundPositionCSSString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1891799894;
        case 1: goto label_L1361241279;
        case 2: goto label_L602280210;
        default: goto label_L92962244;
    }
...
label_L92962244:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_verticalPosition(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1639319040;
...
label_L1639319040:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L670503317;
        case 1: goto label_L873134840;
        case 2: goto label_L1647891936;
...
label_L862931361:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_horizontalPosition(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L747343328;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BackgroundImage_getTargetRect___com_codename1_ui_Component_com_codename1_ui_geom_Rectangle2D_com_codename1_ui_geom_Rectangle2D_R_com_codename1_ui_geom_Rectangle2D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_image(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1337294771;
    ...
    switch((*SP).data.i) {
        ...
        case 99: goto label_L1383675856;
...
label_L1795568752:
    ...
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ goto label_L1814730197;
...
label_L1814730197:
    ...
    PUSH_DOUBLE(tmpResult); }
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ goto label_L919962315;
...
label_L577592048:
    ...
    SP[-1].data.d = SP[-1].data.i; /* I2D */;
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ goto label_L919962315;
...
label_L919962315:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L618199162;
        case 2: goto label_L1057262726;
        case 99: goto label_L626889335;
        default: goto label_L501301044;
    }
...
label_L501301044:
    ...
    switch((*SP).data.i) {
        ...
        case 99: goto label_L753214674;
        default: goto label_L946448101;
    }
...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BackgroundImage_paint___com_codename1_ui_Graphics_com_codename1_ui_Component_com_codename1_ui_geom_Rectangle2D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L2101891021;
        case 1: goto label_L2022586114;
        case 2: goto label_L220588152;
        case 3: goto label_L1192787792;
        default: goto label_L2014406233;
    }
...
label_L1407858699:
    ...
    if (CN1_CMP_EXPR(dlocals_6_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1898870910;
...
label_L610056415:
    ...
    if (CN1_CMP_EXPR(dlocals_6_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1468809177;
...
label_L605787935:
    ...
    if (CN1_CMP_EXPR(dlocals_6_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L649316770;
...
label_L1401212518:
    ...
    if (CN1_CMP_EXPR(dlocals_8_, 0 /* DCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L308221618;
...
label_L238590461:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_linearGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L320414325;
...
label_L430290487:
    if (ilocals_18_>=ilocals_17_) /* IF_ICMPGE CustomJump */ goto label_L211507865;
...
locals[19].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1496);
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1891535340;
...
label_L211507865:
    ...
    if (locals[15].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L320414325;
...
label_L320414325:
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BackgroundImage_radialGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1799545709;
