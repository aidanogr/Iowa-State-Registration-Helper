...
JAVA_VOID com_codename1_ui_Component_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL71860931601;
    int tryBlockOffsetL71860931601;
    DEFINE_CATCH_BLOCK(catch_L71860931601, label_L1594981181, restoreToL71860931601);
    int restoreToL159498118102;
    int tryBlockOffsetL159498118102;
    DEFINE_CATCH_BLOCK(catch_L159498118102, label_L1594981181, restoreToL159498118102);
    int restoreToL135372624903;
    int tryBlockOffsetL135372624903;
    DEFINE_CATCH_BLOCK(catch_L135372624903, label_L292856581, restoreToL135372624903);
    int restoreToL29285658104;
    int tryBlockOffsetL29285658104;
    DEFINE_CATCH_BLOCK(catch_L29285658104, label_L292856581, restoreToL29285658104);
...
label_L1353726249:
 tryBlockOffsetL135372624903 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L135372624903);
    restoreToL135372624903 = threadStateData->threadObjectStackOffset;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2528);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L1907808127, 1);
        case 2: JUMP_TO(label_L409393797, 1);
        case 3: JUMP_TO(label_L1291485735, 1);
        case 4: JUMP_TO(label_L2015521846, 1);
        case 5: JUMP_TO(label_L1063801186, 1);
        case 6: JUMP_TO(label_L301205240, 1);
        case 7: JUMP_TO(label_L1063801186, 1);
        case 8: JUMP_TO(label_L159860059, 1);
        case 9: JUMP_TO(label_L1647303553, 1);
        case 10: JUMP_TO(label_L1063801186, 1);
        case 11: JUMP_TO(label_L1063801186, 1);
        case 12: JUMP_TO(label_L523331047, 1);
        case 13: JUMP_TO(label_L1063801186, 1);
        case 14: JUMP_TO(label_L1063801186, 1);
        case 15: JUMP_TO(label_L1063801186, 1);
        case 16: JUMP_TO(label_L784556863, 1);
        case 17: JUMP_TO(label_L1063801186, 1);
        case 18: JUMP_TO(label_L1063801186, 1);
        case 19: JUMP_TO(label_L1063801186, 1);
        case 20: JUMP_TO(label_L1063801186, 1);
        case 21: JUMP_TO(label_L1063801186, 1);
        case 22: JUMP_TO(label_L1063801186, 1);
        case 23: JUMP_TO(label_L1063801186, 1);
        case 24: JUMP_TO(label_L492656161, 1);
        default: JUMP_TO(label_L1063801186, 1);
    }
...
label_L718609316:
 tryBlockOffsetL71860931601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L71860931601);
    restoreToL71860931601 = threadStateData->threadObjectStackOffset;
...
label_L278885249:
END_TRY(1);    JUMP_TO(label_L20084184, 1);

label_L1594981181:
 tryBlockOffsetL159498118102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L159498118102);
    restoreToL159498118102 = threadStateData->threadObjectStackOffset;
...
END_TRY(1);    __CN1_DEBUG_INFO(2622);
    ...
    JUMP_TO(label_L364389956, 0);

label_L292856581:
 tryBlockOffsetL29285658104 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L29285658104);
    restoreToL29285658104 = threadStateData->threadObjectStackOffset;
