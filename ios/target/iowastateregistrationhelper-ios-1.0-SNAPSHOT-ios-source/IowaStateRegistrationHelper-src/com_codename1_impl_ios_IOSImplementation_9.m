...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_9_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1120466008cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1120466008cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1120466008cn1_class_id_java_lang_InterruptedException1, label_L834562889, restoreToL1120466008cn1_class_id_java_lang_InterruptedException1);
    int restoreToL739555002;
    int tryBlockOffsetL739555002;
    DEFINE_CATCH_BLOCK(catch_L739555002, label_L773238925, restoreToL739555002);
    int restoreToL77323892503;
    int tryBlockOffsetL77323892503;
    DEFINE_CATCH_BLOCK(catch_L77323892503, label_L773238925, restoreToL77323892503);
...
label_L7395550:
 tryBlockOffsetL739555002 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L739555002);
    restoreToL739555002 = threadStateData->threadObjectStackOffset;
    ...
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ JUMP_TO(label_L1536728519, 1);

label_L1120466008:
 tryBlockOffsetL1120466008cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1120466008cn1_class_id_java_lang_InterruptedException1);
    restoreToL1120466008cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L337207992:
END_TRY(1);    JUMP_TO(label_L1112940474, 0);

label_L773238925:
 tryBlockOffsetL77323892503 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L77323892503);
    restoreToL77323892503 = threadStateData->threadObjectStackOffset;
