...
JAVA_OBJECT com_codename1_ui_spinner_Spinner_createDate___long_long_long_char_int_R_com_codename1_ui_spinner_Spinner(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1, JAVA_LONG __cn1Arg2, JAVA_LONG __cn1Arg3, JAVA_CHAR __cn1Arg4, JAVA_INT __cn1Arg5) {
    ...
    SP++;
    PUSH_INT(12);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L585634812;
    if (ilocals_7_!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1128109031;

label_L585634812:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L142273642;
...
JAVA_VOID com_codename1_ui_spinner_Spinner___INIT_____com_codename1_ui_list_ListModel_com_codename1_ui_list_ListCellRenderer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_spinner_Spinner_ios7Mode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L556798624;
...
label_L556798624:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1134924425;
...
JAVA_VOID com_codename1_ui_spinner_Spinner_initComponent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    BC_ALOAD(0);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1814594481;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L862862306;
...
label_L308976189:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L1428771375;
...
label_L2108977955:
    ...
    if (get_static_com_codename1_ui_spinner_Spinner_spinnerHandle(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L391823939;
    __CN1_DEBUG_INFO(289);
    if (virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, get_static_com_codename1_ui_spinner_Spinner_spinnerHandle(threadStateData))<=ilocals_5_) /* IF_ICMPLE CustomJump */ goto label_L1369905639;
...
label_L391823939:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L265569691;
    __CN1_DEBUG_INFO(297);
    if (get_field_com_codename1_ui_spinner_Spinner_ios7Mode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L276022884;
...
label_L1366968051:
    ...
    if (virtual_com_codename1_ui_plaf_Style_getBorder___R_com_codename1_ui_plaf_Border(threadStateData, locals[9].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L955979034;
...
JAVA_VOID com_codename1_ui_spinner_Spinner_setValue___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L405685093;
...
label_L405685093:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L510472384;
...
label_L2145942542:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L2023610047;
    ...
    if (locals[5].data.o==locals[1].data.o) /* IF_ACMPEQ CustomJump */ goto label_L59320794;
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1775658917;
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[5].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1775658917;
...
JAVA_OBJECT com_codename1_ui_spinner_Spinner_getValue___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_spinner_SpinnerDateModel);
    if(POP_INT() == 0) /* IFEQ */ goto label_L150255619;
...
JAVA_VOID com_codename1_ui_spinner_Spinner_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    int restoreToL407387019cn1_class_id_java_lang_IllegalArgumentException1;
    int tryBlockOffsetL407387019cn1_class_id_java_lang_IllegalArgumentException1;
    DEFINE_CATCH_BLOCK(catch_L407387019cn1_class_id_java_lang_IllegalArgumentException1, label_L1123649342, restoreToL407387019cn1_class_id_java_lang_IllegalArgumentException1);
    int restoreToL157662396cn1_class_id_java_lang_IllegalArgumentException2;
    int tryBlockOffsetL157662396cn1_class_id_java_lang_IllegalArgumentException2;
    DEFINE_CATCH_BLOCK(catch_L157662396cn1_class_id_java_lang_IllegalArgumentException2, label_L1123649342, restoreToL157662396cn1_class_id_java_lang_IllegalArgumentException2);
    int restoreToL1219735992cn1_class_id_java_lang_IllegalArgumentException3;
    int tryBlockOffsetL1219735992cn1_class_id_java_lang_IllegalArgumentException3;
    DEFINE_CATCH_BLOCK(catch_L1219735992cn1_class_id_java_lang_IllegalArgumentException3, label_L1123649342, restoreToL1219735992cn1_class_id_java_lang_IllegalArgumentException3);
    int restoreToL157084869cn1_class_id_java_lang_IllegalArgumentException4;
    int tryBlockOffsetL157084869cn1_class_id_java_lang_IllegalArgumentException4;
    DEFINE_CATCH_BLOCK(catch_L157084869cn1_class_id_java_lang_IllegalArgumentException4, label_L1123649342, restoreToL157084869cn1_class_id_java_lang_IllegalArgumentException4);
    int restoreToL1614620123cn1_class_id_java_lang_IllegalArgumentException5;
    int tryBlockOffsetL1614620123cn1_class_id_java_lang_IllegalArgumentException5;
    DEFINE_CATCH_BLOCK(catch_L1614620123cn1_class_id_java_lang_IllegalArgumentException5, label_L1123649342, restoreToL1614620123cn1_class_id_java_lang_IllegalArgumentException5);
    int restoreToL1067420963cn1_class_id_java_lang_IllegalArgumentException6;
    int tryBlockOffsetL1067420963cn1_class_id_java_lang_IllegalArgumentException6;
    DEFINE_CATCH_BLOCK(catch_L1067420963cn1_class_id_java_lang_IllegalArgumentException6, label_L1123649342, restoreToL1067420963cn1_class_id_java_lang_IllegalArgumentException6);
    int restoreToL128654041cn1_class_id_java_lang_IllegalArgumentException7;
    int tryBlockOffsetL128654041cn1_class_id_java_lang_IllegalArgumentException7;
    DEFINE_CATCH_BLOCK(catch_L128654041cn1_class_id_java_lang_IllegalArgumentException7, label_L1123649342, restoreToL128654041cn1_class_id_java_lang_IllegalArgumentException7);
    int restoreToL383753182cn1_class_id_java_lang_IllegalArgumentException8;
    int tryBlockOffsetL383753182cn1_class_id_java_lang_IllegalArgumentException8;
    DEFINE_CATCH_BLOCK(catch_L383753182cn1_class_id_java_lang_IllegalArgumentException8, label_L1123649342, restoreToL383753182cn1_class_id_java_lang_IllegalArgumentException8);
    int restoreToL1152298548cn1_class_id_java_lang_IllegalArgumentException9;
    int tryBlockOffsetL1152298548cn1_class_id_java_lang_IllegalArgumentException9;
    DEFINE_CATCH_BLOCK(catch_L1152298548cn1_class_id_java_lang_IllegalArgumentException9, label_L1123649342, restoreToL1152298548cn1_class_id_java_lang_IllegalArgumentException9);
    int restoreToL1084793455cn1_class_id_java_lang_IllegalArgumentException10;
    int tryBlockOffsetL1084793455cn1_class_id_java_lang_IllegalArgumentException10;
    DEFINE_CATCH_BLOCK(catch_L1084793455cn1_class_id_java_lang_IllegalArgumentException10, label_L1123649342, restoreToL1084793455cn1_class_id_java_lang_IllegalArgumentException10);
    ...
    if (ilocals_2_<=0) /* IFLE CustomJump */ JUMP_TO(label_L407387019, 0);
    __CN1_DEBUG_INFO(370);
    /* CustomInvoke */com_codename1_ui_List_keyReleased___int(threadStateData, __cn1ThisObject, ilocals_1_); 
    JUMP_TO(label_L620506240, 0);

label_L407387019:
 tryBlockOffsetL407387019cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L407387019cn1_class_id_java_lang_IllegalArgumentException1);
    restoreToL407387019cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->threadObjectStackOffset;
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[3].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L157662396, 0);
...
label_L157662396:
 tryBlockOffsetL157662396cn1_class_id_java_lang_IllegalArgumentException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L157662396cn1_class_id_java_lang_IllegalArgumentException2);
    restoreToL157662396cn1_class_id_java_lang_IllegalArgumentException2 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(380);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_spinner_Spinner_getRenderer___R_com_codename1_ui_list_ListCellRenderer(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_spinner_DateTimeRenderer);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L128654041, 0);
    __CN1_DEBUG_INFO(382);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_spinner_Spinner_getModel___R_com_codename1_ui_list_ListModel(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_spinner_SpinnerNumberModel);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1592196548, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L465257140, 1);
        case 2: JUMP_TO(label_L1067420963, 0);
        case 3: JUMP_TO(label_L1614620123, 0);
        case 4: JUMP_TO(label_L157084869, 0);
        default: JUMP_TO(label_L1067420963, 0);
    }
...
label_L465257140:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1219735992, 0);
    __CN1_DEBUG_INFO(393);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_7_; 
    SP++;
    PUSH_INT(24);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1067420963, 0);
...
label_L1219735992:
 tryBlockOffsetL1219735992cn1_class_id_java_lang_IllegalArgumentException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L1219735992cn1_class_id_java_lang_IllegalArgumentException3);
    restoreToL1219735992cn1_class_id_java_lang_IllegalArgumentException3 = threadStateData->threadObjectStackOffset;
...
label_L157084869:
 tryBlockOffsetL157084869cn1_class_id_java_lang_IllegalArgumentException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L157084869cn1_class_id_java_lang_IllegalArgumentException4);
    restoreToL157084869cn1_class_id_java_lang_IllegalArgumentException4 = threadStateData->threadObjectStackOffset;
...
label_L1614620123:
 tryBlockOffsetL1614620123cn1_class_id_java_lang_IllegalArgumentException5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L1614620123cn1_class_id_java_lang_IllegalArgumentException5);
    restoreToL1614620123cn1_class_id_java_lang_IllegalArgumentException5 = threadStateData->threadObjectStackOffset;
...
label_L1067420963:
 tryBlockOffsetL1067420963cn1_class_id_java_lang_IllegalArgumentException6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L1067420963cn1_class_id_java_lang_IllegalArgumentException6);
    restoreToL1067420963cn1_class_id_java_lang_IllegalArgumentException6 = threadStateData->threadObjectStackOffset;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L193383192, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L43787342, 1);
        case 2: JUMP_TO(label_L193383192, 1);
        case 3: JUMP_TO(label_L1825102364, 1);
        case 4: JUMP_TO(label_L967022668, 1);
        default: JUMP_TO(label_L193383192, 1);
    }
...
label_L967022668:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L71322219, 1);
...
label_L1592196548:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L1294966332, 1);
        case 2: JUMP_TO(label_L1751850541, 1);
        case 3: JUMP_TO(label_L1853751897, 1);
        case 4: JUMP_TO(label_L1684958471, 1);
        default: JUMP_TO(label_L1751850541, 1);
    }

label_L1294966332:
    __CN1_DEBUG_INFO(446);
    if (get_field_com_codename1_ui_spinner_Spinner_monthFirst(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1426182600, 1);
...
label_L1684958471:
    ...
    if (get_field_com_codename1_ui_spinner_Spinner_monthFirst(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1697330995, 1);
...
label_L1751850541:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1729995001, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L2069466373, 1);
        case 2: JUMP_TO(label_L1729995001, 1);
        case 3: JUMP_TO(label_L1825095996, 1);
        case 4: JUMP_TO(label_L924635900, 1);
        default: JUMP_TO(label_L1729995001, 1);
    }
...
label_L128654041:
 tryBlockOffsetL128654041cn1_class_id_java_lang_IllegalArgumentException7 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L128654041cn1_class_id_java_lang_IllegalArgumentException7);
    restoreToL128654041cn1_class_id_java_lang_IllegalArgumentException7 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_ui_spinner_SpinnerNumberModel_realValues(locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L187885955, 1);
    ...
    BC_DCMPL();
    if(POP_INT() > 0) /* IFGT */ JUMP_TO(label_L1010068549, 1);
    BC_DLOAD(5);
    BC_ALOAD(0);
    ...
    SP[-1].data.d = tmpResult; SP[-1].type = CN1_TYPE_DOUBLE; }
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L383753182, 0);
...
label_L383753182:
 tryBlockOffsetL383753182cn1_class_id_java_lang_IllegalArgumentException8 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L383753182cn1_class_id_java_lang_IllegalArgumentException8);
    restoreToL383753182cn1_class_id_java_lang_IllegalArgumentException8 = threadStateData->threadObjectStackOffset;
...
label_L187885955:
    ...
    SP[-1].data.d = tmpResult; SP[-1].type = CN1_TYPE_DOUBLE; }
    BC_DCMPL();
    if(POP_INT() > 0) /* IFGT */ JUMP_TO(label_L1541912393, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    SP[-1].data.d = SP[-1].data.i; /* I2D */;
    ...
    SP[-1].data.d = tmpResult; SP[-1].type = CN1_TYPE_DOUBLE; }
    BC_DCMPL();
    if(POP_INT() >= 0) /* IFGE */ JUMP_TO(label_L1152298548, 0);
...
label_L1152298548:
 tryBlockOffsetL1152298548cn1_class_id_java_lang_IllegalArgumentException9 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L1152298548cn1_class_id_java_lang_IllegalArgumentException9);
    restoreToL1152298548cn1_class_id_java_lang_IllegalArgumentException9 = threadStateData->threadObjectStackOffset;
...
label_L647170252:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L784714772, 1);
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[6].data.o, locals[3].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1084793455, 0);
...
label_L1084793455:
 tryBlockOffsetL1084793455cn1_class_id_java_lang_IllegalArgumentException10 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L1084793455cn1_class_id_java_lang_IllegalArgumentException10);
    restoreToL1084793455cn1_class_id_java_lang_IllegalArgumentException10 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(504);
    BC_IINC(5, 1);
    JUMP_TO(label_L647170252, 1);
...
JAVA_VOID com_codename1_ui_spinner_Spinner_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_static_com_codename1_ui_spinner_Spinner_spinnerHandle(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L394124580;
...
label_L394124580:
    ...
    BC_LCMP();
    if(POP_INT() < 0) /* IFLT */ goto label_L400037555;
    if (virtual_com_codename1_ui_TextField_isPendingCommit___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Spinner_quickType(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L308704765;
...
label_L400037555:
    ...
    PUSH_OBJ(tmpResult); }
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_spinner_DateTimeRenderer);
    if(POP_INT() == 0) /* IFEQ */ goto label_L739101205;
    __CN1_DEBUG_INFO(536);
    PUSH_INT(get_field_com_codename1_ui_spinner_Spinner_currentInputAlign(__cn1ThisObject));
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1432401485;
        case 3: goto label_L47865820;
        default: goto label_L590486503;
    }
...
JAVA_BOOLEAN com_codename1_ui_spinner_Spinner_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_spinner_Spinner_lastKeyInteraction(__cn1ThisObject), -1LL)==0) /* IFEQ CustomJump */ goto label_L825176144;
    ...
    if (virtual_com_codename1_ui_TextField_isPendingCommit___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Spinner_quickType(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1633398038;
...
JAVA_BOOLEAN com_codename1_ui_spinner_Spinner_shouldRenderSelection___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_spinner_Spinner_isIgnoreFocusComponentWhenUnfocused___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1384476665;
