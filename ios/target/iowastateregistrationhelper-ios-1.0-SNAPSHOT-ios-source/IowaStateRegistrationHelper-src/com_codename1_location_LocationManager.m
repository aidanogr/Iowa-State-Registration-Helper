...
JAVA_VOID com_codename1_location_LocationManager_setBackgroundLocationListener___java_lang_Class(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    int restoreToL37214413101;
    int tryBlockOffsetL37214413101;
    DEFINE_CATCH_BLOCK(catch_L37214413101, label_L470399866, restoreToL37214413101);
    int restoreToL122803425502;
    int tryBlockOffsetL122803425502;
    DEFINE_CATCH_BLOCK(catch_L122803425502, label_L470399866, restoreToL122803425502);
    int restoreToL47039986603;
    int tryBlockOffsetL47039986603;
    DEFINE_CATCH_BLOCK(catch_L47039986603, label_L470399866, restoreToL47039986603);
...
label_L372144131:
 tryBlockOffsetL37214413101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L37214413101);
    restoreToL37214413101 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(236);
    if (get_static_com_codename1_location_LocationManager_backgroundlistener(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L363243807, 1);
...
label_L363243807:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1228034255, 0);
...
label_L1228034255:
 tryBlockOffsetL122803425502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L122803425502);
    restoreToL122803425502 = threadStateData->threadObjectStackOffset;
...
label_L2024219843:
END_TRY(1);    JUMP_TO(label_L612928907, 0);

label_L470399866:
 tryBlockOffsetL47039986603 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L47039986603);
    restoreToL47039986603 = threadStateData->threadObjectStackOffset;
