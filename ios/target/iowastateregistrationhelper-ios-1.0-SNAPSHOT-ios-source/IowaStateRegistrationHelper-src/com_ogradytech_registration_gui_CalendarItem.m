...
JAVA_OBJECT get_field_com_ogradytech_registration_gui_CalendarItem_snapshotSection(JAVA_OBJECT __cn1T) {
  return (*(struct obj__com_ogradytech_registration_gui_CalendarItem*)__cn1T).com_ogradytech_registration_gui_CalendarItem_snapshotSection;
}

void set_field_com_ogradytech_registration_gui_CalendarItem_snapshotSection(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Val, JAVA_OBJECT __cn1T) {
    (*(struct obj__com_ogradytech_registration_gui_CalendarItem*)__cn1T).com_ogradytech_registration_gui_CalendarItem_snapshotSection = __cn1Val;
}

JAVA_INT get_field_com_ogradytech_registration_gui_CalendarItem_snapshotSectionIndex(JAVA_OBJECT __cn1T) {
  return (*(struct obj__com_ogradytech_registration_gui_CalendarItem*)__cn1T).com_ogradytech_registration_gui_CalendarItem_snapshotSectionIndex;
}

void set_field_com_ogradytech_registration_gui_CalendarItem_snapshotSectionIndex(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Val, JAVA_OBJECT __cn1T) {
    (*(struct obj__com_ogradytech_registration_gui_CalendarItem*)__cn1T).com_ogradytech_registration_gui_CalendarItem_snapshotSectionIndex = __cn1Val;
}

JAVA_BOOLEAN get_field_com_ogradytech_registration_gui_CalendarItem_hasSnapshot(JAVA_OBJECT __cn1T) {
  return (*(struct obj__com_ogradytech_registration_gui_CalendarItem*)__cn1T).com_ogradytech_registration_gui_CalendarItem_hasSnapshot;
}

void set_field_com_ogradytech_registration_gui_CalendarItem_hasSnapshot(CODENAME_ONE_THREAD_STATE, JAVA_BOOLEAN __cn1Val, JAVA_OBJECT __cn1T) {
    (*(struct obj__com_ogradytech_registration_gui_CalendarItem*)__cn1T).com_ogradytech_registration_gui_CalendarItem_hasSnapshot = __cn1Val;
}
...
void __GC_MARK_com_ogradytech_registration_gui_CalendarItem(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force) {
    ...
    gcMarkObject(threadStateData, objInstance->com_ogradytech_registration_gui_CalendarItem_snapshotSection, force);
...
JAVA_VOID com_ogradytech_registration_gui_CalendarItem___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(4, 0, 0, 10445, 861);
    __CN1_DEBUG_INFO(13);
    PUSH_INT(10);
...
JAVA_VOID com_ogradytech_registration_gui_CalendarItem___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 10445, 200);
    ...
    __CN1_DEBUG_INFO(43);
    if (get_static_com_ogradytech_registration_gui_CalendarItem_currentColorIndex(threadStateData)<CN1_ARRAY_LENGTH(get_static_com_ogradytech_registration_gui_CalendarItem_allColors(threadStateData))) /* IF_IMPLT CustomJump */ goto label_L1660223291;
    __CN1_DEBUG_INFO(44);
    set_static_com_ogradytech_registration_gui_CalendarItem_currentColorIndex(threadStateData, 0 /* ICONST_0 */);
...
JAVA_VOID com_ogradytech_registration_gui_CalendarItem_addMeetingInfo___java_lang_String_com_ogradytech_registration_Utilities_MeetingInfo(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 10445, 10446);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(53);
    if (get_field_com_ogradytech_registration_gui_CalendarItem_areButtonsInitialized(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L379124840;
    __CN1_DEBUG_INFO(54);
...
label_L544966217:
    ...
    BC_ASTORE(4);
    __CN1_DEBUG_INFO(57);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10447)); 
    __CN1_DEBUG_INFO(58);
...
label_L1157943921:
    ...
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L544966217;
...
JAVA_OBJECT com_ogradytech_registration_gui_CalendarItem_getCurrentSectionMeetingInfo___R_com_ogradytech_registration_Utilities_MeetingInfo(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 10445, 10448);
...
JAVA_OBJECT com_ogradytech_registration_gui_CalendarItem_getCourseName___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10445, 10449);
...
JAVA_INT com_ogradytech_registration_gui_CalendarItem_setInstructionFormat___java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 10445, 10451);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL2113658110cn1_class_id_java_lang_IllegalArgumentException1;
    int tryBlockOffsetL2113658110cn1_class_id_java_lang_IllegalArgumentException1;
    DEFINE_CATCH_BLOCK(catch_L2113658110cn1_class_id_java_lang_IllegalArgumentException1, label_L1706272858, restoreToL2113658110cn1_class_id_java_lang_IllegalArgumentException1);

label_L2113658110:
 tryBlockOffsetL2113658110cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L2113658110cn1_class_id_java_lang_IllegalArgumentException1);
    restoreToL2113658110cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->threadObjectStackOffset;
...
label_L1064041662:
END_TRY(1);    __CN1_DEBUG_INFO(99);
    JUMP_TO(label_L882471736, 0);
...
JAVA_OBJECT com_ogradytech_registration_gui_CalendarItem_getInstructionFormat___R_com_ogradytech_registration_gui_CalendarItem_InstructionFormat(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10445, 10452);
...
JAVA_VOID com_ogradytech_registration_gui_CalendarItem_debugPrint__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 10445, 10453);
    ...
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10454)); 
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10458));
    PUSH_OBJ(tmpResult); }
    ...
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10460)); 
    __CN1_DEBUG_INFO(130);
    if (get_field_com_ogradytech_registration_gui_CalendarItem_sectionMeetingInfo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1475192960;
    if (virtual_java_util_Map_isEmpty___R_boolean(threadStateData, get_field_com_ogradytech_registration_gui_CalendarItem_sectionMeetingInfo(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1475192960;
...
label_L1406253491:
    /* VarOp.assignFrom */ locals[2].data.o = virtual_java_util_Iterator_next___R_java_lang_Object(threadStateData, locals[3].data.o);locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(132);
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_java_util_Map_Entry_getValue___R_java_lang_Object(threadStateData, locals[2].data.o);locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(134);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10462));
    PUSH_OBJ(tmpResult); }
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10464));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L727197178:
    __CN1_DEBUG_INFO(131);
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)!=0) /* IFNE CustomJump */ goto label_L1406253491;
...
label_L749604930:
    ...
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10466)); 
...
JAVA_OBJECT com_ogradytech_registration_gui_CalendarItem_twoDigits___int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_ogradytech_registration_gui_CalendarItem(threadStateData);
    DEFINE_METHOD_STACK(4, 1, 0, 10445, 9809);
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L373097727;
    /* LDC: '0'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(1851));
    goto label_L2082509879;
...
JAVA_VOID com_ogradytech_registration_gui_CalendarItem_lock__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 10445, 1558);
...
JAVA_VOID com_ogradytech_registration_gui_CalendarItem_unlock__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 10445, 1560);
...
JAVA_BOOLEAN com_ogradytech_registration_gui_CalendarItem_isLocked___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10445, 1559);
...
JAVA_OBJECT com_ogradytech_registration_gui_CalendarItem_nextSection___R_com_ogradytech_registration_gui_CalendarItem(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 10445, 10467);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(185);
    if (get_field_com_ogradytech_registration_gui_CalendarItem_isLocked(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L576894497;
...
label_L576894497:
    ...
    if (get_field_com_ogradytech_registration_gui_CalendarItem_currentSectionIndex(__cn1ThisObject)<virtual_java_util_List_size___R_int(threadStateData, get_field_com_ogradytech_registration_gui_CalendarItem_sections(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L2123533871;
...
JAVA_VOID com_ogradytech_registration_gui_CalendarItem_snapshotSelection__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 10445, 10468);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(197);
    set_field_com_ogradytech_registration_gui_CalendarItem_snapshotSection(threadStateData, get_field_com_ogradytech_registration_gui_CalendarItem_currentSection(__cn1ThisObject), __cn1ThisObject);
    __CN1_DEBUG_INFO(198);
    set_field_com_ogradytech_registration_gui_CalendarItem_snapshotSectionIndex(threadStateData, get_field_com_ogradytech_registration_gui_CalendarItem_currentSectionIndex(__cn1ThisObject), __cn1ThisObject);
    __CN1_DEBUG_INFO(199);
    set_field_com_ogradytech_registration_gui_CalendarItem_hasSnapshot(threadStateData, 1 /* ICONST_1 */, __cn1ThisObject);
...
JAVA_VOID com_ogradytech_registration_gui_CalendarItem_nextNoCheck__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 10445, 10469);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(203);
    if (get_field_com_ogradytech_registration_gui_CalendarItem_hasSnapshot(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L16148478;
...
label_L16148478:
    ...
    if (get_field_com_ogradytech_registration_gui_CalendarItem_snapshotSection(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2022689531;
    __CN1_DEBUG_INFO(207);
    /* CustomInvoke */virtual_com_ogradytech_registration_gui_CalendarItem_setCurrentSection___java_lang_String(threadStateData, __cn1ThisObject, get_field_com_ogradytech_registration_gui_CalendarItem_snapshotSection(__cn1ThisObject)); 
    __CN1_DEBUG_INFO(208);
    set_field_com_ogradytech_registration_gui_CalendarItem_currentSectionIndex(threadStateData, get_field_com_ogradytech_registration_gui_CalendarItem_snapshotSectionIndex(__cn1ThisObject), __cn1ThisObject);

label_L2022689531:
    __CN1_DEBUG_INFO(210);
    virtual_com_ogradytech_registration_gui_CalendarItem_clearSnapshot__(threadStateData, __cn1ThisObject); 
...
JAVA_VOID com_ogradytech_registration_gui_CalendarItem_clearSnapshot__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 10445, 10470);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(214);
    set_field_com_ogradytech_registration_gui_CalendarItem_hasSnapshot(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    __CN1_DEBUG_INFO(215);
    set_field_com_ogradytech_registration_gui_CalendarItem_snapshotSection(threadStateData, JAVA_NULL /* ACONST_NULL */, __cn1ThisObject);
...
JAVA_OBJECT com_ogradytech_registration_gui_CalendarItem_getCurrentSection___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10445, 10473);
...
JAVA_VOID com_ogradytech_registration_gui_CalendarItem_setCurrentSection___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 10445, 10474);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(237);
    set_field_com_ogradytech_registration_gui_CalendarItem_currentSection(threadStateData, locals[1].data.o, __cn1ThisObject);
    __CN1_DEBUG_INFO(238);
    if (virtual_java_util_List_isEmpty___R_boolean(threadStateData, get_field_com_ogradytech_registration_gui_CalendarItem_sections(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1340848245;
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L635610193;
...
label_L635610193:
    ...
    /* VarOp.assignFrom */ ilocals_2_ = /* CustomInvoke */virtual_java_util_List_indexOf___java_lang_Object_R_int(threadStateData, get_field_com_ogradytech_registration_gui_CalendarItem_sections(__cn1ThisObject), locals[1].data.o);
    __CN1_DEBUG_INFO(243);
    if (ilocals_2_>=0) /* IFGE CustomJump */ goto label_L379121284;
    __CN1_DEBUG_INFO(244);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(245);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_List_get___int_R_java_lang_Object(threadStateData, get_field_com_ogradytech_registration_gui_CalendarItem_sections(__cn1ThisObject), 0 /* ICONST_0 */);
    PUSH_OBJ(tmpResult); }
    set_field_com_ogradytech_registration_gui_CalendarItem_currentSection(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
...
label_L379121284:
    ...
    { JAVA_INT tmpResult = virtual_java_util_List_size___R_int(threadStateData, get_field_com_ogradytech_registration_gui_CalendarItem_sections(__cn1ThisObject));
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = SP[-1].data.i % (*SP).data.i; /* IREM */
    set_field_com_ogradytech_registration_gui_CalendarItem_currentSectionIndex(threadStateData, POP_INT(), POP_OBJ());
...
JAVA_OBJECT com_ogradytech_registration_gui_CalendarItem_getSectionMeetingInfo___R_java_util_Map(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10445, 10475);
...
JAVA_INT com_ogradytech_registration_gui_CalendarItem_getSize___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10445, 558);
...
class_array1__com_ogradytech_registration_gui_CalendarItem.vtable = initVtableForInterface();
        class__com_ogradytech_registration_gui_CalendarItem.vtable = malloc(sizeof(void*) *27);
