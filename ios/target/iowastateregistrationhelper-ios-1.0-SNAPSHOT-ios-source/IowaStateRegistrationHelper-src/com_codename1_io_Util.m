...
label_L149861573:
    ...
    if (ilocals_5_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L577220795;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L542135392;
...
JAVA_VOID com_codename1_io_Util_copy___java_io_InputStream_java_io_OutputStream_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg3;
    int restoreToL37068412101;
    int tryBlockOffsetL37068412101;
    DEFINE_CATCH_BLOCK(catch_L37068412101, label_L768047458, restoreToL37068412101);

label_L370684121:
 tryBlockOffsetL37068412101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L37068412101);
    restoreToL37068412101 = threadStateData->threadObjectStackOffset;
...
label_L965874704:
    ...
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L151781803;
...
JAVA_VOID com_codename1_io_Util_writeObject___java_lang_Object_java_io_DataOutputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1910857288;
...
label_L1910857288:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L912877601;
...
label_L912877601:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1593914910;
...
label_L1593914910:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1989843834;
...
label_L1342423316:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L760646911;
...
label_L1989843834:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L115653836;
...
label_L1026553658:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L612873761;
...
label_L115653836:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1936362218;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(394);
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_java_util_Collection_iterator___R_java_util_Iterator(threadStateData, locals[2].data.o);locals[4].type=CN1_TYPE_OBJECT;
label_L1231345665:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1347111575;
...
label_L1936362218:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L187723824;
...
label_L641691286:
    ...
    if (virtual_java_util_Enumeration_hasMoreElements___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L749377126;
...
label_L967635335:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1095583342;
...
label_L1232346752:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1681552378;
...
label_L1332370633:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1562669118;
...
label_L1562669118:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1324420411;
...
label_L391463702:
    ...
    if (/* CustomInvoke */com_codename1_io_Util_instanceofObjArray___java_lang_Object_R_boolean(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L1368067090;
...
label_L1085888709:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1525789217;
...
label_L1368067090:
    ...
    if (/* CustomInvoke */com_codename1_io_Util_instanceofByteArray___java_lang_Object_R_boolean(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L2102001207;
...
label_L2102001207:
    ...
    if (/* CustomInvoke */com_codename1_io_Util_instanceofShortArray___java_lang_Object_R_boolean(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L1957398032;
...
label_L694766024:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L589058590;
...
label_L1957398032:
    ...
    if (/* CustomInvoke */com_codename1_io_Util_instanceofDoubleArray___java_lang_Object_R_boolean(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L467903124;
...
label_L1922896936:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L860892414;
...
label_L467903124:
    ...
    if (/* CustomInvoke */com_codename1_io_Util_instanceofFloatArray___java_lang_Object_R_boolean(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L291054778;
...
label_L623717056:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L388551431;
...
label_L291054778:
    ...
    if (/* CustomInvoke */com_codename1_io_Util_instanceofIntArray___java_lang_Object_R_boolean(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L1057707545;
...
label_L919510703:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1739573686;
...
label_L1057707545:
    ...
    if (/* CustomInvoke */com_codename1_io_Util_instanceofLongArray___java_lang_Object_R_boolean(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L2054805916;
...
label_L115112831:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L522711892;
...
JAVA_OBJECT com_codename1_io_Util_readObject___java_io_DataInputStream_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    int restoreToL1272465694cn1_class_id_java_lang_InstantiationException1;
    int tryBlockOffsetL1272465694cn1_class_id_java_lang_InstantiationException1;
    DEFINE_CATCH_BLOCK(catch_L1272465694cn1_class_id_java_lang_InstantiationException1, label_L1143322349, restoreToL1272465694cn1_class_id_java_lang_InstantiationException1);
    int restoreToL1345962703cn1_class_id_java_lang_InstantiationException2;
    int tryBlockOffsetL1345962703cn1_class_id_java_lang_InstantiationException2;
    DEFINE_CATCH_BLOCK(catch_L1345962703cn1_class_id_java_lang_InstantiationException2, label_L1143322349, restoreToL1345962703cn1_class_id_java_lang_InstantiationException2);
    int restoreToL895175732cn1_class_id_java_lang_InstantiationException3;
    int tryBlockOffsetL895175732cn1_class_id_java_lang_InstantiationException3;
    DEFINE_CATCH_BLOCK(catch_L895175732cn1_class_id_java_lang_InstantiationException3, label_L1143322349, restoreToL895175732cn1_class_id_java_lang_InstantiationException3);
    int restoreToL1553991340cn1_class_id_java_lang_InstantiationException4;
    int tryBlockOffsetL1553991340cn1_class_id_java_lang_InstantiationException4;
    DEFINE_CATCH_BLOCK(catch_L1553991340cn1_class_id_java_lang_InstantiationException4, label_L1143322349, restoreToL1553991340cn1_class_id_java_lang_InstantiationException4);
    int restoreToL230944166cn1_class_id_java_lang_InstantiationException5;
    int tryBlockOffsetL230944166cn1_class_id_java_lang_InstantiationException5;
    DEFINE_CATCH_BLOCK(catch_L230944166cn1_class_id_java_lang_InstantiationException5, label_L1143322349, restoreToL230944166cn1_class_id_java_lang_InstantiationException5);
    int restoreToL326265195cn1_class_id_java_lang_InstantiationException6;
    int tryBlockOffsetL326265195cn1_class_id_java_lang_InstantiationException6;
    DEFINE_CATCH_BLOCK(catch_L326265195cn1_class_id_java_lang_InstantiationException6, label_L1143322349, restoreToL326265195cn1_class_id_java_lang_InstantiationException6);
    int restoreToL2091367901cn1_class_id_java_lang_InstantiationException7;
    int tryBlockOffsetL2091367901cn1_class_id_java_lang_InstantiationException7;
    DEFINE_CATCH_BLOCK(catch_L2091367901cn1_class_id_java_lang_InstantiationException7, label_L1143322349, restoreToL2091367901cn1_class_id_java_lang_InstantiationException7);
    int restoreToL544100739cn1_class_id_java_lang_InstantiationException8;
    int tryBlockOffsetL544100739cn1_class_id_java_lang_InstantiationException8;
    DEFINE_CATCH_BLOCK(catch_L544100739cn1_class_id_java_lang_InstantiationException8, label_L1143322349, restoreToL544100739cn1_class_id_java_lang_InstantiationException8);
    int restoreToL844248821cn1_class_id_java_lang_InstantiationException9;
    int tryBlockOffsetL844248821cn1_class_id_java_lang_InstantiationException9;
    DEFINE_CATCH_BLOCK(catch_L844248821cn1_class_id_java_lang_InstantiationException9, label_L1143322349, restoreToL844248821cn1_class_id_java_lang_InstantiationException9);
    int restoreToL854276325cn1_class_id_java_lang_InstantiationException10;
    int tryBlockOffsetL854276325cn1_class_id_java_lang_InstantiationException10;
    DEFINE_CATCH_BLOCK(catch_L854276325cn1_class_id_java_lang_InstantiationException10, label_L1143322349, restoreToL854276325cn1_class_id_java_lang_InstantiationException10);
    int restoreToL1935880752cn1_class_id_java_lang_InstantiationException11;
    int tryBlockOffsetL1935880752cn1_class_id_java_lang_InstantiationException11;
    DEFINE_CATCH_BLOCK(catch_L1935880752cn1_class_id_java_lang_InstantiationException11, label_L1143322349, restoreToL1935880752cn1_class_id_java_lang_InstantiationException11);
    int restoreToL559126422cn1_class_id_java_lang_InstantiationException12;
    int tryBlockOffsetL559126422cn1_class_id_java_lang_InstantiationException12;
    DEFINE_CATCH_BLOCK(catch_L559126422cn1_class_id_java_lang_InstantiationException12, label_L1143322349, restoreToL559126422cn1_class_id_java_lang_InstantiationException12);
    int restoreToL55220696cn1_class_id_java_lang_InstantiationException13;
    int tryBlockOffsetL55220696cn1_class_id_java_lang_InstantiationException13;
    DEFINE_CATCH_BLOCK(catch_L55220696cn1_class_id_java_lang_InstantiationException13, label_L1143322349, restoreToL55220696cn1_class_id_java_lang_InstantiationException13);
    int restoreToL1050165504cn1_class_id_java_lang_InstantiationException14;
    int tryBlockOffsetL1050165504cn1_class_id_java_lang_InstantiationException14;
    DEFINE_CATCH_BLOCK(catch_L1050165504cn1_class_id_java_lang_InstantiationException14, label_L1143322349, restoreToL1050165504cn1_class_id_java_lang_InstantiationException14);
    int restoreToL993731216cn1_class_id_java_lang_InstantiationException15;
    int tryBlockOffsetL993731216cn1_class_id_java_lang_InstantiationException15;
    DEFINE_CATCH_BLOCK(catch_L993731216cn1_class_id_java_lang_InstantiationException15, label_L1143322349, restoreToL993731216cn1_class_id_java_lang_InstantiationException15);
    int restoreToL1240016676cn1_class_id_java_lang_InstantiationException16;
    int tryBlockOffsetL1240016676cn1_class_id_java_lang_InstantiationException16;
    DEFINE_CATCH_BLOCK(catch_L1240016676cn1_class_id_java_lang_InstantiationException16, label_L1143322349, restoreToL1240016676cn1_class_id_java_lang_InstantiationException16);
    int restoreToL1202402952cn1_class_id_java_lang_InstantiationException17;
    int tryBlockOffsetL1202402952cn1_class_id_java_lang_InstantiationException17;
    DEFINE_CATCH_BLOCK(catch_L1202402952cn1_class_id_java_lang_InstantiationException17, label_L1143322349, restoreToL1202402952cn1_class_id_java_lang_InstantiationException17);
    int restoreToL1791032605cn1_class_id_java_lang_InstantiationException18;
    int tryBlockOffsetL1791032605cn1_class_id_java_lang_InstantiationException18;
    DEFINE_CATCH_BLOCK(catch_L1791032605cn1_class_id_java_lang_InstantiationException18, label_L1143322349, restoreToL1791032605cn1_class_id_java_lang_InstantiationException18);
    int restoreToL1679027895cn1_class_id_java_lang_InstantiationException19;
    int tryBlockOffsetL1679027895cn1_class_id_java_lang_InstantiationException19;
    DEFINE_CATCH_BLOCK(catch_L1679027895cn1_class_id_java_lang_InstantiationException19, label_L1143322349, restoreToL1679027895cn1_class_id_java_lang_InstantiationException19);
    int restoreToL1478005042cn1_class_id_java_lang_InstantiationException20;
    int tryBlockOffsetL1478005042cn1_class_id_java_lang_InstantiationException20;
    DEFINE_CATCH_BLOCK(catch_L1478005042cn1_class_id_java_lang_InstantiationException20, label_L1143322349, restoreToL1478005042cn1_class_id_java_lang_InstantiationException20);
    int restoreToL2110350270cn1_class_id_java_lang_InstantiationException21;
    int tryBlockOffsetL2110350270cn1_class_id_java_lang_InstantiationException21;
    DEFINE_CATCH_BLOCK(catch_L2110350270cn1_class_id_java_lang_InstantiationException21, label_L1143322349, restoreToL2110350270cn1_class_id_java_lang_InstantiationException21);
    int restoreToL1577603673cn1_class_id_java_lang_InstantiationException22;
    int tryBlockOffsetL1577603673cn1_class_id_java_lang_InstantiationException22;
    DEFINE_CATCH_BLOCK(catch_L1577603673cn1_class_id_java_lang_InstantiationException22, label_L1143322349, restoreToL1577603673cn1_class_id_java_lang_InstantiationException22);
    int restoreToL226230494cn1_class_id_java_lang_InstantiationException23;
    int tryBlockOffsetL226230494cn1_class_id_java_lang_InstantiationException23;
    DEFINE_CATCH_BLOCK(catch_L226230494cn1_class_id_java_lang_InstantiationException23, label_L1143322349, restoreToL226230494cn1_class_id_java_lang_InstantiationException23);
    int restoreToL1281853983cn1_class_id_java_lang_InstantiationException24;
    int tryBlockOffsetL1281853983cn1_class_id_java_lang_InstantiationException24;
    DEFINE_CATCH_BLOCK(catch_L1281853983cn1_class_id_java_lang_InstantiationException24, label_L1143322349, restoreToL1281853983cn1_class_id_java_lang_InstantiationException24);
    int restoreToL1615264672cn1_class_id_java_lang_InstantiationException25;
    int tryBlockOffsetL1615264672cn1_class_id_java_lang_InstantiationException25;
    DEFINE_CATCH_BLOCK(catch_L1615264672cn1_class_id_java_lang_InstantiationException25, label_L1143322349, restoreToL1615264672cn1_class_id_java_lang_InstantiationException25);
    int restoreToL560990653cn1_class_id_java_lang_InstantiationException26;
    int tryBlockOffsetL560990653cn1_class_id_java_lang_InstantiationException26;
    DEFINE_CATCH_BLOCK(catch_L560990653cn1_class_id_java_lang_InstantiationException26, label_L1143322349, restoreToL560990653cn1_class_id_java_lang_InstantiationException26);
    int restoreToL1272465694cn1_class_id_java_lang_IllegalAccessException27;
    int tryBlockOffsetL1272465694cn1_class_id_java_lang_IllegalAccessException27;
    DEFINE_CATCH_BLOCK(catch_L1272465694cn1_class_id_java_lang_IllegalAccessException27, label_L1881420492, restoreToL1272465694cn1_class_id_java_lang_IllegalAccessException27);
    int restoreToL1345962703cn1_class_id_java_lang_IllegalAccessException28;
    int tryBlockOffsetL1345962703cn1_class_id_java_lang_IllegalAccessException28;
    DEFINE_CATCH_BLOCK(catch_L1345962703cn1_class_id_java_lang_IllegalAccessException28, label_L1881420492, restoreToL1345962703cn1_class_id_java_lang_IllegalAccessException28);
    int restoreToL895175732cn1_class_id_java_lang_IllegalAccessException29;
    int tryBlockOffsetL895175732cn1_class_id_java_lang_IllegalAccessException29;
    DEFINE_CATCH_BLOCK(catch_L895175732cn1_class_id_java_lang_IllegalAccessException29, label_L1881420492, restoreToL895175732cn1_class_id_java_lang_IllegalAccessException29);
    int restoreToL1553991340cn1_class_id_java_lang_IllegalAccessException30;
    int tryBlockOffsetL1553991340cn1_class_id_java_lang_IllegalAccessException30;
    DEFINE_CATCH_BLOCK(catch_L1553991340cn1_class_id_java_lang_IllegalAccessException30, label_L1881420492, restoreToL1553991340cn1_class_id_java_lang_IllegalAccessException30);
    int restoreToL230944166cn1_class_id_java_lang_IllegalAccessException31;
    int tryBlockOffsetL230944166cn1_class_id_java_lang_IllegalAccessException31;
    DEFINE_CATCH_BLOCK(catch_L230944166cn1_class_id_java_lang_IllegalAccessException31, label_L1881420492, restoreToL230944166cn1_class_id_java_lang_IllegalAccessException31);
    int restoreToL326265195cn1_class_id_java_lang_IllegalAccessException32;
    int tryBlockOffsetL326265195cn1_class_id_java_lang_IllegalAccessException32;
    DEFINE_CATCH_BLOCK(catch_L326265195cn1_class_id_java_lang_IllegalAccessException32, label_L1881420492, restoreToL326265195cn1_class_id_java_lang_IllegalAccessException32);
    int restoreToL2091367901cn1_class_id_java_lang_IllegalAccessException33;
    int tryBlockOffsetL2091367901cn1_class_id_java_lang_IllegalAccessException33;
    DEFINE_CATCH_BLOCK(catch_L2091367901cn1_class_id_java_lang_IllegalAccessException33, label_L1881420492, restoreToL2091367901cn1_class_id_java_lang_IllegalAccessException33);
    int restoreToL544100739cn1_class_id_java_lang_IllegalAccessException34;
    int tryBlockOffsetL544100739cn1_class_id_java_lang_IllegalAccessException34;
    DEFINE_CATCH_BLOCK(catch_L544100739cn1_class_id_java_lang_IllegalAccessException34, label_L1881420492, restoreToL544100739cn1_class_id_java_lang_IllegalAccessException34);
    int restoreToL844248821cn1_class_id_java_lang_IllegalAccessException35;
    int tryBlockOffsetL844248821cn1_class_id_java_lang_IllegalAccessException35;
    DEFINE_CATCH_BLOCK(catch_L844248821cn1_class_id_java_lang_IllegalAccessException35, label_L1881420492, restoreToL844248821cn1_class_id_java_lang_IllegalAccessException35);
    int restoreToL854276325cn1_class_id_java_lang_IllegalAccessException36;
    int tryBlockOffsetL854276325cn1_class_id_java_lang_IllegalAccessException36;
    DEFINE_CATCH_BLOCK(catch_L854276325cn1_class_id_java_lang_IllegalAccessException36, label_L1881420492, restoreToL854276325cn1_class_id_java_lang_IllegalAccessException36);
    int restoreToL1935880752cn1_class_id_java_lang_IllegalAccessException37;
    int tryBlockOffsetL1935880752cn1_class_id_java_lang_IllegalAccessException37;
    DEFINE_CATCH_BLOCK(catch_L1935880752cn1_class_id_java_lang_IllegalAccessException37, label_L1881420492, restoreToL1935880752cn1_class_id_java_lang_IllegalAccessException37);
    int restoreToL559126422cn1_class_id_java_lang_IllegalAccessException38;
    int tryBlockOffsetL559126422cn1_class_id_java_lang_IllegalAccessException38;
    DEFINE_CATCH_BLOCK(catch_L559126422cn1_class_id_java_lang_IllegalAccessException38, label_L1881420492, restoreToL559126422cn1_class_id_java_lang_IllegalAccessException38);
    int restoreToL55220696cn1_class_id_java_lang_IllegalAccessException39;
    int tryBlockOffsetL55220696cn1_class_id_java_lang_IllegalAccessException39;
    DEFINE_CATCH_BLOCK(catch_L55220696cn1_class_id_java_lang_IllegalAccessException39, label_L1881420492, restoreToL55220696cn1_class_id_java_lang_IllegalAccessException39);
    int restoreToL1050165504cn1_class_id_java_lang_IllegalAccessException40;
    int tryBlockOffsetL1050165504cn1_class_id_java_lang_IllegalAccessException40;
    DEFINE_CATCH_BLOCK(catch_L1050165504cn1_class_id_java_lang_IllegalAccessException40, label_L1881420492, restoreToL1050165504cn1_class_id_java_lang_IllegalAccessException40);
    int restoreToL993731216cn1_class_id_java_lang_IllegalAccessException41;
    int tryBlockOffsetL993731216cn1_class_id_java_lang_IllegalAccessException41;
    DEFINE_CATCH_BLOCK(catch_L993731216cn1_class_id_java_lang_IllegalAccessException41, label_L1881420492, restoreToL993731216cn1_class_id_java_lang_IllegalAccessException41);
    int restoreToL1240016676cn1_class_id_java_lang_IllegalAccessException42;
    int tryBlockOffsetL1240016676cn1_class_id_java_lang_IllegalAccessException42;
    DEFINE_CATCH_BLOCK(catch_L1240016676cn1_class_id_java_lang_IllegalAccessException42, label_L1881420492, restoreToL1240016676cn1_class_id_java_lang_IllegalAccessException42);
    int restoreToL1202402952cn1_class_id_java_lang_IllegalAccessException43;
    int tryBlockOffsetL1202402952cn1_class_id_java_lang_IllegalAccessException43;
    DEFINE_CATCH_BLOCK(catch_L1202402952cn1_class_id_java_lang_IllegalAccessException43, label_L1881420492, restoreToL1202402952cn1_class_id_java_lang_IllegalAccessException43);
    int restoreToL1791032605cn1_class_id_java_lang_IllegalAccessException44;
    int tryBlockOffsetL1791032605cn1_class_id_java_lang_IllegalAccessException44;
    DEFINE_CATCH_BLOCK(catch_L1791032605cn1_class_id_java_lang_IllegalAccessException44, label_L1881420492, restoreToL1791032605cn1_class_id_java_lang_IllegalAccessException44);
    int restoreToL1679027895cn1_class_id_java_lang_IllegalAccessException45;
    int tryBlockOffsetL1679027895cn1_class_id_java_lang_IllegalAccessException45;
    DEFINE_CATCH_BLOCK(catch_L1679027895cn1_class_id_java_lang_IllegalAccessException45, label_L1881420492, restoreToL1679027895cn1_class_id_java_lang_IllegalAccessException45);
    int restoreToL1478005042cn1_class_id_java_lang_IllegalAccessException46;
    int tryBlockOffsetL1478005042cn1_class_id_java_lang_IllegalAccessException46;
    DEFINE_CATCH_BLOCK(catch_L1478005042cn1_class_id_java_lang_IllegalAccessException46, label_L1881420492, restoreToL1478005042cn1_class_id_java_lang_IllegalAccessException46);
    int restoreToL2110350270cn1_class_id_java_lang_IllegalAccessException47;
    int tryBlockOffsetL2110350270cn1_class_id_java_lang_IllegalAccessException47;
    DEFINE_CATCH_BLOCK(catch_L2110350270cn1_class_id_java_lang_IllegalAccessException47, label_L1881420492, restoreToL2110350270cn1_class_id_java_lang_IllegalAccessException47);
    int restoreToL1577603673cn1_class_id_java_lang_IllegalAccessException48;
    int tryBlockOffsetL1577603673cn1_class_id_java_lang_IllegalAccessException48;
    DEFINE_CATCH_BLOCK(catch_L1577603673cn1_class_id_java_lang_IllegalAccessException48, label_L1881420492, restoreToL1577603673cn1_class_id_java_lang_IllegalAccessException48);
    int restoreToL226230494cn1_class_id_java_lang_IllegalAccessException49;
    int tryBlockOffsetL226230494cn1_class_id_java_lang_IllegalAccessException49;
    DEFINE_CATCH_BLOCK(catch_L226230494cn1_class_id_java_lang_IllegalAccessException49, label_L1881420492, restoreToL226230494cn1_class_id_java_lang_IllegalAccessException49);
    int restoreToL1281853983cn1_class_id_java_lang_IllegalAccessException50;
    int tryBlockOffsetL1281853983cn1_class_id_java_lang_IllegalAccessException50;
    DEFINE_CATCH_BLOCK(catch_L1281853983cn1_class_id_java_lang_IllegalAccessException50, label_L1881420492, restoreToL1281853983cn1_class_id_java_lang_IllegalAccessException50);
    int restoreToL1615264672cn1_class_id_java_lang_IllegalAccessException51;
    int tryBlockOffsetL1615264672cn1_class_id_java_lang_IllegalAccessException51;
    DEFINE_CATCH_BLOCK(catch_L1615264672cn1_class_id_java_lang_IllegalAccessException51, label_L1881420492, restoreToL1615264672cn1_class_id_java_lang_IllegalAccessException51);
    int restoreToL560990653cn1_class_id_java_lang_IllegalAccessException52;
    int tryBlockOffsetL560990653cn1_class_id_java_lang_IllegalAccessException52;
    DEFINE_CATCH_BLOCK(catch_L560990653cn1_class_id_java_lang_IllegalAccessException52, label_L1881420492, restoreToL560990653cn1_class_id_java_lang_IllegalAccessException52);

label_L1272465694:
 tryBlockOffsetL1272465694cn1_class_id_java_lang_IllegalAccessException27 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1272465694cn1_class_id_java_lang_IllegalAccessException27);
    restoreToL1272465694cn1_class_id_java_lang_IllegalAccessException27 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1272465694cn1_class_id_java_lang_InstantiationException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1272465694cn1_class_id_java_lang_InstantiationException1);
    restoreToL1272465694cn1_class_id_java_lang_InstantiationException1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(671);
    if (virtual_java_io_DataInputStream_readBoolean___R_boolean(threadStateData, locals[0].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1345962703, 0);
...
label_L1345962703:
 tryBlockOffsetL1345962703cn1_class_id_java_lang_IllegalAccessException28 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1345962703cn1_class_id_java_lang_IllegalAccessException28);
    restoreToL1345962703cn1_class_id_java_lang_IllegalAccessException28 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1345962703cn1_class_id_java_lang_InstantiationException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1345962703cn1_class_id_java_lang_InstantiationException2);
    restoreToL1345962703cn1_class_id_java_lang_InstantiationException2 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2258), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L895175732, 0);
...
label_L895175732:
 tryBlockOffsetL895175732cn1_class_id_java_lang_IllegalAccessException29 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L895175732cn1_class_id_java_lang_IllegalAccessException29);
    restoreToL895175732cn1_class_id_java_lang_IllegalAccessException29 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL895175732cn1_class_id_java_lang_InstantiationException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L895175732cn1_class_id_java_lang_InstantiationException3);
    restoreToL895175732cn1_class_id_java_lang_InstantiationException3 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(678);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2260), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1553991340, 0);
...
label_L1553991340:
 tryBlockOffsetL1553991340cn1_class_id_java_lang_IllegalAccessException30 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1553991340cn1_class_id_java_lang_IllegalAccessException30);
    restoreToL1553991340cn1_class_id_java_lang_IllegalAccessException30 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1553991340cn1_class_id_java_lang_InstantiationException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1553991340cn1_class_id_java_lang_InstantiationException4);
    restoreToL1553991340cn1_class_id_java_lang_InstantiationException4 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(681);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2261), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L230944166, 0);
...
label_L230944166:
 tryBlockOffsetL230944166cn1_class_id_java_lang_IllegalAccessException31 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L230944166cn1_class_id_java_lang_IllegalAccessException31);
    restoreToL230944166cn1_class_id_java_lang_IllegalAccessException31 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL230944166cn1_class_id_java_lang_InstantiationException5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L230944166cn1_class_id_java_lang_InstantiationException5);
    restoreToL230944166cn1_class_id_java_lang_InstantiationException5 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(684);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2259), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L326265195, 0);
...
label_L326265195:
 tryBlockOffsetL326265195cn1_class_id_java_lang_IllegalAccessException32 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L326265195cn1_class_id_java_lang_IllegalAccessException32);
    restoreToL326265195cn1_class_id_java_lang_IllegalAccessException32 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL326265195cn1_class_id_java_lang_InstantiationException6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L326265195cn1_class_id_java_lang_InstantiationException6);
    restoreToL326265195cn1_class_id_java_lang_InstantiationException6 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(687);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(1060), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2091367901, 0);
...
label_L2091367901:
 tryBlockOffsetL2091367901cn1_class_id_java_lang_IllegalAccessException33 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L2091367901cn1_class_id_java_lang_IllegalAccessException33);
    restoreToL2091367901cn1_class_id_java_lang_IllegalAccessException33 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL2091367901cn1_class_id_java_lang_InstantiationException7 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L2091367901cn1_class_id_java_lang_InstantiationException7);
    restoreToL2091367901cn1_class_id_java_lang_InstantiationException7 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(690);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(1059), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L544100739, 0);
...
label_L544100739:
 tryBlockOffsetL544100739cn1_class_id_java_lang_IllegalAccessException34 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L544100739cn1_class_id_java_lang_IllegalAccessException34);
    restoreToL544100739cn1_class_id_java_lang_IllegalAccessException34 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL544100739cn1_class_id_java_lang_InstantiationException8 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L544100739cn1_class_id_java_lang_InstantiationException8);
    restoreToL544100739cn1_class_id_java_lang_InstantiationException8 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(693);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2262), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L844248821, 0);
...
label_L844248821:
 tryBlockOffsetL844248821cn1_class_id_java_lang_IllegalAccessException35 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L844248821cn1_class_id_java_lang_IllegalAccessException35);
    restoreToL844248821cn1_class_id_java_lang_IllegalAccessException35 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL844248821cn1_class_id_java_lang_InstantiationException9 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L844248821cn1_class_id_java_lang_InstantiationException9);
    restoreToL844248821cn1_class_id_java_lang_InstantiationException9 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(696);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2256), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L854276325, 0);
...
label_L854276325:
 tryBlockOffsetL854276325cn1_class_id_java_lang_IllegalAccessException36 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L854276325cn1_class_id_java_lang_IllegalAccessException36);
    restoreToL854276325cn1_class_id_java_lang_IllegalAccessException36 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL854276325cn1_class_id_java_lang_InstantiationException10 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L854276325cn1_class_id_java_lang_InstantiationException10);
    restoreToL854276325cn1_class_id_java_lang_InstantiationException10 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(699);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2257), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1935880752, 0);
...
label_L1935880752:
 tryBlockOffsetL1935880752cn1_class_id_java_lang_IllegalAccessException37 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1935880752cn1_class_id_java_lang_IllegalAccessException37);
    restoreToL1935880752cn1_class_id_java_lang_IllegalAccessException37 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1935880752cn1_class_id_java_lang_InstantiationException11 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1935880752cn1_class_id_java_lang_InstantiationException11);
    restoreToL1935880752cn1_class_id_java_lang_InstantiationException11 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(703);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2264), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L559126422, 0);
...
label_L1775420512:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L34994391, 2);
...
label_L559126422:
 tryBlockOffsetL559126422cn1_class_id_java_lang_IllegalAccessException38 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L559126422cn1_class_id_java_lang_IllegalAccessException38);
    restoreToL559126422cn1_class_id_java_lang_IllegalAccessException38 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL559126422cn1_class_id_java_lang_InstantiationException12 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L559126422cn1_class_id_java_lang_InstantiationException12);
    restoreToL559126422cn1_class_id_java_lang_InstantiationException12 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(711);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2265), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L55220696, 0);
...
label_L55220696:
 tryBlockOffsetL55220696cn1_class_id_java_lang_IllegalAccessException39 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L55220696cn1_class_id_java_lang_IllegalAccessException39);
    restoreToL55220696cn1_class_id_java_lang_IllegalAccessException39 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL55220696cn1_class_id_java_lang_InstantiationException13 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L55220696cn1_class_id_java_lang_InstantiationException13);
    restoreToL55220696cn1_class_id_java_lang_InstantiationException13 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(716);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2270), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1050165504, 0);
...
label_L1818817180:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L333890884, 2);
...
label_L1050165504:
 tryBlockOffsetL1050165504cn1_class_id_java_lang_IllegalAccessException40 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1050165504cn1_class_id_java_lang_IllegalAccessException40);
    restoreToL1050165504cn1_class_id_java_lang_IllegalAccessException40 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1050165504cn1_class_id_java_lang_InstantiationException14 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1050165504cn1_class_id_java_lang_InstantiationException14);
    restoreToL1050165504cn1_class_id_java_lang_InstantiationException14 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(724);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2266), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L993731216, 0);
...
label_L1648285165:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1205331126, 2);
...
label_L993731216:
 tryBlockOffsetL993731216cn1_class_id_java_lang_IllegalAccessException41 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L993731216cn1_class_id_java_lang_IllegalAccessException41);
    restoreToL993731216cn1_class_id_java_lang_IllegalAccessException41 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL993731216cn1_class_id_java_lang_InstantiationException15 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L993731216cn1_class_id_java_lang_InstantiationException15);
    restoreToL993731216cn1_class_id_java_lang_InstantiationException15 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(732);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2267), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1240016676, 0);
...
label_L1395523773:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L732214059, 2);
...
label_L1240016676:
 tryBlockOffsetL1240016676cn1_class_id_java_lang_IllegalAccessException42 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1240016676cn1_class_id_java_lang_IllegalAccessException42);
    restoreToL1240016676cn1_class_id_java_lang_IllegalAccessException42 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1240016676cn1_class_id_java_lang_InstantiationException16 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1240016676cn1_class_id_java_lang_InstantiationException16);
    restoreToL1240016676cn1_class_id_java_lang_InstantiationException16 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(740);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2268), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1202402952, 0);
...
label_L1229465441:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1207695710, 2);
...
label_L1202402952:
 tryBlockOffsetL1202402952cn1_class_id_java_lang_IllegalAccessException43 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1202402952cn1_class_id_java_lang_IllegalAccessException43);
    restoreToL1202402952cn1_class_id_java_lang_IllegalAccessException43 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1202402952cn1_class_id_java_lang_InstantiationException17 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1202402952cn1_class_id_java_lang_InstantiationException17);
    restoreToL1202402952cn1_class_id_java_lang_InstantiationException17 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(748);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2269), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1791032605, 0);
...
label_L1827192676:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1950456251, 2);
...
label_L1791032605:
 tryBlockOffsetL1791032605cn1_class_id_java_lang_IllegalAccessException44 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1791032605cn1_class_id_java_lang_IllegalAccessException44);
    restoreToL1791032605cn1_class_id_java_lang_IllegalAccessException44 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1791032605cn1_class_id_java_lang_InstantiationException18 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1791032605cn1_class_id_java_lang_InstantiationException18);
    restoreToL1791032605cn1_class_id_java_lang_InstantiationException18 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(756);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2251), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1679027895, 0);
...
label_L1898058733:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L156684093, 2);
...
label_L1679027895:
 tryBlockOffsetL1679027895cn1_class_id_java_lang_IllegalAccessException45 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1679027895cn1_class_id_java_lang_IllegalAccessException45);
    restoreToL1679027895cn1_class_id_java_lang_IllegalAccessException45 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1679027895cn1_class_id_java_lang_InstantiationException19 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1679027895cn1_class_id_java_lang_InstantiationException19);
    restoreToL1679027895cn1_class_id_java_lang_InstantiationException19 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(764);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2254), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1478005042, 0);
...
label_L471180970:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L587573968, 2);
...
label_L1478005042:
 tryBlockOffsetL1478005042cn1_class_id_java_lang_IllegalAccessException46 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1478005042cn1_class_id_java_lang_IllegalAccessException46);
    restoreToL1478005042cn1_class_id_java_lang_IllegalAccessException46 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1478005042cn1_class_id_java_lang_InstantiationException20 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1478005042cn1_class_id_java_lang_InstantiationException20);
    restoreToL1478005042cn1_class_id_java_lang_InstantiationException20 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(772);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2252), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2110350270, 0);
...
label_L1872337398:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1640299572, 2);
...
label_L2110350270:
 tryBlockOffsetL2110350270cn1_class_id_java_lang_IllegalAccessException47 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L2110350270cn1_class_id_java_lang_IllegalAccessException47);
    restoreToL2110350270cn1_class_id_java_lang_IllegalAccessException47 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL2110350270cn1_class_id_java_lang_InstantiationException21 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L2110350270cn1_class_id_java_lang_InstantiationException21);
    restoreToL2110350270cn1_class_id_java_lang_InstantiationException21 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(780);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2253), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1577603673, 0);
...
label_L1577603673:
 tryBlockOffsetL1577603673cn1_class_id_java_lang_IllegalAccessException48 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1577603673cn1_class_id_java_lang_IllegalAccessException48);
    restoreToL1577603673cn1_class_id_java_lang_IllegalAccessException48 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1577603673cn1_class_id_java_lang_InstantiationException22 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1577603673cn1_class_id_java_lang_InstantiationException22);
    restoreToL1577603673cn1_class_id_java_lang_InstantiationException22 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(788);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2255), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L226230494, 0);
...
label_L226230494:
 tryBlockOffsetL226230494cn1_class_id_java_lang_IllegalAccessException49 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L226230494cn1_class_id_java_lang_IllegalAccessException49);
    restoreToL226230494cn1_class_id_java_lang_IllegalAccessException49 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL226230494cn1_class_id_java_lang_InstantiationException23 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L226230494cn1_class_id_java_lang_InstantiationException23);
    restoreToL226230494cn1_class_id_java_lang_InstantiationException23 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(796);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(2263), locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1281853983, 0);
...
label_L1281853983:
 tryBlockOffsetL1281853983cn1_class_id_java_lang_IllegalAccessException50 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1281853983cn1_class_id_java_lang_IllegalAccessException50);
    restoreToL1281853983cn1_class_id_java_lang_IllegalAccessException50 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1281853983cn1_class_id_java_lang_InstantiationException24 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1281853983cn1_class_id_java_lang_InstantiationException24);
    restoreToL1281853983cn1_class_id_java_lang_InstantiationException24 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L560990653, 0);
    ...
    BC_ALOAD(3);
    BC_INSTANCEOF(cn1_class_id_com_codename1_io_Externalizable);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1615264672, 0);
...
label_L1615264672:
 tryBlockOffsetL1615264672cn1_class_id_java_lang_IllegalAccessException51 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L1615264672cn1_class_id_java_lang_IllegalAccessException51);
    restoreToL1615264672cn1_class_id_java_lang_IllegalAccessException51 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1615264672cn1_class_id_java_lang_InstantiationException25 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L1615264672cn1_class_id_java_lang_InstantiationException25);
    restoreToL1615264672cn1_class_id_java_lang_InstantiationException25 = threadStateData->threadObjectStackOffset;
...
label_L560990653:
 tryBlockOffsetL560990653cn1_class_id_java_lang_IllegalAccessException52 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalAccessException, catch_L560990653cn1_class_id_java_lang_IllegalAccessException52);
    restoreToL560990653cn1_class_id_java_lang_IllegalAccessException52 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL560990653cn1_class_id_java_lang_InstantiationException26 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InstantiationException, catch_L560990653cn1_class_id_java_lang_InstantiationException26);
    restoreToL560990653cn1_class_id_java_lang_InstantiationException26 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_io_Util_toCharArray___java_lang_String_R_char_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_static_com_codename1_io_Util_charArrayBugTested(threadStateData)!=0) /* IFNE CustomJump */ goto label_L613131516;
    ...
    { JAVA_OBJECT tmpResult = virtual_java_lang_String_toCharArray___R_char_1ARRAY(threadStateData, locals[0].data.o);
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L613131516;
    __CN1_DEBUG_INFO(861);
    set_static_com_codename1_io_Util_charArrayBug(threadStateData, 1 /* ICONST_1 */);

label_L613131516:
    __CN1_DEBUG_INFO(864);
    if (get_static_com_codename1_io_Util_charArrayBug(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1422714112;
...
JAVA_OBJECT com_codename1_io_Util_encode___java_lang_String_java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1968190405;
...
JAVA_OBJECT com_codename1_io_Util_decode___java_lang_String_java_lang_String_boolean_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg3;
    int restoreToL39864640cn1_class_id_java_io_UnsupportedEncodingException1;
    int tryBlockOffsetL39864640cn1_class_id_java_io_UnsupportedEncodingException1;
    DEFINE_CATCH_BLOCK(catch_L39864640cn1_class_id_java_io_UnsupportedEncodingException1, label_L580668724, restoreToL39864640cn1_class_id_java_io_UnsupportedEncodingException1);
    int restoreToL1755226641cn1_class_id_java_lang_NumberFormatException2;
    int tryBlockOffsetL1755226641cn1_class_id_java_lang_NumberFormatException2;
    DEFINE_CATCH_BLOCK(catch_L1755226641cn1_class_id_java_lang_NumberFormatException2, label_L1531556319, restoreToL1755226641cn1_class_id_java_lang_NumberFormatException2);
    __CN1_DEBUG_INFO(888);
    /* VarOp.assignFrom */     ilocals_3_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(889);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1755229011, 0);
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L472146846, 0);
...
label_L472146846:
    ...
    SP++;
    PUSH_INT(500);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1553033411, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    PUSH_INT(2); /* ICONST_2 */
...
label_L1071901619:
    ...
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1461257215, 0);
    ...
    SP--;
    switch((*SP).data.i) {
        case 37: JUMP_TO(label_L1755226641, 0);
        case 43: JUMP_TO(label_L1058937009, 0);
        default: JUMP_TO(label_L1920853072, 0);
    }

label_L1058937009:
    __CN1_DEBUG_INFO(902);
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1843660571, 0);
...
label_L1886891676:
    ...
    JUMP_TO(label_L1071901619, 0);

label_L1755226641:
 tryBlockOffsetL1755226641cn1_class_id_java_lang_NumberFormatException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1755226641cn1_class_id_java_lang_NumberFormatException2);
    restoreToL1755226641cn1_class_id_java_lang_NumberFormatException2 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(913);
    if (locals[8].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L581031803, 1);
...
label_L587108575:
    ...
    if ((ilocals_6_ + 2 /* ICONST_2 */)>=ilocals_4_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1865470187, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_7_; 
    SP++;
    PUSH_INT(37);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1865470187, 1);
    ...
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L587108575, 1);
    __CN1_DEBUG_INFO(923);
    /* VarOp.assignFrom */ ilocals_7_ = /* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[0].data.o, ilocals_6_);
    JUMP_TO(label_L587108575, 1);

label_L1865470187:
    __CN1_DEBUG_INFO(927);
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L39864640, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_7_; 
    SP++;
    PUSH_INT(37);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L39864640, 1);
...
label_L39864640:
 tryBlockOffsetL39864640cn1_class_id_java_io_UnsupportedEncodingException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_UnsupportedEncodingException, catch_L39864640cn1_class_id_java_io_UnsupportedEncodingException1);
    restoreToL39864640cn1_class_id_java_io_UnsupportedEncodingException1 = threadStateData->threadObjectStackOffset;
...
label_L1461257215:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L287735431, 0);
...
label_L2015874556:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L294395818;
    ...
    SP++;
    PUSH_INT(65);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L228963439;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_6_; 
    SP++;
    PUSH_INT(90);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L161445348;
...
label_L228963439:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L728756246;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_6_; 
    SP++;
    PUSH_INT(122);
...
label_L728756246:
    ...
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1525668766;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_6_; 
    SP++;
    PUSH_INT(57);
...
label_L1525668766:
    ...
    SP++;
    PUSH_INT(45);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L161445348;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_6_; 
    SP++;
    PUSH_INT(95);
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(-1); /* ICONST_M1 */
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L161445348;
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2051611232;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[2].data.o, ilocals_6_)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L2051611232;
...
label_L2051611232:
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1546706639;
...
JAVA_VOID com_codename1_io_Util_appendHex___java_lang_StringBuilder_char(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_CHAR __cn1Arg2) {
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L896185192;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(127);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L896185192;
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L865660178;
...
label_L896185192:
    ...
    SP++;
    PUSH_INT(2047);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L206921246;
...
JAVA_OBJECT com_codename1_io_Util_relativeToAbsolute___java_lang_String_java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(18))==0) /* IFEQ CustomJump */ goto label_L1725904428;
...
JAVA_OBJECT com_codename1_io_Util_getURLProtocol___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_1_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L307996568;
...
JAVA_OBJECT com_codename1_io_Util_getURLHost___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_2_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L878231139;
...
JAVA_OBJECT com_codename1_io_Util_getURLPath___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_1_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L1136787778;
...
JAVA_OBJECT com_codename1_io_Util_getURLBasePath___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_1_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L1555243328;
    if (ilocals_2_<=ilocals_1_) /* IF_ICMPLE CustomJump */ goto label_L1555243328;
...
JAVA_VOID com_codename1_io_Util_readFully___java_io_InputStream_byte_1ARRAY_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    if (ilocals_3_>=0) /* IFGE CustomJump */ goto label_L836432020;
...
label_L1436581783:
    ...
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1948679886;
    ...
    if (ilocals_5_>=0) /* IFGE CustomJump */ goto label_L1042700305;
...
label_L2028313348:
    ...
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L865627111;
    ...
    if (ilocals_4_>=0) /* IFGE CustomJump */ goto label_L1955570516;
...
label_L1591250481:
    ...
    if (ilocals_3_<0) /* IFLT CustomJump */ goto label_L779034440;
...
label_L61710314:
    if (ilocals_5_>=virtual_java_util_Vector_size___R_int(threadStateData, locals[2].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1464079293;
...
JAVA_VOID com_codename1_io_Util_wait___java_lang_Object_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    int restoreToL179572972cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL179572972cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L179572972cn1_class_id_java_lang_InterruptedException1, label_L1987377620, restoreToL179572972cn1_class_id_java_lang_InterruptedException1);
    int restoreToL17957297202;
    int tryBlockOffsetL17957297202;
    DEFINE_CATCH_BLOCK(catch_L17957297202, label_L1264380765, restoreToL17957297202);
    int restoreToL126438076503;
    int tryBlockOffsetL126438076503;
    DEFINE_CATCH_BLOCK(catch_L126438076503, label_L1264380765, restoreToL126438076503);
...
label_L179572972:
 tryBlockOffsetL17957297202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L17957297202);
    restoreToL17957297202 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL179572972cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L179572972cn1_class_id_java_lang_InterruptedException1);
    restoreToL179572972cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L1707097883:
END_TRY(1);    JUMP_TO(label_L2091447767, 0);

label_L1264380765:
 tryBlockOffsetL126438076503 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L126438076503);
    restoreToL126438076503 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_io_Util_wait___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    int restoreToL2085495512cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL2085495512cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L2085495512cn1_class_id_java_lang_InterruptedException1, label_L767760847, restoreToL2085495512cn1_class_id_java_lang_InterruptedException1);
    int restoreToL208549551202;
    int tryBlockOffsetL208549551202;
    DEFINE_CATCH_BLOCK(catch_L208549551202, label_L23660841, restoreToL208549551202);
    int restoreToL2366084103;
    int tryBlockOffsetL2366084103;
    DEFINE_CATCH_BLOCK(catch_L2366084103, label_L23660841, restoreToL2366084103);
...
label_L2085495512:
 tryBlockOffsetL208549551202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L208549551202);
    restoreToL208549551202 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL2085495512cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L2085495512cn1_class_id_java_lang_InterruptedException1);
    restoreToL2085495512cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L2105678809:
END_TRY(1);    JUMP_TO(label_L267331432, 0);

label_L23660841:
 tryBlockOffsetL2366084103 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L2366084103);
    restoreToL2366084103 = threadStateData->threadObjectStackOffset;
...
JAVA_BOOLEAN com_codename1_io_Util_toBooleanValue___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L978799163;
...
label_L978799163:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Boolean);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1933458457;
...
label_L1933458457:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1410894140;
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2299))!=0) /* IFNE CustomJump */ goto label_L582627504;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2300))==0) /* IFEQ CustomJump */ goto label_L582787150;

label_L582627504:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L543198964;
...
label_L1410894140:
    ...
    if (/* CustomInvoke */com_codename1_io_Util_toIntValue___java_lang_Object_R_int(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L815903405;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1131228089;
...
JAVA_INT com_codename1_io_Util_toIntValue___java_lang_Object_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L68439370;
...
label_L68439370:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Integer);
    if(POP_INT() == 0) /* IFEQ */ goto label_L539452434;
...
label_L539452434:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ goto label_L497983073;
    __CN1_DEBUG_INFO(1685);
    /* VarOp.assignFrom */ locals[1].type=CN1_TYPE_INVALID;    locals[1].data.o = locals[0].data.o;
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1686);
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L934563470;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(615))==0) /* IFEQ CustomJump */ goto label_L300690223;
...
label_L497983073:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Double);
    if(POP_INT() == 0) /* IFEQ */ goto label_L175168244;
...
label_L175168244:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Float);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1665400909;
...
label_L1665400909:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Long);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1980883605;
...
label_L1980883605:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Boolean);
    if(POP_INT() == 0) /* IFEQ */ goto label_L114559531;
    __CN1_DEBUG_INFO(1707);
    /* VarOp.assignFrom */ locals[1].type=CN1_TYPE_INVALID;    locals[1].data.o = locals[0].data.o;
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1708);
    if (virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L176150399;
...
JAVA_LONG com_codename1_io_Util_toLongValue___java_lang_Object_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Long);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1241184277;
...
label_L1241184277:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Integer);
    if(POP_INT() == 0) /* IFEQ */ goto label_L805744373;
...
label_L805744373:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ goto label_L371556236;
...
label_L371556236:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Double);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1645577752;
...
label_L1645577752:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Float);
    if(POP_INT() == 0) /* IFEQ */ goto label_L2083643423;
...
label_L2083643423:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_util_Date);
    if(POP_INT() == 0) /* IFEQ */ goto label_L2034604138;
...
label_L2034604138:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Boolean);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1143034321;
    __CN1_DEBUG_INFO(1748);
    /* VarOp.assignFrom */ locals[1].type=CN1_TYPE_INVALID;    locals[1].data.o = locals[0].data.o;
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1749);
    if (virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L181021195;
...
label_L2030568021:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Long);
    if(POP_INT() == 0) /* IFEQ */ goto label_L752571350;
...
label_L752571350:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Integer);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1656369221;
...
label_L1656369221:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ goto label_L964416619;
...
label_L964416619:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Double);
    if(POP_INT() == 0) /* IFEQ */ goto label_L14181307;
...
label_L14181307:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Boolean);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1995167125;
    __CN1_DEBUG_INFO(1786);
    /* VarOp.assignFrom */ locals[1].type=CN1_TYPE_INVALID;    locals[1].data.o = locals[0].data.o;
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1787);
    if (virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1163979541;
...
label_L1641667861:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Long);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1228340166;
...
label_L1228340166:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_Integer);
    if(POP_INT() == 0) /* IFEQ */ goto label_L189565366;
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1825);
    if (virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L100550728;
...
JAVA_OBJECT com_codename1_io_Util_toDateValue___java_lang_Object_R_java_util_Date(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    int restoreToL646297172cn1_class_id_com_codename1_l10n_ParseException1;
    int tryBlockOffsetL646297172cn1_class_id_com_codename1_l10n_ParseException1;
    DEFINE_CATCH_BLOCK(catch_L646297172cn1_class_id_com_codename1_l10n_ParseException1, label_L1787846776, restoreToL646297172cn1_class_id_com_codename1_l10n_ParseException1);
    int restoreToL140425810cn1_class_id_com_codename1_l10n_ParseException2;
    int tryBlockOffsetL140425810cn1_class_id_com_codename1_l10n_ParseException2;
    DEFINE_CATCH_BLOCK(catch_L140425810cn1_class_id_com_codename1_l10n_ParseException2, label_L265668598, restoreToL140425810cn1_class_id_com_codename1_l10n_ParseException2);
    __CN1_DEBUG_INFO(1849);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L925150096, 0);
...
label_L925150096:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_util_Date);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1089411380, 0);
...
label_L1089411380:
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L689251057, 0);
    __CN1_DEBUG_INFO(1856);
    if (get_static_com_codename1_io_Util_dateFormatter(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L140425810, 0);

label_L646297172:
 tryBlockOffsetL646297172cn1_class_id_com_codename1_l10n_ParseException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_com_codename1_l10n_ParseException, catch_L646297172cn1_class_id_com_codename1_l10n_ParseException1);
    restoreToL646297172cn1_class_id_com_codename1_l10n_ParseException1 = threadStateData->threadObjectStackOffset;
...
label_L140425810:
 tryBlockOffsetL140425810cn1_class_id_com_codename1_l10n_ParseException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_com_codename1_l10n_ParseException, catch_L140425810cn1_class_id_com_codename1_l10n_ParseException2);
    restoreToL140425810cn1_class_id_com_codename1_l10n_ParseException2 = threadStateData->threadObjectStackOffset;
