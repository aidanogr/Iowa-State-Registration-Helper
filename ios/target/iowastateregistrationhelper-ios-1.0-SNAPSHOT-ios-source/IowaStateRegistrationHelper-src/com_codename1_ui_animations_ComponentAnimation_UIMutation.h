...
#define virtual_com_codename1_ui_animations_ComponentAnimation_UIMutation_isLocked___R_boolean com_codename1_ui_animations_ComponentAnimation_UIMutation_isLocked___R_boolean
