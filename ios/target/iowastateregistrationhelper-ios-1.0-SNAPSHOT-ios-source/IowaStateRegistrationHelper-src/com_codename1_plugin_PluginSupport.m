...
JAVA_OBJECT com_codename1_plugin_PluginSupport_firePluginEvent___com_codename1_plugin_event_PluginEvent_R_com_codename1_plugin_event_PluginEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    int restoreToL170574026001;
    int tryBlockOffsetL170574026001;
    DEFINE_CATCH_BLOCK(catch_L170574026001, label_L741827681, restoreToL170574026001);
    int restoreToL74182768102;
    int tryBlockOffsetL74182768102;
    DEFINE_CATCH_BLOCK(catch_L74182768102, label_L741827681, restoreToL74182768102);
    __CN1_DEBUG_INFO(73);
    BC_ALOAD(0);
...
label_L1705740260:
 tryBlockOffsetL170574026001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L170574026001);
    restoreToL170574026001 = threadStateData->threadObjectStackOffset;
...
label_L1085543872:
END_TRY(1);    JUMP_TO(label_L656689800, 0);

label_L741827681:
 tryBlockOffsetL74182768102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L74182768102);
    restoreToL74182768102 = threadStateData->threadObjectStackOffset;
...
label_L2107660410:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L78081168, 0);
    ...
    if (virtual_com_codename1_plugin_event_PluginEvent_isConsumed___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1780694323, 0);
    __CN1_DEBUG_INFO(78);
