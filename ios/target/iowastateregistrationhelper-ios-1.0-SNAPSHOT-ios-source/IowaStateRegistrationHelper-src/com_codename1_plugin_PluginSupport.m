...
JAVA_OBJECT com_codename1_plugin_PluginSupport_firePluginEvent___com_codename1_plugin_event_PluginEvent_R_com_codename1_plugin_event_PluginEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    int restoreToL188955279701;
    int tryBlockOffsetL188955279701;
    DEFINE_CATCH_BLOCK(catch_L188955279701, label_L2144584587, restoreToL188955279701);
    int restoreToL214458458702;
    int tryBlockOffsetL214458458702;
    DEFINE_CATCH_BLOCK(catch_L214458458702, label_L2144584587, restoreToL214458458702);
    __CN1_DEBUG_INFO(73);
    BC_ALOAD(0);
...
label_L1889552797:
 tryBlockOffsetL188955279701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L188955279701);
    restoreToL188955279701 = threadStateData->threadObjectStackOffset;
...
label_L2064702302:
END_TRY(1);    JUMP_TO(label_L656805788, 0);

label_L2144584587:
 tryBlockOffsetL214458458702 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L214458458702);
    restoreToL214458458702 = threadStateData->threadObjectStackOffset;
...
label_L903151311:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L620961748, 0);
    ...
    if (virtual_com_codename1_plugin_event_PluginEvent_isConsumed___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1425711168, 0);
    __CN1_DEBUG_INFO(78);
