...
JAVA_OBJECT com_codename1_plugin_PluginSupport_firePluginEvent___com_codename1_plugin_event_PluginEvent_R_com_codename1_plugin_event_PluginEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    int restoreToL40091382001;
    int tryBlockOffsetL40091382001;
    DEFINE_CATCH_BLOCK(catch_L40091382001, label_L1202261290, restoreToL40091382001);
    int restoreToL120226129002;
    int tryBlockOffsetL120226129002;
    DEFINE_CATCH_BLOCK(catch_L120226129002, label_L1202261290, restoreToL120226129002);
    __CN1_DEBUG_INFO(73);
    BC_ALOAD(0);
...
label_L400913820:
 tryBlockOffsetL40091382001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L40091382001);
    restoreToL40091382001 = threadStateData->threadObjectStackOffset;
...
label_L387675565:
END_TRY(1);    JUMP_TO(label_L881883721, 0);

label_L1202261290:
 tryBlockOffsetL120226129002 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L120226129002);
    restoreToL120226129002 = threadStateData->threadObjectStackOffset;
...
label_L363717234:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1267504937, 0);
    ...
    if (virtual_com_codename1_plugin_event_PluginEvent_isConsumed___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L451046489, 0);
    __CN1_DEBUG_INFO(78);
