...
JAVA_INT get_field_com_codename1_ui_TextArea_4_val_keyEvent(JAVA_OBJECT __cn1T) {
  return (*(struct obj__com_codename1_ui_TextArea_4*)__cn1T).com_codename1_ui_TextArea_4_val_keyEvent;
}

void set_field_com_codename1_ui_TextArea_4_val_keyEvent(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Val, JAVA_OBJECT __cn1T) {
    (*(struct obj__com_codename1_ui_TextArea_4*)__cn1T).com_codename1_ui_TextArea_4_val_keyEvent = __cn1Val;
}
...
JAVA_VOID com_codename1_ui_TextArea_4___INIT_____com_codename1_ui_TextArea_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    set_field_com_codename1_ui_TextArea_4_val_keyEvent(threadStateData, ilocals_2_, __cn1ThisObject);
