...
class_array1__com_codename1_ui_animations_Animation.vtable = initVtableForInterface();
    ...
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_ogradytech_registration_gui_InfoDialog] = malloc(sizeof(int*) * 14);
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_ogradytech_registration_gui_InfoDialog][0] = 10;
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_ogradytech_registration_gui_InfoDialog][1] = 11;
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_ogradytech_registration_gui_ConflictInfoButton] = malloc(sizeof(int*) * 14);
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_ogradytech_registration_gui_ConflictInfoButton][0] = 10;
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_ogradytech_registration_gui_ConflictInfoButton][1] = 11;
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_ogradytech_registration_gui_DropdownContainer] = malloc(sizeof(int*) * 14);
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_ogradytech_registration_gui_DropdownContainer][0] = 10;
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_ogradytech_registration_gui_DropdownContainer][1] = 11;
    ...
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_codename1_ui_animations_Timeline][0] = 48;
    classToInterfaceMap_com_codename1_ui_animations_Animation[cn1_class_id_com_codename1_ui_animations_Timeline][1] = 56;
