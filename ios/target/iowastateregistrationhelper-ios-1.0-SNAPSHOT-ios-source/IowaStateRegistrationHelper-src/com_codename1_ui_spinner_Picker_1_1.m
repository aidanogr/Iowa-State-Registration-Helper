...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(654);
    ...
    if (get_field_com_codename1_ui_spinner_Picker_1_1_keyListener(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L488654523;
...
JAVA_VOID com_codename1_ui_spinner_Picker_1_1_deinitialize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L993263609;
...
label_L993263609:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L265845794;
    if (get_field_com_codename1_ui_spinner_Picker_1_1_keyListener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L265845794;
