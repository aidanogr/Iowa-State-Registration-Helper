...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_4___INIT_____com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9642, 200);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_4_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 9642, 202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL171218050301;
    int tryBlockOffsetL171218050301;
    DEFINE_CATCH_BLOCK(catch_L171218050301, label_L1266093632, restoreToL171218050301);
    __CN1_DEBUG_INFO(639);
    if (get_field_com_codename1_impl_ios_IOSImplementation_4_val_current(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2028036437, 0);
    __CN1_DEBUG_INFO(640);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2028036437, 0);
...
label_L1712180503:
 tryBlockOffsetL171218050301 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L171218050301);
    restoreToL171218050301 = threadStateData->threadObjectStackOffset;
...
label_L118722760:
END_TRY(1);    __CN1_DEBUG_INFO(645);
