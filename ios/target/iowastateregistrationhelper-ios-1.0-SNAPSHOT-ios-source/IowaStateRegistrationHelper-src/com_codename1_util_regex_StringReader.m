...
JAVA_INT com_codename1_util_regex_StringReader_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_util_regex_StringReader_pointer(__cn1ThisObject)<virtual_java_lang_String_length___R_int(threadStateData, get_field_com_codename1_util_regex_StringReader_str(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L1836544723;
    __CN1_DEBUG_INFO(38);
...
JAVA_INT com_codename1_util_regex_StringReader_read___char_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __CN1_DEBUG_INFO(44);
    if (get_field_com_codename1_util_regex_StringReader_pointer(__cn1ThisObject)<virtual_java_lang_String_length___R_int(threadStateData, get_field_com_codename1_util_regex_StringReader_str(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L943279734;
    __CN1_DEBUG_INFO(45);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return -1 /* ICONST_M1 */;
...
label_L1526441996:
    if (ilocals_6_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L936634176;
    if (get_field_com_codename1_util_regex_StringReader_pointer(__cn1ThisObject)>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L936634176;
    __CN1_DEBUG_INFO(50);
    BC_ALOAD(1);
