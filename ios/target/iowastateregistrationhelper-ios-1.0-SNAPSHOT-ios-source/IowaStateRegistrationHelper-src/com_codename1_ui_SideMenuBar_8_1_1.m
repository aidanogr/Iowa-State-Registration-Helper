...
JAVA_VOID com_codename1_ui_SideMenuBar_8_1_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1354893604cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL1354893604cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L1354893604cn1_class_id_java_lang_Exception1, label_L1679352734, restoreToL1354893604cn1_class_id_java_lang_Exception1);
...
label_L497104907:
    ...
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L56840345, 0);

label_L1354893604:
 tryBlockOffsetL1354893604cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1354893604cn1_class_id_java_lang_Exception1);
    restoreToL1354893604cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
