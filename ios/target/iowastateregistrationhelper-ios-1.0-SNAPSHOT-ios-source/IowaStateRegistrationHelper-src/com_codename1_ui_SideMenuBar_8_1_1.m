...
JAVA_VOID com_codename1_ui_SideMenuBar_8_1_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_CATCH_BLOCK(catch_L392546893cn1_class_id_java_lang_Exception1, label_L1139605173, restoreToL392546893cn1_class_id_java_lang_Exception1);
...
label_L1402211887:
    ...
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L1374664497, 0);
