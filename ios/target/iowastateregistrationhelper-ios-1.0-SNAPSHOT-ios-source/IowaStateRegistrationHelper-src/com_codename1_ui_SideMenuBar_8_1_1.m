...
JAVA_VOID com_codename1_ui_SideMenuBar_8_1_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL445801139cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL445801139cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L445801139cn1_class_id_java_lang_Exception1, label_L1043822951, restoreToL445801139cn1_class_id_java_lang_Exception1);
...
label_L1887326180:
    ...
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L1303238288, 0);

label_L445801139:
 tryBlockOffsetL445801139cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L445801139cn1_class_id_java_lang_Exception1);
    restoreToL445801139cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
