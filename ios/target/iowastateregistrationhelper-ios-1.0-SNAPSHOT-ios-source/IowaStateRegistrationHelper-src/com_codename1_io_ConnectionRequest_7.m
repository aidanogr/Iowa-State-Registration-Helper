...
JAVA_VOID com_codename1_io_ConnectionRequest_7_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL2025536049cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL2025536049cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L2025536049cn1_class_id_java_lang_Exception1, label_L1294962407, restoreToL2025536049cn1_class_id_java_lang_Exception1);
    int restoreToL64631757cn1_class_id_java_lang_Exception2;
    int tryBlockOffsetL64631757cn1_class_id_java_lang_Exception2;
    DEFINE_CATCH_BLOCK(catch_L64631757cn1_class_id_java_lang_Exception2, label_L1497258319, restoreToL64631757cn1_class_id_java_lang_Exception2);
    __CN1_DEBUG_INFO(2796);
    if (virtual_com_codename1_io_ConnectionRequest_getDestinationFile___R_java_lang_String(threadStateData, get_field_com_codename1_io_ConnectionRequest_7_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L975069095, 0);
    ...
    if (/* CustomInvoke */virtual_com_codename1_io_FileSystemStorage_exists___java_lang_String_R_boolean(threadStateData, locals[2].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2020015678, 0);

label_L2025536049:
 tryBlockOffsetL2025536049cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L2025536049cn1_class_id_java_lang_Exception1);
    restoreToL2025536049cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1234116451, 1);
...
label_L975069095:
    if (virtual_com_codename1_io_ConnectionRequest_getDestinationStorage___R_java_lang_String(threadStateData, get_field_com_codename1_io_ConnectionRequest_7_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L712723382, 0);
    ...
    if (/* CustomInvoke */virtual_com_codename1_io_Storage_exists___java_lang_String_R_boolean(threadStateData, locals[2].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1705236425, 0);

label_L64631757:
 tryBlockOffsetL64631757cn1_class_id_java_lang_Exception2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L64631757cn1_class_id_java_lang_Exception2);
    restoreToL64631757cn1_class_id_java_lang_Exception2 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1416013849, 1);
