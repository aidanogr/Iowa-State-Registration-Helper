...
class_array1__com_codename1_ui_events_ActionListener.vtable = initVtableForInterface();
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_ogradytech_registration_gui_CalendarContainer__Lambda_4] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_ogradytech_registration_gui_CalendarContainer__Lambda_4][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_ogradytech_registration_gui_CalendarContainer__Lambda_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_ogradytech_registration_gui_CalendarContainer__Lambda_2][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_ogradytech_registration_gui_CalendarContainer__Lambda_3] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_ogradytech_registration_gui_CalendarContainer__Lambda_3][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_ogradytech_registration_gui_CalendarContainer__Lambda_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_ogradytech_registration_gui_CalendarContainer__Lambda_1][0] = 10;
