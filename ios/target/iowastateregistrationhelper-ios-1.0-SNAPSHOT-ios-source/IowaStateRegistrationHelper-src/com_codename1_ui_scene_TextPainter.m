...
JAVA_VOID com_codename1_ui_scene_TextPainter_paint___com_codename1_ui_Graphics_com_codename1_ui_geom_Rectangle_com_codename1_ui_scene_Node(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1537436803;
    __CN1_DEBUG_INFO(59);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
...
label_L1537436803:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1396835114;
    __CN1_DEBUG_INFO(63);
...
label_L1396835114:
    ...
    SP--;
    switch((*SP).data.i) {
        case 3: goto label_L597531831;
        case 4: goto label_L1513467522;
        default: goto label_L447878707;
    }
...
label_L447878707:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L1504320796;
        case 4: goto label_L379407034;
        default: goto label_L1630254933;
    }
