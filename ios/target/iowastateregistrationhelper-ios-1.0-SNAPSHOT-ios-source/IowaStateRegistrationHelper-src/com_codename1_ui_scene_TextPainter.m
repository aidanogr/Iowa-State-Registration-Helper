...
JAVA_VOID com_codename1_ui_scene_TextPainter_paint___com_codename1_ui_Graphics_com_codename1_ui_geom_Rectangle_com_codename1_ui_scene_Node(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2140427291;
    __CN1_DEBUG_INFO(59);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
...
label_L2140427291:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2079042829;
    __CN1_DEBUG_INFO(63);
...
label_L2079042829:
    ...
    SP--;
    switch((*SP).data.i) {
        case 3: goto label_L1816986148;
        case 4: goto label_L1864856331;
        default: goto label_L852412024;
    }
...
label_L852412024:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L350983913;
        case 4: goto label_L280226418;
        default: goto label_L1146649668;
    }
