...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NetworkConnection_setInsecure___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L7548983;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NetworkConnection_ensureConnection__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL177953925cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL177953925cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L177953925cn1_class_id_java_lang_InterruptedException1, label_L1999135802, restoreToL177953925cn1_class_id_java_lang_InterruptedException1);
    int restoreToL1783578100cn1_class_id_java_io_IOException2;
    int tryBlockOffsetL1783578100cn1_class_id_java_io_IOException2;
    DEFINE_CATCH_BLOCK(catch_L1783578100cn1_class_id_java_io_IOException2, label_L52487168, restoreToL1783578100cn1_class_id_java_io_IOException2);
    int restoreToL1998166040cn1_class_id_java_lang_InterruptedException3;
    int tryBlockOffsetL1998166040cn1_class_id_java_lang_InterruptedException3;
    DEFINE_CATCH_BLOCK(catch_L1998166040cn1_class_id_java_lang_InterruptedException3, label_L85357160, restoreToL1998166040cn1_class_id_java_lang_InterruptedException3);
    int restoreToL25408906604;
    int tryBlockOffsetL25408906604;
    DEFINE_CATCH_BLOCK(catch_L25408906604, label_L486348917, restoreToL25408906604);
    int restoreToL68371824405;
    int tryBlockOffsetL68371824405;
    DEFINE_CATCH_BLOCK(catch_L68371824405, label_L486348917, restoreToL68371824405);
    int restoreToL74267228006;
    int tryBlockOffsetL74267228006;
    DEFINE_CATCH_BLOCK(catch_L74267228006, label_L486348917, restoreToL74267228006);
    int restoreToL48634891707;
    int tryBlockOffsetL48634891707;
    DEFINE_CATCH_BLOCK(catch_L48634891707, label_L486348917, restoreToL48634891707);
...
label_L254089066:
 tryBlockOffsetL25408906604 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L25408906604);
    restoreToL25408906604 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(7218);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_connected(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L683718244, 0);
...
label_L683718244:
 tryBlockOffsetL68371824405 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L68371824405);
    restoreToL68371824405 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(7221);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_ensureConnectionLock(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L742672280, 0);

label_L1857910993:
    __CN1_DEBUG_INFO(7222);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_ensureConnectionLock(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L452457802, 1);

label_L177953925:
 tryBlockOffsetL177953925cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L177953925cn1_class_id_java_lang_InterruptedException1);
    restoreToL177953925cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L742672280:
 tryBlockOffsetL74267228006 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L74267228006);
    restoreToL74267228006 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_body(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1130598644, 1);

label_L1783578100:
 tryBlockOffsetL1783578100cn1_class_id_java_io_IOException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1783578100cn1_class_id_java_io_IOException2);
    restoreToL1783578100cn1_class_id_java_io_IOException2 = threadStateData->threadObjectStackOffset;
...
label_L1293252487:
    ...
    if (virtual_com_codename1_impl_ios_IOSImplementation_FileBackedOutputStream_isBackedByFile___R_boolean(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_body(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1760401098, 1);
...
label_L841537936:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_connected(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1829966070, 1);

label_L1998166040:
 tryBlockOffsetL1998166040cn1_class_id_java_lang_InterruptedException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1998166040cn1_class_id_java_lang_InterruptedException3);
    restoreToL1998166040cn1_class_id_java_lang_InterruptedException3 = threadStateData->threadObjectStackOffset;
...
label_L1829966070:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_error(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1424439581, 1);
...
label_L486348917:
 tryBlockOffsetL48634891707 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L48634891707);
    restoreToL48634891707 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NetworkConnection___INIT_____long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    int restoreToL85673450401;
    int tryBlockOffsetL85673450401;
    DEFINE_CATCH_BLOCK(catch_L85673450401, label_L626626764, restoreToL85673450401);
...
label_L856734504:
 tryBlockOffsetL85673450401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L85673450401);
    restoreToL85673450401 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NetworkConnection_streamComplete__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL136828862001;
    int tryBlockOffsetL136828862001;
    DEFINE_CATCH_BLOCK(catch_L136828862001, label_L1015799131, restoreToL136828862001);
    int restoreToL101579913102;
    int tryBlockOffsetL101579913102;
    DEFINE_CATCH_BLOCK(catch_L101579913102, label_L1015799131, restoreToL101579913102);
...
label_L1368288620:
 tryBlockOffsetL136828862001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L136828862001);
    restoreToL136828862001 = threadStateData->threadObjectStackOffset;
...
label_L672113729:
END_TRY(1);    JUMP_TO(label_L701681793, 0);

label_L1015799131:
 tryBlockOffsetL101579913102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L101579913102);
    restoreToL101579913102 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_impl_ios_IOSImplementation_NetworkConnection_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL554997084cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL554997084cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L554997084cn1_class_id_java_lang_InterruptedException1, label_L1088744071, restoreToL554997084cn1_class_id_java_lang_InterruptedException1);
    int restoreToL114789292102;
    int tryBlockOffsetL114789292102;
    DEFINE_CATCH_BLOCK(catch_L114789292102, label_L1484275564, restoreToL114789292102);
    int restoreToL8512132303;
    int tryBlockOffsetL8512132303;
    DEFINE_CATCH_BLOCK(catch_L8512132303, label_L1484275564, restoreToL8512132303);
    int restoreToL98115999704;
    int tryBlockOffsetL98115999704;
    DEFINE_CATCH_BLOCK(catch_L98115999704, label_L1484275564, restoreToL98115999704);
    int restoreToL148427556405;
    int tryBlockOffsetL148427556405;
    DEFINE_CATCH_BLOCK(catch_L148427556405, label_L1484275564, restoreToL148427556405);
...
label_L1147892921:
 tryBlockOffsetL114789292102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L114789292102);
    restoreToL114789292102 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(7304);
    if (virtual_com_codename1_impl_ios_IOSImplementation_NetworkConnection_available___R_int(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L981159997, 0);
    __CN1_DEBUG_INFO(7305);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_completed(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L85121323, 0);
...
label_L85121323:
 tryBlockOffsetL8512132303 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L8512132303);
    restoreToL8512132303 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(7309);
    if (virtual_com_codename1_impl_ios_IOSImplementation_NetworkConnection_available___R_int(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L981159997, 0);

label_L554997084:
 tryBlockOffsetL554997084cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L554997084cn1_class_id_java_lang_InterruptedException1);
    restoreToL554997084cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L1657125852:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_error(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2078239671, 1);
...
label_L2078239671:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_completed(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L85121323, 0);
    if (virtual_com_codename1_impl_ios_IOSImplementation_NetworkConnection_available___R_int(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L85121323, 0);
...
label_L981159997:
 tryBlockOffsetL98115999704 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L98115999704);
    restoreToL98115999704 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_error(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L465909321, 1);
...
label_L1484275564:
 tryBlockOffsetL148427556405 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L148427556405);
    restoreToL148427556405 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_impl_ios_IOSImplementation_NetworkConnection_available___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_error(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L143486875;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NetworkConnection_close__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL204489783701;
    int tryBlockOffsetL204489783701;
    DEFINE_CATCH_BLOCK(catch_L204489783701, label_L1205419533, restoreToL204489783701);
    int restoreToL196492654202;
    int tryBlockOffsetL196492654202;
    DEFINE_CATCH_BLOCK(catch_L196492654202, label_L1205419533, restoreToL196492654202);
    int restoreToL120541953303;
    int tryBlockOffsetL120541953303;
    DEFINE_CATCH_BLOCK(catch_L120541953303, label_L1205419533, restoreToL120541953303);
    int restoreToL189241907304;
    int tryBlockOffsetL189241907304;
    DEFINE_CATCH_BLOCK(catch_L189241907304, label_L1197176722, restoreToL189241907304);
    int restoreToL119717672205;
    int tryBlockOffsetL119717672205;
    DEFINE_CATCH_BLOCK(catch_L119717672205, label_L1197176722, restoreToL119717672205);
...
label_L2044897837:
 tryBlockOffsetL204489783701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L204489783701);
    restoreToL204489783701 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(7363);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_closed(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1964926542, 0);
...
label_L1964926542:
 tryBlockOffsetL196492654202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L196492654202);
    restoreToL196492654202 = threadStateData->threadObjectStackOffset;
...
label_L1974252326:
END_TRY(1);    JUMP_TO(label_L369901249, 0);

label_L1205419533:
 tryBlockOffsetL120541953303 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L120541953303);
    restoreToL120541953303 = threadStateData->threadObjectStackOffset;
...
label_L1892419073:
 tryBlockOffsetL189241907304 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L189241907304);
    restoreToL189241907304 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_body(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L405488475, 1);
    if (virtual_com_codename1_impl_ios_IOSImplementation_FileBackedOutputStream_isBackedByFile___R_boolean(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_body(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L405488475, 1);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L405488475, 1);
...
label_L1260889084:
END_TRY(1);    JUMP_TO(label_L80756779, 0);

label_L1197176722:
 tryBlockOffsetL119717672205 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L119717672205);
    restoreToL119717672205 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_impl_ios_IOSImplementation_NetworkConnection_read___byte_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    int restoreToL1233398797cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1233398797cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1233398797cn1_class_id_java_lang_InterruptedException1, label_L49969897, restoreToL1233398797cn1_class_id_java_lang_InterruptedException1);
    int restoreToL108858653202;
    int tryBlockOffsetL108858653202;
    DEFINE_CATCH_BLOCK(catch_L108858653202, label_L1970779713, restoreToL108858653202);
    int restoreToL82757990003;
    int tryBlockOffsetL82757990003;
    DEFINE_CATCH_BLOCK(catch_L82757990003, label_L1970779713, restoreToL82757990003);
    int restoreToL92301367904;
    int tryBlockOffsetL92301367904;
    DEFINE_CATCH_BLOCK(catch_L92301367904, label_L1970779713, restoreToL92301367904);
    int restoreToL197077971305;
    int tryBlockOffsetL197077971305;
    DEFINE_CATCH_BLOCK(catch_L197077971305, label_L1970779713, restoreToL197077971305);
...
label_L1088586532:
 tryBlockOffsetL108858653202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L108858653202);
    restoreToL108858653202 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(7389);
    if (virtual_com_codename1_impl_ios_IOSImplementation_NetworkConnection_available___R_int(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L923013679, 0);
    __CN1_DEBUG_INFO(7390);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_completed(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L827579900, 0);
...
label_L827579900:
 tryBlockOffsetL82757990003 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L82757990003);
    restoreToL82757990003 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(7394);
    if (virtual_com_codename1_impl_ios_IOSImplementation_NetworkConnection_available___R_int(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L923013679, 0);

label_L1233398797:
 tryBlockOffsetL1233398797cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1233398797cn1_class_id_java_lang_InterruptedException1);
    restoreToL1233398797cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L1622135821:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_completed(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L827579900, 0);
    if (virtual_com_codename1_impl_ios_IOSImplementation_NetworkConnection_available___R_int(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L827579900, 0);
...
label_L923013679:
 tryBlockOffsetL92301367904 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L92301367904);
    restoreToL92301367904 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_error(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L681747431, 1);
...
label_L1970779713:
 tryBlockOffsetL197077971305 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L197077971305);
    restoreToL197077971305 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_impl_ios_IOSImplementation_NetworkConnection_getSSLCertificates___java_lang_String_R_java_lang_String_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1962165946cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL1962165946cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L1962165946cn1_class_id_java_lang_Exception1, label_L1059080630, restoreToL1962165946cn1_class_id_java_lang_Exception1);
    int restoreToL866273692cn1_class_id_java_lang_Exception2;
    int tryBlockOffsetL866273692cn1_class_id_java_lang_Exception2;
    DEFINE_CATCH_BLOCK(catch_L866273692cn1_class_id_java_lang_Exception2, label_L1059080630, restoreToL866273692cn1_class_id_java_lang_Exception2);
    int restoreToL245530164cn1_class_id_java_lang_Exception3;
    int tryBlockOffsetL245530164cn1_class_id_java_lang_Exception3;
    DEFINE_CATCH_BLOCK(catch_L245530164cn1_class_id_java_lang_Exception3, label_L1059080630, restoreToL245530164cn1_class_id_java_lang_Exception3);
    __CN1_DEBUG_INFO(7428);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_sslCertificates(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L280223635, 0);

label_L1962165946:
 tryBlockOffsetL1962165946cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1962165946cn1_class_id_java_lang_Exception1);
    restoreToL1962165946cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L245530164, 0);
    __CN1_DEBUG_INFO(7437);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NetworkConnection_sslCertificates(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L866273692, 0);
...
label_L866273692:
 tryBlockOffsetL866273692cn1_class_id_java_lang_Exception2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L866273692cn1_class_id_java_lang_Exception2);
    restoreToL866273692cn1_class_id_java_lang_Exception2 = threadStateData->threadObjectStackOffset;
...
label_L245530164:
 tryBlockOffsetL245530164cn1_class_id_java_lang_Exception3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L245530164cn1_class_id_java_lang_Exception3);
    restoreToL245530164cn1_class_id_java_lang_Exception3 = threadStateData->threadObjectStackOffset;
