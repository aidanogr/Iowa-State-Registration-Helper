...
JAVA_OBJECT com_codename1_contacts_Contact_getDisplayName___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_contacts_Contact_displayName(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1691481417;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(218), get_field_com_codename1_contacts_Contact_displayName(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L532028852;

label_L1691481417:
    __CN1_DEBUG_INFO(100);
    if (get_field_com_codename1_contacts_Contact_familyName(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L491652795;
    if (get_field_com_codename1_contacts_Contact_firstName(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L491652795;
    ...
    POP_MANY(2);
    goto label_L532028852;

label_L491652795:
    __CN1_DEBUG_INFO(102);
    if (virtual_com_codename1_contacts_Contact_getPrimaryPhoneNumber___R_java_lang_String(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L783927213;
...
label_L783927213:
    ...
    if (virtual_com_codename1_contacts_Contact_getPrimaryEmail___R_java_lang_String(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1160316046;
...
label_L1160316046:
    ...
    if (virtual_com_codename1_contacts_Contact_getFirstName___R_java_lang_String(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1792932386;
...
label_L1792932386:
    ...
    if (virtual_com_codename1_contacts_Contact_getFamilyName___R_java_lang_String(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L122376732;
...
JAVA_OBJECT com_codename1_contacts_Contact_getPrimaryEmail___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_contacts_Contact_primaryEmail(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1731160567;
    if (get_field_com_codename1_contacts_Contact_emails(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1731160567;
    ...
    if (virtual_java_util_Collection_size___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L1731160567;
...
JAVA_OBJECT com_codename1_contacts_Contact_getPrimaryPhoneNumber___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_contacts_Contact_primaryPhoneNumber(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1789861096;
    if (get_field_com_codename1_contacts_Contact_phoneNumbers(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1789861096;
    ...
    if (virtual_java_util_Collection_size___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L1789861096;
