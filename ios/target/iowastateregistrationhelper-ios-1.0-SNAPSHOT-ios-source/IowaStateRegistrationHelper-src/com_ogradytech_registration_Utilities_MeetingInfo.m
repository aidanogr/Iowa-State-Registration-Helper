...
JAVA_VOID com_ogradytech_registration_Utilities_MeetingInfo___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 7, 0, 10427, 200);
...
JAVA_VOID com_ogradytech_registration_Utilities_MeetingInfo_parseTime___java_lang_String_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 10, 0, 10427, 10428);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L1563053805:
    if (ilocals_8_>=virtual_java_lang_String_length___R_int(threadStateData, locals[5].data.o)) /* IF_ICMPGE CustomJump */ goto label_L402808045;
    __CN1_DEBUG_INFO(70);
    ...
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L332365138;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L332365138;
    __CN1_DEBUG_INFO(72);
...
label_L402808045:
    ...
    BC_ASTORE(9);
    __CN1_DEBUG_INFO(82);
    if (/* CustomInvoke */virtual_java_lang_String_contains___java_lang_CharSequence_R_boolean(threadStateData, locals[9].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(6658))==0) /* IFEQ CustomJump */ goto label_L1464177809;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    PUSH_INT(12);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1464177809;
    __CN1_DEBUG_INFO(83);
    /* VarOp.assignFrom */ ilocals_4_=(((ilocals_4_ + 12) << 16) >> 16);

label_L1464177809:
    __CN1_DEBUG_INFO(85);
    if (/* CustomInvoke */virtual_java_lang_String_contains___java_lang_CharSequence_R_boolean(threadStateData, locals[9].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(6657))==0) /* IFEQ CustomJump */ goto label_L1057507014;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    PUSH_INT(12);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1057507014;
    __CN1_DEBUG_INFO(86);
    /* VarOp.assignFrom */     ilocals_4_ = 0 /* ICONST_0 */; 

label_L1057507014:
    __CN1_DEBUG_INFO(89);
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L2007599722;
    __CN1_DEBUG_INFO(90);
...
JAVA_OBJECT com_ogradytech_registration_Utilities_MeetingInfo_getMeetingDays___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10427, 10429);
...
JAVA_SHORT com_ogradytech_registration_Utilities_MeetingInfo_getStartHour___R_short(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10427, 10430);
...
JAVA_SHORT com_ogradytech_registration_Utilities_MeetingInfo_getEndHour___R_short(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10427, 10431);
...
JAVA_SHORT com_ogradytech_registration_Utilities_MeetingInfo_getStartMinute___R_short(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10427, 10432);
...
JAVA_SHORT com_ogradytech_registration_Utilities_MeetingInfo_getEndMinute___R_short(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10427, 10433);
...
JAVA_OBJECT com_ogradytech_registration_Utilities_MeetingInfo_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 10427, 897);
    ...
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10434));     SP -= 1;
