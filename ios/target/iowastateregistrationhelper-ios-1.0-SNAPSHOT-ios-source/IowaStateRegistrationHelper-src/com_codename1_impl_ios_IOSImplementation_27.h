...
JAVA_OBJECT com_codename1_impl_ios_IOSImplementation_27_currentThread___R_java_lang_Thread(CODENAME_ONE_THREAD_STATE);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_27_sleep___long(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1);

JAVA_VOID com_codename1_impl_ios_IOSImplementation_27_start__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
#define get_static_com_codename1_impl_ios_IOSImplementation_27_MAX_PRIORITY(threadStateArgument) get_static_java_lang_Thread_MAX_PRIORITY(threadStateArgument)
#define set_static_com_codename1_impl_ios_IOSImplementation_27_MAX_PRIORITY(threadStateArgument, valueArgument) set_static_java_lang_Thread_MAX_PRIORITY(threadStateArgument, valueArgument)
#define get_static_com_codename1_impl_ios_IOSImplementation_27_MIN_PRIORITY(threadStateArgument) get_static_java_lang_Thread_MIN_PRIORITY(threadStateArgument)
#define set_static_com_codename1_impl_ios_IOSImplementation_27_MIN_PRIORITY(threadStateArgument, valueArgument) set_static_java_lang_Thread_MIN_PRIORITY(threadStateArgument, valueArgument)
#define get_static_com_codename1_impl_ios_IOSImplementation_27_NORM_PRIORITY(threadStateArgument) get_static_java_lang_Thread_NORM_PRIORITY(threadStateArgument)
#define set_static_com_codename1_impl_ios_IOSImplementation_27_NORM_PRIORITY(threadStateArgument, valueArgument) set_static_java_lang_Thread_NORM_PRIORITY(threadStateArgument, valueArgument)
