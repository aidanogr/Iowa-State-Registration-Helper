...
JAVA_VOID com_codename1_io_JSONSanitizer___INIT_____java_lang_String_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    BC_ALOAD(0);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1284775193;
    BC_ALOAD(1);
    goto label_L1380499546;
...
JAVA_VOID com_codename1_io_JSONSanitizer_sanitize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL551314014cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1;
    int tryBlockOffsetL551314014cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1;
    DEFINE_CATCH_BLOCK(catch_L551314014cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1, label_L354359092, restoreToL551314014cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1);
    int restoreToL669406950cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2;
    int tryBlockOffsetL669406950cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2;
    DEFINE_CATCH_BLOCK(catch_L669406950cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2, label_L354359092, restoreToL669406950cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2);
...
label_L1052247420:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1612610711, 0);

label_L551314014:
 tryBlockOffsetL551314014cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma, catch_L551314014cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1);
    restoreToL551314014cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma1 = threadStateData->threadObjectStackOffset;
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: JUMP_TO(label_L210688344, 1);
        case 10: JUMP_TO(label_L210688344, 1);
        case 13: JUMP_TO(label_L210688344, 1);
        case 32: JUMP_TO(label_L210688344, 1);
        case 34: JUMP_TO(label_L416322179, 1);
        case 39: JUMP_TO(label_L416322179, 1);
        case 40: JUMP_TO(label_L1964740634, 1);
        case 41: JUMP_TO(label_L1964740634, 1);
        case 44: JUMP_TO(label_L1718792426, 1);
        case 47: JUMP_TO(label_L483189093, 1);
        case 58: JUMP_TO(label_L9714933, 1);
        case 91: JUMP_TO(label_L690419645, 1);
        case 93: JUMP_TO(label_L1512109971, 1);
        case 123: JUMP_TO(label_L690419645, 1);
        case 125: JUMP_TO(label_L1512109971, 1);
        default: JUMP_TO(label_L555545211, 1);
    }
...
label_L690419645:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_isMap(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L508269970, 1);
...
label_L508269970:
    ...
    SP++;
    PUSH_INT(123);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1133143463, 1);
    PUSH_INT(1); /* ICONST_1 */
...
label_L88328327:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1978943199, 1);
...
label_L1512109971:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L669406950, 0);
...
END_TRY(1);    __CN1_DEBUG_INFO(264);
    JUMP_TO(label_L1612610711, 0);

label_L669406950:
 tryBlockOffsetL669406950cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma, catch_L669406950cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2);
    restoreToL669406950cn1_class_id_com_codename1_io_JSONSanitizer_UnbracketedComma2 = threadStateData->threadObjectStackOffset;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L1023063405, 1);
        case 2: JUMP_TO(label_L1802493587, 1);
        case 3: JUMP_TO(label_L1802493587, 1);
        case 4: JUMP_TO(label_L1372802818, 1);
        case 5: JUMP_TO(label_L1142383288, 1);
        case 6: JUMP_TO(label_L1142383288, 1);
        case 7: JUMP_TO(label_L1142383288, 1);
        case 8: JUMP_TO(label_L1142383288, 1);
        default: JUMP_TO(label_L1142383288, 1);
    }
...
label_L1142383288:
    ...
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_io_JSONSanitizer_isMap(__cn1ThisObject), get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L758113930, 1);
    PUSH_INT(125);
    JUMP_TO(label_L941702906, 1);
...
label_L941702906:
    ...
    if (ilocals_4_==ilocals_7_) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1942085027, 1);
...
label_L1942085027:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L205284289, 1);
    if (CN1_ARRAY_ELEMENT_BYTE(get_field_com_codename1_io_JSONSanitizer_isMap(__cn1ThisObject), (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject) - 1 /* ICONST_1 */))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1584779130, 1);
...
label_L1718792426:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L314771492, 1);
...
label_L314771492:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L2098086870, 1);
        case 2: JUMP_TO(label_L233852178, 1);
        case 3: JUMP_TO(label_L1971275760, 1);
        case 4: JUMP_TO(label_L1971275760, 1);
        case 5: JUMP_TO(label_L1971275760, 1);
        case 6: JUMP_TO(label_L233852178, 1);
        case 7: JUMP_TO(label_L2146952019, 1);
        case 8: JUMP_TO(label_L1885867912, 1);
        default: JUMP_TO(label_L2139051082, 1);
    }
...
label_L9714933:
    ...
    if (locals[1].data.o!=get_static_com_codename1_io_JSONSanitizer_State_AFTER_KEY(threadStateData)) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L1890638994, 1);
...
locals[1].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L5112121, 1);
...
label_L483189093:
    ...
    if ((ilocals_3_ + 1 /* ICONST_1 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L815617196, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 42: JUMP_TO(label_L3737976, 1);
        case 47: JUMP_TO(label_L90292273, 1);
        default: JUMP_TO(label_L815617196, 1);
    }
...
label_L1794130044:
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1933826115, 1);
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L698473139, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(13);
    ...
    SP++;
    PUSH_INT(8233);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1637577782, 1);
...
label_L1933826115:
    ...
    JUMP_TO(label_L815617196, 1);

label_L3737976:
    __CN1_DEBUG_INFO(351);
    /* VarOp.assignFrom */     ilocals_8_ = ilocals_2_;
    __CN1_DEBUG_INFO(352);
    if ((ilocals_3_ + 3 /* ICONST_3 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L815617196, 1);
...
label_L119282849:
    ...
    BC_DUP(); /* DUP */
    BC_ISTORE(9);
    if(POP_INT() < 0) /* IFLT */ JUMP_TO(label_L815617196, 1);
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(42);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L119282849, 1);
...
label_L673189187:
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L550451891, 1);
    ...
    (*SP).data.i = ilocals_10_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L449822808, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(122);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1918144733, 1);
...
label_L449822808:
    ...
    (*SP).data.i = ilocals_10_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L365589282, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(57);
...
label_L365589282:
    ...
    (*SP).data.i = ilocals_10_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1284098442, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(90);
...
label_L1284098442:
    ...
    SP++;
    PUSH_INT(36);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L550451891, 1);
    __CN1_DEBUG_INFO(387);
    JUMP_TO(label_L1918144733, 1);
...
label_L550451891:
    ...
    if (ilocals_9_!=ilocals_3_) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L2116330210, 1);
...
label_L942771559:
    ...
    SP++;
    PUSH_INT(45);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L311725690, 1);
...
label_L1232870776:
    ...
    if (ilocals_10_!=0) /* IFNE CustomJump */ JUMP_TO(label_L2098396037, 1);
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isKeyword___int_int_R_boolean(threadStateData, __cn1ThisObject, ilocals_3_, ilocals_9_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2098396037, 1);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1910204163, 1);
...
label_L1910204163:
    ...
    if (ilocals_10_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1191890972, 1);
    if (ilocals_11_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1191890972, 1);

label_L777588278:
    __CN1_DEBUG_INFO(406);
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1848939096, 1);
    __CN1_DEBUG_INFO(407);
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isJsonSpecialChar___int_R_boolean(threadStateData, __cn1ThisObject, ilocals_9_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L68195016, 1);
    __CN1_DEBUG_INFO(408);
    JUMP_TO(label_L1848939096, 1);
...
label_L1848939096:
    ...
    if (ilocals_9_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1191890972, 1);
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(34);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1191890972, 1);
    __CN1_DEBUG_INFO(412);
    BC_IINC(9, 1);

label_L1191890972:
    __CN1_DEBUG_INFO(416);
    if (locals[1].data.o!=get_static_com_codename1_io_JSONSanitizer_State_AFTER_KEY(threadStateData)) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L1069720017, 1);
    ...
    if (ilocals_10_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1965965859, 1);
...
label_L1069720017:
    ...
    if (ilocals_10_==0) /* IFEQ CustomJump */ JUMP_TO(label_L325488817, 1);
...
label_L1612610711:
    ...
    if (locals[1].data.o!=get_static_com_codename1_io_JSONSanitizer_State_START_ARRAY(threadStateData)) /* IF_ACMPNE CustomJump */ JUMP_TO(label_L199329503, 0);
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L199329503, 0);
...
label_L199329503:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L740654090, 0);
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L371630068, 0);

label_L740654090:
    if (get_field_com_codename1_io_JSONSanitizer_cleaned(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L371630068, 0);
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1749810089, 0);

label_L371630068:
    __CN1_DEBUG_INFO(469);
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1872453377, 0);
...
label_L1872453377:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: JUMP_TO(label_L1750711252, 0);
        case 2: JUMP_TO(label_L1243762708, 0);
        case 3: JUMP_TO(label_L1243762708, 0);
        case 4: JUMP_TO(label_L2105764938, 0);
        default: JUMP_TO(label_L1213548460, 0);
    }
...
label_L1213548460:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1836569193, 0);
    PUSH_INT(125);
...
label_L1488129598:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1393182452;
    ...
    SP--;
    switch((*SP).data.i) {
        case 10: goto label_L830477086;
        case 13: goto label_L1647799261;
        case 34: goto label_L998901309;
        case 39: goto label_L998901309;
        case 47: goto label_L976673374;
        case 92: goto label_L186595045;
        case 93: goto label_L1387253208;
        case 8232: goto label_L964661854;
        case 8233: goto label_L899111685;
        default: goto label_L1196288844;
    }
...
label_L998901309:
    ...
    if (ilocals_4_!=ilocals_1_) /* IF_ICMPNE CustomJump */ goto label_L780709176;
    __CN1_DEBUG_INFO(526);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(39);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1805660016;
...
label_L780709176:
    ...
    if ((ilocals_4_ + 1 /* ICONST_1 */)!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L558400671;
    ...
    SP++;
    PUSH_INT(39);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L158801009;
...
label_L158801009:
    ...
    if (ilocals_6_!=ilocals_5_) /* IF_ICMPNE CustomJump */ goto label_L1673947520;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L147646893;
...
label_L558400671:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1841686615;
...
label_L976673374:
    ...
    if (ilocals_4_<=ilocals_1_) /* IF_ICMPLE CustomJump */ goto label_L1805660016;
    if ((ilocals_4_ + 2 /* ICONST_2 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1805660016;
    PUSH_INT(60);
...
label_L186595045:
    ...
    if ((ilocals_4_ + 1 /* ICONST_1 */)!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L1558246666;
...
label_L1558246666:
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: goto label_L205135231;
        case 47: goto label_L205135231;
        case 48: goto label_L1666456788;
        case 49: goto label_L1666456788;
        case 50: goto label_L1666456788;
        case 51: goto label_L1666456788;
        case 52: goto label_L1666456788;
        case 53: goto label_L1666456788;
        case 54: goto label_L1666456788;
        case 55: goto label_L1666456788;
        case 92: goto label_L205135231;
        case 98: goto label_L205135231;
        case 102: goto label_L205135231;
        case 110: goto label_L205135231;
        case 114: goto label_L205135231;
        case 116: goto label_L205135231;
        case 117: goto label_L554817465;
        case 118: goto label_L2046967348;
        case 120: goto label_L638518766;
        default: goto label_L1711152967;
    }
...
label_L638518766:
    ...
    if ((ilocals_4_ + 4/* ICONST_4 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1258139742;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 2 /* ICONST_2 */))==0) /* IFEQ CustomJump */ goto label_L1258139742;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 3 /* ICONST_3 */))==0) /* IFEQ CustomJump */ goto label_L1258139742;
...
label_L554817465:
    ...
    if ((ilocals_4_ + 6)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L560321707;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 2 /* ICONST_2 */))==0) /* IFEQ CustomJump */ goto label_L560321707;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 3 /* ICONST_3 */))==0) /* IFEQ CustomJump */ goto label_L560321707;
    BC_ALOAD(0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L560321707;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isHexAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_4_ + 5 /* ICONST_5 */))==0) /* IFEQ CustomJump */ goto label_L560321707;
...
label_L1666456788:
    ...
    if ((ilocals_7_ + 1 /* ICONST_1 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L2140898588;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isOctAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_7_ + 1 /* ICONST_1 */))==0) /* IFEQ CustomJump */ goto label_L2140898588;
    ...
    SP++;
    PUSH_INT(51);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1787476367;
    if ((ilocals_7_ + 1 /* ICONST_1 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1787476367;
    if (/* CustomInvoke */com_codename1_io_JSONSanitizer_isOctAt___int_R_boolean(threadStateData, __cn1ThisObject, (ilocals_7_ + 1 /* ICONST_1 */))==0) /* IFEQ CustomJump */ goto label_L1787476367;
...
label_L1117642317:
    if (ilocals_9_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L1297259456;
...
label_L1196288844:
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1628242023;
    ...
    SP++;
    PUSH_INT(13);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1593084680;
    goto label_L1805660016;

label_L1628242023:
    __CN1_DEBUG_INFO(626);
    if (ilocals_5_>=55296) /* IF_ICMPGE CustomJump */ goto label_L128026509;
    __CN1_DEBUG_INFO(627);
    goto label_L1805660016;

label_L128026509:
    __CN1_DEBUG_INFO(628);
    if (ilocals_5_>=57344) /* IF_ICMPGE CustomJump */ goto label_L727867010;
    __CN1_DEBUG_INFO(629);
    if (/* CustomInvoke */java_lang_Character_isHighSurrogate___char_R_boolean(threadStateData, ilocals_5_)==0) /* IFEQ CustomJump */ goto label_L1593084680;
    if ((ilocals_4_ + 1 /* ICONST_1 */)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1593084680;
    PUSH_POINTER(get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject));
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    SP++;
...
label_L727867010:
    ...
    if (ilocals_5_>65533) /* IF_ICMPGT CustomJump */ goto label_L1593084680;
...
label_L577076657:
    BC_IINC(7, -1);
    if (ilocals_7_<0) /* IFLT CustomJump */ goto label_L1805660016;
...
label_L1393182452:
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1394960202;
...
JAVA_OBJECT com_codename1_io_JSONSanitizer_requireValueState___int_com_codename1_io_JSONSanitizer_State_boolean_R_com_codename1_io_JSONSanitizer_State(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1779082722;
        case 2: goto label_L1661720039;
        case 3: goto label_L596243782;
        case 4: goto label_L1533987146;
        case 5: goto label_L596243782;
        case 6: goto label_L1661720039;
        case 7: goto label_L1685344880;
        case 8: goto label_L1500321780;
        default: goto label_L899869274;
    }

label_L596243782:
    __CN1_DEBUG_INFO(651);
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L413880637;
...
label_L1500321780:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1586128778;
...
label_L1685344880:
    ...
    if (get_field_com_codename1_io_JSONSanitizer_bracketDepth(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1877547288;
    PUSH_POINTER(__NEW_java_lang_RuntimeException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_RuntimeException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7566));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_VOID com_codename1_io_JSONSanitizer_elide___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1295769221;
...
label_L1674661311:
    ...
    BC_DUP(); /* DUP */
    BC_ISTORE(3);
    if(POP_INT() < 0) /* IFLT */ goto label_L257641638;
    __CN1_DEBUG_INFO(716);
    /* VarOp.assignFrom */     ilocals_4_ = ilocals_3_;

label_L627451005:
    __CN1_DEBUG_INFO(717);
    if (ilocals_4_<=ilocals_1_) /* IF_ICMPLE CustomJump */ goto label_L39898352;
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(92);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L39898352;
...
label_L39898352:
    ...
    if (((ilocals_3_ - ilocals_4_) & 1 /* ICONST_1 */)!=0) /* IFNE CustomJump */ goto label_L909773218;
...
label_L196196466:
    BC_IINC(2, -1);
    if (ilocals_2_<get_field_com_codename1_io_JSONSanitizer_cleaned(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L1733433977;
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: goto label_L1938005794;
        case 10: goto label_L1938005794;
        case 13: goto label_L1938005794;
        case 32: goto label_L1938005794;
        case 44: goto label_L353562601;
        default: goto label_L2093474881;
    }
...
label_L1733433977:
    ...
    if (get_static_com_codename1_io_JSONSanitizer__assertionsDisabled(threadStateData)!=0) /* IFNE CustomJump */ goto label_L1680104617;
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1680104617;
...
label_L1597802092:
    BC_IINC(2, -1);
    if (ilocals_2_<0) /* IFLT CustomJump */ goto label_L1724619363;
...
JAVA_VOID com_codename1_io_JSONSanitizer_normalizeNumber___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L383823787;
    ...
    SP--;
    switch((*SP).data.i) {
        case 43: goto label_L2073782870;
        case 45: goto label_L1846614763;
        default: goto label_L383823787;
    }
...
label_L383823787:
    ...
    if (ilocals_3_!=ilocals_4_) /* IF_ICMPNE CustomJump */ goto label_L1436937891;
...
label_L1436937891:
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_3_);
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1185648203;
    __CN1_DEBUG_INFO(793);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(794);
    /* VarOp.assignFrom */     llocals_6_ = 0 /* LCONST_0 */; 
    __CN1_DEBUG_INFO(795);
    if ((ilocals_4_ - ilocals_3_)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1715635474;
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1715635474;
    PUSH_INT(120);
    PUSH_POINTER(get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject));
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_4_; 
    ...
    PUSH_INT(32);
    SP--; SP[-1].data.i = SP[-1].data.i | (*SP).data.i; /* IOR */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1715635474;
...
label_L311642344:
    ...
    (*SP).data.i = ilocals_8_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L2051550010;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_8_; 
    SP++;
    PUSH_INT(57);
...
label_L2051550010:
    ...
    (*SP).data.i = ilocals_8_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L14818675;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_8_; 
    SP++;
    PUSH_INT(102);
...
label_L1715635474:
    ...
    if ((ilocals_4_ - ilocals_3_)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L34264652;
    __CN1_DEBUG_INFO(814);
    /* VarOp.assignFrom */     ilocals_8_ = ilocals_3_;

label_L143751348:
    if (ilocals_8_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L966802636;
    ...
    if (ilocals_9_>=0) /* IFGE CustomJump */ goto label_L5092445;
    __CN1_DEBUG_INFO(817);
    goto label_L966802636;
...
label_L34264652:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1185648203;
    ...
    if (CN1_CMP_EXPR(llocals_6_, 0 /* LCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1551722332;
    ...
    if (ilocals_8_<0) /* IFLT CustomJump */ goto label_L1551722332;
    ...
    SP++;
    PUSH_INT(45);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1686332995;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(43);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1551722332;
...
label_L1185648203:
    ...
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L159504850;
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_3_);
    PUSH_INT(tmpResult); }
    PUSH_INT(46);
    ...
    if (ilocals_5_!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L181814414;
...
label_L159504850:
    ...
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1034327311;
    PUSH_INT(101);
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_3_);
    PUSH_INT(tmpResult); }
    PUSH_INT(32);
    SP--; SP[-1].data.i = SP[-1].data.i | (*SP).data.i; /* IOR */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1034327311;
    __CN1_DEBUG_INFO(865);
    BC_IINC(3, 1);
    __CN1_DEBUG_INFO(866);
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1114131846;
    __CN1_DEBUG_INFO(867);
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, get_field_com_codename1_io_JSONSanitizer_jsonish(__cn1ThisObject), ilocals_3_);
    PUSH_INT(tmpResult); }
    SP--;
    switch((*SP).data.i) {
        case 43: goto label_L1168134992;
        case 45: goto label_L1168134992;
        default: goto label_L1114131846;
    }
...
label_L1114131846:
    ...
    if (ilocals_5_!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L2104139102;
...
label_L1034327311:
    ...
    if (ilocals_3_==ilocals_2_) /* IF_ICMPEQ CustomJump */ goto label_L1961718033;
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_canonicalizeNumber___java_lang_StringBuilder_int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    int restoreToL2141744605cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL2141744605cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L2141744605cn1_class_id_java_lang_NumberFormatException1, label_L1953044087, restoreToL2141744605cn1_class_id_java_lang_NumberFormatException1);
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(45);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L857010553, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L448600616, 0);
...
label_L766136466:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L88573335, 0);
    ...
    (*SP).data.i = ilocals_9_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L88573335, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L966910438, 0);
    JUMP_TO(label_L88573335, 0);

label_L966910438:
    __CN1_DEBUG_INFO(925);
    BC_IINC(4, 1);
    JUMP_TO(label_L766136466, 0);

label_L88573335:
    __CN1_DEBUG_INFO(929);
    if (ilocals_4_==ilocals_2_) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1597268821, 0);
    PUSH_INT(46);
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L1726361113, 0);
...
label_L1409112532:
    if (ilocals_6_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1358847474, 0);
    ...
    (*SP).data.i = ilocals_9_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1358847474, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_9_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L800041407, 0);
    JUMP_TO(label_L1358847474, 0);

label_L800041407:
    __CN1_DEBUG_INFO(933);
    BC_IINC(6, 1);
    JUMP_TO(label_L1409112532, 0);

label_L1358847474:
    __CN1_DEBUG_INFO(938);
    if (ilocals_6_!=ilocals_2_) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L71054164, 0);
...
label_L1950308547:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(43);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1295359081, 0);
    BC_IINC(7, 1);
...
label_L638582764:
    ...
    if (ilocals_3_>ilocals_4_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L687251464, 0);
    if (ilocals_4_>ilocals_5_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L687251464, 0);
    if (ilocals_5_>ilocals_6_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L687251464, 0);
    if (ilocals_6_>ilocals_7_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L687251464, 0);
    if (ilocals_7_<=ilocals_8_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1910491749, 0);
...
label_L1910491749:
    ...
    if (ilocals_8_!=ilocals_7_) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L2141744605, 0);
    __CN1_DEBUG_INFO(960);
    /* VarOp.assignFrom */     ilocals_9_ = 0 /* ICONST_0 */; 
    JUMP_TO(label_L513761429, 0);

label_L2141744605:
 tryBlockOffsetL2141744605cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L2141744605cn1_class_id_java_lang_NumberFormatException1);
    restoreToL2141744605cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L783759938:
    if (ilocals_14_>=ilocals_6_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L66348462, 0);
    ...
    if (ilocals_12_==0) /* IFEQ CustomJump */ JUMP_TO(label_L814565761, 0);
    /* VarOp.assignFrom */     ilocals_15_ = 0 /* ICONST_0 */; 
    JUMP_TO(label_L814565761, 0);

label_L209128279:
    __CN1_DEBUG_INFO(1002);
    /* VarOp.assignFrom */     ilocals_17_ = ilocals_16_;
    __CN1_DEBUG_INFO(1003);
    if (ilocals_12_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1433607373, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_17_; 
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ JUMP_TO(label_L1963645656, 0);

label_L1433607373:
    if (ilocals_11_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1963645656, 0);
    BC_IINC(10, 1);
...
label_L1963645656:
    ...
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1100176029, 0);
...
label_L1100176029:
    ...
    if (ilocals_12_==0) /* IFEQ CustomJump */ JUMP_TO(label_L453562991, 0);
    __CN1_DEBUG_INFO(1013);
    if (ilocals_11_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1448095927, 0);
...
label_L620195959:
    ...
    if (ilocals_15_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1966075071, 0);
    if (ilocals_17_==0) /* IFEQ CustomJump */ JUMP_TO(label_L814565761, 0);

label_L1966075071:
    __CN1_DEBUG_INFO(1021);
    if (ilocals_15_!=0) /* IFNE CustomJump */ JUMP_TO(label_L783488821, 0);
...
label_L66348462:
    ...
    if (ilocals_12_==0) /* IFEQ CustomJump */ JUMP_TO(label_L411802142, 0);
...
label_L411802142:
    ...
    if (ilocals_14_>ilocals_10_) /* IF_ICMPGT CustomJump */ JUMP_TO(label_L1111320106, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(21);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L1111320106, 0);
    __CN1_DEBUG_INFO(1053);
    /* VarOp.assignFrom */     ilocals_15_ = ilocals_14_;

label_L1243911696:
    if (ilocals_15_>=ilocals_10_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1565967058, 0);
...
label_L1111320106:
    ...
    if (0 /* ICONST_0 */>=ilocals_10_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L664700395, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_10_; 
    SP++;
    PUSH_INT(21);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ JUMP_TO(label_L664700395, 0);
...
label_L664700395:
    ...
    (*SP).data.i = ilocals_10_; 
    SP++;
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ JUMP_TO(label_L1286968216, 0);
    if (ilocals_10_>0) /* IFGT CustomJump */ JUMP_TO(label_L1286968216, 0);
...
label_L1286968216:
    ...
    if (ilocals_14_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L583997448, 0);
    JUMP_TO(label_L1901525199, 0);
...
label_L1901525199:
    ...
    PUSH_OBJ(tmpResult); }
    if (ilocals_15_>=0) /* IFGE CustomJump */ JUMP_TO(label_L573872851, 0);
    PUSH_INT(45);
...
label_L1486504709:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L405318481;
    __CN1_DEBUG_INFO(1100);
    if (/* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[0].data.o, (ilocals_1_ + ilocals_5_))==/* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[2].data.o, (ilocals_3_ + ilocals_5_))) /* IF_ICMPEQ CustomJump */ goto label_L1585358875;
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_isKeyword___int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_3_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1969754956;
...
label_L1969754956:
    ...
    SP-=4;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L156954340;
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_isOctAt___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    (*SP).data.i = ilocals_2_; 
    SP++;
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L774676004;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(55);
...
JAVA_BOOLEAN com_codename1_io_JSONSanitizer_isJsonSpecialChar___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1350561011;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;
...
label_L1350561011:
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: goto label_L1058885327;
        case 44: goto label_L1058885327;
        case 58: goto label_L1058885327;
        case 91: goto label_L1058885327;
        case 93: goto label_L1058885327;
        case 123: goto label_L1058885327;
        case 125: goto label_L1058885327;
        default: goto label_L1807402813;
    }
...
label_L157567214:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1314113263;
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1633989538;
    PUSH_INT(48);
...
label_L1439651366:
    ...
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L2126991912;
...
JAVA_OBJECT com_codename1_io_JSONSanitizer_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_JSONSanitizer_sanitizedJson(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L148802311;
...
JAVA_VOID com_codename1_io_JSONSanitizer___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    ...
    __CN1_DEBUG_INFO(93);
    if (virtual_java_lang_Class_desiredAssertionStatus___R_boolean(threadStateData, (JAVA_OBJECT)&class__com_codename1_io_JSONSanitizer)!=0) /* IFNE CustomJump */ goto label_L1070050294;
    PUSH_INT(1); /* ICONST_1 */
