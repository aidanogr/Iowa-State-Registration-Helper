...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_11___INIT_____boolean_int_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 9513, 201);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_11_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 9513, 203);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL78893407601;
    int tryBlockOffsetL78893407601;
    DEFINE_CATCH_BLOCK(catch_L78893407601, label_L1437129801, restoreToL78893407601);
    int restoreToL143712980102;
    int tryBlockOffsetL143712980102;
    DEFINE_CATCH_BLOCK(catch_L143712980102, label_L1437129801, restoreToL143712980102);
    __CN1_DEBUG_INFO(1002);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L708926121, 0);
    __CN1_DEBUG_INFO(1003);
    if (get_field_com_codename1_impl_ios_IOSImplementation_11_val_finished(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1406004470, 0);
    __CN1_DEBUG_INFO(1004);
    PUSH_INT(get_field_com_codename1_impl_ios_IOSImplementation_11_val_cursorPositon(__cn1ThisObject));
    PUSH_INT(-2);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1911168986, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1655955258, 0);
...
label_L788934076:
 tryBlockOffsetL78893407601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L78893407601);
    restoreToL78893407601 = threadStateData->threadObjectStackOffset;
    ...
    if (com_codename1_impl_ios_IOSImplementation_access$800___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1107772887, 1);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1107772887, 1);
    /* CustomInvoke */PUSH_OBJ(com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData)));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_TextArea);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1107772887, 1);
...
label_L1107772887:
    ...
    if (virtual_com_codename1_impl_ios_IOSNative_isAsyncEditMode___R_boolean(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_nativeInstance(threadStateData))==0) /* IFEQ CustomJump */ JUMP_TO(label_L2115087165, 1);
...
label_L2115087165:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1604616170, 1);
...
label_L126769944:
END_TRY(1);    JUMP_TO(label_L596779307, 0);

label_L1437129801:
 tryBlockOffsetL143712980102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L143712980102);
    restoreToL143712980102 = threadStateData->threadObjectStackOffset;
...
label_L596779307:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1531175283, 0);
    if (virtual_com_codename1_ui_Form_isFormBottomPaddingEditingMode___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1531175283, 0);
...
label_L687399269:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1415545023, 0);
    if (get_field_com_codename1_impl_ios_IOSImplementation_11_val_cursorPositon(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1415545023, 0);
...
label_L708926121:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9514));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
