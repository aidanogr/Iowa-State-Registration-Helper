...
JAVA_VOID com_codename1_ui_plaf_Style___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3439, 201);
...
JAVA_VOID com_codename1_ui_plaf_Style_markAsRendererStyle__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3439, 3440);
...
JAVA_OBJECT com_codename1_ui_plaf_Style_createProxyStyle___com_codename1_ui_plaf_Style_1ARRAY_R_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_plaf_Style(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 3439, 3441);
...
JAVA_VOID com_codename1_ui_plaf_Style___INIT_____com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(6, 2, 0, 3439, 201);
    ...
    if (get_field_com_codename1_ui_plaf_Style_backgroundGradient(locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L700171153;
...
JAVA_VOID com_codename1_ui_plaf_Style___INIT_____int_int_com_codename1_ui_Font_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_BYTE __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(7, 5, 0, 3439, 201);
...
JAVA_VOID com_codename1_ui_plaf_Style___INIT_____int_int_com_codename1_ui_Font_byte_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_BYTE __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    ...
    volatile JAVA_INT ilocals_1_ = 0; /* fgColor */
    volatile JAVA_INT ilocals_2_ = 0; /* bgColor */
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 3439, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    locals[3].data.o = __cn1Arg3;
    locals[3].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_plaf_Style___INIT_____int_int_com_codename1_ui_Font_byte_com_codename1_ui_Image_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_BYTE __cn1Arg4, JAVA_OBJECT __cn1Arg5, JAVA_BYTE __cn1Arg6) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* bgColor */
    DEFINE_INSTANCE_METHOD_STACK(2, 7, 0, 3439, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    locals[3].data.o = __cn1Arg3;
    locals[3].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_plaf_Style_merge___com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 4, 0, 3439, 3442);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 1 /* LCONST_1 */), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L881280045;
...
label_L881280045:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 262144LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1393484427;
...
label_L1393484427:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 2LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L977245867;
...
label_L977245867:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 32LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1307540790;
...
label_L1307540790:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 2048LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1137180298;
...
label_L1137180298:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 4096LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1744389827;
...
label_L1744389827:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 8192LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L565517913;
...
label_L565517913:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 16LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L394645908;
...
label_L394645908:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 128LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1800031808;
...
label_L1800031808:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 32768LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1185465012;
...
label_L1185465012:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 256LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1332104174;
...
label_L1332104174:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 512LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1985362663;
...
label_L1985362663:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 1024LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1339507235;
...
label_L1339507235:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 64LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1340769295;
...
label_L1340769295:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 16384LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L850300711;
...
label_L850300711:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 65536LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1978141335;
...
label_L1978141335:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 524288LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L5998675;
...
label_L5998675:
    ...
    if (CN1_CMP_EXPR((get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject) & 131072LL), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L462073515;
...
JAVA_INT com_codename1_ui_plaf_Style_getElevation___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3443);
...
JAVA_INT com_codename1_ui_plaf_Style_getIconGap___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3439, 3444);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(763);
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_Style_iconGap(__cn1ThisObject), 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1562107210;
...
JAVA_BOOLEAN com_codename1_ui_plaf_Style_isSurface___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3320);
...
JAVA_BOOLEAN com_codename1_ui_plaf_Style_isModified___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3439, 3446);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(794);
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_Style_modifiedFlag(__cn1ThisObject), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1746061516;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_INT com_codename1_ui_plaf_Style_getBgColor___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3447);
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getBgImage___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3448);
...
JAVA_BYTE com_codename1_ui_plaf_Style_getBackgroundType___R_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3449);
...
JAVA_BYTE com_codename1_ui_plaf_Style_getBackgroundAlignment___R_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3450);
...
JAVA_INT com_codename1_ui_plaf_Style_getBackgroundGradientStartColor___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3439, 3451);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(847);
    if (get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2053555034;
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L2053555034;
...
JAVA_INT com_codename1_ui_plaf_Style_getBackgroundGradientEndColor___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3439, 3452);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(859);
    if (get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2039783633;
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L2039783633;
...
JAVA_FLOAT com_codename1_ui_plaf_Style_getBackgroundGradientRelativeX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3439, 3453);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(871);
    if (get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L121521031;
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject))<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L121521031;
...
JAVA_FLOAT com_codename1_ui_plaf_Style_getBackgroundGradientRelativeY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3439, 3454);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(883);
    if (get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L227005513;
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject))<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L227005513;
...
JAVA_FLOAT com_codename1_ui_plaf_Style_getBackgroundGradientRelativeSize___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3439, 3455);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(895);
    if (get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1094167216;
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject))<=4/* ICONST_4 */) /* IF_ICMPLE CustomJump */ goto label_L1094167216;
...
JAVA_INT com_codename1_ui_plaf_Style_getFgColor___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3456);
...
JAVA_INT com_codename1_ui_plaf_Style_getFgAlpha___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3457);
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getFont___R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3458);
...
JAVA_VOID com_codename1_ui_plaf_Style_setElevation___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3459);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(937);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L502863983;
...
label_L1538844412:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1747862060;
...
label_L502863983:
    ...
    if (get_field_com_codename1_ui_plaf_Style_elevation(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L656844049;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1925835770;
...
JAVA_VOID com_codename1_ui_plaf_Style_setElevation___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* elevation */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3459);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setIconGap___float_byte_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BYTE __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 8, 0, 3439, 3460);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    __CN1_DEBUG_INFO(972);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1751972013;
...
label_L1726169577:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1954507866;
...
label_L1751972013:
    ...
    if (ilocals_2_!=get_field_com_codename1_ui_plaf_Style_iconGapUnit(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1531506932;
    ...
    BC_DCMPL();
    if(POP_INT() <= 0) /* IFLE */ goto label_L1416549024;
...
label_L1531506932:
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1543272907;
...
JAVA_VOID com_codename1_ui_plaf_Style_setIconGap___float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 3439, 3460);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_VOID com_codename1_ui_plaf_Style_setIconGap___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3460);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setIconGapUnit___byte_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3461);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1029);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L669812564;
...
label_L669812564:
    ...
    if (ilocals_1_==get_field_com_codename1_ui_plaf_Style_iconGapUnit(__cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L560734926;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1660536720;
...
JAVA_VOID com_codename1_ui_plaf_Style_setIconGapUnit___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* unit */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3461);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setSurface___boolean_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 2402);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1064);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L568717494;
...
label_L568717494:
    ...
    if (get_field_com_codename1_ui_plaf_Style_surface(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1701331644;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1803976423;
...
JAVA_VOID com_codename1_ui_plaf_Style_setSurface___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* surface */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 2402);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgColor___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3462);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setAlignment___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3039);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setAlignment___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3039);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1123);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1038892935;
...
label_L1572516402:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L2053136992;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1038892935:
    ...
    if (get_field_com_codename1_ui_plaf_Style_align(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L93560356;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1499437334;
...
JAVA_INT com_codename1_ui_plaf_Style_getAlignment___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3463);
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgImage___com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 2896);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundType___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3464);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundAlignment___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3465);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientStartColor___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3466);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientEndColor___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3467);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeX___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3468);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeY___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3469);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeSize___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3470);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFgColor___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* fgColor */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3471);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFgAlpha___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3472);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFont___com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3473);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_INT com_codename1_ui_plaf_Style_getTextDecoration___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3485);
...
JAVA_VOID com_codename1_ui_plaf_Style_setTextDecoration___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3486);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setTextDecoration___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3486);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1453);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1287728562;
...
label_L970423785:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L99253188;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1287728562:
    ...
    if (get_field_com_codename1_ui_plaf_Style_textDecoration(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1768926513;
    __CN1_DEBUG_INFO(1461);
    set_field_com_codename1_ui_plaf_Style_textDecoration(threadStateData, ilocals_1_, __cn1ThisObject);
    __CN1_DEBUG_INFO(1462);
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L738636051;
...
JAVA_BYTE com_codename1_ui_plaf_Style_getBgTransparency___R_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3439, 3487);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1476);
    if (get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2053425932;
    if (get_field_com_codename1_ui_plaf_Style_backgroundType(__cn1ThisObject)>2 /* ICONST_2 */) /* IF_ICMPGT CustomJump */ goto label_L2053425932;
    if (get_field_com_codename1_ui_plaf_Style_backgroundType(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2053425932;
    if (virtual_com_codename1_ui_Image_isAnimation___R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L2019482012;
    if (virtual_com_codename1_ui_Image_isOpaque___R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L2053425932;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgTransparency___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3488);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_INT com_codename1_ui_plaf_Style_getOpacity___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 3439, 3489);
...
JAVA_VOID com_codename1_ui_plaf_Style_setOpacity___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3490);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setOpacity___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3490);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1519);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1816978819;
...
label_L700171836:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1968922416;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1816978819:
    ...
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L656898222;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(255);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L751628596;
...
label_L656898222:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3491));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L751628596:
    ...
    if (get_field_com_codename1_ui_plaf_Style_opacity(__cn1ThisObject)==((ilocals_1_ << 24) >> 24)) /* IF_ICMPEQ CustomJump */ goto label_L63015234;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1950102816;
...
JAVA_VOID com_codename1_ui_plaf_Style_stripMarginAndPadding__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3439, 2415);
...
JAVA_VOID com_codename1_ui_plaf_Style_setPadding___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 3439, 3492);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    ilocals_4_ = __cn1Arg4;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPadding___float_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 9, 0, 3439, 3492);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    flocals_2_ = __cn1Arg2;
    flocals_3_ = __cn1Arg3;
    flocals_4_ = __cn1Arg4;
    __CN1_DEBUG_INFO(1582);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1749205249;
...
label_L742969054:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L592238700;
...
label_L1749205249:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L969440066;
    if (CN1_CMP_EXPR(flocals_3_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L969440066;
    if (CN1_CMP_EXPR(flocals_4_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L969440066;
    if (CN1_CMP_EXPR(flocals_2_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1207758771;

label_L969440066:
    __CN1_DEBUG_INFO(1589);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3493));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1207758771:
    __CN1_DEBUG_INFO(1591);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 0 /* ICONST_0 */), flocals_1_)!=0) /* IFNE CustomJump */ goto label_L37142680;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 2 /* ICONST_2 */), flocals_2_)!=0) /* IFNE CustomJump */ goto label_L37142680;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 1 /* ICONST_1 */), flocals_3_)!=0) /* IFNE CustomJump */ goto label_L37142680;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 3 /* ICONST_3 */), flocals_4_)==0) /* IFEQ CustomJump */ goto label_L1759694910;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPadding___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 3439, 3492);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMargin___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* left */
    volatile JAVA_INT ilocals_4_ = 0; /* right */
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 3439, 3494);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    ilocals_4_ = __cn1Arg4;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMargin___float_float_float_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4) {
    ...
    volatile JAVA_FLOAT flocals_1_ = 0; /* top */
    volatile JAVA_FLOAT flocals_2_ = 0; /* bottom */
    DEFINE_INSTANCE_METHOD_STACK(5, 9, 0, 3439, 3494);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    flocals_2_ = __cn1Arg2;
    flocals_3_ = __cn1Arg3;
    flocals_4_ = __cn1Arg4;
    __CN1_DEBUG_INFO(1646);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L302687243;
...
label_L112026691:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L850083982;
    /* VarOp.assignFrom */ locals[8].type=CN1_TYPE_INVALID;locals[8].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[5].data.o, ilocals_7_);
...
label_L302687243:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L2024814472;
    if (CN1_CMP_EXPR(flocals_3_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L2024814472;
    if (CN1_CMP_EXPR(flocals_4_, 0 /* FCONST_0 */)<0) /* IFLT CustomJump */ goto label_L2024814472;
    if (CN1_CMP_EXPR(flocals_2_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1063124585;

label_L2024814472:
    __CN1_DEBUG_INFO(1653);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3495));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1063124585:
    __CN1_DEBUG_INFO(1655);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 0 /* ICONST_0 */), flocals_1_)!=0) /* IFNE CustomJump */ goto label_L1461347900;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 2 /* ICONST_2 */), flocals_2_)!=0) /* IFNE CustomJump */ goto label_L1461347900;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 1 /* ICONST_1 */), flocals_3_)!=0) /* IFNE CustomJump */ goto label_L1461347900;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 3 /* ICONST_3 */), flocals_4_)==0) /* IFEQ CustomJump */ goto label_L980979680;
...
JAVA_VOID com_codename1_ui_plaf_Style_cacheMargins___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3439, 3496);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1678);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1124987728;
...
label_L391928890:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L326362094;
...
label_L1124987728:
    ...
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1772471998;
    if (get_field_com_codename1_ui_plaf_Style_cached_margin(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1159606185;
...
JAVA_VOID com_codename1_ui_plaf_Style_restoreCachedMargins__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(6, 5, 0, 3439, 3497);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1698);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1233049719;
...
label_L2069971440:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1018618094;
...
label_L1233049719:
    ...
    if (get_field_com_codename1_ui_plaf_Style_cached_margin(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1337346642;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMargin___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    volatile JAVA_INT ilocals_1_ = 0; /* orientation */
    volatile JAVA_INT ilocals_2_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 3439, 3494);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_FLOAT com_codename1_ui_plaf_Style_getPaddingFloatValue___boolean_int_R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 3439, 3500);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1769);
    if (ilocals_2_<0) /* IFLT CustomJump */ goto label_L1997028929;
    if (ilocals_2_<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L589166341;
...
label_L1997028929:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3501));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L589166341:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L756222660;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L789367604;
        case 3: goto label_L423629474;
        default: goto label_L756222660;
    }
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingLeft___boolean_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* rtl */
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 3439, 3502);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1793);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1428777808;
...
JAVA_VOID com_codename1_ui_plaf_Style_initPaddingUnits__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3439, 3503);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1800);
    if (get_field_com_codename1_ui_plaf_Style_paddingUnit(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1616453147;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingUnitLeft___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 3439, 3504);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1812);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L700791887;
...
label_L786722925:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L805957335;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingUnitRight___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 3439, 3505);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1829);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L107285100;
...
label_L2034385122:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L105019819;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingUnitTop___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 3439, 3506);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1846);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1957175487;
...
label_L1328203744:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1513124396;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingUnitBottom___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 3439, 3507);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1863);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L612686775;
...
label_L1222908765:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L287095360;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingRight___boolean_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* rtl */
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 3439, 3508);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1880);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1374212198;
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingTop___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3439, 3509);
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingTop___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3439, 3510);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingTop___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3439, 3510);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1912);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1395912847;
...
label_L1331644236:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L663326227;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1395912847:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1487131937;
...
label_L1487131937:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 0 /* ICONST_0 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L349757746;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingBottom___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3439, 3511);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingBottom___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3439, 3511);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1947);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2135563436;
...
label_L206999441:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1243234606;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L2135563436:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1607745112;
...
label_L1607745112:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 2 /* ICONST_2 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L1893004914;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingLeft___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3439, 3512);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingLeft___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3439, 3512);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1982);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1759500919;
...
label_L781527109:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1355676410;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1759500919:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L2032479363;
...
label_L2032479363:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 1 /* ICONST_1 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L1874812338;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingRight___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3439, 3513);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingRight___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3439, 3513);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(2017);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1352294549;
...
label_L123458189:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1472904643;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1352294549:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L312233241;
...
label_L312233241:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), 3 /* ICONST_3 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L293669143;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginTop___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3439, 3514);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginTop___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3439, 3514);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(2049);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L321358401;
...
label_L984978888:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1244785938;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L321358401:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L593881656;
    __CN1_DEBUG_INFO(2056);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3515));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L593881656:
    __CN1_DEBUG_INFO(2058);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 0 /* ICONST_0 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L213850519;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginBottom___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3439, 3516);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginBottom___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3439, 3516);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
...
label_L1402400433:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1605299030;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1227041903:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L663824117;
...
label_L663824117:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 2 /* ICONST_2 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L2004952636;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginLeft___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3439, 3517);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginLeft___float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_FLOAT flocals_1_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 3439, 3517);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(2111);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1608357825;
...
label_L366098173:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L995760621;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1608357825:
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1805402813;
...
label_L1805402813:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), 1 /* ICONST_1 */), flocals_1_)==0) /* IFEQ CustomJump */ goto label_L1481417616;
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingBottom___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3439, 3519);
...
JAVA_INT com_codename1_ui_plaf_Style_getHorizontalMargins___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3439, 3520);
...
JAVA_INT com_codename1_ui_plaf_Style_getVerticalMargins___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3439, 3521);
...
JAVA_INT com_codename1_ui_plaf_Style_getHorizontalPadding___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3439, 3522);
...
JAVA_INT com_codename1_ui_plaf_Style_getVerticalPadding___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3439, 3523);
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginRightNoRTL___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3439, 3524);
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginLeftNoRTL___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3439, 3525);
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingRightNoRTL___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3439, 3526);
...
JAVA_INT com_codename1_ui_plaf_Style_getPaddingLeftNoRTL___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3439, 3527);
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginRight___boolean_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* rtl */
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 3439, 3528);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(2240);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L171751994;
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginLeft___boolean_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* rtl */
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 3439, 3529);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(2252);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L720007548;
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginTop___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3439, 3530);
...
JAVA_INT com_codename1_ui_plaf_Style_getMarginBottom___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3439, 3531);
...
JAVA_INT com_codename1_ui_plaf_Style_getPadding___boolean_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_1_ = 0; /* rtl */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 3439, 3532);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_INT com_codename1_ui_plaf_Style_convertUnit___byte_1ARRAY_float_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 3439, 3533);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    flocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    __CN1_DEBUG_INFO(2286);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1554308325;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L311536309;
        case 2: goto label_L2098413495;
        case 3: goto label_L67883256;
        case 4: goto label_L2125625192;
        case 5: goto label_L1634319881;
        case 6: goto label_L98818836;
        case 7: goto label_L1605715776;
        default: goto label_L844194537;
    }
...
label_L311536309:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L518261596;
    if (ilocals_3_!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L96749807;
...
JAVA_INT com_codename1_ui_plaf_Style_getPadding___int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* orientation */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3532);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgColor___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3462);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2393);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L307148861;
...
label_L276922182:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1753607449;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L307148861:
    ...
    if (get_field_com_codename1_ui_plaf_Style_bgColor(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L759840275;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1243800791;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgImage___com_codename1_ui_Image_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 2896);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2416);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L227030447;
...
label_L1789791855:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L375918615;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L227030447:
    ...
    if (get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject)==locals[1].data.o) /* IF_ACMPEQ CustomJump */ goto label_L930569137;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L2073961917;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundType___byte_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3464);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2442);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L757099121;
...
label_L977320786:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L937936076;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L757099121:
    ...
    if (get_field_com_codename1_ui_plaf_Style_backgroundType(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L813285994;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L505693686;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundAlignment___byte_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3465);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2470);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L401355610;
...
label_L1448967471:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L675909854;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L401355610:
    ...
    if (get_field_com_codename1_ui_plaf_Style_backgroundAlignment(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1793759719;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L476709123;
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getBackgroundGradient___R_java_lang_Object_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(7, 2, 0, 3439, 3537);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2493);
    if (get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2017574192;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradient___java_lang_Object_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3439, 3538);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientStartColor___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3466);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2515);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1170735890;
...
label_L931003277:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L2077462509;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1170735890:
    ...
    (*SP).data.i = ilocals_1_; 
    SP++;
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1117812847;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1198859194;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientEndColor___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3467);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2538);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L540962910;
...
label_L962931248:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L2026325575;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L540962910:
    ...
    (*SP).data.i = ilocals_1_; 
    SP++;
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1466148437;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L67928167;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeX___float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    volatile JAVA_FLOAT flocals_1_ = 0; /* backgroundGradientRelativeX */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3468);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2562);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1186663391;
...
label_L478468106:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1444912530;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1186663391:
    ...
    BC_FLOAD(1);
    BC_FCMPL();
    if(POP_INT() == 0) /* IFEQ */ goto label_L2095803461;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1653634548;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeY___float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    volatile JAVA_FLOAT flocals_1_ = 0; /* backgroundGradientRelativeY */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3469);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2585);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1212782393;
...
label_L1436127733:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1916224178;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1212782393:
    ...
    BC_FLOAD(1);
    BC_FCMPL();
    if(POP_INT() == 0) /* IFEQ */ goto label_L885481831;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L817092761;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBackgroundGradientRelativeSize___float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    volatile JAVA_FLOAT flocals_1_ = 0; /* backgroundGradientRelativeSize */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3470);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     flocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2609);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2027499247;
...
label_L1855297340:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1641418296;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L2027499247:
    ...
    BC_FLOAD(1);
    BC_FCMPL();
    if(POP_INT() == 0) /* IFEQ */ goto label_L1078783335;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1901272535;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFgColor___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3471);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2632);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L539322891;
...
label_L1162595263:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1649096004;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L539322891:
    ...
    if (get_field_com_codename1_ui_plaf_Style_fgColor(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L748673892;
    __CN1_DEBUG_INFO(2639);
    set_field_com_codename1_ui_plaf_Style_fgColor(threadStateData, ilocals_1_, __cn1ThisObject);
    __CN1_DEBUG_INFO(2640);
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L669096398;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFgAlpha___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3472);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2655);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L473655651;
...
label_L1436610577:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L120999784;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L473655651:
    ...
    if (get_field_com_codename1_ui_plaf_Style_fgAlpha(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L2124688514;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L957559364;
...
JAVA_VOID com_codename1_ui_plaf_Style_setFont___com_codename1_ui_Font_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3473);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2678);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L216758017;
...
label_L17222024:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1578712821;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L216758017:
    ...
    if (get_field_com_codename1_ui_plaf_Style_font(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L556223230;
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1990419108;

label_L556223230:
    if (get_field_com_codename1_ui_plaf_Style_font(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1641677843;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1641677843;
...
label_L1990419108:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1445448489;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgTransparency___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3488);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2704);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1296833449;
...
label_L291279979:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L538441446;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1296833449:
    ...
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L2043313130;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(255);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1425454633;

label_L2043313130:
    __CN1_DEBUG_INFO(2711);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3539));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1425454633:
    __CN1_DEBUG_INFO(2713);
    if (get_field_com_codename1_ui_plaf_Style_transparency(__cn1ThisObject)==((ilocals_1_ << 24) >> 24)) /* IF_ICMPEQ CustomJump */ goto label_L1271515799;
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1044639817;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPadding___int_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* gap */
    volatile JAVA_INT ilocals_3_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 3439, 3492);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
JAVA_VOID com_codename1_ui_plaf_Style_setPadding___int_float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* override */
    volatile JAVA_FLOAT flocals_2_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 8, 0, 3439, 3492);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    flocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    __CN1_DEBUG_INFO(2745);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L343722304;
...
label_L1891799894:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1968861720;
    /* VarOp.assignFrom */ locals[7].type=CN1_TYPE_INVALID;locals[7].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[4].data.o, ilocals_6_);
...
label_L343722304:
    ...
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1361241279;
    if (ilocals_1_<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L602280210;
...
label_L602280210:
    ...
    if (CN1_CMP_EXPR(flocals_2_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L92962244;
...
label_L92962244:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), ilocals_1_), flocals_2_)==0) /* IFEQ CustomJump */ goto label_L1639319040;
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L670503317;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMargin___int_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* gap */
    volatile JAVA_INT ilocals_3_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 3439, 3494);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMargin___int_float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* override */
    volatile JAVA_FLOAT flocals_2_ = 0; /* gap */
    DEFINE_INSTANCE_METHOD_STACK(5, 8, 0, 3439, 3494);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    flocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    __CN1_DEBUG_INFO(2788);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L873134840;
...
label_L862931361:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1647891936;
    /* VarOp.assignFrom */ locals[7].type=CN1_TYPE_INVALID;locals[7].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[4].data.o, ilocals_6_);
...
label_L873134840:
    ...
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L747343328;
    if (ilocals_1_<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L1337294771;
...
label_L1337294771:
    ...
    if (CN1_CMP_EXPR(flocals_2_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1795568752;
...
label_L1795568752:
    ...
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), ilocals_1_), flocals_2_)==0) /* IFEQ CustomJump */ goto label_L577592048;
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1383675856;
...
JAVA_BOOLEAN com_codename1_ui_plaf_Style_isSuppressChangeEvents___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3540);
...
JAVA_VOID com_codename1_ui_plaf_Style_setSuppressChangeEvents___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3439, 3541);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_plaf_Style_firePropertyChanged___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3542);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (get_field_com_codename1_ui_plaf_Style_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L919962315;
    if (get_field_com_codename1_ui_plaf_Style_suppressChangeEvents(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1814730197;
...
JAVA_VOID com_codename1_ui_plaf_Style_addStyleListener___com_codename1_ui_events_StyleListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 3439, 3543);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(2844);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L618199162;
...
label_L626889335:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1057262726;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L618199162:
    ...
    if (get_field_com_codename1_ui_plaf_Style_listeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L501301044;
...
JAVA_VOID com_codename1_ui_plaf_Style_removeStyleListener___com_codename1_ui_events_StyleListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 3439, 3544);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(2862);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2115575770;
...
label_L753214674:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1700973603;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L2115575770:
    ...
    if (get_field_com_codename1_ui_plaf_Style_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L946448101;
...
JAVA_VOID com_codename1_ui_plaf_Style_removeListeners__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 3439, 3545);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2877);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L238590461;
...
label_L2022586114:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L2101891021;
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;locals[4].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, ilocals_3_);
...
label_L238590461:
    ...
    if (get_field_com_codename1_ui_plaf_Style_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L220588152;
...
JAVA_VOID com_codename1_ui_plaf_Style_resetModifiedFlag__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 3439, 3546);
...
JAVA_VOID com_codename1_ui_plaf_Style_setBorder___com_codename1_ui_plaf_Border(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 3439, 3547);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_plaf_Style_setBorder___com_codename1_ui_plaf_Border_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_2_ = 0; /* override */
    DEFINE_INSTANCE_METHOD_STACK(5, 7, 0, 3439, 3547);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2909);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1192787792;
...
label_L1898870910:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L2014406233;
    /* VarOp.assignFrom */ locals[6].type=CN1_TYPE_INVALID;locals[6].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_5_);
...
label_L1192787792:
    ...
    if (get_field_com_codename1_ui_plaf_Style_border(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1407858699;
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1468809177;

label_L1407858699:
    if (get_field_com_codename1_ui_plaf_Style_border(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L610056415;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L610056415;
...
label_L1468809177:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L649316770;
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getBorder___R_com_codename1_ui_plaf_Border(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 2531);
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getBgPainter___R_com_codename1_ui_Painter(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3548);
...
JAVA_VOID com_codename1_ui_plaf_Style_setBgPainter___com_codename1_ui_Painter(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 3439, 3549);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(2951);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L605787935;
...
label_L1401212518:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L308221618;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getPaddingUnit___R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3550);
...
JAVA_VOID com_codename1_ui_plaf_Style_setPaddingUnit___byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(6, 6, 0, 3439, 3551);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(2978);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1799545709;
    __CN1_DEBUG_INFO(2979);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L320414325;
    if (CN1_ARRAY_LENGTH(locals[1].data.o)>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L320414325;
...
label_L211507865:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L2031705122;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1799545709:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1891535340;
    if (CN1_ARRAY_LENGTH(locals[1].data.o)>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L1891535340;
...
label_L1891535340:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L430290487;
...
label_L430290487:
    ...
    if (get_field_com_codename1_ui_plaf_Style_paddingUnit(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1329362952;
...
JAVA_OBJECT com_codename1_ui_plaf_Style_getMarginUnit___R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3439, 3552);
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginUnit___byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(6, 6, 0, 3439, 3553);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(3018);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1263102442;
    __CN1_DEBUG_INFO(3019);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L298156448;
    if (CN1_ARRAY_LENGTH(locals[1].data.o)>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L298156448;
...
label_L154487101:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L627411361;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
label_L1263102442:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L162752456;
    if (CN1_ARRAY_LENGTH(locals[1].data.o)>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L162752456;
...
label_L162752456:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1038585959;
...
label_L1038585959:
    ...
    if (get_field_com_codename1_ui_plaf_Style_marginUnit(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L515398215;
...
JAVA_VOID com_codename1_ui_plaf_Style_initMarginUnits__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 3439, 3554);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(3042);
    if (get_field_com_codename1_ui_plaf_Style_marginUnit(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L212329343;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginUnitTop___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 3439, 3557);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(3088);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1459462244;
...
JAVA_VOID com_codename1_ui_plaf_Style_setMarginUnitBottom___byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BYTE __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 3439, 3558);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(3105);
    if (get_field_com_codename1_ui_plaf_Style_proxyTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L517991921;
...
label_L1280081260:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L622497998;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_BOOLEAN com_codename1_ui_plaf_Style_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 3439, 879);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(3117);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2131191535;
...
label_L2131191535:
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L509000859;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(3124);
    if (get_field_com_codename1_ui_plaf_Style_fgColor(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_fgColor(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1866191743;
    __CN1_DEBUG_INFO(3125);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1866191743:
    __CN1_DEBUG_INFO(3127);
    if (get_field_com_codename1_ui_plaf_Style_fgAlpha(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_fgAlpha(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1077109993;
    __CN1_DEBUG_INFO(3128);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1077109993:
    __CN1_DEBUG_INFO(3130);
    if (get_field_com_codename1_ui_plaf_Style_bgColor(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_bgColor(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L71782942;
    __CN1_DEBUG_INFO(3131);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L71782942:
    __CN1_DEBUG_INFO(3133);
    if (get_field_com_codename1_ui_plaf_Style_font(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_font(locals[2].data.o)) /* IF_ACMPEQ CustomJump */ goto label_L803116137;
    if (get_field_com_codename1_ui_plaf_Style_font(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L516885190;
    PUSH_POINTER(get_field_com_codename1_ui_plaf_Style_font(__cn1ThisObject));
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L803116137;
...
label_L803116137:
    ...
    if (get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_bgImage(locals[2].data.o)) /* IF_ACMPEQ CustomJump */ goto label_L1166029274;
    if (get_field_com_codename1_ui_plaf_Style_bgImage(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2078887126;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1166029274;
...
label_L1166029274:
    ...
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_deepEquals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_padding(__cn1ThisObject), get_field_com_codename1_ui_plaf_Style_padding(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L550498846;
    __CN1_DEBUG_INFO(3142);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L550498846:
    __CN1_DEBUG_INFO(3144);
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_deepEquals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_margin(__cn1ThisObject), get_field_com_codename1_ui_plaf_Style_margin(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L1177568763;
    __CN1_DEBUG_INFO(3145);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1177568763:
    __CN1_DEBUG_INFO(3147);
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_deepEquals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_paddingUnit(__cn1ThisObject), get_field_com_codename1_ui_plaf_Style_paddingUnit(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L41595398;
    __CN1_DEBUG_INFO(3148);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L41595398:
    __CN1_DEBUG_INFO(3150);
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_deepEquals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_marginUnit(__cn1ThisObject), get_field_com_codename1_ui_plaf_Style_marginUnit(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L860148067;
    __CN1_DEBUG_INFO(3151);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L860148067:
    __CN1_DEBUG_INFO(3153);
    if (get_field_com_codename1_ui_plaf_Style_transparency(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_transparency(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1824819735;
    __CN1_DEBUG_INFO(3154);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1824819735:
    __CN1_DEBUG_INFO(3156);
    if (get_field_com_codename1_ui_plaf_Style_opacity(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_opacity(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L681514473;
    __CN1_DEBUG_INFO(3157);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L681514473:
    __CN1_DEBUG_INFO(3159);
    if (get_field_com_codename1_ui_plaf_Style_backgroundType(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_backgroundType(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L2132961406;
    __CN1_DEBUG_INFO(3160);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L2132961406:
    __CN1_DEBUG_INFO(3162);
    if (get_field_com_codename1_ui_plaf_Style_backgroundAlignment(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_backgroundAlignment(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1794666800;
    __CN1_DEBUG_INFO(3163);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1794666800:
    __CN1_DEBUG_INFO(3165);
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_deepEquals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_plaf_Style_backgroundGradient(__cn1ThisObject), get_field_com_codename1_ui_plaf_Style_backgroundGradient(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L581225034;
    __CN1_DEBUG_INFO(3167);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L581225034:
    __CN1_DEBUG_INFO(3169);
    if (get_field_com_codename1_ui_plaf_Style_border(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_border(locals[2].data.o)) /* IF_ACMPEQ CustomJump */ goto label_L1925489578;
    if (get_field_com_codename1_ui_plaf_Style_border(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L508122132;
    PUSH_POINTER(get_field_com_codename1_ui_plaf_Style_border(__cn1ThisObject));
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1925489578;
...
label_L1925489578:
    ...
    if (get_field_com_codename1_ui_plaf_Style_align(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_align(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L923911964;
    __CN1_DEBUG_INFO(3174);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L923911964:
    __CN1_DEBUG_INFO(3176);
    if (get_field_com_codename1_ui_plaf_Style_textDecoration(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_textDecoration(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L870563118;
    __CN1_DEBUG_INFO(3177);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L870563118:
    __CN1_DEBUG_INFO(3179);
    if (get_field_com_codename1_ui_plaf_Style_elevation(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_elevation(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1684898059;
    __CN1_DEBUG_INFO(3180);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1684898059:
    __CN1_DEBUG_INFO(3182);
    if (get_field_com_codename1_ui_plaf_Style_surface(__cn1ThisObject)==get_field_com_codename1_ui_plaf_Style_surface(locals[2].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L810582118;
...
JAVA_BOOLEAN com_codename1_ui_plaf_Style_equals___float_1ARRAY_float_1ARRAY_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    __STATIC_INITIALIZER_com_codename1_ui_plaf_Style(threadStateData);
    DEFINE_METHOD_STACK(3, 4, 0, 3439, 879);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(3189);
    if (locals[0].data.o!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L155224151;
...
label_L155224151:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L789178034;
...
label_L789178034:
    ...
    if (CN1_ARRAY_LENGTH(locals[1].data.o)==ilocals_2_) /* IF_ICMPEQ CustomJump */ goto label_L468582533;
...
label_L1940407755:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L383852959;
    __CN1_DEBUG_INFO(3203);
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_FLOAT(locals[0].data.o, ilocals_3_), CN1_ARRAY_ELEMENT_FLOAT(locals[1].data.o, ilocals_3_))==0) /* IFEQ CustomJump */ goto label_L334761329;
