...
JAVA_VOID com_codename1_util_DateUtil___INIT_____java_util_TimeZone(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7730, 201);
...
JAVA_VOID com_codename1_util_DateUtil___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7730, 201);
...
JAVA_INT com_codename1_util_DateUtil_getOffset___long_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(10, 5, 0, 7730, 6687);
...
JAVA_BOOLEAN com_codename1_util_DateUtil_inDaylightTime___java_util_Date_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7730, 6698);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(214);
    if (virtual_java_util_TimeZone_useDaylightTime___R_boolean(threadStateData, get_field_com_codename1_util_DateUtil_tz(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1673971173;
    if (/* CustomInvoke */virtual_com_codename1_util_DateUtil_getOffset___long_R_int(threadStateData, __cn1ThisObject, virtual_java_util_Date_getTime___R_long(threadStateData, locals[1].data.o))==virtual_java_util_TimeZone_getRawOffset___R_int(threadStateData, get_field_com_codename1_util_DateUtil_tz(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ goto label_L1673971173;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_BOOLEAN com_codename1_util_DateUtil_isSameYear___java_util_Calendar_java_util_Calendar_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7730, 7732);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(228);
    if (/* CustomInvoke */virtual_java_util_Calendar_get___int_R_int(threadStateData, locals[1].data.o, 1 /* ICONST_1 */)!=/* CustomInvoke */virtual_java_util_Calendar_get___int_R_int(threadStateData, locals[2].data.o, 1 /* ICONST_1 */)) /* IF_ICMPNE CustomJump */ goto label_L1889879857;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_BOOLEAN com_codename1_util_DateUtil_isSameMonth___java_util_Calendar_java_util_Calendar_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7730, 7733);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(260);
    if (/* CustomInvoke */virtual_com_codename1_util_DateUtil_isSameYear___java_util_Calendar_java_util_Calendar_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1667878940;
    BC_ALOAD(1);
    PUSH_INT(2); /* ICONST_2 */
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1667878940;
    PUSH_INT(1); /* ICONST_1 */
