...
JAVA_VOID com_codename1_ui_animations_Motion___INIT_____int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __CN1_DEBUG_INFO(97);
    if (get_static_com_codename1_ui_animations_Motion_slowMotion(threadStateData)==0) /* IFEQ CustomJump */ goto label_L2100827639;
    __CN1_DEBUG_INFO(98);
...
JAVA_VOID com_codename1_ui_animations_Motion_finish__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L193456779;
...
JAVA_LONG com_codename1_ui_animations_Motion_getCurrentMotionTime___R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_animations_Motion_currentMotionTime(__cn1ThisObject), 0 /* LCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1692817328;
...
JAVA_VOID com_codename1_ui_animations_Motion_setCurrentMotionTime___long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_animations_Motion_lastReturnedValue(__cn1ThisObject)!=get_field_com_codename1_ui_animations_Motion_destinationValue(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1342257685;
...
JAVA_BOOLEAN com_codename1_ui_animations_Motion_isDecayMotion___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    PUSH_INT(6);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1816583170;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1443288375;
...
JAVA_BOOLEAN com_codename1_ui_animations_Motion_isFinished___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    SP[-1].data.l = SP[-1].data.i; /* I2L */
    BC_LCMP();
    if(POP_INT() > 0) /* IFGT */ goto label_L742288;
    if (get_field_com_codename1_ui_animations_Motion_destinationValue(__cn1ThisObject)==get_field_com_codename1_ui_animations_Motion_lastReturnedValue(__cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L742288;
    PUSH_INT(6);
    PUSH_INT(get_field_com_codename1_ui_animations_Motion_motionType(__cn1ThisObject));
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1501761558;
    if (CN1_ARRAY_ELEMENT_INT(get_field_com_codename1_ui_animations_Motion_previousLastReturnedValue(__cn1ThisObject), 0 /* ICONST_0 */)!=get_field_com_codename1_ui_animations_Motion_lastReturnedValue(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1501761558;
...
JAVA_INT com_codename1_ui_animations_Motion_getSplineValue___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1672524765;
...
label_L1672524765:
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_animations_Motion_currentMotionTime(__cn1ThisObject), -1LL)<=0) /* IFLE CustomJump */ goto label_L964557800;
...
label_L964557800:
    ...
    if (get_field_com_codename1_ui_animations_Motion_sourceValue(__cn1ThisObject)>=get_field_com_codename1_ui_animations_Motion_destinationValue(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L2017419121;
    __CN1_DEBUG_INFO(395);
    if (CN1_CMP_EXPR(flocals_2_, flocals_4_)<=0) /* IFLE CustomJump */ goto label_L3641775;
...
label_L2017419121:
    ...
    if (CN1_CMP_EXPR(flocals_2_, flocals_4_)<=0) /* IFLE CustomJump */ goto label_L814473635;
...
label_L239841547:
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_animations_Motion_currentMotionTime(__cn1ThisObject), -1LL)<=0) /* IFLE CustomJump */ goto label_L395076193;
...
label_L395076193:
    ...
    if (get_field_com_codename1_ui_animations_Motion_destinationValue(__cn1ThisObject)<=get_field_com_codename1_ui_animations_Motion_sourceValue(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L2028277706;
...
JAVA_INT com_codename1_ui_animations_Motion_getValue___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_animations_Motion_currentMotionTime(__cn1ThisObject), -1LL)<=0) /* IFLE CustomJump */ goto label_L1992656846;
    PUSH_LONG(get_field_com_codename1_ui_animations_Motion_startTime(__cn1ThisObject));
    { JAVA_LONG tmpResult = virtual_com_codename1_ui_animations_Motion_getCurrentMotionTime___R_long(threadStateData, __cn1ThisObject);
    PUSH_LONG(tmpResult); }
    BC_LCMP();
    if(POP_INT() <= 0) /* IFLE */ goto label_L1992656846;
...
label_L1992656846:
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_animations_Motion_previousCurrentMotionTime(__cn1ThisObject), 0 /* LCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L44989469;
...
label_L44989469:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1382394077;
        case 2: goto label_L1525953166;
        case 3: goto label_L5584361;
        case 4: goto label_L1911222122;
        case 5: goto label_L238457546;
        case 6: goto label_L1974317504;
        default: goto label_L1560160481;
    }
...
label_L484801467:
    if (ilocals_7_<0) /* IFLT CustomJump */ goto label_L1087598842;
    ...
    if (CN1_CMP_EXPR(llocals_8_, 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1087598842;
    if (CN1_CMP_EXPR(llocals_1_, llocals_8_)!=0) /* IFNE CustomJump */ goto label_L1483270801;
...
label_L1483270801:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L1971087453;
    BC_DLOAD(11);
...
label_L112176935:
    if (ilocals_4_<0) /* IFLT CustomJump */ goto label_L54929108;
    ...
    if (CN1_CMP_EXPR(llocals_5_, 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L54929108;
    if (CN1_CMP_EXPR(llocals_2_, llocals_5_)!=0) /* IFNE CustomJump */ goto label_L367954017;
...
JAVA_INT com_codename1_ui_animations_Motion_getLinear___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L832578794;
...
label_L832578794:
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_animations_Motion_currentMotionTime(__cn1ThisObject), -1LL)<=0) /* IFLE CustomJump */ goto label_L56804492;
...
label_L56804492:
    ...
    if (get_field_com_codename1_ui_animations_Motion_destinationValue(__cn1ThisObject)>=get_field_com_codename1_ui_animations_Motion_sourceValue(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1655630081;
...
JAVA_INT com_codename1_ui_animations_Motion_getColorLinear___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L428057828;
...
label_L428057828:
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_animations_Motion_currentMotionTime(__cn1ThisObject), -1LL)<=0) /* IFLE CustomJump */ goto label_L699679818;
...
label_L689218344:
    ...
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L758417002;
...
label_L640225682:
    ...
    if (ilocals_8_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L668330752;
...
JAVA_INT com_codename1_ui_animations_Motion_getFriction___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_animations_Motion_initVelocity(__cn1ThisObject), 0 /* DCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L576374247;
...
label_L576374247:
    ...
    if (get_field_com_codename1_ui_animations_Motion_destinationValue(__cn1ThisObject)<=get_field_com_codename1_ui_animations_Motion_sourceValue(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L1284634047;
...
JAVA_INT com_codename1_ui_animations_Motion_getExponentialDecay___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_animations_Motion_destinationValue(__cn1ThisObject)<=get_field_com_codename1_ui_animations_Motion_sourceValue(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L1150585542;
...
JAVA_INT com_codename1_ui_animations_Motion_getRubber___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1338136300;
...
label_L1338136300:
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_animations_Motion_currentMotionTime(__cn1ThisObject), -1LL)<=0) /* IFLE CustomJump */ goto label_L1002690318;
...
label_L1002690318:
    ...
    if (get_field_com_codename1_ui_animations_Motion_sourceValue(__cn1ThisObject)>=get_field_com_codename1_ui_animations_Motion_destinationValue(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L2025644484;
