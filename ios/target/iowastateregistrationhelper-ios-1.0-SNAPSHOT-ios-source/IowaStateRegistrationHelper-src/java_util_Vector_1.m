...
JAVA_OBJECT java_util_Vector_1_nextElement___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL71590441601;
    int tryBlockOffsetL71590441601;
    DEFINE_CATCH_BLOCK(catch_L71590441601, label_L2024453272, restoreToL71590441601);
...
label_L715904416:
 tryBlockOffsetL71590441601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L71590441601);
    restoreToL71590441601 = threadStateData->threadObjectStackOffset;
