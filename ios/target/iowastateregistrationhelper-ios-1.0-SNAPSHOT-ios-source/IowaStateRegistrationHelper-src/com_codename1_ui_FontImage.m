...
JAVA_OBJECT com_codename1_ui_FontImage_getMaterialDesignFont___R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_ui_FontImage_materialDesignFont(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1715606187;
    __CN1_DEBUG_INFO(11179);
    if (com_codename1_ui_Font_isTrueTypeFileSupported___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L647218712;
...
JAVA_INT com_codename1_ui_FontImage_rightSize___com_codename1_ui_plaf_Style_float_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_FLOAT __cn1Arg2) {
    ...
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L876864630;
...
JAVA_BOOLEAN com_codename1_ui_FontImage_setMaterialIcon___com_codename1_ui_Component_char_float_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_CHAR __cn1Arg2, JAVA_FLOAT __cn1Arg3) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L2093996783;
...
JAVA_VOID com_codename1_ui_FontImage_setIcon___com_codename1_ui_IconHolder_com_codename1_ui_Font_char_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_CHAR __cn1Arg3, JAVA_FLOAT __cn1Arg4) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L854977732;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(11278);
    ...
    if (virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[6].data.o)!=virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L431939256;
    if (virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[6].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L431939256;
    if (virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[6].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L431939256;
    if (virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[6].data.o)==virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L463759298;
...
label_L1677115089:
    ...
    if (virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[7].data.o)!=virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L2130242983;
    if (virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[7].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L2130242983;
    if (virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[7].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L2130242983;
    if (virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[7].data.o)==virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L291284958;
...
label_L704530496:
    ...
    if (virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[8].data.o)!=virtual_com_codename1_ui_plaf_Style_getFgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L2133359512;
    if (virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[8].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgColor___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L2133359512;
    if (virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[8].data.o)!=virtual_com_codename1_ui_plaf_Style_getBgTransparency___R_byte(threadStateData, locals[4].data.o)) /* IF_ICMPNE CustomJump */ goto label_L2133359512;
    if (virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[8].data.o)==virtual_com_codename1_ui_plaf_Style_getFgAlpha___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPEQ CustomJump */ goto label_L1183065103;
...
JAVA_OBJECT com_codename1_ui_FontImage_sizeFont___com_codename1_ui_Font_int_int_R_com_codename1_ui_Font(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (com_codename1_ui_Font_isTrueTypeFileSupported___R_boolean(threadStateData)!=0) /* IFNE CustomJump */ goto label_L117859171;
...
label_L117859171:
    ...
    if (ilocals_4_==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1974701110;
...
JAVA_VOID com_codename1_ui_FontImage_drawImage___com_codename1_ui_Graphics_java_lang_Object_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    if (get_field_com_codename1_ui_FontImage_opacity(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1193577032;
    PUSH_INT(get_field_com_codename1_ui_FontImage_opacity(__cn1ThisObject));
    PUSH_INT(255);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1193577032;
...
label_L1193577032:
    ...
    if (get_field_com_codename1_ui_FontImage_backgroundOpacity(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L592048461;
...
label_L592048461:
    ...
    if (ilocals_9_>0) /* IFGT CustomJump */ goto label_L400593724;
...
label_L400593724:
    ...
    PUSH_INT(255);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L2128310218;
...
label_L2128310218:
    ...
    if (get_field_com_codename1_ui_FontImage_rotated(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L500096147;
...
JAVA_VOID com_codename1_ui_FontImage_drawImage___com_codename1_ui_Graphics_java_lang_Object_int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_INT __cn1Arg6) {
    ...
    if (ilocals_5_!=get_field_com_codename1_ui_FontImage_width(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1653309853;
    if (ilocals_6_!=get_field_com_codename1_ui_FontImage_height(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1653309853;
...
label_L1653309853:
    ...
    if (get_field_com_codename1_ui_FontImage_backgroundOpacity(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1200293689;
...
label_L1200293689:
    ...
    if (ilocals_12_>0) /* IFGT CustomJump */ goto label_L751460639;
...
label_L751460639:
    ...
    if (get_field_com_codename1_ui_FontImage_rotated(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1375297293;
...
JAVA_BOOLEAN com_codename1_ui_FontImage_isAnimation___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_FontImage_rotationMotion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L265330243;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L340441475;
...
JAVA_BOOLEAN com_codename1_ui_FontImage_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_FontImage_rotationMotion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2126392903;
    ...
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, get_field_com_codename1_ui_FontImage_rotationMotion(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1620253123;
...
JAVA_OBJECT com_codename1_ui_FontImage_rotate180Degrees___boolean_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    BC_ALOAD(2);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1670849676;
    PUSH_INT(get_field_com_codename1_ui_FontImage_opacity(__cn1ThisObject));
...
JAVA_OBJECT com_codename1_ui_FontImage_toEncodedImage___R_com_codename1_ui_EncodedImage(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1924999281;
    if (/* CustomInvoke */virtual_com_codename1_ui_util_ImageIO_isFormatSupported___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(100))==0) /* IFEQ CustomJump */ goto label_L1924999281;
...
JAVA_OBJECT com_codename1_ui_FontImage_toImage___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_Image_isAlphaMutableImageSupported___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L2000851008;
