...
JAVA_VOID com_codename1_util_AsyncResource_1___INIT_____com_codename1_util_AsyncResource_boolean_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7251, 201);
...
JAVA_VOID com_codename1_util_AsyncResource_1_update___java_util_Observable_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 7251, 2518);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL168887150101;
    int tryBlockOffsetL168887150101;
    DEFINE_CATCH_BLOCK(catch_L168887150101, label_L1717536993, restoreToL168887150101);
    int restoreToL171753699302;
    int tryBlockOffsetL171753699302;
    DEFINE_CATCH_BLOCK(catch_L171753699302, label_L1717536993, restoreToL171753699302);
    __CN1_DEBUG_INFO(140);
    if (virtual_com_codename1_util_AsyncResource_isDone___R_boolean(threadStateData, get_field_com_codename1_util_AsyncResource_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L111667836, 0);
...
label_L1688871501:
 tryBlockOffsetL168887150101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L168887150101);
    restoreToL168887150101 = threadStateData->threadObjectStackOffset;
...
label_L564045905:
END_TRY(1);    JUMP_TO(label_L111667836, 0);

label_L1717536993:
 tryBlockOffsetL171753699302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L171753699302);
    restoreToL171753699302 = threadStateData->threadObjectStackOffset;
