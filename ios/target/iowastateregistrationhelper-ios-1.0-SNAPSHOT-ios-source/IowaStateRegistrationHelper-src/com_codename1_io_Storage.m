...
JAVA_OBJECT com_codename1_io_Storage_fixFileName___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(69);
    if (get_field_com_codename1_io_Storage_normalizeNames(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L764884044;
    __CN1_DEBUG_INFO(70);
...
JAVA_VOID com_codename1_io_Storage_init___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(89);
    if (com_codename1_io_Util_getImplementation___R_com_codename1_impl_CodenameOneImplementation(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2139332293;
    __CN1_DEBUG_INFO(90);
...
label_L2139332293:
    __CN1_DEBUG_INFO(92);
    if (get_static_com_codename1_io_Storage_INSTANCE(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L603273695;
    __CN1_DEBUG_INFO(93);
...
JAVA_BOOLEAN com_codename1_io_Storage_isInitialized___R_boolean(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_io_Storage_INSTANCE(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L193303381;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L522511165;
...
JAVA_OBJECT com_codename1_io_Storage_getInstance___R_com_codename1_io_Storage(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_io_Storage_INSTANCE(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2083660714;
...
JAVA_OBJECT com_codename1_io_Storage_createInputStream___java_lang_String_R_java_io_InputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_com_codename1_io_Storage_exists___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1988351538;
...
JAVA_BOOLEAN com_codename1_io_Storage_writeObject___java_lang_String_java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL1085767497cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL1085767497cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L1085767497cn1_class_id_java_lang_Exception1, label_L1362881676, restoreToL1085767497cn1_class_id_java_lang_Exception1);
...
label_L1085767497:
 tryBlockOffsetL1085767497cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1085767497cn1_class_id_java_lang_Exception1);
    restoreToL1085767497cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
...
label_L1362881676:
    ...
    if (com_codename1_io_Log_isCrashBound___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1765724317, 0);
...
JAVA_OBJECT com_codename1_io_Storage_readObject___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL268025456cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL268025456cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L268025456cn1_class_id_java_lang_Throwable1, label_L83657059, restoreToL268025456cn1_class_id_java_lang_Throwable1);
    int restoreToL1660369676cn1_class_id_java_lang_Throwable2;
    int tryBlockOffsetL1660369676cn1_class_id_java_lang_Throwable2;
    DEFINE_CATCH_BLOCK(catch_L1660369676cn1_class_id_java_lang_Throwable2, label_L83657059, restoreToL1660369676cn1_class_id_java_lang_Throwable2);
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1814488456, 0);
...
locals[3].type=CN1_TYPE_OBJECT;
label_L268025456:
 tryBlockOffsetL268025456cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L268025456cn1_class_id_java_lang_Throwable1);
    restoreToL268025456cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(262);
    if (/* CustomInvoke */virtual_com_codename1_io_Storage_exists___java_lang_String_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1660369676, 0);
...
label_L1660369676:
 tryBlockOffsetL1660369676cn1_class_id_java_lang_Throwable2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1660369676cn1_class_id_java_lang_Throwable2);
    restoreToL1660369676cn1_class_id_java_lang_Throwable2 = threadStateData->threadObjectStackOffset;
...
label_L83657059:
    ...
    if (com_codename1_io_Log_isCrashBound___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2110957047, 0);
