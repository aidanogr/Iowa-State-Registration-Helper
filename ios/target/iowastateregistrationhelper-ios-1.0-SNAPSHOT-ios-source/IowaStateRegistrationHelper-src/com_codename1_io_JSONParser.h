...
#define virtual_com_codename1_io_JSONParser_parseJSON___java_io_Reader_R_java_util_Map com_codename1_io_JSONParser_parseJSON___java_io_Reader_R_java_util_Map
