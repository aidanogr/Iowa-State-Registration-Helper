...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_8_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL40010124901;
    int tryBlockOffsetL40010124901;
    DEFINE_CATCH_BLOCK(catch_L40010124901, label_L2074492901, restoreToL40010124901);
    int restoreToL207449290102;
    int tryBlockOffsetL207449290102;
    DEFINE_CATCH_BLOCK(catch_L207449290102, label_L2074492901, restoreToL207449290102);
...
locals[9].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(913);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1933077874, 0);
...
label_L1933077874:
    ...
    if (virtual_com_codename1_impl_ios_IOSImplementation_isAsyncEditMode___R_boolean(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1865617081, 0);
...
label_L400101249:
 tryBlockOffsetL40010124901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L40010124901);
    restoreToL40010124901 = threadStateData->threadObjectStackOffset;
...
END_TRY(1);    __CN1_DEBUG_INFO(924);
    ...
    JUMP_TO(label_L308021294, 0);

label_L2074492901:
 tryBlockOffsetL207449290102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L207449290102);
    restoreToL207449290102 = threadStateData->threadObjectStackOffset;
...
label_L1865617081:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Component_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_val_cmp(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(9663))!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1481594007, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1756160273, 0);
...
label_L1756160273:
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ JUMP_TO(label_L530410619, 0);
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L530410619, 0);
    __CN1_DEBUG_INFO(930);
    /* VarOp.assignFrom */     ilocals_11_ = 0 /* ICONST_0 */; 

label_L530410619:
    __CN1_DEBUG_INFO(932);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_8_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1844579038, 0);
