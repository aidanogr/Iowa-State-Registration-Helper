...
const struct clazz *base_interfaces_for_com_codename1_impl_ios_IOSImplementation_36[] = {&class__java_lang_Runnable};
struct clazz class__com_codename1_impl_ios_IOSImplementation_36 = {
  DEBUG_GC_INIT &class__java_lang_Class, 999999, 0, 0, 0, 0, &__FINALIZER_com_codename1_impl_ios_IOSImplementation_36 ,0 , &__GC_MARK_com_codename1_impl_ios_IOSImplementation_36,  0, cn1_class_id_com_codename1_impl_ios_IOSImplementation_36, "com.codename1.impl.ios.IOSImplementation.36", 0, 0, 0, JAVA_FALSE, &class__java_lang_Object, base_interfaces_for_com_codename1_impl_ios_IOSImplementation_36, 1, 0, 0
, 0, 0, 0, JAVA_TRUE, 0, 0};

JAVA_OBJECT get_field_com_codename1_impl_ios_IOSImplementation_36_val_sku(JAVA_OBJECT __cn1T) {
  return (*(struct obj__com_codename1_impl_ios_IOSImplementation_36*)__cn1T).com_codename1_impl_ios_IOSImplementation_36_val_sku;
}

void set_field_com_codename1_impl_ios_IOSImplementation_36_val_sku(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Val, JAVA_OBJECT __cn1T) {
    (*(struct obj__com_codename1_impl_ios_IOSImplementation_36*)__cn1T).com_codename1_impl_ios_IOSImplementation_36_val_sku = __cn1Val;
}
...
void __GC_MARK_com_codename1_impl_ios_IOSImplementation_36(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force) {
    ...
    gcMarkObject(threadStateData, objInstance->com_codename1_impl_ios_IOSImplementation_36_val_sku, force);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_36___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9637, 200);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(8720);
    set_field_com_codename1_impl_ios_IOSImplementation_36_val_sku(threadStateData, locals[1].data.o, __cn1ThisObject);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_36_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 9637, 202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(8723);
    /* CustomInvoke */virtual_com_codename1_impl_ios_IOSImplementation_addPurchase___java_lang_String(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData), get_field_com_codename1_impl_ios_IOSImplementation_36_val_sku(__cn1ThisObject)); 
    __CN1_DEBUG_INFO(8724);
    if (com_codename1_impl_ios_IOSImplementation_access$6700___R_com_codename1_payment_PurchaseCallback(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1846539844;
    __CN1_DEBUG_INFO(8725);
    PUSH_OBJ(com_codename1_impl_ios_IOSImplementation_access$6700___R_com_codename1_payment_PurchaseCallback(threadStateData));
    /* CustomInvoke */virtual_com_codename1_payment_PurchaseCallback_itemPurchased___java_lang_String(threadStateData, SP[-1].data.o, get_field_com_codename1_impl_ios_IOSImplementation_36_val_sku(__cn1ThisObject));     SP -= 1;

label_L1846539844:
    __CN1_DEBUG_INFO(8727);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
...
void __STATIC_INITIALIZER_com_codename1_impl_ios_IOSImplementation_36(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_impl_ios_IOSImplementation_36.vtable = malloc(sizeof(void*) *11);
