...
JAVA_VOID com_codename1_processing_PrettyPrinter___INIT_____java_util_Map(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7673, 201);
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_print___java_util_Map_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_processing_PrettyPrinter(threadStateData);
    DEFINE_METHOD_STACK(3, 1, 0, 7673, 935);
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_print___java_util_Map_int_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_com_codename1_processing_PrettyPrinter(threadStateData);
    DEFINE_METHOD_STACK(3, 4, 0, 7673, 935);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_print___java_util_List_int_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_com_codename1_processing_PrettyPrinter(threadStateData);
    DEFINE_METHOD_STACK(4, 8, 0, 7673, 935);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    ilocals_2_ = __cn1Arg3;
    ...
    __CN1_DEBUG_INFO(76);
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1705558790;
    __CN1_DEBUG_INFO(77);
...
label_L1705558790:
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_StringBuffer___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1920));     SP -= 1;
    BC_ASTORE(5);
    __CN1_DEBUG_INFO(81);
    if (ilocals_3_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1909332462;
    __CN1_DEBUG_INFO(82);
    BC_ALOAD(5);
...
label_L1206325076:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L841975037;
    __CN1_DEBUG_INFO(88);
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L289194317;
    __CN1_DEBUG_INFO(89);
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___java_lang_String_R_java_lang_StringBuffer(threadStateData, locals[5].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7674)); 
...
label_L816224332:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1220163548;
    __CN1_DEBUG_INFO(99);
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___char_R_java_lang_StringBuffer(threadStateData, locals[5].data.o, 32); 
    __CN1_DEBUG_INFO(98);
    BC_IINC(4, 1);
    goto label_L816224332;
...
JAVA_INT com_codename1_processing_PrettyPrinter_length___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7673, 888);
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_keys___R_java_util_Enumeration(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7673, 1990);
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_toString___int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* indentFactor */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7673, 898);
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_toString___int_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_INT ilocals_7_ = 0; /* v7 */
    DEFINE_INSTANCE_METHOD_STACK(4, 9, 0, 7673, 898);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L1160785510;
...
label_L1160785510:
    ...
    PUSH_POINTER(__NEW_java_lang_StringBuffer(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_StringBuffer___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5253));     SP -= 1;
    BC_ASTORE(6);
    __CN1_DEBUG_INFO(161);
    /* VarOp.assignFrom */ ilocals_7_=(ilocals_2_ + ilocals_1_);
    __CN1_DEBUG_INFO(163);
    if (ilocals_4_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1204036307;
    ...
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___java_lang_String_R_java_lang_StringBuffer(threadStateData, locals[6].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(921)); 
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    SP--; /* POP */
    goto label_L942016720;

label_L1204036307:
    __CN1_DEBUG_INFO(170);
    if (virtual_java_util_Enumeration_hasMoreElements___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1011254112;
    ...
    if (virtual_java_lang_StringBuffer_length___R_int(threadStateData, locals[6].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L2017577360;
    __CN1_DEBUG_INFO(173);
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___java_lang_String_R_java_lang_StringBuffer(threadStateData, locals[6].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7674)); 
    goto label_L511033073;
...
label_L508074327:
    if (ilocals_3_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L379409767;
...
label_L379409767:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    SP--; /* POP */
    goto label_L1204036307;

label_L1011254112:
    __CN1_DEBUG_INFO(185);
    if (virtual_java_lang_StringBuffer_length___R_int(threadStateData, locals[6].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L942016720;
...
label_L1756618311:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L942016720;
    __CN1_DEBUG_INFO(188);
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___char_R_java_lang_StringBuffer(threadStateData, locals[6].data.o, 32); 
    __CN1_DEBUG_INFO(187);
    BC_IINC(3, 1);
    goto label_L1756618311;
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_valueToString___java_lang_Object_int_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* indent */
    __STATIC_INITIALIZER_com_codename1_processing_PrettyPrinter(threadStateData);
    DEFINE_METHOD_STACK(3, 4, 0, 7673, 7675);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    ilocals_2_ = __cn1Arg3;
    int restoreToL2098233443cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL2098233443cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L2098233443cn1_class_id_java_lang_Exception1, label_L1535276950, restoreToL2098233443cn1_class_id_java_lang_Exception1);
    __CN1_DEBUG_INFO(212);
    if (locals[0].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L667428844, 0);
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[0].data.o, JAVA_NULL /* ACONST_NULL */)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2098233443, 0);

label_L667428844:
    __CN1_DEBUG_INFO(213);
    releaseForReturnInException(threadStateData, cn1LocalsBeginInThread, methodBlockOffset); return STRING_FROM_CONSTANT_POOL_OFFSET(902);

label_L2098233443:
 tryBlockOffsetL2098233443cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L2098233443cn1_class_id_java_lang_Exception1);
    restoreToL2098233443cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(216);
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L187115616, 0);
...
label_L1129435221:
    ...
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L633366676, 0);
    BC_ALOAD(0);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1546315735, 0);
...
label_L1546315735:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1853665306, 0);
...
label_L1853665306:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L593626872, 0);
...
label_L593626872:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L96489160, 0);
...
label_L96489160:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L241108472, 0);
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_quote___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    __STATIC_INITIALIZER_com_codename1_processing_PrettyPrinter(threadStateData);
    DEFINE_METHOD_STACK(5, 7, 0, 7673, 133);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(251);
    if (locals[0].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L94931017;
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[0].data.o)!=0) /* IFNE CustomJump */ goto label_L919473090;
...
label_L1810650734:
    if (ilocals_3_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L830449117;
    ...
    SP--;
    switch((*SP).data.i) {
        case 8: goto label_L1199113935;
        case 9: goto label_L106050729;
        case 10: goto label_L1074053050;
        case 12: goto label_L203012906;
        case 13: goto label_L56204056;
        case 34: goto label_L339280038;
        case 47: goto label_L1898288372;
        case 92: goto label_L339280038;
        default: goto label_L816095505;
    }
...
label_L1898288372:
    ...
    SP++;
    PUSH_INT(60);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L596278845;
...
label_L1199113935:
    ...
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___java_lang_String_R_java_lang_StringBuffer(threadStateData, locals[5].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7500)); 
    __CN1_DEBUG_INFO(280);
    goto label_L2137681222;

label_L106050729:
    __CN1_DEBUG_INFO(282);
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___java_lang_String_R_java_lang_StringBuffer(threadStateData, locals[5].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7501)); 
    __CN1_DEBUG_INFO(283);
    goto label_L2137681222;

label_L1074053050:
    __CN1_DEBUG_INFO(285);
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___java_lang_String_R_java_lang_StringBuffer(threadStateData, locals[5].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7502)); 
    __CN1_DEBUG_INFO(286);
    goto label_L2137681222;

label_L203012906:
    __CN1_DEBUG_INFO(288);
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___java_lang_String_R_java_lang_StringBuffer(threadStateData, locals[5].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7503)); 
    __CN1_DEBUG_INFO(289);
    goto label_L2137681222;

label_L56204056:
    __CN1_DEBUG_INFO(291);
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___java_lang_String_R_java_lang_StringBuffer(threadStateData, locals[5].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7504)); 
...
label_L816095505:
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L2127940748;
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_trimNumber___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_processing_PrettyPrinter(threadStateData);
    DEFINE_METHOD_STACK(4, 1, 0, 7673, 7676);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(341);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[0].data.o, 46)<=0) /* IFLE CustomJump */ goto label_L2075339084;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[0].data.o, 101)>=0) /* IFGE CustomJump */ goto label_L2075339084;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[0].data.o, 69)>=0) /* IFGE CustomJump */ goto label_L2075339084;

label_L1482151715:
    __CN1_DEBUG_INFO(342);
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1852))==0) /* IFEQ CustomJump */ goto label_L255401554;
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    BC_ASTORE(0);
    goto label_L1482151715;

label_L255401554:
    __CN1_DEBUG_INFO(345);
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(683))==0) /* IFEQ CustomJump */ goto label_L2075339084;
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_numberToString___java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_processing_PrettyPrinter(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 7673, 7677);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(359);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1263633989;
