...
JAVA_OBJECT com_codename1_util_AsyncResource_get___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL28751365cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL28751365cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L28751365cn1_class_id_java_lang_InterruptedException1, label_L254093154, restoreToL28751365cn1_class_id_java_lang_InterruptedException1);

label_L28751365:
 tryBlockOffsetL28751365cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L28751365cn1_class_id_java_lang_InterruptedException1);
    restoreToL28751365cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_util_AsyncResource_get___int_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_CATCH_BLOCK(catch_L53527041901, label_L1534376821, restoreToL53527041901);
    int restoreToL153437682102;
    int tryBlockOffsetL153437682102;
    DEFINE_CATCH_BLOCK(catch_L153437682102, label_L1534376821, restoreToL153437682102);
    __CN1_DEBUG_INFO(130);
    if (ilocals_1_<=0) /* IFLE CustomJump */ JUMP_TO(label_L1734079809, 0);
    PUSH_LONG(java_lang_System_currentTimeMillis___R_long(threadStateData));
    JUMP_TO(label_L715949995, 0);
...
label_L715949995:
    ...
    if (get_field_com_codename1_util_AsyncResource_done(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L202685355, 0);
    if (get_field_com_codename1_util_AsyncResource_error(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L202685355, 0);
...
label_L202685355:
    ...
    if (get_field_com_codename1_util_AsyncResource_done(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1925514831, 0);
    if (get_field_com_codename1_util_AsyncResource_error(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1925514831, 0);
...
label_L2006906315:
    ...
    if (CN1_ARRAY_ELEMENT_BYTE(locals[4].data.o, 0 /* ICONST_0 */)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1242301611, 0);
    __CN1_DEBUG_INFO(150);
    if (ilocals_1_<=0) /* IFLE CustomJump */ JUMP_TO(label_L72565662, 0);
    PUSH_LONG(java_lang_System_currentTimeMillis___R_long(threadStateData));
    BC_LLOAD(2);
    ...
    BC_LCMP();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L72565662, 0);
...
label_L72565662:
    ...
    if (com_codename1_ui_CN_isEdt___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L758348124, 0);
...
label_L535270419:
 tryBlockOffsetL53527041901 = threadStateData->tryBlockOffset;
    ...
    if (ilocals_1_<=0) /* IFLE CustomJump */ JUMP_TO(label_L1570606799, 1);
...
label_L1225848924:
END_TRY(1);    JUMP_TO(label_L1971524077, 0);

label_L1534376821:
 tryBlockOffsetL153437682102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L153437682102);
    restoreToL153437682102 = threadStateData->threadObjectStackOffset;
...
label_L1242301611:
    ...
    if (get_field_com_codename1_util_AsyncResource_error(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1966314043, 0);
...
JAVA_OBJECT com_codename1_util_AsyncResource_get___java_lang_Object_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_util_AsyncResource_value(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1625681616;
...
JAVA_OBJECT com_codename1_util_AsyncResource_ready___com_codename1_util_SuccessCallback_com_codename1_util_EasyThread_R_com_codename1_util_AsyncResource(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL198127838901;
    int tryBlockOffsetL198127838901;
    DEFINE_CATCH_BLOCK(catch_L198127838901, label_L239471777, restoreToL198127838901);
    int restoreToL23947177702;
    int tryBlockOffsetL23947177702;
    DEFINE_CATCH_BLOCK(catch_L23947177702, label_L239471777, restoreToL23947177702);
...
label_L1981278389:
 tryBlockOffsetL198127838901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L198127838901);
    restoreToL198127838901 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(346);
    if (get_field_com_codename1_util_AsyncResource_done(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1092280535, 1);
    if (get_field_com_codename1_util_AsyncResource_error(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1092280535, 1);
    ...
    BC_ASTORE(3);
    JUMP_TO(label_L1619796034, 1);

label_L1092280535:
    __CN1_DEBUG_INFO(349);
    if (get_field_com_codename1_util_AsyncResource_successCallback(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L2122622251, 1);
...
label_L239471777:
 tryBlockOffsetL23947177702 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L23947177702);
    restoreToL23947177702 = threadStateData->threadObjectStackOffset;
...
label_L1075420510:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1452528082, 0);
...
JAVA_OBJECT com_codename1_util_AsyncResource_except___com_codename1_util_SuccessCallback_com_codename1_util_EasyThread_R_com_codename1_util_AsyncResource(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL40920160601;
    int tryBlockOffsetL40920160601;
    DEFINE_CATCH_BLOCK(catch_L40920160601, label_L1461482866, restoreToL40920160601);
    int restoreToL146148286602;
    int tryBlockOffsetL146148286602;
    DEFINE_CATCH_BLOCK(catch_L146148286602, label_L1461482866, restoreToL146148286602);
...
label_L409201606:
 tryBlockOffsetL40920160601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L40920160601);
    restoreToL40920160601 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(394);
    if (get_field_com_codename1_util_AsyncResource_done(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L208289607, 1);
    if (get_field_com_codename1_util_AsyncResource_error(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L208289607, 1);
    __CN1_DEBUG_INFO(395);
    PUSH_POINTER(__NEW_com_codename1_util_AsyncResource_AsyncCallback(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_util_AsyncResource_AsyncCallback___INIT_____com_codename1_util_AsyncResource_com_codename1_util_SuccessCallback_com_codename1_util_EasyThread(threadStateData, SP[-1].data.o, __cn1ThisObject, locals[1].data.o, locals[2].data.o);     SP -= 1;
    BC_ASTORE(3);
    JUMP_TO(label_L1417465, 1);

label_L208289607:
    __CN1_DEBUG_INFO(397);
    if (get_field_com_codename1_util_AsyncResource_errorCallback(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1212214376, 1);
...
label_L1904629384:
END_TRY(1);    JUMP_TO(label_L2093197303, 0);

label_L1461482866:
 tryBlockOffsetL146148286602 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L146148286602);
    restoreToL146148286602 = threadStateData->threadObjectStackOffset;
...
label_L2093197303:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L554577711, 0);
...
JAVA_VOID com_codename1_util_AsyncResource_complete___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL13407813301;
    int tryBlockOffsetL13407813301;
    DEFINE_CATCH_BLOCK(catch_L13407813301, label_L204554655, restoreToL13407813301);
    int restoreToL20455465502;
    int tryBlockOffsetL20455465502;
    DEFINE_CATCH_BLOCK(catch_L20455465502, label_L204554655, restoreToL20455465502);
...
label_L134078133:
 tryBlockOffsetL13407813301 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L13407813301);
    restoreToL13407813301 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_util_AsyncResource_successCallback(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1138614237, 1);
...
label_L204554655:
 tryBlockOffsetL20455465502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L20455465502);
    restoreToL20455465502 = threadStateData->threadObjectStackOffset;
...
label_L583021646:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1919352942, 0);
...
JAVA_VOID com_codename1_util_AsyncResource_error___java_lang_Throwable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL63778205001;
    int tryBlockOffsetL63778205001;
    DEFINE_CATCH_BLOCK(catch_L63778205001, label_L1952221700, restoreToL63778205001);
...
label_L637782050:
 tryBlockOffsetL63778205001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L63778205001);
    restoreToL63778205001 = threadStateData->threadObjectStackOffset;
    ...
    if (get_field_com_codename1_util_AsyncResource_errorCallback(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1506971749, 1);
...
label_L1330615528:
END_TRY(1);    JUMP_TO(label_L2048109909, 0);
...
label_L2048109909:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L809350665, 0);
