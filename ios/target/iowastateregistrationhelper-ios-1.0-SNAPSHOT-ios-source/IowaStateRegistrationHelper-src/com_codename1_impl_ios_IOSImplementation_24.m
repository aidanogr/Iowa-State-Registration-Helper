...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_24_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL192361371701;
    int tryBlockOffsetL192361371701;
    DEFINE_CATCH_BLOCK(catch_L192361371701, label_L1627496281, restoreToL192361371701);

label_L1923613717:
 tryBlockOffsetL192361371701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L192361371701);
    restoreToL192361371701 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(8033);
    if (get_field_com_codename1_impl_ios_IOSImplementation_24_val_type(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1659435106, 1);
