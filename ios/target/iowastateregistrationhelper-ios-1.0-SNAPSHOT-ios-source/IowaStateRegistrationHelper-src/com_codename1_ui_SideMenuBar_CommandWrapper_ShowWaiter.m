...
JAVA_VOID com_codename1_ui_SideMenuBar_CommandWrapper_ShowWaiter___INIT_____com_codename1_ui_SideMenuBar_CommandWrapper(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7064, 201);
...
JAVA_VOID com_codename1_ui_SideMenuBar_CommandWrapper_ShowWaiter_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(7, 6, 0, 7064, 203);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL615333072cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL615333072cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L615333072cn1_class_id_java_lang_Exception1, label_L853955254, restoreToL615333072cn1_class_id_java_lang_Exception1);
    int restoreToL202241798202;
    int tryBlockOffsetL202241798202;
    DEFINE_CATCH_BLOCK(catch_L202241798202, label_L1268786037, restoreToL202241798202);
    int restoreToL126878603703;
    int tryBlockOffsetL126878603703;
    DEFINE_CATCH_BLOCK(catch_L126878603703, label_L1268786037, restoreToL126878603703);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1972628089, 0);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L847841178, 0);
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L847841178, 0);
...
label_L2022417982:
 tryBlockOffsetL202241798202 = threadStateData->tryBlockOffset;
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_SideMenuBar_access$000___com_codename1_ui_SideMenuBar_R_com_codename1_ui_Form(threadStateData, get_field_com_codename1_ui_SideMenuBar_CommandWrapper_this_0(get_field_com_codename1_ui_SideMenuBar_CommandWrapper_ShowWaiter_this_1(__cn1ThisObject))));
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L855277727, 1);

label_L615333072:
 tryBlockOffsetL615333072cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L615333072cn1_class_id_java_lang_Exception1);
    restoreToL615333072cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
...
label_L1280763505:
END_TRY(1);    JUMP_TO(label_L312560500, 0);

label_L1268786037:
 tryBlockOffsetL126878603703 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L126878603703);
    restoreToL126878603703 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_SideMenuBar_CommandWrapper_ShowWaiter_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 7064, 3056);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL160967444601;
    int tryBlockOffsetL160967444601;
    DEFINE_CATCH_BLOCK(catch_L160967444601, label_L1760443245, restoreToL160967444601);
    int restoreToL176044324502;
    int tryBlockOffsetL176044324502;
    DEFINE_CATCH_BLOCK(catch_L176044324502, label_L1760443245, restoreToL176044324502);
...
label_L1609674446:
 tryBlockOffsetL160967444601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L160967444601);
    restoreToL160967444601 = threadStateData->threadObjectStackOffset;
...
label_L442572487:
END_TRY(1);    JUMP_TO(label_L242659479, 0);

label_L1760443245:
 tryBlockOffsetL176044324502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L176044324502);
    restoreToL176044324502 = threadStateData->threadObjectStackOffset;
