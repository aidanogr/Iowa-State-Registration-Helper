...
JAVA_VOID com_codename1_ui_SideMenuBar_CommandWrapper_ShowWaiter_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL2079057374cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL2079057374cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L2079057374cn1_class_id_java_lang_Exception1, label_L464606033, restoreToL2079057374cn1_class_id_java_lang_Exception1);
    int restoreToL170871192802;
    int tryBlockOffsetL170871192802;
    DEFINE_CATCH_BLOCK(catch_L170871192802, label_L1336418989, restoreToL170871192802);
    int restoreToL133641898903;
    int tryBlockOffsetL133641898903;
    DEFINE_CATCH_BLOCK(catch_L133641898903, label_L1336418989, restoreToL133641898903);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1501497655, 0);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L2060569250, 0);
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2060569250, 0);
...
label_L1708711928:
 tryBlockOffsetL170871192802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L170871192802);
    restoreToL170871192802 = threadStateData->threadObjectStackOffset;
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_SideMenuBar_access$000___com_codename1_ui_SideMenuBar_R_com_codename1_ui_Form(threadStateData, get_field_com_codename1_ui_SideMenuBar_CommandWrapper_this_0(get_field_com_codename1_ui_SideMenuBar_CommandWrapper_ShowWaiter_this_1(__cn1ThisObject))));
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L1802188146, 1);

label_L2079057374:
 tryBlockOffsetL2079057374cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L2079057374cn1_class_id_java_lang_Exception1);
    restoreToL2079057374cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
...
label_L1830602785:
END_TRY(1);    JUMP_TO(label_L1146045637, 0);

label_L1336418989:
 tryBlockOffsetL133641898903 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L133641898903);
    restoreToL133641898903 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_SideMenuBar_CommandWrapper_ShowWaiter_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL144415790201;
    int tryBlockOffsetL144415790201;
    DEFINE_CATCH_BLOCK(catch_L144415790201, label_L809439796, restoreToL144415790201);
    int restoreToL80943979602;
    int tryBlockOffsetL80943979602;
    DEFINE_CATCH_BLOCK(catch_L80943979602, label_L809439796, restoreToL80943979602);
...
label_L1444157902:
 tryBlockOffsetL144415790201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L144415790201);
    restoreToL144415790201 = threadStateData->threadObjectStackOffset;
...
label_L1768385436:
END_TRY(1);    JUMP_TO(label_L38625764, 0);

label_L809439796:
 tryBlockOffsetL80943979602 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L80943979602);
    restoreToL80943979602 = threadStateData->threadObjectStackOffset;
