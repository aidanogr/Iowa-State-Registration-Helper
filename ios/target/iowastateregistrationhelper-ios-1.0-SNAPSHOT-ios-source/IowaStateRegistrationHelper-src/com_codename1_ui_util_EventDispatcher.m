...
JAVA_VOID com_codename1_ui_util_EventDispatcher_addListener___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2140635066;
    __CN1_DEBUG_INFO(134);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1148088421;
...
label_L1148088421:
    ...
    if (/* CustomInvoke */virtual_java_util_ArrayList_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject), locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L2140635066;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_removeListener___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L224738881;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireDataChangeEvent___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    int restoreToL201763561801;
    int tryBlockOffsetL201763561801;
    DEFINE_CATCH_BLOCK(catch_L201763561801, label_L997770883, restoreToL201763561801);
    int restoreToL99777088302;
    int tryBlockOffsetL99777088302;
    DEFINE_CATCH_BLOCK(catch_L99777088302, label_L997770883, restoreToL99777088302);
    __CN1_DEBUG_INFO(180);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2136347897, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1208794670, 0);
...
label_L1208794670:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1816073816, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1816073816, 0);
...
label_L2017635618:
 tryBlockOffsetL201763561801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L201763561801);
    restoreToL201763561801 = threadStateData->threadObjectStackOffset;
...
label_L1588635270:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L286169474, 1);
...
label_L1038280073:
END_TRY(1);    JUMP_TO(label_L1935707824, 0);

label_L997770883:
 tryBlockOffsetL99777088302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L99777088302);
    restoreToL99777088302 = threadStateData->threadObjectStackOffset;
...
label_L1935707824:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1744423762, 0);
...
label_L1744423762:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1493274349, 0);
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireBindTargetChange___com_codename1_ui_Component_java_lang_String_java_lang_Object_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    ...
    int restoreToL199382195001;
    int tryBlockOffsetL199382195001;
    DEFINE_CATCH_BLOCK(catch_L199382195001, label_L786669171, restoreToL199382195001);
    int restoreToL78666917102;
    int tryBlockOffsetL78666917102;
    DEFINE_CATCH_BLOCK(catch_L78666917102, label_L786669171, restoreToL78666917102);
    __CN1_DEBUG_INFO(221);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L124351398, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1906635841, 0);
...
label_L1993821950:
 tryBlockOffsetL199382195001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L199382195001);
    restoreToL199382195001 = threadStateData->threadObjectStackOffset;
...
label_L371554459:
    if (ilocals_8_>=ilocals_7_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L612854398, 1);
...
label_L1653957392:
END_TRY(1);    JUMP_TO(label_L1511906746, 0);

label_L786669171:
 tryBlockOffsetL78666917102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L78666917102);
    restoreToL78666917102 = threadStateData->threadObjectStackOffset;
...
label_L1511906746:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isEdt___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L206384196, 0);
...
label_L206384196:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L786047074, 0);
...
label_L2144659477:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L446613518;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireStyleChangeEvent___java_lang_String_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL101530123801;
    int tryBlockOffsetL101530123801;
    DEFINE_CATCH_BLOCK(catch_L101530123801, label_L1600869357, restoreToL101530123801);
    int restoreToL160086935702;
    int tryBlockOffsetL160086935702;
    DEFINE_CATCH_BLOCK(catch_L160086935702, label_L1600869357, restoreToL160086935702);
    __CN1_DEBUG_INFO(268);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L550351186, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1291834365, 0);
...
label_L1291834365:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L347282999, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L347282999, 0);
...
label_L1015301238:
 tryBlockOffsetL101530123801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L101530123801);
    restoreToL101530123801 = threadStateData->threadObjectStackOffset;
...
label_L1548269356:
    if (ilocals_6_>=CN1_ARRAY_LENGTH(locals[4].data.o)) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L289592183, 1);
...
label_L1184940767:
END_TRY(1);    JUMP_TO(label_L1847256931, 0);

label_L1600869357:
 tryBlockOffsetL160086935702 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L160086935702);
    restoreToL160086935702 = threadStateData->threadObjectStackOffset;
...
label_L1847256931:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1658064433, 0);
...
label_L1658064433:
    ...
    if (get_static_com_codename1_ui_util_EventDispatcher_fireStyleEventsOnNonEDT(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1695195255, 0);
...
label_L1165646637:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L2095225389;
...
label_L925131177:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L127758389;
...
label_L1221274995:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1610593938;
...
label_L814150784:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L607907975;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireActionEvent___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL161816949101;
    int tryBlockOffsetL161816949101;
    DEFINE_CATCH_BLOCK(catch_L161816949101, label_L309301028, restoreToL161816949101);
    int restoreToL30930102802;
    int tryBlockOffsetL30930102802;
    DEFINE_CATCH_BLOCK(catch_L30930102802, label_L309301028, restoreToL30930102802);
    __CN1_DEBUG_INFO(341);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L56531119, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L2015035275, 0);
...
label_L2015035275:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L2143233788, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L2143233788, 0);
...
label_L1618169491:
 tryBlockOffsetL161816949101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L161816949101);
    restoreToL161816949101 = threadStateData->threadObjectStackOffset;
...
label_L1714153975:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L298287232, 1);
...
label_L1545729538:
END_TRY(1);    JUMP_TO(label_L1231205406, 0);

label_L309301028:
 tryBlockOffsetL30930102802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L30930102802);
    restoreToL30930102802 = threadStateData->threadObjectStackOffset;
...
label_L1231205406:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1340928776, 0);
...
label_L1340928776:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1532989443, 0);
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireSelectionEvent___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    int restoreToL53636506001;
    int tryBlockOffsetL53636506001;
    DEFINE_CATCH_BLOCK(catch_L53636506001, label_L130096434, restoreToL53636506001);
    int restoreToL13009643402;
    int tryBlockOffsetL13009643402;
    DEFINE_CATCH_BLOCK(catch_L13009643402, label_L130096434, restoreToL13009643402);
    __CN1_DEBUG_INFO(382);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L798874225, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1478984550, 0);
...
label_L1478984550:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L2136985577, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L2136985577, 0);
...
label_L536365060:
 tryBlockOffsetL53636506001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L53636506001);
    restoreToL53636506001 = threadStateData->threadObjectStackOffset;
...
label_L838301585:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1886938557, 1);
    __CN1_DEBUG_INFO(397);
    CN1_SET_ARRAY_ELEMENT_OBJECT(locals[4].data.o, ilocals_7_, /* CustomInvoke */virtual_java_util_ArrayList_get___int_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject), ilocals_7_));
    __CN1_DEBUG_INFO(396);
    BC_IINC(7, 1);
    JUMP_TO(label_L838301585, 1);
...
label_L532306605:
END_TRY(1);    JUMP_TO(label_L1429204602, 0);

label_L130096434:
 tryBlockOffsetL13009643402 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L13009643402);
    restoreToL13009643402 = threadStateData->threadObjectStackOffset;
...
label_L1429204602:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1418609585, 0);
...
label_L1418609585:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1831418259, 0);
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireScrollEvent___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    ilocals_3_ = __cn1Arg3;
    ilocals_4_ = __cn1Arg4;
    int restoreToL113065065701;
    int tryBlockOffsetL113065065701;
    DEFINE_CATCH_BLOCK(catch_L113065065701, label_L1197430386, restoreToL113065065701);
    int restoreToL119743038602;
    int tryBlockOffsetL119743038602;
    DEFINE_CATCH_BLOCK(catch_L119743038602, label_L1197430386, restoreToL119743038602);
    __CN1_DEBUG_INFO(420);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1634338531, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1110014943, 0);
...
label_L1110014943:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1726490536, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L1726490536, 0);
...
label_L1130650657:
 tryBlockOffsetL113065065701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L113065065701);
    restoreToL113065065701 = threadStateData->threadObjectStackOffset;
...
label_L1783978315:
    if (ilocals_9_>=ilocals_8_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1538855361, 1);
...
label_L2127003431:
END_TRY(1);    JUMP_TO(label_L1663774813, 0);

label_L1197430386:
 tryBlockOffsetL119743038602 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L119743038602);
    restoreToL119743038602 = threadStateData->threadObjectStackOffset;
...
label_L1663774813:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1146719991, 0);
...
label_L1146719991:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L388115473, 0);
...
label_L424743902:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L766599024;
    __CN1_DEBUG_INFO(458);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L630669831;
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L521528969;
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireFocus___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL116117787901;
    int tryBlockOffsetL116117787901;
    DEFINE_CATCH_BLOCK(catch_L116117787901, label_L1052546395, restoreToL116117787901);
    int restoreToL105254639502;
    int tryBlockOffsetL105254639502;
    DEFINE_CATCH_BLOCK(catch_L105254639502, label_L1052546395, restoreToL105254639502);
    __CN1_DEBUG_INFO(470);
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L564424689, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L297137378, 0);
...
label_L297137378:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L7064297, 0);
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ JUMP_TO(label_L7064297, 0);
    ...
    if (virtual_com_codename1_ui_Component_hasFocus___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1520927218, 0);
...
label_L1161177879:
 tryBlockOffsetL116117787901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L116117787901);
    restoreToL116117787901 = threadStateData->threadObjectStackOffset;
...
label_L942733592:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1725062057, 1);
    __CN1_DEBUG_INFO(489);
    CN1_SET_ARRAY_ELEMENT_OBJECT(locals[3].data.o, ilocals_6_, /* CustomInvoke */virtual_java_util_ArrayList_get___int_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject), ilocals_6_));
    __CN1_DEBUG_INFO(488);
    BC_IINC(6, 1);
    JUMP_TO(label_L942733592, 1);
...
label_L77086095:
END_TRY(1);    JUMP_TO(label_L1593722877, 0);

label_L1052546395:
 tryBlockOffsetL105254639502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L105254639502);
    restoreToL105254639502 = threadStateData->threadObjectStackOffset;
...
label_L1939354020:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_blocking(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L950330032, 0);
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_fireFocusSync___com_codename1_ui_events_FocusListener_1ARRAY_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (virtual_com_codename1_ui_Component_hasFocus___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L348756982;
...
label_L948451889:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L644783578;
    ...
    __CN1_DEBUG_INFO(512);
    BC_IINC(4, 1);
    goto label_L948451889;

label_L644783578:
    __CN1_DEBUG_INFO(515);
    goto label_L665255666;
...
label_L2145961947:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L665255666;
...
JAVA_BOOLEAN com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L767165873;
    if (virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_ui_util_EventDispatcher_listeners(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L767165873;
    PUSH_INT(1); /* ICONST_1 */
