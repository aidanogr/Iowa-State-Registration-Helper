...
JAVA_OBJECT get_field_com_codename1_impl_ios_IOSImplementation_39_val_errorMessage(JAVA_OBJECT __cn1T) {
  return (*(struct obj__com_codename1_impl_ios_IOSImplementation_39*)__cn1T).com_codename1_impl_ios_IOSImplementation_39_val_errorMessage;
}

void set_field_com_codename1_impl_ios_IOSImplementation_39_val_errorMessage(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Val, JAVA_OBJECT __cn1T) {
    (*(struct obj__com_codename1_impl_ios_IOSImplementation_39*)__cn1T).com_codename1_impl_ios_IOSImplementation_39_val_errorMessage = __cn1Val;
}
...
void __GC_MARK_com_codename1_impl_ios_IOSImplementation_39(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force) {
    ...
    gcMarkObject(threadStateData, objInstance->com_codename1_impl_ios_IOSImplementation_39_val_errorMessage, force);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_39___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9642, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(8756);
    set_field_com_codename1_impl_ios_IOSImplementation_39_val_errorMessage(threadStateData, locals[1].data.o, __cn1ThisObject);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_39_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 9642, 203);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(8759);
    PUSH_OBJ(com_codename1_impl_ios_IOSImplementation_access$6800___R_com_codename1_payment_RestoreCallback(threadStateData));
    /* CustomInvoke */virtual_com_codename1_payment_RestoreCallback_restoreRequestError___java_lang_String(threadStateData, SP[-1].data.o, get_field_com_codename1_impl_ios_IOSImplementation_39_val_errorMessage(__cn1ThisObject));     SP -= 1;
    __CN1_DEBUG_INFO(8760);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
