...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_49_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1872328450cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1872328450cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1872328450cn1_class_id_java_lang_InterruptedException1, label_L779018428, restoreToL1872328450cn1_class_id_java_lang_InterruptedException1);
    int restoreToL187232845002;
    int tryBlockOffsetL187232845002;
    DEFINE_CATCH_BLOCK(catch_L187232845002, label_L1107404311, restoreToL187232845002);
    int restoreToL110740431103;
    int tryBlockOffsetL110740431103;
    DEFINE_CATCH_BLOCK(catch_L110740431103, label_L1107404311, restoreToL110740431103);
...
label_L234223040:
    ...
    PUSH_LONG(-2LL); /* LDC */
    BC_LCMP();
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L1182758821, 0);
...
label_L1872328450:
 tryBlockOffsetL187232845002 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L187232845002);
    restoreToL187232845002 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1872328450cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1872328450cn1_class_id_java_lang_InterruptedException1);
    restoreToL1872328450cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L422108262:
END_TRY(1);    JUMP_TO(label_L1108066952, 0);

label_L1107404311:
 tryBlockOffsetL110740431103 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L110740431103);
    restoreToL110740431103 = threadStateData->threadObjectStackOffset;
