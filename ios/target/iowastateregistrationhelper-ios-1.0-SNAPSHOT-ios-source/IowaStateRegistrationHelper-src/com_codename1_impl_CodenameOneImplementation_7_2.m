...
JAVA_VOID com_codename1_impl_CodenameOneImplementation_7_2_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL292307924cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL292307924cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L292307924cn1_class_id_java_io_IOException1, label_L1250582716, restoreToL292307924cn1_class_id_java_io_IOException1);
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L907815246, 0);
...
label_L292307924:
 tryBlockOffsetL292307924cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L292307924cn1_class_id_java_io_IOException1);
    restoreToL292307924cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
