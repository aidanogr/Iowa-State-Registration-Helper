...
JAVA_OBJECT com_codename1_ui_plaf_RoundBorder_stroke___float_boolean_R_com_codename1_ui_plaf_RoundBorder(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_RoundBorder_strokeThickness(__cn1ThisObject), 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L2134639513;
...
label_L2134639513:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L406831866;
...
JAVA_OBJECT com_codename1_ui_plaf_RoundBorder_createTargetImage___com_codename1_ui_Component_int_int_boolean_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_BOOLEAN __cn1Arg4) {
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_shadowMM(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L974242027;
...
label_L974242027:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_shadowOpacity(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L856937591;
...
label_L1247938090:
    if (ilocals_12_<0) /* IFLT CustomJump */ goto label_L741095751;
...
label_L741095751:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L856937591;
...
label_L856937591:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_uiid(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2126545173;
    if (virtual_com_codename1_ui_Graphics_isShapeClipSupported___R_boolean(threadStateData, locals[10].data.o)==0) /* IFEQ CustomJump */ goto label_L2126545173;
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_rectangle(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1407009494;
    __CN1_DEBUG_INFO(435);
    if (get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L511094763;
...
label_L1149217113:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_onlyLeftRounded(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1045250282;
...
label_L121597447:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_onlyRightRounded(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L748523772;
...
label_L1407009494:
    ...
    if (ilocals_8_==ilocals_9_) /* IF_ICMPEQ CustomJump */ goto label_L1027377263;
    __CN1_DEBUG_INFO(457);
    if (ilocals_8_<=ilocals_9_) /* IF_ICMPLE CustomJump */ goto label_L2103895364;
...
label_L1099925775:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_strokeOpacity(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1717967062;
    if (get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1717967062;
...
JAVA_VOID com_codename1_ui_plaf_RoundBorder_paintBorderBackground___com_codename1_ui_Graphics_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (ilocals_3_<=0) /* IFLE CustomJump */ goto label_L45790744;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1220292558;
...
locals[8].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(493);
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_RoundBorder_CacheValue_modificationTime(locals[8].data.o), get_field_com_codename1_ui_plaf_RoundBorder_modificationTime(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1220292558;
    ...
    SP++;
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1220292558;
    if (virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundBorder_CacheValue_img(locals[8].data.o))!=ilocals_4_) /* IF_ICMPNE CustomJump */ goto label_L1220292558;
...
JAVA_VOID com_codename1_ui_plaf_RoundBorder_fillShape___com_codename1_ui_Graphics_int_int_int_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_BOOLEAN __cn1Arg6) {
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_rectangle(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L620471432;
    if (ilocals_4_>ilocals_5_) /* IF_ICMPGT CustomJump */ goto label_L1940311161;
...
label_L620471432:
    ...
    if (ilocals_4_==ilocals_5_) /* IF_ICMPEQ CustomJump */ goto label_L1515016092;
    __CN1_DEBUG_INFO(539);
    if (ilocals_4_<=ilocals_5_) /* IF_ICMPLE CustomJump */ goto label_L356347252;
...
label_L1515016092:
    ...
    if (ilocals_9_>=5 /* ICONST_5 */) /* IF_ICMPGE CustomJump */ goto label_L1822115007;
...
label_L1822115007:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L698062929;
    if (get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L698062929;
    __CN1_DEBUG_INFO(552);
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L421135185;
    if (get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L421135185;
    { JAVA_FLOAT tmpResult = virtual_com_codename1_ui_Stroke_getLineWidth___R_float(threadStateData, get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject));
    PUSH_FLOAT(tmpResult); }
...
label_L1731365835:
    ...
    PUSH_INT(360);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1371182382;
...
label_L1940311161:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L507575219;
    if (get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L507575219;
    { JAVA_FLOAT tmpResult = virtual_com_codename1_ui_Stroke_getLineWidth___R_float(threadStateData, get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject));
    PUSH_FLOAT(tmpResult); }
...
label_L458624688:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_onlyLeftRounded(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L165687172;
...
label_L509632753:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_onlyRightRounded(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L132423149;
...
label_L745287727:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L1834961152;
    if (get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1834961152;
...
JAVA_BOOLEAN com_codename1_ui_plaf_RoundBorder_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o!=__cn1ThisObject) /* IF_ACMPNE CustomJump */ goto label_L611890729;
    PUSH_INT(1); /* ICONST_1 */
