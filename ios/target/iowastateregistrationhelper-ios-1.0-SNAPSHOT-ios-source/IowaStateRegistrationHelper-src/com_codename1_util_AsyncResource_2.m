...
JAVA_VOID com_codename1_util_AsyncResource_2_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL202206309601;
    int tryBlockOffsetL202206309601;
    DEFINE_CATCH_BLOCK(catch_L202206309601, label_L1958395112, restoreToL202206309601);
    int restoreToL195839511202;
    int tryBlockOffsetL195839511202;
    DEFINE_CATCH_BLOCK(catch_L195839511202, label_L1958395112, restoreToL195839511202);
...
label_L2022063096:
 tryBlockOffsetL202206309601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L202206309601);
    restoreToL202206309601 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(156);
    if (get_field_com_codename1_util_AsyncResource_2_val_timeout(__cn1ThisObject)<=0) /* IFLE CustomJump */ JUMP_TO(label_L531301268, 1);
...
label_L45228556:
END_TRY(1);    JUMP_TO(label_L786808973, 0);

label_L1958395112:
 tryBlockOffsetL195839511202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L195839511202);
    restoreToL195839511202 = threadStateData->threadObjectStackOffset;
