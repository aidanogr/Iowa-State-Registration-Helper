...
JAVA_VOID com_codename1_util_AsyncResource_2_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL53777848601;
    int tryBlockOffsetL53777848601;
    DEFINE_CATCH_BLOCK(catch_L53777848601, label_L1184092751, restoreToL53777848601);
    int restoreToL118409275102;
    int tryBlockOffsetL118409275102;
    DEFINE_CATCH_BLOCK(catch_L118409275102, label_L1184092751, restoreToL118409275102);
...
label_L537778486:
 tryBlockOffsetL53777848601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L53777848601);
    restoreToL53777848601 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(156);
    if (get_field_com_codename1_util_AsyncResource_2_val_timeout(__cn1ThisObject)<=0) /* IFLE CustomJump */ JUMP_TO(label_L37135332, 1);
...
label_L1184092751:
 tryBlockOffsetL118409275102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L118409275102);
    restoreToL118409275102 = threadStateData->threadObjectStackOffset;
