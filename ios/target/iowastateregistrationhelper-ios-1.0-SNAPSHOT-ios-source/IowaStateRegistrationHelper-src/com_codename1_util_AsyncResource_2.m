...
JAVA_VOID com_codename1_util_AsyncResource_2_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_CATCH_BLOCK(catch_L789157901, label_L1693127898, restoreToL789157901);
    int restoreToL169312789802;
    int tryBlockOffsetL169312789802;
    DEFINE_CATCH_BLOCK(catch_L169312789802, label_L1693127898, restoreToL169312789802);
...
label_L7891579:
 tryBlockOffsetL789157901 = threadStateData->tryBlockOffset;
    ...
    if (get_field_com_codename1_util_AsyncResource_2_val_timeout(__cn1ThisObject)<=0) /* IFLE CustomJump */ JUMP_TO(label_L626553488, 1);
...
label_L590000838:
END_TRY(1);    JUMP_TO(label_L2147388034, 0);

label_L1693127898:
 tryBlockOffsetL169312789802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L169312789802);
    restoreToL169312789802 = threadStateData->threadObjectStackOffset;
