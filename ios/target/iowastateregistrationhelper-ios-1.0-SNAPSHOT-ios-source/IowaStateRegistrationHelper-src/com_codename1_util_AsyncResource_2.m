...
JAVA_VOID com_codename1_util_AsyncResource_2_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL113050857701;
    int tryBlockOffsetL113050857701;
    DEFINE_CATCH_BLOCK(catch_L113050857701, label_L462869575, restoreToL113050857701);
    int restoreToL46286957502;
    int tryBlockOffsetL46286957502;
    DEFINE_CATCH_BLOCK(catch_L46286957502, label_L462869575, restoreToL46286957502);
...
label_L1130508577:
 tryBlockOffsetL113050857701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L113050857701);
    restoreToL113050857701 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(156);
    if (get_field_com_codename1_util_AsyncResource_2_val_timeout(__cn1ThisObject)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1248381893, 1);
...
label_L1099038981:
END_TRY(1);    JUMP_TO(label_L1114665055, 0);

label_L462869575:
 tryBlockOffsetL46286957502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L46286957502);
    restoreToL46286957502 = threadStateData->threadObjectStackOffset;
