...
JAVA_VOID com_codename1_ui_table_TableLayout___INIT_____int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 10297, 200);
...
JAVA_INT com_codename1_ui_table_TableLayout_getRows___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10297, 4133);
...
JAVA_INT com_codename1_ui_table_TableLayout_getColumns___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10297, 4131);
...
JAVA_OBJECT com_codename1_ui_table_TableLayout_getComponentAt___int_int_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 10297, 3378);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ...
    if (ilocals_3_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1937294500;
    if (ilocals_3_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_table_TableLayout_tablePositions(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1937294500;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(434);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1721039643;
...
JAVA_VOID com_codename1_ui_table_TableLayout_layoutContainer___com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(7, 41, 0, 10297, 3366);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL9018638cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1;
    int tryBlockOffsetL9018638cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1;
    DEFINE_CATCH_BLOCK(catch_L9018638cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1, label_L1240077238, restoreToL9018638cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1);

label_L9018638:
 tryBlockOffsetL9018638cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_ArrayIndexOutOfBoundsException, catch_L9018638cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1);
    restoreToL9018638cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1 = threadStateData->threadObjectStackOffset;
...
label_L874747059:
    if (ilocals_18_>=ilocals_12_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L2080551883, 1);
    ...
    if (CN1_ARRAY_ELEMENT_INT(locals[19].data.o, 1 /* ICONST_1 */)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1032835955, 1);
...
label_L1032835955:
    ...
    if (CN1_ARRAY_ELEMENT_INT(locals[19].data.o, 1 /* ICONST_1 */)>=-1 /* ICONST_M1 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L768427295, 1);
...
label_L768427295:
    __CN1_DEBUG_INFO(471);
    BC_IINC(18, 1);
    JUMP_TO(label_L874747059, 1);

label_L2080551883:
    __CN1_DEBUG_INFO(488);
    if (ilocals_15_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1574368535, 1);
    if (ilocals_13_<=0) /* IFLE CustomJump */ JUMP_TO(label_L1574368535, 1);
    __CN1_DEBUG_INFO(489);
    /* VarOp.assignFrom */     ilocals_18_ = 0 /* ICONST_0 */; 

label_L1503914743:
    if (ilocals_18_>=ilocals_12_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1574368535, 1);
    __CN1_DEBUG_INFO(490);
    if (CN1_ARRAY_ELEMENT_BYTE(locals[10].data.o, ilocals_18_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L503427477, 1);
...
label_L503427477:
    __CN1_DEBUG_INFO(489);
    BC_IINC(18, 1);
    JUMP_TO(label_L1503914743, 1);

label_L1574368535:
    __CN1_DEBUG_INFO(499);
    if (virtual_com_codename1_ui_Container_isScrollableX___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1905093500, 1);
    if (ilocals_11_>=ilocals_16_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1905093500, 1);
    __CN1_DEBUG_INFO(500);
    if (get_field_com_codename1_ui_table_TableLayout_truncateHorizontally(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L463029783, 1);
...
label_L1320515149:
    if (ilocals_18_>=ilocals_12_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L134726120, 1);
    ...
    __CN1_DEBUG_INFO(503);
    BC_IINC(18, 1);
    JUMP_TO(label_L1320515149, 1);

label_L134726120:
    JUMP_TO(label_L1905093500, 1);
...
label_L83980058:
    if (ilocals_20_>=ilocals_12_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1905093500, 1);
    __CN1_DEBUG_INFO(513);
    if (CN1_ARRAY_ELEMENT_BYTE(locals[9].data.o, ilocals_20_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1425617516, 1);
...
label_L1163723986:
    if (ilocals_19_>=ilocals_12_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L868214483, 1);
    __CN1_DEBUG_INFO(523);
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1457383927, 1);
...
label_L9108707:
    if (ilocals_27_>=ilocals_23_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L161020884, 1);
    ...
    if (CN1_ARRAY_ELEMENT_INT(locals[28].data.o, 0 /* ICONST_0 */)>=0) /* IFGE CustomJump */ JUMP_TO(label_L808663361, 1);
...
label_L808663361:
    ...
    if (CN1_ARRAY_ELEMENT_INT(locals[28].data.o, 0 /* ICONST_0 */)>=-1 /* ICONST_M1 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L761009678, 1);
...
label_L761009678:
    __CN1_DEBUG_INFO(547);
    BC_IINC(27, 1);
    JUMP_TO(label_L9108707, 1);

label_L161020884:
    __CN1_DEBUG_INFO(564);
    if (ilocals_25_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1308815741, 1);
    if (ilocals_13_<=0) /* IFLE CustomJump */ JUMP_TO(label_L1308815741, 1);
    __CN1_DEBUG_INFO(565);
    /* VarOp.assignFrom */     ilocals_27_ = 0 /* ICONST_0 */; 

label_L712222287:
    if (ilocals_27_>=ilocals_23_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1308815741, 1);
    __CN1_DEBUG_INFO(566);
    if (CN1_ARRAY_ELEMENT_BYTE(locals[21].data.o, ilocals_27_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1733439693, 1);
...
label_L1733439693:
    __CN1_DEBUG_INFO(565);
    BC_IINC(27, 1);
    JUMP_TO(label_L712222287, 1);

label_L1308815741:
    __CN1_DEBUG_INFO(575);
    if (virtual_com_codename1_ui_Container_isScrollableY___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L2110335494, 1);
    if (ilocals_22_>=ilocals_26_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L2110335494, 1);
    __CN1_DEBUG_INFO(576);
    if (get_field_com_codename1_ui_table_TableLayout_truncateVertically(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L605660635, 1);
...
label_L1699592203:
    if (ilocals_27_>=ilocals_23_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1388002765, 1);
    ...
    __CN1_DEBUG_INFO(579);
    BC_IINC(27, 1);
    JUMP_TO(label_L1699592203, 1);

label_L1388002765:
    JUMP_TO(label_L2110335494, 1);
...
label_L943613748:
    if (ilocals_29_>=ilocals_23_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L2110335494, 1);
    __CN1_DEBUG_INFO(589);
    if (CN1_ARRAY_ELEMENT_BYTE(locals[20].data.o, ilocals_29_)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1365260222, 1);
...
label_L1004866348:
    if (ilocals_28_>=ilocals_23_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L861958315, 1);
...
label_L433699465:
    if (ilocals_29_>=ilocals_23_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1810368041, 1);
    __CN1_DEBUG_INFO(607);
    /* VarOp.assignFrom */     ilocals_30_ = 0 /* ICONST_0 */; 

label_L1750404486:
    if (ilocals_30_>=ilocals_28_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L547670951, 1);
...
locals[31].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(610);
    if (locals[31].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L284230192, 1);
    if (locals[31].data.o==get_static_com_codename1_ui_table_TableLayout_H_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ JUMP_TO(label_L284230192, 1);
    if (locals[31].data.o==get_static_com_codename1_ui_table_TableLayout_V_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ JUMP_TO(label_L284230192, 1);
    if (locals[31].data.o==get_static_com_codename1_ui_table_TableLayout_VH_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ JUMP_TO(label_L284230192, 1);
    ...
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$300___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[31].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L64931689, 1);
...
label_L785604388:
    if (ilocals_40_>=/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$300___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[31].data.o)) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L673992821, 1);
    ...
    __CN1_DEBUG_INFO(621);
    BC_IINC(40, 1);
    JUMP_TO(label_L785604388, 1);

label_L673992821:
    __CN1_DEBUG_INFO(626);
    if (ilocals_7_==0) /* IFEQ CustomJump */ JUMP_TO(label_L908802124, 1);
    ...
    if (ilocals_40_>=0) /* IFGE CustomJump */ JUMP_TO(label_L1127961711, 1);
    __CN1_DEBUG_INFO(630);
    /* VarOp.assignFrom */     ilocals_40_ = 0 /* ICONST_0 */; 
    JUMP_TO(label_L165550981, 1);

label_L1127961711:
    __CN1_DEBUG_INFO(631);
    if (ilocals_40_<=(ilocals_28_ - 1 /* ICONST_1 */)) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L165550981, 1);
...
label_L1027629029:
    ...
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$400___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[31].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1388767577, 1);
...
label_L842821532:
    if (ilocals_40_>=/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$400___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[31].data.o)) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1262966594, 1);
...
label_L284230192:
    __CN1_DEBUG_INFO(607);
    BC_IINC(30, 1);
    JUMP_TO(label_L1750404486, 1);

label_L547670951:
    __CN1_DEBUG_INFO(606);
    BC_IINC(29, 1);
    JUMP_TO(label_L433699465, 1);

label_L1810368041:
END_TRY(1);    __CN1_DEBUG_INFO(658);
    JUMP_TO(label_L1212708513, 0);
...
JAVA_VOID com_codename1_ui_table_TableLayout_placeComponent___boolean_com_codename1_ui_table_TableLayout_Constraint_int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_INT __cn1Arg6) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 12, 0, 10297, 10300);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (ilocals_8_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L876008407;
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1061181070;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L776447774;
        case 3: goto label_L934572255;
        default: goto label_L1061181070;
    }
...
label_L1061181070:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L899589525;
        case 2: goto label_L876008407;
        case 3: goto label_L148337038;
        case 4: goto label_L465258717;
        default: goto label_L876008407;
    }
...
label_L876008407:
    ...
    if (ilocals_9_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L262005245;
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1341083542;
        case 1: goto label_L262005245;
        case 2: goto label_L2089229540;
        case 3: goto label_L262005245;
        case 4: goto label_L1027296777;
        default: goto label_L262005245;
    }
...
JAVA_OBJECT com_codename1_ui_table_TableLayout_getColumnWidthPixels___int_int_R_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_6_ = 0; /* v6 */
    DEFINE_INSTANCE_METHOD_STACK(4, 9, 0, 10297, 10301);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
label_L1046723947:
    if (ilocals_6_>=get_field_com_codename1_ui_table_TableLayout_rows(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1573507674;
...
locals[7].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(764);
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1752151434;
    if (locals[7].data.o==get_static_com_codename1_ui_table_TableLayout_H_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ goto label_L1752151434;
    if (locals[7].data.o==get_static_com_codename1_ui_table_TableLayout_V_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ goto label_L1752151434;
    if (locals[7].data.o==get_static_com_codename1_ui_table_TableLayout_VH_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ goto label_L1752151434;
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$300___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[7].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L743171167;
    __CN1_DEBUG_INFO(765);
    goto label_L1752151434;

label_L743171167:
    __CN1_DEBUG_INFO(769);
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$700___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[7].data.o)<=0) /* IFLE CustomJump */ goto label_L1273474265;
    if (ilocals_2_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1273474265;
...
label_L1273474265:
    ...
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L1752151434;
    __CN1_DEBUG_INFO(775);
    /* CustomInvoke */PUSH_INT(com_codename1_ui_table_TableLayout_Constraint_access$700___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[7].data.o));
    PUSH_INT(-2);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1487924477;
    if (get_field_com_codename1_ui_table_TableLayout_growHorizontally(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1299829127;
    if (ilocals_1_!=(get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject) - 1 /* ICONST_1 */)) /* IF_ICMPNE CustomJump */ goto label_L1299829127;
...
label_L1573507674:
    ...
    BC_DUP(); /* DUP */
    PUSH_INT(1); /* ICONST_1 */
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L1209290522;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L1870367457;

label_L1209290522:
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1821215584;
    PUSH_INT(-2);
    goto label_L1870367457;
...
JAVA_OBJECT com_codename1_ui_table_TableLayout_getRowHeightPixels___int_int_R_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_6_ = 0; /* v6 */
    DEFINE_INSTANCE_METHOD_STACK(4, 9, 0, 10297, 10302);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
label_L1273093350:
    if (ilocals_6_>=get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1336343423;
...
locals[7].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(796);
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L622854414;
    if (locals[7].data.o==get_static_com_codename1_ui_table_TableLayout_H_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ goto label_L622854414;
    if (locals[7].data.o==get_static_com_codename1_ui_table_TableLayout_V_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ goto label_L622854414;
    if (locals[7].data.o==get_static_com_codename1_ui_table_TableLayout_VH_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ goto label_L622854414;
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$400___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[7].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L373275593;
    __CN1_DEBUG_INFO(797);
    goto label_L622854414;

label_L373275593:
    __CN1_DEBUG_INFO(801);
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$800___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[7].data.o)<=0) /* IFLE CustomJump */ goto label_L376042725;
    if (ilocals_2_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L376042725;
...
label_L376042725:
    ...
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L622854414;
    __CN1_DEBUG_INFO(807);
    /* CustomInvoke */PUSH_INT(com_codename1_ui_table_TableLayout_Constraint_access$800___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[7].data.o));
    PUSH_INT(-2);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1852606548;
...
label_L1336343423:
    ...
    BC_DUP(); /* DUP */
    PUSH_INT(1); /* ICONST_1 */
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L543938464;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L2046611860;

label_L543938464:
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1943587031;
    PUSH_INT(-2);
    goto label_L2046611860;
...
JAVA_OBJECT com_codename1_ui_table_TableLayout_getPreferredSize___com_codename1_ui_Container_R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 10297, 2439);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L1211317010:
    if (ilocals_5_>=get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L907754662;
...
label_L1660409789:
    if (ilocals_5_>=get_field_com_codename1_ui_table_TableLayout_rows(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1465656305;
...
JAVA_VOID com_codename1_ui_table_TableLayout_shiftCell___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 10297, 10305);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
label_L910156634:
    if (ilocals_4_>=get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L233191753;
    __CN1_DEBUG_INFO(860);
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_table_TableLayout_tablePositions(__cn1ThisObject), ((ilocals_1_ * get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) + ilocals_4_))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1549563980;
...
label_L1771811588:
    if (ilocals_4_>=virtual_com_codename1_ui_table_TableLayout_getRows___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L170899621;
    __CN1_DEBUG_INFO(870);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 

label_L766302874:
    if (ilocals_5_>=virtual_com_codename1_ui_table_TableLayout_getColumns___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L890126260;
    __CN1_DEBUG_INFO(871);
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_table_TableLayout_tablePositions(__cn1ThisObject), ((ilocals_4_ * get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) + ilocals_5_))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L333295611;
...
label_L1513204713:
    __CN1_DEBUG_INFO(870);
    BC_IINC(5, 1);
    goto label_L766302874;

label_L890126260:
    __CN1_DEBUG_INFO(869);
    BC_IINC(4, 1);
    goto label_L1771811588;
...
JAVA_VOID com_codename1_ui_table_TableLayout_addRow__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 2, 0, 10297, 10306);
...
JAVA_VOID com_codename1_ui_table_TableLayout_addLayoutComponent___java_lang_Object_com_codename1_ui_Component_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_6_ = 0; /* v6 */
    DEFINE_INSTANCE_METHOD_STACK(4, 7, 0, 10297, 3414);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(898);
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L390560699;
    __CN1_DEBUG_INFO(899);
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_table_TableLayout_createConstraint___R_com_codename1_ui_table_TableLayout_Constraint(threadStateData, __cn1ThisObject);locals[4].type=CN1_TYPE_OBJECT;    goto label_L1090446425;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(902);
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$200___com_codename1_ui_table_TableLayout_Constraint_R_com_codename1_ui_Component(threadStateData, locals[4].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1090446425;
...
label_L1090446425:
    ...
    if (get_field_com_codename1_ui_table_TableLayout_Constraint_actualRow(locals[4].data.o)>=0) /* IFGE CustomJump */ goto label_L198024918;
...
label_L198024918:
    ...
    if (get_field_com_codename1_ui_table_TableLayout_Constraint_actualColumn(locals[4].data.o)>=0) /* IFGE CustomJump */ goto label_L1073352504;
...
label_L1140572863:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10309));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L614978515:
    ...
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$300___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[4].data.o)>1 /* ICONST_1 */) /* IF_ICMPGT CustomJump */ goto label_L1579620531;
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$400___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[4].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1141137903;
...
label_L1774995948:
    if (ilocals_5_>=/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$300___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[4].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1141137903;
    __CN1_DEBUG_INFO(941);
    /* VarOp.assignFrom */     ilocals_6_ = 0 /* ICONST_0 */; 

label_L1814190811:
    if (ilocals_6_>=/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$400___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[4].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1501019626;
    __CN1_DEBUG_INFO(942);
    if (ilocals_5_>0) /* IFGT CustomJump */ goto label_L1237401293;
    if (ilocals_6_<=0) /* IFLE CustomJump */ goto label_L793068998;

label_L1237401293:
    if (get_field_com_codename1_ui_table_TableLayout_rows(__cn1ThisObject)<=(get_field_com_codename1_ui_table_TableLayout_Constraint_actualRow(locals[4].data.o) + ilocals_6_)) /* IF_ICMPLE CustomJump */ goto label_L793068998;
    if (get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)<=(get_field_com_codename1_ui_table_TableLayout_Constraint_actualColumn(locals[4].data.o) + ilocals_5_)) /* IF_ICMPLE CustomJump */ goto label_L793068998;
    __CN1_DEBUG_INFO(944);
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_table_TableLayout_tablePositions(__cn1ThisObject), ((((get_field_com_codename1_ui_table_TableLayout_Constraint_actualRow(locals[4].data.o) + ilocals_6_) * get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) + get_field_com_codename1_ui_table_TableLayout_Constraint_actualColumn(locals[4].data.o)) + ilocals_5_))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L793068998;
    __CN1_DEBUG_INFO(945);
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$300___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[4].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1210663640;
    __CN1_DEBUG_INFO(946);
    if (/* CustomInvoke */com_codename1_ui_table_TableLayout_Constraint_access$400___com_codename1_ui_table_TableLayout_Constraint_R_int(threadStateData, locals[4].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L752168666;
...
JAVA_VOID com_codename1_ui_table_TableLayout_updateRowColumn__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 10297, 10310);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(964);
    if (get_field_com_codename1_ui_table_TableLayout_currentRow(__cn1ThisObject)<get_field_com_codename1_ui_table_TableLayout_rows(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L1802627471;
...
label_L1802627471:
    ...
    if (get_field_com_codename1_ui_table_TableLayout_currentColumn(__cn1ThisObject)<get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L1802627471;
...
JAVA_VOID com_codename1_ui_table_TableLayout_removeLayoutComponent___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(4, 7, 0, 10297, 3416);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L280663936:
    if (ilocals_3_>=get_field_com_codename1_ui_table_TableLayout_rows(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L2080162056;
    __CN1_DEBUG_INFO(1048);
    /* VarOp.assignFrom */     ilocals_4_ = 0 /* ICONST_0 */; 

label_L1096293439:
    if (ilocals_4_>=get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1706459316;
    __CN1_DEBUG_INFO(1049);
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_table_TableLayout_tablePositions(__cn1ThisObject), ((ilocals_3_ * get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) + ilocals_4_))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L142568117;
    ...
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1546740272;
...
label_L142568117:
    ...
    __CN1_DEBUG_INFO(1048);
    BC_IINC(4, 1);
    goto label_L1096293439;

label_L1706459316:
    __CN1_DEBUG_INFO(1047);
    BC_IINC(3, 1);
    goto label_L280663936;
...
label_L1903062949:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1667460576;
    ...
    if (locals[5].data.o==get_static_com_codename1_ui_table_TableLayout_H_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ goto label_L882156382;
    if (locals[5].data.o==get_static_com_codename1_ui_table_TableLayout_V_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPEQ CustomJump */ goto label_L882156382;
    if (locals[5].data.o!=get_static_com_codename1_ui_table_TableLayout_VH_SPAN_CONSTRAINT(threadStateData)) /* IF_ACMPNE CustomJump */ goto label_L892135447;
    __CN1_DEBUG_INFO(1065);
    goto label_L882156382;
...
JAVA_OBJECT com_codename1_ui_table_TableLayout_getComponentConstraint___com_codename1_ui_Component_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 10297, 3417);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L292099569:
    if (ilocals_2_>=get_field_com_codename1_ui_table_TableLayout_rows(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L152702981;
    __CN1_DEBUG_INFO(1078);
    /* VarOp.assignFrom */     ilocals_3_ = 0 /* ICONST_0 */; 

label_L1219145433:
    if (ilocals_3_>=get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L411425835;
    __CN1_DEBUG_INFO(1079);
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_table_TableLayout_tablePositions(__cn1ThisObject), ((ilocals_2_ * get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) + ilocals_3_))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1245442940;
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_table_TableLayout_Constraint_access$200___com_codename1_ui_table_TableLayout_Constraint_R_com_codename1_ui_Component(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_table_TableLayout_tablePositions(__cn1ThisObject), ((ilocals_2_ * get_field_com_codename1_ui_table_TableLayout_columns(__cn1ThisObject)) + ilocals_3_))));
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1245442940;
...
JAVA_OBJECT com_codename1_ui_table_TableLayout_createConstraint___R_com_codename1_ui_table_TableLayout_Constraint(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 10297, 6875);
...
JAVA_OBJECT com_codename1_ui_table_TableLayout_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10297, 897);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1200);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return STRING_FROM_CONSTANT_POOL_OFFSET(10324);
}
...
JAVA_BOOLEAN com_codename1_ui_table_TableLayout_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10297, 878);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1207);
    if (/* CustomInvoke */com_codename1_ui_layouts_Layout_equals___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L666625907;
    if (virtual_com_codename1_ui_table_TableLayout_getRows___R_int(threadStateData, locals[1].data.o)!=virtual_com_codename1_ui_table_TableLayout_getRows___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L666625907;
    if (virtual_com_codename1_ui_table_TableLayout_getColumns___R_int(threadStateData, locals[1].data.o)!=virtual_com_codename1_ui_table_TableLayout_getColumns___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L666625907;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L848187627;
...
JAVA_BOOLEAN com_codename1_ui_table_TableLayout_isConstraintTracking___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10297, 3420);
...
JAVA_VOID com_codename1_ui_table_TableLayout_setGrowHorizontally___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10297, 10326);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_OBJECT com_codename1_ui_table_TableLayout_encloseIn___int_com_codename1_ui_Component_1ARRAY_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_table_TableLayout(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 10297, 3317);
...
JAVA_OBJECT com_codename1_ui_table_TableLayout_encloseIn___int_boolean_com_codename1_ui_Component_1ARRAY_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    volatile JAVA_INT ilocals_1_ = 0; /* growHorizontally */
    __STATIC_INITIALIZER_com_codename1_ui_table_TableLayout(threadStateData);
    DEFINE_METHOD_STACK(4, 5, 0, 10297, 3317);
    ilocals_0_ = __cn1Arg1;
    ...
    if ((ilocals_3_ % ilocals_0_)<=0) /* IFLE CustomJump */ goto label_L802159621;
    __CN1_DEBUG_INFO(1294);
    /* VarOp.assignFrom */ ilocals_3_=((ilocals_3_ / ilocals_0_) + 1 /* ICONST_1 */);
    goto label_L1993384592;
...
JAVA_BOOLEAN com_codename1_ui_table_TableLayout_overridesTabIndices___com_codename1_ui_Container_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 10297, 3422);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_table_TableLayout_getChildrenInTraversalOrder___com_codename1_ui_Container_R_com_codename1_ui_Component_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 10297, 3423);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L505323885:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L245908294;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1314);
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1314997104;
...
JAVA_INT com_codename1_ui_table_TableLayout_access$000___R_int(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_table_TableLayout(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 10297, 216);
...
JAVA_INT com_codename1_ui_table_TableLayout_access$100___R_int(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_table_TableLayout(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 10297, 800);
    __CN1_DEBUG_INFO(106);
...
JAVA_VOID com_codename1_ui_table_TableLayout___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(2, 0, 0, 10297, 861);
