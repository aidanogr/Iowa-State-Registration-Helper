...
JAVA_VOID com_codename1_ui_Toolbar_16_scrollChanged___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    int restoreToL135308076101;
    int tryBlockOffsetL135308076101;
    DEFINE_CATCH_BLOCK(catch_L135308076101, label_L2118413714, restoreToL135308076101);
    int restoreToL5082641202;
    int tryBlockOffsetL5082641202;
    DEFINE_CATCH_BLOCK(catch_L5082641202, label_L2118413714, restoreToL5082641202);
    int restoreToL211841371403;
    int tryBlockOffsetL211841371403;
    DEFINE_CATCH_BLOCK(catch_L211841371403, label_L2118413714, restoreToL211841371403);
    __CN1_DEBUG_INFO(2401);
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$500___com_codename1_ui_Toolbar_R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1475982439, 0);
    if (virtual_com_codename1_ui_Container_isTensileMotionInProgress___R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_val_contentPane(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1834755909, 0);
...
label_L1353080761:
 tryBlockOffsetL135308076101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L135308076101);
    restoreToL135308076101 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(2408);
    /* VarOp.assignFrom */ ilocals_5_=(ilocals_2_ - ilocals_4_);
    __CN1_DEBUG_INFO(2409);
    if (ilocals_5_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1152554134, 1);
...
label_L1152554134:
    ...
    if (ilocals_2_<0) /* IFLT CustomJump */ JUMP_TO(label_L424106351, 1);
    if (/* CustomInvoke */java_lang_Math_abs___int_R_int(threadStateData, ilocals_6_)>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L50826412, 0);
...
label_L50826412:
 tryBlockOffsetL5082641202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L5082641202);
    restoreToL5082641202 = threadStateData->threadObjectStackOffset;
    ...
    if (ilocals_6_==virtual_com_codename1_ui_Toolbar_getY___R_int(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L258860422, 1);
    ...
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$800___com_codename1_ui_Toolbar_R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1596708569, 1);
...
label_L2118413714:
 tryBlockOffsetL211841371403 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L211841371403);
    restoreToL211841371403 = threadStateData->threadObjectStackOffset;
