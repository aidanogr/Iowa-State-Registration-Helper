...
JAVA_VOID java_lang_System_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL420398953cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL420398953cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L420398953cn1_class_id_java_lang_InterruptedException1, label_L849776463, restoreToL420398953cn1_class_id_java_lang_InterruptedException1);
    int restoreToL42039895302;
    int tryBlockOffsetL42039895302;
    DEFINE_CATCH_BLOCK(catch_L42039895302, label_L120689887, restoreToL42039895302);
    ...
    int restoreToL145338292904;
    int tryBlockOffsetL145338292904;
    DEFINE_CATCH_BLOCK(catch_L145338292904, label_L1857173583, restoreToL145338292904);
    ...
    int restoreToL1963495726cn1_class_id_java_lang_InterruptedException6;
    int tryBlockOffsetL1963495726cn1_class_id_java_lang_InterruptedException6;
    DEFINE_CATCH_BLOCK(catch_L1963495726cn1_class_id_java_lang_InterruptedException6, label_L1016860054, restoreToL1963495726cn1_class_id_java_lang_InterruptedException6);
...
label_L420398953:
 tryBlockOffsetL42039895302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L42039895302);
    restoreToL42039895302 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL420398953cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L420398953cn1_class_id_java_lang_InterruptedException1);
    restoreToL420398953cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L1963495726:
 tryBlockOffsetL1963495726cn1_class_id_java_lang_InterruptedException6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1963495726cn1_class_id_java_lang_InterruptedException6);
    restoreToL1963495726cn1_class_id_java_lang_InterruptedException6 = threadStateData->threadObjectStackOffset;
...
label_L1453382929:
 tryBlockOffsetL145338292904 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L145338292904);
    restoreToL145338292904 = threadStateData->threadObjectStackOffset;
