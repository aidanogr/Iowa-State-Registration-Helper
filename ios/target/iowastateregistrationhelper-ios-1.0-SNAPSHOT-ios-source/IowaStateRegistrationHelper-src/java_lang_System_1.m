...
JAVA_VOID java_lang_System_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1442573242cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1442573242cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1442573242cn1_class_id_java_lang_InterruptedException1, label_L849776463, restoreToL1442573242cn1_class_id_java_lang_InterruptedException1);
    int restoreToL144257324202;
    int tryBlockOffsetL144257324202;
    DEFINE_CATCH_BLOCK(catch_L144257324202, label_L120689887, restoreToL144257324202);
    ...
    int restoreToL192888016904;
    int tryBlockOffsetL192888016904;
    DEFINE_CATCH_BLOCK(catch_L192888016904, label_L1857173583, restoreToL192888016904);
    ...
    int restoreToL428796726cn1_class_id_java_lang_InterruptedException6;
    int tryBlockOffsetL428796726cn1_class_id_java_lang_InterruptedException6;
    DEFINE_CATCH_BLOCK(catch_L428796726cn1_class_id_java_lang_InterruptedException6, label_L1016860054, restoreToL428796726cn1_class_id_java_lang_InterruptedException6);
...
label_L1442573242:
 tryBlockOffsetL144257324202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L144257324202);
    restoreToL144257324202 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1442573242cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1442573242cn1_class_id_java_lang_InterruptedException1);
    restoreToL1442573242cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L428796726:
 tryBlockOffsetL428796726cn1_class_id_java_lang_InterruptedException6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L428796726cn1_class_id_java_lang_InterruptedException6);
    restoreToL428796726cn1_class_id_java_lang_InterruptedException6 = threadStateData->threadObjectStackOffset;
...
label_L1928880169:
 tryBlockOffsetL192888016904 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L192888016904);
    restoreToL192888016904 = threadStateData->threadObjectStackOffset;
