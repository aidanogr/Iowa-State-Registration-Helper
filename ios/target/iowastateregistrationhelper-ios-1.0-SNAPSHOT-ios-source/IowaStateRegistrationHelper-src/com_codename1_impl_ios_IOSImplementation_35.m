...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_35_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL743286356cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL743286356cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L743286356cn1_class_id_java_lang_Throwable1, label_L1495407511, restoreToL743286356cn1_class_id_java_lang_Throwable1);

label_L743286356:
 tryBlockOffsetL743286356cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L743286356cn1_class_id_java_lang_Throwable1);
    restoreToL743286356cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
