...
JAVA_VOID com_codename1_util_EasyThread_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL51782772401;
    int tryBlockOffsetL51782772401;
    DEFINE_CATCH_BLOCK(catch_L51782772401, label_L1352701387, restoreToL51782772401);
    int restoreToL135270138702;
    int tryBlockOffsetL135270138702;
    DEFINE_CATCH_BLOCK(catch_L135270138702, label_L1352701387, restoreToL135270138702);
    int restoreToL580779646cn1_class_id_java_lang_Throwable3;
    int tryBlockOffsetL580779646cn1_class_id_java_lang_Throwable3;
    DEFINE_CATCH_BLOCK(catch_L580779646cn1_class_id_java_lang_Throwable3, label_L1059781259, restoreToL580779646cn1_class_id_java_lang_Throwable3);
    __CN1_DEBUG_INFO(47);
...
label_L210055609:
    __CN1_DEBUG_INFO(49);
    if (/* CustomInvoke */com_codename1_util_EasyThread_access$000___com_codename1_util_EasyThread_R_boolean(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1798241454, 0);

label_L580779646:
 tryBlockOffsetL580779646cn1_class_id_java_lang_Throwable3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L580779646cn1_class_id_java_lang_Throwable3);
    restoreToL580779646cn1_class_id_java_lang_Throwable3 = threadStateData->threadObjectStackOffset;
...
label_L517827724:
 tryBlockOffsetL51782772401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L51782772401);
    restoreToL51782772401 = threadStateData->threadObjectStackOffset;
    ...
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L145364322, 2);
    __CN1_DEBUG_INFO(53);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1550894961, 2);
    __CN1_DEBUG_INFO(55);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
...
label_L2135203084:
END_TRY(1);    JUMP_TO(label_L674349432, 1);

label_L1352701387:
 tryBlockOffsetL135270138702 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L135270138702);
    restoreToL135270138702 = threadStateData->threadObjectStackOffset;
...
label_L674349432:
    __CN1_DEBUG_INFO(63);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1894301721, 1);
    __CN1_DEBUG_INFO(64);
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_java_lang_Runnable);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L712628794, 1);
    __CN1_DEBUG_INFO(65);
    virtual_java_lang_Runnable_run__(threadStateData, locals[1].data.o); 
    JUMP_TO(label_L1894301721, 1);
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(75);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[2].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L210055609, 0);
