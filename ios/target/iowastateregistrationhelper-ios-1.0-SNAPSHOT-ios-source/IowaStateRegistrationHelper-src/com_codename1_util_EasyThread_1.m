...
JAVA_VOID com_codename1_util_EasyThread_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL134818367301;
    int tryBlockOffsetL134818367301;
    DEFINE_CATCH_BLOCK(catch_L134818367301, label_L416519915, restoreToL134818367301);
    int restoreToL41651991502;
    int tryBlockOffsetL41651991502;
    DEFINE_CATCH_BLOCK(catch_L41651991502, label_L416519915, restoreToL41651991502);
    int restoreToL1435685475cn1_class_id_java_lang_Throwable3;
    int tryBlockOffsetL1435685475cn1_class_id_java_lang_Throwable3;
    DEFINE_CATCH_BLOCK(catch_L1435685475cn1_class_id_java_lang_Throwable3, label_L737025043, restoreToL1435685475cn1_class_id_java_lang_Throwable3);
    __CN1_DEBUG_INFO(47);
...
label_L728153884:
    __CN1_DEBUG_INFO(49);
    if (/* CustomInvoke */com_codename1_util_EasyThread_access$000___com_codename1_util_EasyThread_R_boolean(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L408533398, 0);

label_L1435685475:
 tryBlockOffsetL1435685475cn1_class_id_java_lang_Throwable3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1435685475cn1_class_id_java_lang_Throwable3);
    restoreToL1435685475cn1_class_id_java_lang_Throwable3 = threadStateData->threadObjectStackOffset;
...
label_L1348183673:
 tryBlockOffsetL134818367301 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L134818367301);
    restoreToL134818367301 = threadStateData->threadObjectStackOffset;
    ...
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1896452019, 2);
    __CN1_DEBUG_INFO(53);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1978215351, 2);
    __CN1_DEBUG_INFO(55);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
...
label_L1730398598:
END_TRY(1);    JUMP_TO(label_L2080126677, 1);

label_L416519915:
 tryBlockOffsetL41651991502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L41651991502);
    restoreToL41651991502 = threadStateData->threadObjectStackOffset;
...
label_L2080126677:
    __CN1_DEBUG_INFO(63);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1186290190, 1);
    __CN1_DEBUG_INFO(64);
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_java_lang_Runnable);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L2059236860, 1);
    __CN1_DEBUG_INFO(65);
    virtual_java_lang_Runnable_run__(threadStateData, locals[1].data.o); 
    JUMP_TO(label_L1186290190, 1);
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(75);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[2].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L728153884, 0);
