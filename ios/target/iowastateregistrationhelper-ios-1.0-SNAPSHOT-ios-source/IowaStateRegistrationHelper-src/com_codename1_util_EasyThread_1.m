...
JAVA_VOID com_codename1_util_EasyThread_1___INIT_____com_codename1_util_EasyThread(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7284, 200);
...
JAVA_VOID com_codename1_util_EasyThread_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 7284, 202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL178466283401;
    int tryBlockOffsetL178466283401;
    DEFINE_CATCH_BLOCK(catch_L178466283401, label_L423459527, restoreToL178466283401);
    int restoreToL42345952702;
    int tryBlockOffsetL42345952702;
    DEFINE_CATCH_BLOCK(catch_L42345952702, label_L423459527, restoreToL42345952702);
    int restoreToL1293626943cn1_class_id_java_lang_Throwable3;
    int tryBlockOffsetL1293626943cn1_class_id_java_lang_Throwable3;
    DEFINE_CATCH_BLOCK(catch_L1293626943cn1_class_id_java_lang_Throwable3, label_L2097361864, restoreToL1293626943cn1_class_id_java_lang_Throwable3);
    __CN1_DEBUG_INFO(47);
...
label_L2125952195:
    __CN1_DEBUG_INFO(49);
    if (/* CustomInvoke */com_codename1_util_EasyThread_access$000___com_codename1_util_EasyThread_R_boolean(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L408648902, 0);

label_L1293626943:
 tryBlockOffsetL1293626943cn1_class_id_java_lang_Throwable3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1293626943cn1_class_id_java_lang_Throwable3);
    restoreToL1293626943cn1_class_id_java_lang_Throwable3 = threadStateData->threadObjectStackOffset;
...
label_L1784662834:
 tryBlockOffsetL178466283401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L178466283401);
    restoreToL178466283401 = threadStateData->threadObjectStackOffset;
    ...
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L546552684, 2);
    __CN1_DEBUG_INFO(53);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1384781563, 2);
    __CN1_DEBUG_INFO(55);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
...
label_L1138171728:
END_TRY(1);    JUMP_TO(label_L1972176213, 1);

label_L423459527:
 tryBlockOffsetL42345952702 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L42345952702);
    restoreToL42345952702 = threadStateData->threadObjectStackOffset;
...
label_L1972176213:
    __CN1_DEBUG_INFO(63);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1215858771, 1);
    __CN1_DEBUG_INFO(64);
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_java_lang_Runnable);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1254584937, 1);
    __CN1_DEBUG_INFO(65);
    virtual_java_lang_Runnable_run__(threadStateData, locals[1].data.o); 
    JUMP_TO(label_L1215858771, 1);
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(75);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[2].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L2125952195, 0);
