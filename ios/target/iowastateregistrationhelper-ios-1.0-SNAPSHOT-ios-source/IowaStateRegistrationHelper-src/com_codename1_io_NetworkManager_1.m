...
JAVA_VOID com_codename1_io_NetworkManager_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1570285166cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1570285166cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1570285166cn1_class_id_java_lang_InterruptedException1, label_L1495860636, restoreToL1570285166cn1_class_id_java_lang_InterruptedException1);
    int restoreToL221267015cn1_class_id_java_lang_InterruptedException2;
    int tryBlockOffsetL221267015cn1_class_id_java_lang_InterruptedException2;
    DEFINE_CATCH_BLOCK(catch_L221267015cn1_class_id_java_lang_InterruptedException2, label_L627747774, restoreToL221267015cn1_class_id_java_lang_InterruptedException2);

label_L25734038:
    __CN1_DEBUG_INFO(528);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$700___com_codename1_io_NetworkManager_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1803161368, 0);

label_L1570285166:
 tryBlockOffsetL1570285166cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1570285166cn1_class_id_java_lang_InterruptedException1);
    restoreToL1570285166cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L411064571:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L152349586, 0);
...
label_L324346512:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L2043922005, 0);
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1122636984, 0);
    ...
    if (virtual_com_codename1_io_ConnectionRequest_getTimeout___R_int(threadStateData, locals[4].data.o)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1480051614, 0);
...
label_L1480051614:
    ...
    if (virtual_com_codename1_io_ConnectionRequest_getTimeSinceLastActivity___R_int(threadStateData, locals[4].data.o)<=ilocals_5_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1122636984, 0);
...
label_L221267015:
 tryBlockOffsetL221267015cn1_class_id_java_lang_InterruptedException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L221267015cn1_class_id_java_lang_InterruptedException2);
    restoreToL221267015cn1_class_id_java_lang_InterruptedException2 = threadStateData->threadObjectStackOffset;
...
label_L1960031025:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(4);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ JUMP_TO(label_L1122636984, 0);
    __CN1_DEBUG_INFO(559);
    if (virtual_com_codename1_io_ConnectionRequest_getTimeSinceLastActivity___R_int(threadStateData, locals[4].data.o)<=ilocals_5_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1122636984, 0);
    __CN1_DEBUG_INFO(561);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$700___com_codename1_io_NetworkManager_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1122636984, 0);
...
label_L1122636984:
    __CN1_DEBUG_INFO(540);
    BC_IINC(3, 1);
    JUMP_TO(label_L324346512, 0);

label_L2043922005:
    __CN1_DEBUG_INFO(570);
    JUMP_TO(label_L25734038, 0);
