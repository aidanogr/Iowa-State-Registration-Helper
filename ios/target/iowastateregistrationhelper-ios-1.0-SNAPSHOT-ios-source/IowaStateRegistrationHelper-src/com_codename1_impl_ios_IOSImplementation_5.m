...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_5_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 9658, 203);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL173509989101;
    int tryBlockOffsetL173509989101;
    DEFINE_CATCH_BLOCK(catch_L173509989101, label_L743219449, restoreToL173509989101);
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L108982313, 0);
...
label_L1735099891:
 tryBlockOffsetL173509989101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L173509989101);
    restoreToL173509989101 = threadStateData->threadObjectStackOffset;
