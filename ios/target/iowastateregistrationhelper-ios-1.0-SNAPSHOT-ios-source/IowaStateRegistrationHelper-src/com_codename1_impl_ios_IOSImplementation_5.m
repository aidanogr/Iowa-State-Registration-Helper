...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_5_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL114765008601;
    int tryBlockOffsetL114765008601;
    DEFINE_CATCH_BLOCK(catch_L114765008601, label_L2021053848, restoreToL114765008601);
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1245593227, 0);
...
label_L1147650086:
 tryBlockOffsetL114765008601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L114765008601);
    restoreToL114765008601 = threadStateData->threadObjectStackOffset;
